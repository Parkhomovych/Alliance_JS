...
let s=new URLSearchParams({limit:t}),l=await eI.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${s}`);return l};function ih(t){iu.innerHTML=t.map(t=>`
    ...
    function(t){let e=id.findIndex(({_id:e})=>e===t);return(console.log(e),e>-1&&id[e].favorit)?" add-fill":""}(t._id)}" data-set="${t._id}" viewBox="0 0 32 32">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join(""),function(){let t=document.querySelectorAll(".box-star");t.forEach(t=>{let e=t.previousElementSibling,i=Math.round(e.textContent),n=[...t.children];n.forEach((t,e)=>{e<i&&t.classList.add("yellow-star")})})}()}window.addEventListener("load",function(){im().then(ih).catch(t=>{console.log(t)})});const ig=new MutationObserver(function(){let t=document.querySelectorAll(".info-btn");// витягуємо всі кнопки
t.forEach(t=>{t.addEventListener("click",iy);// вішаємо слухача на кнопки
})});// створюємо екземпляр класу MutationObserver
function iy(t){let e=t.target.id;eQ(e).then(t=>{ix(t);let e=document.querySelector(".basicLightbox");e.classList.add("correct-recipe")}).catch(t=>{console.log(t)})}function ix(t){let{data:{title:e,youtube:i,thumb:n,rating:o,time:a,ingredients:r,tags:s,instructions:l}}=t,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),f=g.create(`<div class="card-modal">
...
childList:!0,subtree:!0});var ib={};window,ib=/******/function(t){/******/// The module cache
...
const iv={allCategiries:document.querySelector(".categories-btn-all-js"),categories:document.querySelector(".categories-js"),popular:document.querySelector(".popular-change-js"),paginationShow:document.querySelector("#tui-pagination-container"),pagination:document.getElementById("tui-pagination-container")};// налаштування початкових значень в залежносты від ширини вьюпорту
let iw=window.innerWidth<768?6:window.innerWidth<1280?8:9,ik=1,iS=window.innerWidth<768?2:3;// екземпляр класу з параметрами для запиту рецептів по філтру
const iC=new URLSearchParams({page:ik,limit:iw}),iE={totalItems:0,itemsPerPage:iw,visiblePages:iS,page:ik},iN=new/*@__PURE__*/(h(ib))(iv.pagination,iE);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
function iT(){iN.off("afterMove",iL),iO("page",1),e2(iC).then(t=>{ih(t.data.results),// встановлення слухача пагінації, відображення її
function(t){if(iN.reset(t*iw),t>1){iN.on("afterMove",iL),iv.paginationShow.classList.remove("is-hidden");return}iv.paginationShow.classList.contains("is-hidden")||iv.paginationShow.classList.add("is-hidden"),t||/*@__PURE__*/h(ic).Notify.info("Вибачте, згідно параметрів пошуку рецептів не знайдено")}(t.data.totalPages)}).catch(()=>{})}// перемальовка рецептів при зміщенні пагінації
function iL(){iO("page",ik=iN.getCurrentPage()),e2(iC).then(t=>{ih(t.data.results)}).catch(()=>{})}// вибір "всіх категорій" по натисканню "AllCategories"
function iA(){iM(),iv.allCategiries.classList.add("is-active"),iB("category"),iT()}// вибір конкретної категорії
function iI(t){if("BUTTON"!==t.target.nodeName)return;iv.allCategiries.classList.contains("is-active")&&iv.allCategiries.classList.remove("is-active"),iM(),t.target.classList.add("is-active");let e=t.target.dataset.set;iO("category",e),iT()}// знімаємо помітку з активної категорії
function iM(){let t=iv.categories.querySelector(".is-active");t&&t.classList.remove("is-active")}// обробка вибору популярного рецепту
function iz(t){if("BUTTON"!==t.currentTarget.nodeName)return;let e=t.currentTarget.dataset.set;!function(t){eQ(t).then(t=>{ix(t);let e=document.querySelector(".basicLightbox");e.classList.add("correct-recipe")}).catch(t=>{console.log(t)})}(e)}// додавання/зміна параметру в об'єкт для пошуку рецепту
function iO(t,e){iC.has(t)&&iC.delete(t),iC.append(t,e)}// вилучення параметра в об'єкті пошуку рецепту
function iB(t){for(;iC.has(t);)iC.delete(t)}/**
  |============================
  | Refs hero
  |============================
...
window.addEventListener("unload",function(){iv.allCategiries.removeEventListener("click",iA),iv.categories.removeEventListener("click",iI),iv.popular.removeEventListener("click",iz),iN.off("afterMove",iL)}),eK().then(t=>{iv.categories.insertAdjacentHTML("beforeend",// формування розмітки переліку категорій
...
iT(),eJ().then(t=>{iv.popular.insertAdjacentHTML("beforeend",t.data.map(t=>`
...
let e=iv.popular.querySelectorAll(".popular-button-js");e.forEach(t=>{t.addEventListener("click",iz)})}).catch(()=>{});const i_=iP();function iR(t){let e=/**
  |============================
  | Розмітка Swiper
  |============================
*/function(t){let{cook:e,topic:i}=t;return t.map(t=>`<div class="swiper-slide">
        ...
        </div>`).join("")}(t.data);i_.markupSwiper.insertAdjacentHTML("afterbegin",e)}/**
  |============================
  | Бібліотека Swiper
  |============================
*//**
 ...
 *//* eslint-disable no-param-reassign */function iD(t){return null!==t&&"object"==typeof t&&"constructor"in t&&t.constructor===Object}function ij(t,e){void 0===t&&(t={}),void 0===e&&(e={}),Object.keys(e).forEach(i=>{void 0===t[i]?t[i]=e[i]:iD(e[i])&&iD(t[i])&&Object.keys(e[i]).length>0&&ij(t[i],e[i])})}// Прослуховувачі подій
window.addEventListener("load",function(){eY().then(iR).catch(t=>{console.log(t)})}),i_.orderBtnHero.addEventListener("click",function(){e9();// const modalMessage = document.querySelector('.header-form');
// callMassageAdd(modalMessage);
});const iW={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector:()=>null,querySelectorAll:()=>[],getElementById:()=>null,createEvent:()=>({initEvent(){}}),createElement:()=>({children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName:()=>[]}),createElementNS:()=>({}),importNode:()=>null,location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function iF(){let t="undefined"!=typeof document?document:{};return ij(t,iW),t}const i$={document:iW,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle:()=>({getPropertyValue:()=>""}),Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia:()=>({}),requestAnimationFrame:t=>"undefined"==typeof setTimeout?(t(),null):setTimeout(t,0),cancelAnimationFrame(t){"undefined"!=typeof setTimeout&&clearTimeout(t)}};function iU(){let t="undefined"!=typeof window?window:{};return ij(t,i$),t}function iH(t,e){return void 0===e&&(e=0),setTimeout(t,e)}function iX(){return Date.now()}function iq(t){return"object"==typeof t&&null!==t&&t.constructor&&"Object"===Object.prototype.toString.call(t).slice(8,-1)}function iG(){let t=Object(arguments.length<=0?void 0:arguments[0]),e=["__proto__","constructor","prototype"];for(let i=1;i<arguments.length;i+=1){let n=i<0||arguments.length<=i?void 0:arguments[i];if(null!=n&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType)){let i=Object.keys(Object(n)).filter(t=>0>e.indexOf(t));for(let e=0,o=i.length;e<o;e+=1){let o=i[e],a=Object.getOwnPropertyDescriptor(n,o);void 0!==a&&a.enumerable&&(iq(t[o])&&iq(n[o])?n[o].__swiper__?t[o]=n[o]:iG(t[o],n[o]):!iq(t[o])&&iq(n[o])?(t[o]={},n[o].__swiper__?t[o]=n[o]:iG(t[o],n[o])):t[o]=n[o])}}}return t}function iV(t,e,i){t.style.setProperty(e,i)}function iY(t){let e,{swiper:i,targetPosition:n,side:o}=t,a=iU(),r=-i.translate,s=null,l=i.params.speed;i.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(i.cssModeFrameID);let c=n>r?"next":"prev",f=(t,e)=>"next"===c&&t>=e||"prev"===c&&t<=e,d=()=>{e=new Date().getTime(),null===s&&(s=e);let t=Math.max(Math.min((e-s)/l,1),0),c=r+(.5-Math.cos(t*Math.PI)/2)*(n-r);if(f(c,n)&&(c=n),i.wrapperEl.scrollTo({[o]:c}),f(c,n)){i.wrapperEl.style.overflow="hidden",i.wrapperEl.style.scrollSnapType="",setTimeout(()=>{i.wrapperEl.style.overflow="",i.wrapperEl.scrollTo({[o]:c})}),a.cancelAnimationFrame(i.cssModeFrameID);return}i.cssModeFrameID=a.requestAnimationFrame(d)};d()}function iK(t,e){return void 0===e&&(e=""),[...t.children].filter(t=>t.matches(e))}function iJ(t,e){void 0===e&&(e=[]);let i=document.createElement(t);return i.classList.add(...Array.isArray(e)?e:[e]),i}function iQ(t,e){let i=iU();return i.getComputedStyle(t,null).getPropertyValue(e)}function iZ(t){let e,i=t;if(i){// eslint-disable-next-line
for(e=0;null!==(i=i.previousSibling);)1===i.nodeType&&(e+=1);return e}}function i0(t,e){let i=[],n=t.parentElement;// eslint-disable-line
for(;n;)e?n.matches(e)&&i.push(n):i.push(n),n=n.parentElement;return i}function i1(t,e,i){let n=iU();return i?t["width"===e?"offsetWidth":"offsetHeight"]+parseFloat(n.getComputedStyle(t,null).getPropertyValue("width"===e?"margin-right":"margin-top"))+parseFloat(n.getComputedStyle(t,null).getPropertyValue("width"===e?"margin-left":"margin-bottom")):t.offsetWidth}function i2(){return e||(e=function(){let t=iU(),e=iF();return{smoothScroll:e.documentElement&&e.documentElement.style&&"scrollBehavior"in e.documentElement.style,touch:!!("ontouchstart"in t||t.DocumentTouch&&e instanceof t.DocumentTouch)}}()),e}const i5=(t,e)=>{if(!t||t.destroyed||!t.params)return;let i=e.closest(t.isElement?"swiper-slide":`.${t.params.slideClass}`);if(i){let e=i.querySelector(`.${t.params.lazyPreloaderClass}`);!e&&t.isElement&&(e=i.shadowRoot.querySelector(`.${t.params.lazyPreloaderClass}`)),e&&e.remove()}},i6=(t,e)=>{if(!t.slides[e])return;let i=t.slides[e].querySelector('[loading="lazy"]');i&&i.removeAttribute("loading")},i3=t=>{if(!t||t.destroyed||!t.params)return;let e=t.params.lazyPreloadPrevNext,i=t.slides.length;if(!i||!e||e<0)return;e=Math.min(e,i);let n="auto"===t.params.slidesPerView?t.slidesPerViewDynamic():Math.ceil(t.params.slidesPerView),o=t.activeIndex;if(t.params.grid&&t.params.grid.rows>1){let i=[o-e];i.push(...Array.from({length:e}).map((t,e)=>o+n+e)),t.slides.forEach((e,n)=>{i.includes(e.column)&&i6(t,n)});return}let a=o+n-1;if(t.params.rewind||t.params.loop)for(let n=o-e;n<=a+e;n+=1){let e=(n%i+i)%i;(e<o||e>a)&&i6(t,e)}else for(let n=Math.max(o-e,0);n<=Math.min(a+e,i-1);n+=1)n!==o&&(n>a||n<o)&&i6(t,n)};function i4(t){let{swiper:e,runCallbacks:i,direction:n,step:o}=t,{activeIndex:a,previousIndex:r}=e,s=n;if(s||(s=a>r?"next":a<r?"prev":"reset"),e.emit(`transition${o}`),i&&a!==r){if("reset"===s){e.emit(`slideResetTransition${o}`);return}e.emit(`slideChangeTransition${o}`),"next"===s?e.emit(`slideNextTransition${o}`):e.emit(`slidePrevTransition${o}`)}}function i8(t){let e=iF(),i=iU(),n=this.touchEventsData;n.evCache.push(t);let{params:o,touches:a,enabled:r}=this;if(!r||!o.simulateTouch&&"mouse"===t.pointerType||this.animating&&o.preventInteractionOnTransition)return;!this.animating&&o.cssMode&&o.loop&&this.loopFix();let s=t;s.originalEvent&&(s=s.originalEvent);let l=s.target;if("wrapper"===o.touchEventsTarget&&!this.wrapperEl.contains(l)||"which"in s&&3===s.which||"button"in s&&s.button>0||n.isTouched&&n.isMoved)return;// change target el for shadow root component
...
r.updateProgress(a),s.cssMode){let t=r.isHorizontal();if(0===e)l[t?"scrollLeft":"scrollTop"]=-a;else{if(!r.support.smoothScroll)return iY({swiper:r,targetPosition:-a,side:t?"left":"top"}),!0;l.scrollTo({[t?"left":"top"]:-a,behavior:"smooth"})}return!0}return 0===e?(r.setTransition(0),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",e,o),r.emit("transitionEnd"))):(r.setTransition(e),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",e,o),r.emit("transitionStart")),r.animating||(r.animating=!0,r.onTranslateToWrapperTransitionEnd||(r.onTranslateToWrapperTransitionEnd=function(t){r&&!r.destroyed&&t.target===this&&(r.wrapperEl.removeEventListener("transitionend",r.onTranslateToWrapperTransitionEnd),r.onTranslateToWrapperTransitionEnd=null,delete r.onTranslateToWrapperTransitionEnd,i&&r.emit("transitionEnd"))}),r.wrapperEl.addEventListener("transitionend",r.onTranslateToWrapperTransitionEnd))),!0}},transition:{setTransition:function(t,e){this.params.cssMode||(this.wrapperEl.style.transitionDuration=`${t}ms`,this.wrapperEl.style.transitionDelay=0===t?"0ms":""),this.emit("setTransition",t,e)},transitionStart:function(t,e){void 0===t&&(t=!0);let{params:i}=this;i.cssMode||(i.autoHeight&&this.updateAutoHeight(),i4({swiper:this,runCallbacks:t,direction:e,step:"Start"}))},transitionEnd:function(t,e){void 0===t&&(t=!0);let{params:i}=this;this.animating=!1,i.cssMode||(this.setTransition(0),i4({swiper:this,runCallbacks:t,direction:e,step:"End"}))}},slide:{slideTo:function(t,e,i,n,o){let a;void 0===t&&(t=0),void 0===e&&(e=this.params.speed),void 0===i&&(i=!0),"string"==typeof t&&(t=parseInt(t,10));let r=this,s=t;s<0&&(s=0);let{params:l,snapGrid:c,slidesGrid:f,previousIndex:d,activeIndex:p,rtlTranslate:u,wrapperEl:m,enabled:h}=r;if(r.animating&&l.preventInteractionOnTransition||!h&&!n&&!o)return!1;let g=Math.min(r.params.slidesPerGroupSkip,s),y=g+Math.floor((s-g)/r.params.slidesPerGroup);y>=c.length&&(y=c.length-1);let x=-c[y];// Normalize slideIndex
...
return t}return iK(i,n())[0]})();return!o&&e.params.createElements&&(o=iJ("div",e.params.wrapperClass),i.append(o),iK(i,`.${e.params.slideClass}`).forEach(t=>{o.append(t)})),Object.assign(e,{el:i,wrapperEl:o,slidesEl:e.isElement&&!i.parentNode.host.slideSlots?i.parentNode.host:o,hostEl:e.isElement?i.parentNode.host:i,mounted:!0,// RTL
rtl:"rtl"===i.dir.toLowerCase()||"rtl"===iQ(i,"direction"),rtlTranslate:"horizontal"===e.params.direction&&("rtl"===i.dir.toLowerCase()||"rtl"===iQ(i,"direction")),wrongRTL:"-webkit-box"===iQ(o,"display")}),!0}init(t){let e=this;if(e.initialized)return e;let i=e.mount(t);if(!1===i)return e;e.emit("beforeInit"),e.params.breakpoints&&e.setBreakpoint(),// Add Classes
...
e.attachEvents();let n=[...e.el.querySelectorAll('[loading="lazy"]')];return e.isElement&&n.push(...e.hostEl.querySelectorAll('[loading="lazy"]')),n.forEach(t=>{t.complete?i5(e,t):t.addEventListener("load",t=>{i5(e,t.target)})}),i3(e),// Init Flag
e.initialized=!0,i3(e),// Emit
...
}})}(i)),i.destroyed=!0),null}static extendDefaults(t){iG(nf,t)}static get extendedDefaults(){return nf}static get defaults(){return nl}static installModule(t){nd.prototype.__modules__||(nd.prototype.__modules__=[]);let e=nd.prototype.__modules__;"function"==typeof t&&0>e.indexOf(t)&&e.push(t)}static use(t){return Array.isArray(t)?t.forEach(t=>nd.installModule(t)):nd.installModule(t),nd}}function np(t){return void 0===t&&(t=""),`.${t.trim().replace(/([\.:!+\/])/g,"\\$1")// eslint-disable-line
.replace(/ /g,".")}`}Object.keys(nc).forEach(t=>{Object.keys(nc[t]).forEach(e=>{nd.prototype[e]=nc[t][e]})}),nd.use([function(t){let{swiper:e,on:i,emit:n}=t,o=iU(),a=null,r=null,s=()=>{e&&!e.destroyed&&e.initialized&&(n("beforeResize"),n("resize"))},l=()=>{e&&!e.destroyed&&e.initialized&&(a=new ResizeObserver(t=>{r=o.requestAnimationFrame(()=>{let{width:i,height:n}=e,o=i,a=n;t.forEach(t=>{let{contentBoxSize:i,contentRect:n,target:r}=t;r&&r!==e.el||(o=n?n.width:(i[0]||i).inlineSize,a=n?n.height:(i[0]||i).blockSize)}),(o!==i||a!==n)&&s()})})).observe(e.el)},c=()=>{r&&o.cancelAnimationFrame(r),a&&a.unobserve&&e.el&&(a.unobserve(e.el),a=null)},f=()=>{e&&!e.destroyed&&e.initialized&&n("orientationchange")};i("init",()=>{if(e.params.resizeObserver&&void 0!==o.ResizeObserver){l();return}o.addEventListener("resize",s),o.addEventListener("orientationchange",f)}),i("destroy",()=>{c(),o.removeEventListener("resize",s),o.removeEventListener("orientationchange",f)})},function(t){let{swiper:e,extendParams:i,on:n,emit:o}=t,a=[],r=iU(),s=function(t,i){void 0===i&&(i={});let n=r.MutationObserver||r.WebkitMutationObserver,s=new n(t=>{// The observerUpdate event should only be triggered
// once despite the number of mutations.  Additional
// triggers are redundant and are very costly
if(e.__preventObserver__)return;if(1===t.length){o("observerUpdate",t[0]);return}let i=function(){o("observerUpdate",t[0])};r.requestAnimationFrame?r.requestAnimationFrame(i):r.setTimeout(i,0)});s.observe(t,{attributes:void 0===i.attributes||i.attributes,childList:void 0===i.childList||i.childList,characterData:void 0===i.characterData||i.characterData}),a.push(s)};i({observer:!1,observeParents:!1,observeSlideChildren:!1}),n("init",()=>{if(e.params.observer){if(e.params.observeParents){let t=i0(e.hostEl);for(let e=0;e<t.length;e+=1)s(t[e])}// Observe container
s(e.hostEl,{childList:e.params.observeSlideChildren}),// Observe wrapper
s(e.wrapperEl,{attributes:!1})}}),n("destroy",()=>{a.forEach(t=>{t.disconnect()}),a.splice(0,a.length)})}]),nd.use([function(t){let e,{swiper:i,extendParams:n,on:o,emit:a}=t,r="swiper-pagination";n({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
dynamicBullets:!1,dynamicMainBullets:1,formatFractionCurrent:t=>t,formatFractionTotal:t=>t,bulletClass:`${r}-bullet`,bulletActiveClass:`${r}-bullet-active`,modifierClass:`${r}-`,currentClass:`${r}-current`,totalClass:`${r}-total`,hiddenClass:`${r}-hidden`,progressbarFillClass:`${r}-progressbar-fill`,progressbarOppositeClass:`${r}-progressbar-opposite`,clickableClass:`${r}-clickable`,lockClass:`${r}-lock`,horizontalClass:`${r}-horizontal`,verticalClass:`${r}-vertical`,paginationDisabledClass:`${r}-disabled`}}),i.pagination={el:null,bullets:[]};let s=0,l=t=>(Array.isArray(t)?t:[t]).filter(t=>!!t);function c(){return!i.params.pagination.el||!i.pagination.el||Array.isArray(i.pagination.el)&&0===i.pagination.el.length}function f(t,e){let{bulletActiveClass:n}=i.params.pagination;t&&(t=t[`${"prev"===e?"previous":"next"}ElementSibling`])&&(t.classList.add(`${n}-${e}`),(t=t[`${"prev"===e?"previous":"next"}ElementSibling`])&&t.classList.add(`${n}-${e}-${e}`))}function d(t){let e=t.target.closest(np(i.params.pagination.bulletClass));if(!e)return;t.preventDefault();let n=iZ(e)*i.params.slidesPerGroup;if(i.params.loop){if(i.realIndex===n)return;let t=i.realIndex,e=i.getSlideIndexByData(n),o=i.getSlideIndexByData(i.realIndex);if(e>i.slides.length-i.loopedSlides){let n=i.activeIndex;i.loopFix({direction:e>o?"next":"prev",activeSlideIndex:e,slideTo:!1});let a=i.activeIndex;n===a&&i.slideToLoop(t,0,!1,!0)}i.slideToLoop(n)}else i.slideTo(n)}function p(){let t,n;// Render || Update Pagination bullets/items
 ...
 * _.isObject(null);
 * // => false
 */function nA(t){var e=typeof t;return!!t&&("object"==e||"function"==e)}/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nI(t){if("number"==typeof t)return t;if("symbol"==typeof(e=t)||e&&"object"==typeof e&&"[object Symbol]"==nE.call(e))return ng;if(nA(t)){var e,i="function"==typeof t.valueOf?t.valueOf():t;t=nA(i)?i+"":i}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(ny,"");var n=nb.test(t);return n||nv.test(t)?nw(t.slice(2),n?2:8):nx.test(t)?ng:+t}nh=/**
...
return void 0===l||i>=e||i<0||d&&n>=a}function h(){var t,i,n,o=nL();if(m(o))return g(o);// Restart the timer.
s=setTimeout(h,(t=o-l,i=o-c,n=e-t,d?nT(n,a-i):n))}function g(t){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(s=void 0,p&&n)?u(t):(n=o=void 0,r))}function y(){var t,i=nL(),a=m(i);if(n=arguments,o=this,l=i,a){if(void 0===s)return(// Reset any `maxWait` timer.
c=t=l,// Start the timer for the trailing edge.
s=setTimeout(h,e),f?u(t):r);if(d)return(// Handle invocations in a tight loop.
s=setTimeout(h,e),u(l))}return void 0===s&&(s=setTimeout(h,e)),r}return e=nI(e)||0,nA(i)&&(f=!!i.leading,a=(d="maxWait"in i)?nN(nI(i.maxWait)||0,e):a,p="trailing"in i?!!i.trailing:p),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nL())},y};const nM={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nM.form.addEventListener("submit",function(t){t.preventDefault()}),nM.time.addEventListener("change",function(t){iO("time",t.currentTarget.value),iT()}),nM.area.addEventListener("change",function(t){iO("area",t.currentTarget.value),iT()}),nM.ingredients.addEventListener("change",function(t){iO("ingredient",t.currentTarget.value),iT()}),nM.search.addEventListener("input",/*@__PURE__*/h(nh)(()=>{iO("title",nM.search.value.trim()),iT()},300)),e0().then(t=>{nM.area.innerHTML=t.data.map(({name:t})=>`<option class="filter-opt" value="${t}">${t}</option>`).join("")}).catch(t=>{console.log(t)}),eZ().then(t=>{nM.ingredients.innerHTML=t.data.map(({name:t,_id:e})=>`<option class="filter-opt" value="${e}">${t}</option>`).join("")}).catch(t=>{}),// ❗ Створення Time ❗
function(){let t="";// ❗ ДОРОБИТИ ПРАВИЛЬНУ ЛОГІКУ ЧАСУ ❗
for(let e=0;e<220;e+=5)e%10==0&&(t+=`<option class="filter-opt" value="${e}">${e}</option>`);nM.time.insertAdjacentHTML("beforeend",t)}(),// ❗ Створення js-reset-filter-btn ❗
nM.resetBtn.addEventListener("click",function(t){iB("time"),iB("area"),iB("ingredient"),iB("title"),iT()}//# sourceMappingURL=index.2112cd08.js.map
);
//# sourceMappingURL=index.2112cd08.js.map
