...
});let ic=document.querySelector(".card-list");e=375>=window.outerWidth?6:768>=window.outerWidth?8:9;let id=async(t,i,n,o,a,r)=>{// Праметри API запиту
let s=new URLSearchParams({limit:e}),l=await tM.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${s}`);return l};function ip(e){ic.innerHTML=e.data.results.map(e=>`
    <li class="card-item">
    <div class="photo-card">
        ...
        <button type="button" class="btn-favorite" >
                <svg class="icon-favorite" data-set="${e._id}" viewBox="0 0 32 32">
...
function iC(){iS.off("afterMove",iE),iM("page",1),t2(iw).then(e=>{ip(e),// встановлення слухача пагінації, відображення її
...
function iE(){iM("page",ib=iS.getCurrentPage()),t2(iw).then(e=>{ip(e)}).catch(()=>{})}// вибір "всіх категорій" по натисканню "AllCategories"
...
c.params=iH({},d,ns,t),c.originalParams=iH({},c.params),c.passedParams=iH({},t),c.params&&c.params.on&&Object.keys(c.params.on).forEach(e=>{c.on(e,c.params.on[e])}),c.params&&c.params.onAny&&c.onAny(c.params.onAny),// Extend Swiper
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nT(e){if("number"==typeof e)return e;if("symbol"==typeof(t=e)||t&&"object"==typeof t&&"[object Symbol]"==nk.call(t))return nu;if(nN(e)){var t,i="function"==typeof e.valueOf?e.valueOf():e;e=nN(i)?i+"":i}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(nm,"");var n=ng.test(e);return n||ny.test(e)?nx(e.slice(2),n?2:8):nh.test(e)?nu:+e}np=/**
...
nL.resetBtn.addEventListener("click",function(e){iI("time"),iI("area"),iI("ingredient"),iI("title"),iC()})}();//# sourceMappingURL=index.be730870.js.map

//# sourceMappingURL=index.be730870.js.map
