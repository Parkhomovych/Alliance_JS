...
info:function(t,e,n){p(i.Info,t,e,n)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Notify:d.Notify}):{Notify:d.Notify}},"function"==typeof define&&define.amd?define([],function(){return r(a)}):"object"==typeof y?y=r(a):a.Notiflix=r(a);// utils is a library of generic helper functions non-specific to axios
let{toString:b}=Object.prototype,{getPrototypeOf:v}=Object,w=(s=Object.create(null),t=>{let e=b.call(t);return s[e]||(s[e]=e.slice(8,-1).toLowerCase())}),k=t=>(t=t.toLowerCase(),e=>w(e)===t),S=t=>e=>typeof e===t,{isArray:C}=Array,E=S("undefined"),N=k("ArrayBuffer"),T=S("string"),L=S("function"),A=S("number"),I=t=>null!==t&&"object"==typeof t,M=t=>{if("object"!==w(t))return!1;let e=v(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},z=k("Date"),O=k("File"),B=k("Blob"),P=k("FileList"),_=k("URLSearchParams");/**
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&N(t.buffer)},isString:T,isNumber:A,isBoolean:t=>!0===t||!1===t,isObject:I,isPlainObject:M,isUndefined:E,isDate:z,isFile:O,isBlob:B,isRegExp:H,isFunction:L,isStream:t=>I(t)&&L(t.pipe),isURLSearchParams:_,isTypedArray:F,isFileList:P,forEach:R,merge:/**
 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&L(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),i=(t,n)=>{if(I(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=C(t)?[]:{};return R(t,(t,e)=>{let a=i(t,n+1);E(a)||(o[e]=a)}),e[n]=void 0,o}}return t};return i(t,0)},isAsyncFn:Y,isThenable:t=>t&&(I(t)||L(t))&&L(t.then)&&L(t.catch)};/**
...
J.from=(t,e,i,n,o,a)=>{let r=Object.create(Q);return K.toFlatObject(t,r,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),J.call(r,t.message,e,i,n,o),r.cause=t,r.name=t.name,a&&Object.assign(r,a),r},p=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
...
te["-".charCodeAt(0)]=62,te["_".charCodeAt(0)]=63,d=function(t,e,i,n,o){var a,r,s=8*o-n-1,l=(1<<s)-1,c=l>>1,f=-7,p=i?o-1:0,d=i?-1:1,u=t[e+p];for(p+=d,a=u&(1<<-f)-1,u>>=-f,f+=s;f>0;a=256*a+t[e+p],p+=d,f-=8);for(r=a&(1<<-f)-1,a>>=-f,f+=n;f>0;r=256*r+t[e+p],p+=d,f-=8);if(0===a)a=1-c;else{if(a===l)return r?NaN:(u?-1:1)*(1/0);r+=Math.pow(2,n),a-=c}return(u?-1:1)*r*Math.pow(2,a-n)},u=function(t,e,i,n,o,a){var r,s,l,c=8*a-o-1,f=(1<<c)-1,p=f>>1,d=23===o?5960464477539062e-23:0,u=n?0:a-1,m=n?1:-1,h=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,r=f):(r=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-r))<1&&(r--,l*=2),r+p>=1?e+=d/l:e+=d*Math.pow(2,1-p),e*l>=2&&(r++,l/=2),r+p>=f?(s=0,r=f):r+p>=1?(s=(e*l-1)*Math.pow(2,o),r+=p):(s=e*Math.pow(2,p-1)*Math.pow(2,o),r=0));o>=8;t[i+u]=255&s,u+=m,s/=256,o-=8);for(r=r<<o|s,c+=o;c>0;t[i+u]=255&r,u+=m,r/=256,c-=8);t[i+u-m]|=128*h};let tr="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
if("number"==typeof t){if("string"==typeof e)throw TypeError('The "string" argument must be of type string. Received type number');return tp(t)}return tc(t,e,i)}function tc(t,e,i){if("string"==typeof t)return function(t,e){if(("string"!=typeof e||""===e)&&(e="utf8"),!tl.isEncoding(e))throw TypeError("Unknown encoding: "+e);let i=0|th(t,e),n=ts(i),o=n.write(t,e);return o!==i&&// cause everything after the first invalid character to be ignored. (e.g.
 ...
 * */tl.allocUnsafe=function(t){return tp(t)},/**
 * Equivalent to SlowBuffer(num), by default creates a non-zero-filled Buffer instance.
 */tl.allocUnsafeSlow=function(t){return tp(t)},tl.isBuffer=function(t){return null!=t&&!0===t._isBuffer&&t!==tl.prototype// so Buffer.isBuffer(Buffer.prototype) will be false
...
return l=e,c=i,tR(t_(t),this,l,c);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return f=e,p=i,tR(function(t,e){let i,n;let o=[];for(let a=0;a<t.length&&!((e-=2)<0);++a)n=(i=t.charCodeAt(a))>>8,o.push(i%256),o.push(n);return o}(t,this.length-f),this,f,p);default:if(u)throw TypeError("Unknown encoding: "+n);n=(""+n).toLowerCase(),u=!0}},tl.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}},tl.prototype.slice=function(t,e){let i=this.length;t=~~t,e=void 0===e?i:~~e,t<0?(t+=i)<0&&(t=0):t>i&&(t=i),e<0?(e+=i)<0&&(e=0):e>i&&(e=i),e<t&&(e=t);let n=this.subarray(t,e);return(// Return an augmented `Uint8Array` instance
...
let tL={};function tA(t,e,i){tL[t]=class extends i{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
this.name=`${this.name} [${t}]`,// Access the stack to generate the error message including the error code
// from the name.
this.stack// eslint-disable-line no-unused-expressions
,// Reset the name to the actual name.
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tI(t){let e="",i=t.length,n="-"===t[0]?1:0;for(;i>=n+4;i-=3)e=`_${t.slice(i-3,i)}${e}`;return`${t.slice(0,i)}${e}`}function tM(t,e,i,n,o,a){if(t>i||t<e){let n;let o="bigint"==typeof e?"n":"";throw n=a>3?0===e||e===BigInt(0)?`>= 0${o} and < 2${o} ** ${(a+1)*8}${o}`:`>= -(2${o} ** ${(a+1)*8-1}${o}) and < 2 ** ${(a+1)*8-1}${o}`:`>= ${e}${o} and <= ${i}${o}`,new tL.ERR_OUT_OF_RANGE("value",n,t)}tz(o,"offset"),(void 0===n[o]||void 0===n[o+a])&&tO(o,n.length-(a+1))}function tz(t,e){if("number"!=typeof t)throw new tL.ERR_INVALID_ARG_TYPE(e,"number",t)}function tO(t,e,i){if(Math.floor(t)!==t)throw tz(t,i),new tL.ERR_OUT_OF_RANGE(i||"offset","an integer",t);if(e<0)throw new tL.ERR_BUFFER_OUT_OF_BOUNDS;throw new tL.ERR_OUT_OF_RANGE(i||"offset",`>= ${i?1:0} and <= ${e}`,t)}tA("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tA("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tA("ERR_OUT_OF_RANGE",function(t,e,i){let n=`The value of "${t}" is out of range.`,o=i;return Number.isInteger(i)&&Math.abs(i)>4294967296?o=tI(String(i)):"bigint"==typeof i&&(o=String(i),(i>BigInt(2)**BigInt(32)||i<-(BigInt(2)**BigInt(32)))&&(o=tI(o)),o+="n"),n+=` It must be ${e}. Received ${o}`},RangeError);// HELPER FUNCTIONS
// ================
let tB=/[^+/0-9A-Za-z-_]/g;function tP(t,e){let i;e=e||1/0;let n=t.length,o=null,a=[];for(let r=0;r<n;++r){// is surrogate component
...
t=tU(t),!i&&e?"["+t+"]":t)}).join(i?".":""):e}let tX=K.toFlatObject(K,{},null,function(t){return/^is[A-Z]/.test(t)});var tq=/**
...
i=tU(i),s.forEach(function(t,n){K.isUndefined(t)||null===t||e.append(!0===r?tH([i],n,a):null===r?i:i+"[]",c(t))}),!1)}}return!!t$(t)||(e.append(tH(o,i,a),c(t)),!1)}let p=[],d=Object.assign(tX,{defaultVisitor:f,convertValue:c,isVisitable:t$});if(!K.isObject(t))throw TypeError("data must be an object");return!function t(i,n){if(!K.isUndefined(i)){if(-1!==p.indexOf(i))throw Error("Circular reference detected in "+n.join("."));p.push(i),K.forEach(i,function(i,a){let r=!(K.isUndefined(i)||null===i)&&o.call(e,i,K.isString(a)?a.trim():a,n,d);!0===r&&t(i,n?n.concat(a):[a])}),p.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tV(t,e){this._pairs=[],t&&tq(t,this,e)}let tY=tV.prototype;/**
 ...
 *
 * @returns {boolean}
 */let t5=("undefined"==typeof navigator||"ReactNative"!==(o=navigator.product)&&"NativeScript"!==o&&"NS"!==o)&&"undefined"!=typeof window&&"undefined"!=typeof document,t6="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
...
let t9=K.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
...
i.setAttribute("href",n),n=i.href),i.setAttribute("href",n),{href:i.href,protocol:i.protocol?i.protocol.replace(/:$/,""):"",host:i.host,search:i.search?i.search.replace(/^\?/,""):"",hash:i.hash?i.hash.replace(/^#/,""):"",hostname:i.hostname,port:i.port,pathname:"/"===i.pathname.charAt(0)?i.pathname:"/"+i.pathname}}/**
    ...
    */return t=n(window.location.href),function(e){let i=K.isString(e)?n(e):e;return i.protocol===t.protocol&&i.host===t.host}}():function(){return!0},ed=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(t,e){let i;t=t||10;let n=Array(t),o=Array(t),a=0,r=0;return e=void 0!==e?e:1e3,function(s){let l=Date.now(),c=o[r];i||(i=l),n[a]=s,o[a]=l;let f=r,p=0;for(;f!==a;)p+=n[f++],f%=t;if((a=(a+1)%t)===r&&(r=(r+1)%t),l-i<e)return;let d=c&&l-c;return d?Math.round(1e3*p/d):void 0}};function eu(t,e){let i=0,n=ed(50,250);return o=>{let a=o.loaded,r=o.lengthComputable?o.total:void 0,s=a-i,l=n(s),c=a<=r;i=a;let f={loaded:a,total:r,progress:r?a/r:void 0,bytes:s,rate:l||void 0,estimated:l&&r&&c?(r-a)/l:void 0,event:o};f[e?"download":"upload"]=!0,t(f)}}let em="undefined"!=typeof XMLHttpRequest;var eh=em&&function(t){return new Promise(function(e,i){let n,o=t.data,a=ea.from(t.headers).normalize(),r=t.responseType;function s(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}K.isFormData(o)&&(t3.isStandardBrowserEnv||t3.isStandardBrowserWebWorkerEnv?a.setContentType(!1):a.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
...
let e=(t.withCredentials||ep(c))&&t.xsrfCookieName&&ec.read(t.xsrfCookieName);e&&a.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
...
n=e=>{l&&(i(!e||e.type?new el(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let p=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(c);if(p&&-1===t3.protocols.indexOf(p)){i(new J("Unsupported protocol "+p+":",J.ERR_BAD_REQUEST,t));return}// Send the request
l.send(o||null)})};let eg={http:null,xhr:eh};K.forEach(eg,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
e.data=er.call(t,t.transformResponse,e),e.headers=ea.from(e.headers),e},function(e){return!es(e)&&(ex(t),e&&e.response&&(e.response.data=er.call(t,t.transformResponse,e.response),e.response.headers=ea.from(e.response.headers))),Promise.reject(e)})}let ev=t=>t instanceof ea?t.toJSON():t;function ew(t,e){// eslint-disable-next-line no-param-reassign
...
eI.Axios=eT,// Expose Cancel & CancelToken
eI.CanceledError=el,eI.CancelToken=eL,eI.isCancel=es,eI.VERSION=ek,eI.toFormData=tq,// Expose AxiosError class
eI.AxiosError=J,// alias for CanceledError for backward compatibility
eI.Cancel=eI.CanceledError,// Expose all/spread
eI.all=function(t){return Promise.all(t)},eI.spread=function(t){return function(e){return t.apply(null,e)}},// Expose isAxiosError
eI.isAxiosError=function(t){return K.isObject(t)&&!0===t.isAxiosError},// Expose mergeConfig
eI.mergeConfig=ew,eI.AxiosHeaders=ea,eI.formToJSON=t=>t4(K.isHTMLForm(t)?new FormData(t):t),eI.getAdapter=ey.getAdapter,eI.HttpStatusCode=eA,eI.default=eI;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:eM,AxiosError:ez,CanceledError:eO,isCancel:eB,CancelToken:eP,VERSION:e_,all:eR,Cancel:eD,isAxiosError:ej,spread:eW,toFormData:eF,AxiosHeaders:e$,HttpStatusCode:eU,formToJSON:eH,getAdapter:eX,mergeConfig:eq}=eI,eG="https://tasty-treats-backend.p.goit.global/api",eV={events:"/events",recipes:"/recipes",categories:"/categories",popular:"/recipes/popular",ingredients:"/ingredients",areas:"/areas",orders:"/orders/add"},eY=async()=>{let t=await eI.get(`${eG}${eV.events}`);return t},eK=async()=>{let t=await eI.get(`${eG}${eV.categories}`);return t},eJ=async()=>{let t=await eI.get(`${eG}${eV.popular}`);return t},eQ=async t=>{let e=await eI.get(`${eG}${eV.recipes}/${t}`);return e},eZ=async()=>{let t=await eI.get(`${eG}${eV.ingredients}`);return t},e0=async()=>{let t=await eI.get(`${eG}${eV.areas}`);return t},e1=async t=>{let e=await eI.post(`${eG}${eV.orders}`,t);return e},e2=async t=>{let e=await eI.get(`${eG}${eV.recipes}?${t}`);return e};function e5(t){"Success"===t.data.message?(0,y.Notify).success("Вітаємо, ваше замовлення прийнято!"):(0,y.Notify).warning("Вибачте, в цей час замовлення не приймаються!")}// ********************************************************
let e6=document.querySelector(".js-open-menu"),e3=document.querySelector(".js-close-menu"),e4=document.querySelector(".js-menu-container"),e8=document.querySelector(".basket-button");function e9(){let t=g.create(`
...
let s=new URLSearchParams({limit:t}),l=await eI.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${s}`);return l};function ic(t){is.innerHTML=t.map(t=>`
    ...
    function(t){let e=ia.findIndex(({_id:e})=>e===t);return(console.log(e),e>-1&&ia[e].favorit)?" add-fill":""}(t._id)}" data-set="${t._id}" viewBox="0 0 32 32">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join(""),function(){let t=document.querySelectorAll(".box-star");t.forEach(t=>{let e=t.previousElementSibling,i=Math.round(e.textContent),n=[...t.children];n.forEach((t,e)=>{e<i&&t.classList.add("yellow-star")})})}()}window.addEventListener("load",function(){il().then(ic).catch(t=>{console.log(t)})});let ip=new MutationObserver(function(){let t=document.querySelectorAll(".info-btn");// витягуємо всі кнопки
t.forEach(t=>{t.addEventListener("click",id);// вішаємо слухача на кнопки
})});// створюємо екземпляр класу MutationObserver
function id(t){let e=t.target.id;eQ(e).then(t=>{iu(t);let e=document.querySelector(".basicLightbox");e.classList.add("correct-recipe")}).catch(t=>{console.log(t)})}function iu(t){let{data:{title:e,youtube:i,thumb:n,rating:o,time:a,ingredients:r,tags:s,instructions:l}}=t,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),f=g.create(`<div class="card-modal">
...
`,{onShow:t=>{document.addEventListener("keydown",p)}},{closeShow:t=>{document.removeEventListener("keydown",p)}});function p(t){if("Escape"===t.code)return f.close()}f.show(),// Функція для Tags
...
function(t){let e=document.querySelector(".box-stars");document.querySelector(".star");let i=[...e.children],n=Math.round(t);i.forEach((t,e)=>{e<n&&t.classList.add("yellow-star")})}(o),document.body.style.overflow="hidden";let d=document.querySelector(".js-card-close-btn");document.querySelector(".card-modal"),d.addEventListener("click",()=>{document.body.style.overflow="auto",f.close()})}ip.observe(is,{// параметри MutationObserver
...
let ih={allCategiries:document.querySelector(".categories-btn-all-js"),categories:document.querySelector(".categories-js"),popular:document.querySelector(".popular-change-js"),paginationShow:document.querySelector("#tui-pagination-container"),pagination:document.getElementById("tui-pagination-container")},ig=window.innerWidth<768?6:window.innerWidth<1280?8:9,iy=1,ix=window.innerWidth<768?2:3,ib=new URLSearchParams({page:iy,limit:ig}),iv={totalItems:0,itemsPerPage:ig,visiblePages:ix,page:iy},iw=new/*@__PURE__*/(h(im))(ih.pagination,iv);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
function ik(){iw.off("afterMove",iS),iL("page",1),e2(ib).then(t=>{ic(t.data.results),// встановлення слухача пагінації, відображення її
function(t){if(iw.reset(t*ig),t>1){iw.on("afterMove",iS),ih.paginationShow.classList.remove("is-hidden");return}ih.paginationShow.classList.contains("is-hidden")||ih.paginationShow.classList.add("is-hidden"),t||/*@__PURE__*/h(io).Notify.info("Вибачте, згідно параметрів пошуку рецептів не знайдено")}(t.data.totalPages)}).catch(()=>{})}// перемальовка рецептів при зміщенні пагінації
function iS(){iL("page",iy=iw.getCurrentPage()),e2(ib).then(t=>{ic(t.data.results)}).catch(()=>{})}// вибір "всіх категорій" по натисканню "AllCategories"
function iC(){iN(),ih.allCategiries.classList.add("is-active"),iA("category"),ik()}// вибір конкретної категорії
function iE(t){if("BUTTON"!==t.target.nodeName)return;ih.allCategiries.classList.contains("is-active")&&ih.allCategiries.classList.remove("is-active"),iN(),t.target.classList.add("is-active");let e=t.target.dataset.set;iL("category",e),ik()}// знімаємо помітку з активної категорії
function iN(){let t=ih.categories.querySelector(".is-active");t&&t.classList.remove("is-active")}// обробка вибору популярного рецепту
function iT(t){if("BUTTON"!==t.currentTarget.nodeName)return;let e=t.currentTarget.dataset.set;!function(t){eQ(t).then(t=>{iu(t);let e=document.querySelector(".basicLightbox");e.classList.add("correct-recipe")}).catch(t=>{console.log(t)})}(e)}// додавання/зміна параметру в об'єкт для пошуку рецепту
function iL(t,e){ib.has(t)&&ib.delete(t),ib.append(t,e)}// вилучення параметра в об'єкті пошуку рецепту
function iA(t){for(;ib.has(t);)ib.delete(t)}/**
  |============================
  | Refs hero
  |============================
...
ih.allCategiries.addEventListener("click",iC),ih.categories.addEventListener("click",iE),ih.popular.addEventListener("click",iT),// прибирання слухачів подій
window.addEventListener("unload",function(){ih.allCategiries.removeEventListener("click",iC),ih.categories.removeEventListener("click",iE),ih.popular.removeEventListener("click",iT),iw.off("afterMove",iS)}),eK().then(t=>{ih.categories.insertAdjacentHTML("beforeend",// формування розмітки переліку категорій
...
ik(),eJ().then(t=>{ih.popular.insertAdjacentHTML("beforeend",t.data.map(t=>`
...
let e=ih.popular.querySelectorAll(".popular-button-js");e.forEach(t=>{t.addEventListener("click",iT)})}).catch(()=>{});let iM=iI();function iz(t){let e=/**
  |============================
  | Розмітка Swiper
  |============================
*/function(t){let{cook:e,topic:i}=t;return t.map(t=>`<div class="swiper-slide">
        ...
        </div>`).join("")}(t.data);iM.markupSwiper.insertAdjacentHTML("afterbegin",e)}/**
  |============================
  | Бібліотека Swiper
  |============================
*//**
 ...
 *//* eslint-disable no-param-reassign */function iO(t){return null!==t&&"object"==typeof t&&"constructor"in t&&t.constructor===Object}function iB(t,e){void 0===t&&(t={}),void 0===e&&(e={}),Object.keys(e).forEach(i=>{void 0===t[i]?t[i]=e[i]:iO(e[i])&&iO(t[i])&&Object.keys(e[i]).length>0&&iB(t[i],e[i])})}// Прослуховувачі подій
window.addEventListener("load",function(){eY().then(iz).catch(t=>{console.log(t)})}),iM.orderBtnHero.addEventListener("click",function(){e9();// const modalMessage = document.querySelector('.header-form');
// callMassageAdd(modalMessage);
});let iP={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector:()=>null,querySelectorAll:()=>[],getElementById:()=>null,createEvent:()=>({initEvent(){}}),createElement:()=>({children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName:()=>[]}),createElementNS:()=>({}),importNode:()=>null,location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function i_(){let t="undefined"!=typeof document?document:{};return iB(t,iP),t}let iR={document:iP,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle:()=>({getPropertyValue:()=>""}),Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia:()=>({}),requestAnimationFrame:t=>"undefined"==typeof setTimeout?(t(),null):setTimeout(t,0),cancelAnimationFrame(t){"undefined"!=typeof setTimeout&&clearTimeout(t)}};function iD(){let t="undefined"!=typeof window?window:{};return iB(t,iR),t}function ij(t,e){return void 0===e&&(e=0),setTimeout(t,e)}function iW(){return Date.now()}function iF(t){return"object"==typeof t&&null!==t&&t.constructor&&"Object"===Object.prototype.toString.call(t).slice(8,-1)}function i$(){let t=Object(arguments.length<=0?void 0:arguments[0]),e=["__proto__","constructor","prototype"];for(let i=1;i<arguments.length;i+=1){let n=i<0||arguments.length<=i?void 0:arguments[i];if(null!=n&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType)){let i=Object.keys(Object(n)).filter(t=>0>e.indexOf(t));for(let e=0,o=i.length;e<o;e+=1){let o=i[e],a=Object.getOwnPropertyDescriptor(n,o);void 0!==a&&a.enumerable&&(iF(t[o])&&iF(n[o])?n[o].__swiper__?t[o]=n[o]:i$(t[o],n[o]):!iF(t[o])&&iF(n[o])?(t[o]={},n[o].__swiper__?t[o]=n[o]:i$(t[o],n[o])):t[o]=n[o])}}}return t}function iU(t,e,i){t.style.setProperty(e,i)}function iH(t){let e,{swiper:i,targetPosition:n,side:o}=t,a=iD(),r=-i.translate,s=null,l=i.params.speed;i.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(i.cssModeFrameID);let c=n>r?"next":"prev",f=(t,e)=>"next"===c&&t>=e||"prev"===c&&t<=e,p=()=>{e=new Date().getTime(),null===s&&(s=e);let t=Math.max(Math.min((e-s)/l,1),0),c=r+(.5-Math.cos(t*Math.PI)/2)*(n-r);if(f(c,n)&&(c=n),i.wrapperEl.scrollTo({[o]:c}),f(c,n)){i.wrapperEl.style.overflow="hidden",i.wrapperEl.style.scrollSnapType="",setTimeout(()=>{i.wrapperEl.style.overflow="",i.wrapperEl.scrollTo({[o]:c})}),a.cancelAnimationFrame(i.cssModeFrameID);return}i.cssModeFrameID=a.requestAnimationFrame(p)};p()}function iX(t,e){return void 0===e&&(e=""),[...t.children].filter(t=>t.matches(e))}function iq(t,e){void 0===e&&(e=[]);let i=document.createElement(t);return i.classList.add(...Array.isArray(e)?e:[e]),i}function iG(t,e){let i=iD();return i.getComputedStyle(t,null).getPropertyValue(e)}function iV(t){let e,i=t;if(i){// eslint-disable-next-line
for(e=0;null!==(i=i.previousSibling);)1===i.nodeType&&(e+=1);return e}}function iY(t,e){let i=[],n=t.parentElement;// eslint-disable-line
for(;n;)e?n.matches(e)&&i.push(n):i.push(n),n=n.parentElement;return i}function iK(t,e,i){let n=iD();return i?t["width"===e?"offsetWidth":"offsetHeight"]+parseFloat(n.getComputedStyle(t,null).getPropertyValue("width"===e?"margin-right":"margin-top"))+parseFloat(n.getComputedStyle(t,null).getPropertyValue("width"===e?"margin-left":"margin-bottom")):t.offsetWidth}function iJ(){return e||(e=function(){let t=iD(),e=i_();return{smoothScroll:e.documentElement&&e.documentElement.style&&"scrollBehavior"in e.documentElement.style,touch:!!("ontouchstart"in t||t.DocumentTouch&&e instanceof t.DocumentTouch)}}()),e}let iQ=(t,e)=>{if(!t||t.destroyed||!t.params)return;let i=e.closest(t.isElement?"swiper-slide":`.${t.params.slideClass}`);if(i){let e=i.querySelector(`.${t.params.lazyPreloaderClass}`);!e&&t.isElement&&(e=i.shadowRoot.querySelector(`.${t.params.lazyPreloaderClass}`)),e&&e.remove()}},iZ=(t,e)=>{if(!t.slides[e])return;let i=t.slides[e].querySelector('[loading="lazy"]');i&&i.removeAttribute("loading")},i0=t=>{if(!t||t.destroyed||!t.params)return;let e=t.params.lazyPreloadPrevNext,i=t.slides.length;if(!i||!e||e<0)return;e=Math.min(e,i);let n="auto"===t.params.slidesPerView?t.slidesPerViewDynamic():Math.ceil(t.params.slidesPerView),o=t.activeIndex;if(t.params.grid&&t.params.grid.rows>1){let i=[o-e];i.push(...Array.from({length:e}).map((t,e)=>o+n+e)),t.slides.forEach((e,n)=>{i.includes(e.column)&&iZ(t,n)});return}let a=o+n-1;if(t.params.rewind||t.params.loop)for(let n=o-e;n<=a+e;n+=1){let e=(n%i+i)%i;(e<o||e>a)&&iZ(t,e)}else for(let n=Math.max(o-e,0);n<=Math.min(a+e,i-1);n+=1)n!==o&&(n>a||n<o)&&iZ(t,n)};function i1(t){let{swiper:e,runCallbacks:i,direction:n,step:o}=t,{activeIndex:a,previousIndex:r}=e,s=n;if(s||(s=a>r?"next":a<r?"prev":"reset"),e.emit(`transition${o}`),i&&a!==r){if("reset"===s){e.emit(`slideResetTransition${o}`);return}e.emit(`slideChangeTransition${o}`),"next"===s?e.emit(`slideNextTransition${o}`):e.emit(`slidePrevTransition${o}`)}}function i2(t){let e=i_(),i=iD(),n=this.touchEventsData;n.evCache.push(t);let{params:o,touches:a,enabled:r}=this;if(!r||!o.simulateTouch&&"mouse"===t.pointerType||this.animating&&o.preventInteractionOnTransition)return;!this.animating&&o.cssMode&&o.loop&&this.loopFix();let s=t;s.originalEvent&&(s=s.originalEvent);let l=s.target;if("wrapper"===o.touchEventsTarget&&!this.wrapperEl.contains(l)||"which"in s&&3===s.which||"button"in s&&s.button>0||n.isTouched&&n.isMoved)return;// change target el for shadow root component
...
t.allowSlidePrev=o,t.allowSlideNext=n,t.params.watchOverflow&&a!==t.snapGrid&&t.checkOverflow()}function i4(t){this.enabled&&!this.allowClick&&(this.params.preventClicks&&t.preventDefault(),this.params.preventClicksPropagation&&this.animating&&(t.stopPropagation(),t.stopImmediatePropagation()))}function i8(){let{wrapperEl:t,rtlTranslate:e,enabled:i}=this;if(!i)return;this.previousTranslate=this.translate,this.isHorizontal()?this.translate=-t.scrollLeft:this.translate=-t.scrollTop,0===this.translate&&(this.translate=0),this.updateActiveIndex(),this.updateSlidesClasses();let n=this.maxTranslate()-this.minTranslate();(0===n?0:(this.translate-this.minTranslate())/n)!==this.progress&&this.updateProgress(e?-this.translate:this.translate),this.emit("setTranslate",this.translate,!1)}function i9(t){iQ(this,t.target),!this.params.cssMode&&("auto"===this.params.slidesPerView||this.params.autoHeight)&&this.update()}let i7=!1;function nt(){}let ne=(t,e)=>{let i=i_(),{params:n,el:o,wrapperEl:a,device:r}=t,s=!!n.nested,l="on"===e?"addEventListener":"removeEventListener";// Touch Events
o[l]("pointerdown",t.onTouchStart,{passive:!1}),i[l]("pointermove",t.onTouchMove,{passive:!1,capture:s}),i[l]("pointerup",t.onTouchEnd,{passive:!0}),i[l]("pointercancel",t.onTouchEnd,{passive:!0}),i[l]("pointerout",t.onTouchEnd,{passive:!0}),i[l]("pointerleave",t.onTouchEnd,{passive:!0}),i[l]("contextmenu",t.onTouchEnd,{passive:!0}),(n.preventClicks||n.preventClicksPropagation)&&o[l]("click",t.onClick,!0),n.cssMode&&a[l]("scroll",t.onScroll),n.updateOnWindowResize?t[e](r.ios||r.android?"resize orientationchange observerUpdate":"resize observerUpdate",i3,!0):t[e]("observerUpdate",i3,!0),// Images loader
o[l]("load",t.onLoad,{capture:!0})},ni=(t,e)=>t.grid&&e.grid&&e.grid.rows>1;var nn={init:!0,direction:"horizontal",oneWayMovement:!1,touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",// Overrides
...
r.updateProgress(a),s.cssMode){let t=r.isHorizontal();if(0===e)l[t?"scrollLeft":"scrollTop"]=-a;else{if(!r.support.smoothScroll)return iH({swiper:r,targetPosition:-a,side:t?"left":"top"}),!0;l.scrollTo({[t?"left":"top"]:-a,behavior:"smooth"})}return!0}return 0===e?(r.setTransition(0),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",e,o),r.emit("transitionEnd"))):(r.setTransition(e),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",e,o),r.emit("transitionStart")),r.animating||(r.animating=!0,r.onTranslateToWrapperTransitionEnd||(r.onTranslateToWrapperTransitionEnd=function(t){r&&!r.destroyed&&t.target===this&&(r.wrapperEl.removeEventListener("transitionend",r.onTranslateToWrapperTransitionEnd),r.onTranslateToWrapperTransitionEnd=null,delete r.onTranslateToWrapperTransitionEnd,i&&r.emit("transitionEnd"))}),r.wrapperEl.addEventListener("transitionend",r.onTranslateToWrapperTransitionEnd))),!0}},transition:{setTransition:function(t,e){this.params.cssMode||(this.wrapperEl.style.transitionDuration=`${t}ms`,this.wrapperEl.style.transitionDelay=0===t?"0ms":""),this.emit("setTransition",t,e)},transitionStart:function(t,e){void 0===t&&(t=!0);let{params:i}=this;i.cssMode||(i.autoHeight&&this.updateAutoHeight(),i1({swiper:this,runCallbacks:t,direction:e,step:"Start"}))},transitionEnd:function(t,e){void 0===t&&(t=!0);let{params:i}=this;this.animating=!1,i.cssMode||(this.setTransition(0),i1({swiper:this,runCallbacks:t,direction:e,step:"End"}))}},slide:{slideTo:function(t,e,i,n,o){let a;void 0===t&&(t=0),void 0===e&&(e=this.params.speed),void 0===i&&(i=!0),"string"==typeof t&&(t=parseInt(t,10));let r=this,s=t;s<0&&(s=0);let{params:l,snapGrid:c,slidesGrid:f,previousIndex:p,activeIndex:d,rtlTranslate:u,wrapperEl:m,enabled:h}=r;if(r.animating&&l.preventInteractionOnTransition||!h&&!n&&!o)return!1;let g=Math.min(r.params.slidesPerGroupSkip,s),y=g+Math.floor((s-g)/r.params.slidesPerGroup);y>=c.length&&(y=c.length-1);let x=-c[y];// Normalize slideIndex
...
return t}return iX(i,n())[0]})();return!o&&e.params.createElements&&(o=iq("div",e.params.wrapperClass),i.append(o),iX(i,`.${e.params.slideClass}`).forEach(t=>{o.append(t)})),Object.assign(e,{el:i,wrapperEl:o,slidesEl:e.isElement&&!i.parentNode.host.slideSlots?i.parentNode.host:o,hostEl:e.isElement?i.parentNode.host:i,mounted:!0,// RTL
rtl:"rtl"===i.dir.toLowerCase()||"rtl"===iG(i,"direction"),rtlTranslate:"horizontal"===e.params.direction&&("rtl"===i.dir.toLowerCase()||"rtl"===iG(i,"direction")),wrongRTL:"-webkit-box"===iG(o,"display")}),!0}init(t){let e=this;if(e.initialized)return e;let i=e.mount(t);if(!1===i)return e;e.emit("beforeInit"),e.params.breakpoints&&e.setBreakpoint(),// Add Classes
...
e.attachEvents();let n=[...e.el.querySelectorAll('[loading="lazy"]')];return e.isElement&&n.push(...e.hostEl.querySelectorAll('[loading="lazy"]')),n.forEach(t=>{t.complete?iQ(e,t):t.addEventListener("load",t=>{iQ(e,t.target)})}),i0(e),// Init Flag
e.initialized=!0,i0(e),// Emit
...
}})}(i)),i.destroyed=!0),null}static extendDefaults(t){i$(na,t)}static get extendedDefaults(){return na}static get defaults(){return nn}static installModule(t){nr.prototype.__modules__||(nr.prototype.__modules__=[]);let e=nr.prototype.__modules__;"function"==typeof t&&0>e.indexOf(t)&&e.push(t)}static use(t){return Array.isArray(t)?t.forEach(t=>nr.installModule(t)):nr.installModule(t),nr}}function ns(t){return void 0===t&&(t=""),`.${t.trim().replace(/([\.:!+\/])/g,"\\$1")// eslint-disable-line
.replace(/ /g,".")}`}Object.keys(no).forEach(t=>{Object.keys(no[t]).forEach(e=>{nr.prototype[e]=no[t][e]})}),nr.use([function(t){let{swiper:e,on:i,emit:n}=t,o=iD(),a=null,r=null,s=()=>{e&&!e.destroyed&&e.initialized&&(n("beforeResize"),n("resize"))},l=()=>{e&&!e.destroyed&&e.initialized&&(a=new ResizeObserver(t=>{r=o.requestAnimationFrame(()=>{let{width:i,height:n}=e,o=i,a=n;t.forEach(t=>{let{contentBoxSize:i,contentRect:n,target:r}=t;r&&r!==e.el||(o=n?n.width:(i[0]||i).inlineSize,a=n?n.height:(i[0]||i).blockSize)}),(o!==i||a!==n)&&s()})})).observe(e.el)},c=()=>{r&&o.cancelAnimationFrame(r),a&&a.unobserve&&e.el&&(a.unobserve(e.el),a=null)},f=()=>{e&&!e.destroyed&&e.initialized&&n("orientationchange")};i("init",()=>{if(e.params.resizeObserver&&void 0!==o.ResizeObserver){l();return}o.addEventListener("resize",s),o.addEventListener("orientationchange",f)}),i("destroy",()=>{c(),o.removeEventListener("resize",s),o.removeEventListener("orientationchange",f)})},function(t){let{swiper:e,extendParams:i,on:n,emit:o}=t,a=[],r=iD(),s=function(t,i){void 0===i&&(i={});let n=r.MutationObserver||r.WebkitMutationObserver,s=new n(t=>{// The observerUpdate event should only be triggered
// once despite the number of mutations.  Additional
// triggers are redundant and are very costly
if(e.__preventObserver__)return;if(1===t.length){o("observerUpdate",t[0]);return}let i=function(){o("observerUpdate",t[0])};r.requestAnimationFrame?r.requestAnimationFrame(i):r.setTimeout(i,0)});s.observe(t,{attributes:void 0===i.attributes||i.attributes,childList:void 0===i.childList||i.childList,characterData:void 0===i.characterData||i.characterData}),a.push(s)};i({observer:!1,observeParents:!1,observeSlideChildren:!1}),n("init",()=>{if(e.params.observer){if(e.params.observeParents){let t=iY(e.hostEl);for(let e=0;e<t.length;e+=1)s(t[e])}// Observe container
s(e.hostEl,{childList:e.params.observeSlideChildren}),// Observe wrapper
s(e.wrapperEl,{attributes:!1})}}),n("destroy",()=>{a.forEach(t=>{t.disconnect()}),a.splice(0,a.length)})}]),nr.use([function(t){let e,{swiper:i,extendParams:n,on:o,emit:a}=t,r="swiper-pagination";n({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
dynamicBullets:!1,dynamicMainBullets:1,formatFractionCurrent:t=>t,formatFractionTotal:t=>t,bulletClass:`${r}-bullet`,bulletActiveClass:`${r}-bullet-active`,modifierClass:`${r}-`,currentClass:`${r}-current`,totalClass:`${r}-total`,hiddenClass:`${r}-hidden`,progressbarFillClass:`${r}-progressbar-fill`,progressbarOppositeClass:`${r}-progressbar-opposite`,clickableClass:`${r}-clickable`,lockClass:`${r}-lock`,horizontalClass:`${r}-horizontal`,verticalClass:`${r}-vertical`,paginationDisabledClass:`${r}-disabled`}}),i.pagination={el:null,bullets:[]};let s=0,l=t=>(Array.isArray(t)?t:[t]).filter(t=>!!t);function c(){return!i.params.pagination.el||!i.pagination.el||Array.isArray(i.pagination.el)&&0===i.pagination.el.length}function f(t,e){let{bulletActiveClass:n}=i.params.pagination;t&&(t=t[`${"prev"===e?"previous":"next"}ElementSibling`])&&(t.classList.add(`${n}-${e}`),(t=t[`${"prev"===e?"previous":"next"}ElementSibling`])&&t.classList.add(`${n}-${e}-${e}`))}function p(t){let e=t.target.closest(ns(i.params.pagination.bulletClass));if(!e)return;t.preventDefault();let n=iV(e)*i.params.slidesPerGroup;if(i.params.loop){if(i.realIndex===n)return;let t=i.realIndex,e=i.getSlideIndexByData(n),o=i.getSlideIndexByData(i.realIndex);if(e>i.slides.length-i.loopedSlides){let n=i.activeIndex;i.loopFix({direction:e>o?"next":"prev",activeSlideIndex:e,slideTo:!1});let a=i.activeIndex;n===a&&i.slideToLoop(t,0,!1,!0)}i.slideToLoop(n)}else i.slideTo(n)}function d(){let t,n;// Render || Update Pagination bullets/items
 ...
 * _.isObject(null);
 * // => false
 */function nC(t){var e=typeof t;return!!t&&("object"==e||"function"==e)}/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nE(t){if("number"==typeof t)return t;if("symbol"==typeof(e=t)||e&&"object"==typeof e&&"[object Symbol]"==nv.call(e))return np;if(nC(t)){var e,i="function"==typeof t.valueOf?t.valueOf():t;t=nC(i)?i+"":i}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(nd,"");var n=nm.test(t);return n||nh.test(t)?ng(t.slice(2),n?2:8):nu.test(t)?np:+t}nf=/**
...
return void 0===l||i>=e||i<0||p&&n>=a}function h(){var t,i,n,o=nS();if(m(o))return g(o);// Restart the timer.
s=setTimeout(h,(t=o-l,i=o-c,n=e-t,p?nk(n,a-i):n))}function g(t){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(s=void 0,d&&n)?u(t):(n=o=void 0,r))}function y(){var t,i=nS(),a=m(i);if(n=arguments,o=this,l=i,a){if(void 0===s)return(// Reset any `maxWait` timer.
c=t=l,// Start the timer for the trailing edge.
s=setTimeout(h,e),f?u(t):r);if(p)return(// Handle invocations in a tight loop.
s=setTimeout(h,e),u(l))}return void 0===s&&(s=setTimeout(h,e)),r}return e=nE(e)||0,nC(i)&&(f=!!i.leading,a=(p="maxWait"in i)?nw(nE(i.maxWait)||0,e):a,d="trailing"in i?!!i.trailing:d),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nS())},y};let nN={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nN.form.addEventListener("submit",function(t){t.preventDefault()}),nN.time.addEventListener("change",function(t){iL("time",t.currentTarget.value),ik()}),nN.area.addEventListener("change",function(t){iL("area",t.currentTarget.value),ik()}),nN.ingredients.addEventListener("change",function(t){iL("ingredient",t.currentTarget.value),ik()}),nN.search.addEventListener("input",/*@__PURE__*/h(nf)(()=>{iL("title",nN.search.value.trim()),ik()},300)),e0().then(t=>{nN.area.innerHTML=t.data.map(({name:t})=>`<option class="filter-opt" value="${t}">${t}</option>`).join("")}).catch(t=>{console.log(t)}),eZ().then(t=>{nN.ingredients.innerHTML=t.data.map(({name:t,_id:e})=>`<option class="filter-opt" value="${e}">${t}</option>`).join("")}).catch(t=>{}),// ❗ Створення Time ❗
function(){let t="";// ❗ ДОРОБИТИ ПРАВИЛЬНУ ЛОГІКУ ЧАСУ ❗
for(let e=0;e<220;e+=5)e%10==0&&(t+=`<option class="filter-opt" value="${e}">${e}</option>`);nN.time.insertAdjacentHTML("beforeend",t)}(),// ❗ Створення js-reset-filter-btn ❗
nN.resetBtn.addEventListener("click",function(t){iA("time"),iA("area"),iA("ingredient"),iA("title"),ik()})}();//# sourceMappingURL=index.c3c27a5e.js.map

//# sourceMappingURL=index.c3c27a5e.js.map
