...
info:function(t,e,n){p(i.Info,t,e,n)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Notify:d.Notify}):{Notify:d.Notify}},"function"==typeof define&&define.amd?define([],function(){return a(o)}):"object"==typeof g?g=a(o):o.Notiflix=a(o);// utils is a library of generic helper functions non-specific to axios
const{toString:x}=Object.prototype,{getPrototypeOf:b}=Object,v=(r=Object.create(null),t=>{let e=x.call(t);return r[e]||(r[e]=e.slice(8,-1).toLowerCase())}),w=t=>(t=t.toLowerCase(),e=>v(e)===t),k=t=>e=>typeof e===t,{isArray:S}=Array,C=k("undefined"),E=w("ArrayBuffer"),N=k("string"),T=k("function"),L=k("number"),A=t=>null!==t&&"object"==typeof t,M=t=>{if("object"!==v(t))return!1;let e=b(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},I=w("Date"),z=w("File"),O=w("Blob"),B=w("FileList"),P=w("URLSearchParams");/**
 ...
 * @returns {any}
 */function _(t,e,{allOwnKeys:i=!1}={}){let n,o;// Don't bother if no value provided
if(null!=t){if("object"!=typeof t&&/*eslint no-param-reassign:0*/(t=[t]),S(t))for(n=0,o=t.length;n<o;n++)e.call(null,t[n],n,t);else{let o;// Iterate over object keys
let a=i?Object.getOwnPropertyNames(t):Object.keys(t),r=a.length;for(n=0;n<r;n++)o=a[n],e.call(null,t[o],o,t)}}}function R(t,e){let i;e=e.toLowerCase();let n=Object.keys(t),o=n.length;for(;o-- >0;)if(e===(i=n[o]).toLowerCase())return i;return null}const D=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:u,j=t=>!C(t)&&t!==D,W=(s="undefined"!=typeof Uint8Array&&b(Uint8Array),t=>s&&t instanceof s),F=w("HTMLFormElement"),$=(({hasOwnProperty:t})=>(e,i)=>t.call(e,i))(Object.prototype),U=w("RegExp"),H=(t,e)=>{let i=Object.getOwnPropertyDescriptors(t),n={};_(i,(i,o)=>{let a;!1!==(a=e(i,o,t))&&(n[o]=a||i)}),Object.defineProperties(t,n)},X="abcdefghijklmnopqrstuvwxyz",q="0123456789",G={DIGIT:q,ALPHA:X,ALPHA_DIGIT:X+X.toUpperCase()+q},V=w("AsyncFunction");var Y={isArray:S,isArrayBuffer:E,isBuffer:/**
 * Determine if a value is a Buffer
 *
 * @param {*} val The value to test
 *
 * @returns {boolean} True if value is a Buffer, otherwise false
 */function(t){return null!==t&&!C(t)&&null!==t.constructor&&!C(t.constructor)&&T(t.constructor.isBuffer)&&t.constructor.isBuffer(t)},isFormData:t=>{let e;return t&&("function"==typeof FormData&&t instanceof FormData||T(t.append)&&("formdata"===(e=v(t))||// detect form-data instance
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&E(t.buffer)},isString:N,isNumber:L,isBoolean:t=>!0===t||!1===t,isObject:A,isPlainObject:M,isUndefined:C,isDate:I,isFile:z,isBlob:O,isRegExp:U,isFunction:T,isStream:t=>A(t)&&T(t.pipe),isURLSearchParams:P,isTypedArray:W,isFileList:B,forEach:_,merge:/**
 ...
 */function t(){let{caseless:e}=j(this)&&this||{},i={},n=(n,o)=>{let a=e&&R(i,o)||o;M(i[a])&&M(n)?i[a]=t(i[a],n):M(n)?i[a]=t({},n):S(n)?i[a]=n.slice():i[a]=n};for(let t=0,e=arguments.length;t<e;t++)arguments[t]&&_(arguments[t],n);return i},extend:(t,e,i,{allOwnKeys:n}={})=>(_(e,(e,n)=>{i&&T(e)?t[n]=y(e,i):t[n]=e},{allOwnKeys:n}),t),trim:t=>t.trim?t.trim():t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""),stripBOM:t=>(65279===t.charCodeAt(0)&&(t=t.slice(1)),t),inherits:(t,e,i,n)=>{t.prototype=Object.create(e.prototype,n),t.prototype.constructor=t,Object.defineProperty(t,"super",{value:e.prototype}),i&&Object.assign(t.prototype,i)},toFlatObject:(t,e,i,n)=>{let o,a,r;let s={};// eslint-disable-next-line no-eq-null,eqeqeq
if(e=e||{},null==t)return e;do{for(a=(o=Object.getOwnPropertyNames(t)).length;a-- >0;)r=o[a],(!n||n(r,t,e))&&!s[r]&&(e[r]=t[r],s[r]=!0);t=!1!==i&&b(t)}while(t&&(!i||i(t,e))&&t!==Object.prototype)return e},kindOf:v,kindOfTest:w,endsWith:(t,e,i)=>{t=String(t),(void 0===i||i>t.length)&&(i=t.length),i-=e.length;let n=t.indexOf(e,i);return -1!==n&&n===i},toArray:t=>{if(!t)return null;if(S(t))return t;let e=t.length;if(!L(e))return null;let i=Array(e);for(;e-- >0;)i[e]=t[e];return i},forEachEntry:(t,e)=>{let i;let n=t&&t[Symbol.iterator],o=n.call(t);for(;(i=o.next())&&!i.done;){let n=i.value;e.call(t,n[0],n[1])}},matchAll:(t,e)=>{let i;let n=[];for(;null!==(i=t.exec(e));)n.push(i);return n},isHTMLForm:F,hasOwnProperty:$,hasOwnProp:$,reduceDescriptors:H,freezeMethods:t=>{H(t,(e,i)=>{// skip restricted props in strict mode
if(T(t)&&-1!==["arguments","caller","callee"].indexOf(i))return!1;let n=t[i];if(T(n)){if(e.enumerable=!1,"writable"in e){e.writable=!1;return}e.set||(e.set=()=>{throw Error("Can not rewrite read-only method '"+i+"'")})}})},toObjectSet:(t,e)=>{let i={};return(t=>{t.forEach(t=>{i[t]=!0})})(S(t)?t:String(t).split(e)),i},toCamelCase:t=>t.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(t,e,i){return e.toUpperCase()+i}),noop:()=>{},toFiniteNumber:(t,e)=>Number.isFinite(t=+t)?t:e,findKey:R,global:D,isContextDefined:j,ALPHABET:G,generateString:(t=16,e=G.ALPHA_DIGIT)=>{let i="",{length:n}=e;for(;t--;)i+=e[Math.random()*n|0];return i},isSpecCompliantForm:/**
 * If the thing is a FormData object, return true, otherwise return false.
 *
 * @param {unknown} thing - The thing to check.
 *
 * @returns {boolean}
 */function(t){return!!(t&&T(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),i=(t,n)=>{if(A(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=S(t)?[]:{};return _(t,(t,e)=>{let a=i(t,n+1);C(a)||(o[e]=a)}),e[n]=void 0,o}}return t};return i(t,0)},isAsyncFn:V,isThenable:t=>t&&(A(t)||T(t))&&T(t.then)&&T(t.catch)};/**
 ...
 */function K(t,e,i,n,o){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack,this.message=t,this.name="AxiosError",e&&(this.code=e),i&&(this.config=i),n&&(this.request=n),o&&(this.response=o)}Y.inherits(K,Error,{toJSON:function(){return{// Standard
message:this.message,name:this.name,// Microsoft
description:this.description,number:this.number,// Mozilla
fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,// Axios
config:Y.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});const J=K.prototype,Q={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(t=>{Q[t]={value:t}}),Object.defineProperties(K,Q),Object.defineProperty(J,"isAxiosError",{value:!0}),// eslint-disable-next-line func-names
K.from=(t,e,i,n,o,a)=>{let r=Object.create(J);return Y.toFlatObject(t,r,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),K.call(r,t.message,e,i,n,o),r.cause=t,r.name=t.name,a&&Object.assign(r,a),r},f=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
for(var e,i=t.length,n=i%3// if we have 1 byte left, pad 2 bytes
,o=[],a=0,r=i-n;a<r;a+=16383// must be multiple of 3
)o.push(function(t,e,i){for(var n,o=[],a=e;a<i;a+=3)o.push(Z[(n=(t[a]<<16&16711680)+(t[a+1]<<8&65280)+(255&t[a+2]))>>18&63]+Z[n>>12&63]+Z[n>>6&63]+Z[63&n]);return o.join("")}(t,a,a+16383>r?r:a+16383));return 1===n?o.push(Z[(e=t[i-1])>>2]+Z[e<<4&63]+"=="):2===n&&o.push(Z[(e=(t[i-2]<<8)+t[i-1])>>10]+Z[e>>4&63]+Z[e<<2&63]+"="),o.join("")};for(var Z=[],tt=[],te="undefined"!=typeof Uint8Array?Uint8Array:Array,ti="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",tn=0,to=ti.length;tn<to;++tn)Z[tn]=ti[tn],tt[ti.charCodeAt(tn)]=tn;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
tt["-".charCodeAt(0)]=62,tt["_".charCodeAt(0)]=63,p=function(t,e,i,n,o){var a,r,s=8*o-n-1,l=(1<<s)-1,c=l>>1,f=-7,p=i?o-1:0,d=i?-1:1,u=t[e+p];for(p+=d,a=u&(1<<-f)-1,u>>=-f,f+=s;f>0;a=256*a+t[e+p],p+=d,f-=8);for(r=a&(1<<-f)-1,a>>=-f,f+=n;f>0;r=256*r+t[e+p],p+=d,f-=8);if(0===a)a=1-c;else{if(a===l)return r?NaN:(u?-1:1)*(1/0);r+=Math.pow(2,n),a-=c}return(u?-1:1)*r*Math.pow(2,a-n)},d=function(t,e,i,n,o,a){var r,s,l,c=8*a-o-1,f=(1<<c)-1,p=f>>1,d=23===o?5960464477539062e-23:0,u=n?0:a-1,m=n?1:-1,h=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,r=f):(r=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-r))<1&&(r--,l*=2),r+p>=1?e+=d/l:e+=d*Math.pow(2,1-p),e*l>=2&&(r++,l/=2),r+p>=f?(s=0,r=f):r+p>=1?(s=(e*l-1)*Math.pow(2,o),r+=p):(s=e*Math.pow(2,p-1)*Math.pow(2,o),r=0));o>=8;t[i+u]=255&s,u+=m,s/=256,o-=8);for(r=r<<o|s,c+=o;c>0;t[i+u]=255&r,u+=m,r/=256,c-=8);t[i+u-m]|=128*h};const ta="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
let e=new Uint8Array(t);return Object.setPrototypeOf(e,ts.prototype),e}/**
 ...
 */function ts(t,e,i){// Common case.
if("number"==typeof t){if("string"==typeof e)throw TypeError('The "string" argument must be of type string. Received type number');return tf(t)}return tl(t,e,i)}function tl(t,e,i){if("string"==typeof t)return function(t,e){if(("string"!=typeof e||""===e)&&(e="utf8"),!ts.isEncoding(e))throw TypeError("Unknown encoding: "+e);let i=0|tm(t,e),n=tr(i),o=n.write(t,e);return o!==i&&// cause everything after the first invalid character to be ignored. (e.g.
// 'abxxcd' will be treated as 'ab')
(n=n.slice(0,o)),n}(t,e);if(ArrayBuffer.isView(t))return function(t){if(tR(t,Uint8Array)){let e=new Uint8Array(t);return td(e.buffer,e.byteOffset,e.byteLength)}return tp(t)}(t);if(null==t)throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof t);if(tR(t,ArrayBuffer)||t&&tR(t.buffer,ArrayBuffer)||"undefined"!=typeof SharedArrayBuffer&&(tR(t,SharedArrayBuffer)||t&&tR(t.buffer,SharedArrayBuffer)))return td(t,e,i);if("number"==typeof t)throw TypeError('The "value" argument must not be of type number. Received type number');let n=t.valueOf&&t.valueOf();if(null!=n&&n!==t)return ts.from(n,e,i);let o=function(t){var e;if(ts.isBuffer(t)){let e=0|tu(t.length),i=tr(e);return 0===i.length||t.copy(i,0,0,e),i}return void 0!==t.length?"number"!=typeof t.length||(e=t.length)!=e// eslint-disable-line no-self-compare
?tr(0):tp(t):"Buffer"===t.type&&Array.isArray(t.data)?tp(t.data):void 0}(t);if(o)return o;if("undefined"!=typeof Symbol&&null!=Symbol.toPrimitive&&"function"==typeof t[Symbol.toPrimitive])return ts.from(t[Symbol.toPrimitive]("string"),e,i);throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof t)}function tc(t){if("number"!=typeof t)throw TypeError('"size" argument must be of type number');if(t<0)throw RangeError('The value "'+t+'" is invalid for option "size"')}function tf(t){return tc(t),tr(t<0?0:0|tu(t))}function tp(t){let e=t.length<0?0:0|tu(t.length),i=tr(e);for(let n=0;n<e;n+=1)i[n]=255&t[n];return i}function td(t,e,i){let n;if(e<0||t.byteLength<e)throw RangeError('"offset" is outside of buffer bounds');if(t.byteLength<e+(i||0))throw RangeError('"length" is outside of buffer bounds');return(// Return an augmented `Uint8Array` instance
Object.setPrototypeOf(n=void 0===e&&void 0===i?new Uint8Array(t):void 0===i?new Uint8Array(t,e):new Uint8Array(t,e,i),ts.prototype),n)}function tu(t){// Note: cannot use `length < K_MAX_LENGTH` here because that fails when
// length is NaN (which is otherwise coerced to zero.)
if(t>=2147483647)throw RangeError("Attempt to allocate Buffer larger than maximum size: 0x7fffffff bytes");return 0|t}function tm(t,e){if(ts.isBuffer(t))return t.length;if(ArrayBuffer.isView(t)||tR(t,ArrayBuffer))return t.byteLength;if("string"!=typeof t)throw TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof t);let i=t.length,n=arguments.length>2&&!0===arguments[2];if(!n&&0===i)return 0;// Use a for loop to avoid recursion
let o=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return i;case"utf8":case"utf-8":return tB(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*i;case"hex":return i>>>1;case"base64":return tP(t).length;default:if(o)return n?-1:tB(t).length// assume utf8
;e=(""+e).toLowerCase(),o=!0}}function th(t,e,i){let n=!1;// Return early if start > this.length. Done here to prevent potential uint32
// coercion fail below.
...
function ty(t,e,i,n,o){var a;// Empty buffer means no match
...
if("string"==typeof e&&(e=ts.from(e,n)),ts.isBuffer(e))return(// Special case: looking for empty string/buffer always fails
0===e.length?-1:tx(t,e,i,n,o));if("number"==typeof e)return(e&=255// Search for a byte value [0-255]
,"function"==typeof Uint8Array.prototype.indexOf)?o?Uint8Array.prototype.indexOf.call(t,e,i):Uint8Array.prototype.lastIndexOf.call(t,e,i):tx(t,[e],i,n,o);throw TypeError("val must be string, number or Buffer")}function tx(t,e,i,n,o){let a,r=1,s=t.length,l=e.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(t.length<2||e.length<2)return -1;r=2,s/=2,l/=2,i/=2}function c(t,e){return 1===r?t[e]:t.readUInt16BE(e*r)}if(o){let n=-1;for(a=i;a<s;a++)if(c(t,a)===c(e,-1===n?0:a-n)){if(-1===n&&(n=a),a-n+1===l)return n*r}else -1!==n&&(a-=a-n),n=-1}else for(i+l>s&&(i=s-l),a=i;a>=0;a--){let i=!0;for(let n=0;n<l;n++)if(c(t,a+n)!==c(e,n)){i=!1;break}if(i)return a}return -1}function tb(t,e,i){i=Math.min(t.length,i);let n=[],o=e;for(;o<i;){let e=t[o],a=null,r=e>239?4:e>223?3:e>191?2:1;if(o+r<=i){let i,n,s,l;switch(r){case 1:e<128&&(a=e);break;case 2:(192&(i=t[o+1]))==128&&(l=(31&e)<<6|63&i)>127&&(a=l);break;case 3:i=t[o+1],n=t[o+2],(192&i)==128&&(192&n)==128&&(l=(15&e)<<12|(63&i)<<6|63&n)>2047&&(l<55296||l>57343)&&(a=l);break;case 4:i=t[o+1],n=t[o+2],s=t[o+3],(192&i)==128&&(192&n)==128&&(192&s)==128&&(l=(15&e)<<18|(63&i)<<12|(63&n)<<6|63&s)>65535&&l<1114112&&(a=l)}}null===a?(// we did not generate a valid codePoint so insert a
 ...
 */function tv(t,e,i){if(t%1!=0||t<0)throw RangeError("offset is not uint");if(t+e>i)throw RangeError("Trying to access beyond buffer length")}function tw(t,e,i,n,o,a){if(!ts.isBuffer(t))throw TypeError('"buffer" argument must be a Buffer instance');if(e>o||e<a)throw RangeError('"value" argument is out of bounds');if(i+n>t.length)throw RangeError("Index out of range")}function tk(t,e,i,n,o){tM(e,n,o,t,i,7);let a=Number(e&BigInt(4294967295));t[i++]=a,a>>=8,t[i++]=a,a>>=8,t[i++]=a,a>>=8,t[i++]=a;let r=Number(e>>BigInt(32)&BigInt(4294967295));return t[i++]=r,r>>=8,t[i++]=r,r>>=8,t[i++]=r,r>>=8,t[i++]=r,i}function tS(t,e,i,n,o){tM(e,n,o,t,i,7);let a=Number(e&BigInt(4294967295));t[i+7]=a,a>>=8,t[i+6]=a,a>>=8,t[i+5]=a,a>>=8,t[i+4]=a;let r=Number(e>>BigInt(32)&BigInt(4294967295));return t[i+3]=r,r>>=8,t[i+2]=r,r>>=8,t[i+1]=r,r>>=8,t[i]=r,i+8}function tC(t,e,i,n,o,a){if(i+n>t.length||i<0)throw RangeError("Index out of range")}function tE(t,e,i,n,o){return e=+e,i>>>=0,o||tC(t,e,i,4,34028234663852886e22,-34028234663852886e22),d(t,e,i,n,23,4),i+4}function tN(t,e,i,n,o){return e=+e,i>>>=0,o||tC(t,e,i,8,17976931348623157e292,-17976931348623157e292),d(t,e,i,n,52,8),i+8}/**
 ...
 **/ts.from=function(t,e,i){return tl(t,e,i)},// Note: Change prototype *after* Buffer.from is defined to workaround Chrome bug:
// https://github.com/feross/buffer/pull/148
Object.setPrototypeOf(ts.prototype,Uint8Array.prototype),Object.setPrototypeOf(ts,Uint8Array),/**
 * Creates a new filled Buffer instance.
 * alloc(size[, fill[, encoding]])
 **/ts.alloc=function(t,e,i){return(tc(t),t<=0)?tr(t):void 0!==e?"string"==typeof i?tr(t).fill(e,i):tr(t).fill(e):tr(t)},/**
 * Equivalent to Buffer(num), by default creates a non-zero-filled Buffer instance.
 * */ts.allocUnsafe=function(t){return tf(t)},/**
 * Equivalent to SlowBuffer(num), by default creates a non-zero-filled Buffer instance.
 */ts.allocUnsafeSlow=function(t){return tf(t)},ts.isBuffer=function(t){return null!=t&&!0===t._isBuffer&&t!==ts.prototype// so Buffer.isBuffer(Buffer.prototype) will be false
},ts.compare=function(t,e){if(tR(t,Uint8Array)&&(t=ts.from(t,t.offset,t.byteLength)),tR(e,Uint8Array)&&(e=ts.from(e,e.offset,e.byteLength)),!ts.isBuffer(t)||!ts.isBuffer(e))throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(t===e)return 0;let i=t.length,n=e.length;for(let o=0,a=Math.min(i,n);o<a;++o)if(t[o]!==e[o]){i=t[o],n=e[o];break}return i<n?-1:n<i?1:0},ts.isEncoding=function(t){switch(String(t).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},ts.concat=function(t,e){let i;if(!Array.isArray(t))throw TypeError('"list" argument must be an Array of Buffers');if(0===t.length)return ts.alloc(0);if(void 0===e)for(i=0,e=0;i<t.length;++i)e+=t[i].length;let n=ts.allocUnsafe(e),o=0;for(i=0;i<t.length;++i){let e=t[i];if(tR(e,Uint8Array))o+e.length>n.length?(ts.isBuffer(e)||(e=ts.from(e)),e.copy(n,o)):Uint8Array.prototype.set.call(n,e,o);else if(ts.isBuffer(e))e.copy(n,o);else throw TypeError('"list" argument must be an Array of Buffers');o+=e.length}return n},ts.byteLength=tm,// This property is used by `Buffer.isBuffer` (and the `is-buffer` npm package)
// to detect a Buffer instance. It's not possible to use `instanceof Buffer`
// reliably in a browserify context because there could be multiple different
// copies of the 'buffer' package in use. This method works even for Buffer
// instances that were created from another copy of the `buffer` package.
// See: https://github.com/feross/buffer/issues/154
ts.prototype._isBuffer=!0,ts.prototype.swap16=function(){let t=this.length;if(t%2!=0)throw RangeError("Buffer size must be a multiple of 16-bits");for(let e=0;e<t;e+=2)tg(this,e,e+1);return this},ts.prototype.swap32=function(){let t=this.length;if(t%4!=0)throw RangeError("Buffer size must be a multiple of 32-bits");for(let e=0;e<t;e+=4)tg(this,e,e+3),tg(this,e+1,e+2);return this},ts.prototype.swap64=function(){let t=this.length;if(t%8!=0)throw RangeError("Buffer size must be a multiple of 64-bits");for(let e=0;e<t;e+=8)tg(this,e,e+7),tg(this,e+1,e+6),tg(this,e+2,e+5),tg(this,e+3,e+4);return this},ts.prototype.toString=function(){let t=this.length;return 0===t?"":0==arguments.length?tb(this,0,t):th.apply(this,arguments)},ts.prototype.toLocaleString=ts.prototype.toString,ts.prototype.equals=function(t){if(!ts.isBuffer(t))throw TypeError("Argument must be a Buffer");return this===t||0===ts.compare(this,t)},ts.prototype.inspect=function(){let t="";return t=this.toString("hex",0,50).replace(/(.{2})/g,"$1 ").trim(),this.length>50&&(t+=" ... "),"<Buffer "+t+">"},ta&&(ts.prototype[ta]=ts.prototype.inspect),ts.prototype.compare=function(t,e,i,n,o){if(tR(t,Uint8Array)&&(t=ts.from(t,t.offset,t.byteLength)),!ts.isBuffer(t))throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof t);if(void 0===e&&(e=0),void 0===i&&(i=t?t.length:0),void 0===n&&(n=0),void 0===o&&(o=this.length),e<0||i>t.length||n<0||o>this.length)throw RangeError("out of range index");if(n>=o&&e>=i)return 0;if(n>=o)return -1;if(e>=i)return 1;if(e>>>=0,i>>>=0,n>>>=0,o>>>=0,this===t)return 0;let a=o-n,r=i-e,s=Math.min(a,r),l=this.slice(n,o),c=t.slice(e,i);for(let t=0;t<s;++t)if(l[t]!==c[t]){a=l[t],r=c[t];break}return a<r?-1:r<a?1:0},ts.prototype.includes=function(t,e,i){return -1!==this.indexOf(t,e,i)},ts.prototype.indexOf=function(t,e,i){return ty(this,t,e,i,!0)},ts.prototype.lastIndexOf=function(t,e,i){return ty(this,t,e,i,!1)},ts.prototype.write=function(t,e,i,n){var o,a,r,s,l,c,f,p;// Buffer#write(string)
if(void 0===e)n="utf8",i=this.length,e=0;else if(void 0===i&&"string"==typeof e)n=e,i=this.length,e=0;else if(isFinite(e))e>>>=0,isFinite(i)?(i>>>=0,void 0===n&&(n="utf8")):(n=i,i=void 0);else throw Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");let d=this.length-e;if((void 0===i||i>d)&&(i=d),t.length>0&&(i<0||e<0)||e>this.length)throw RangeError("Attempt to write outside buffer bounds");n||(n="utf8");let u=!1;for(;;)switch(n){case"hex":return function(t,e,i,n){let o;i=Number(i)||0;let a=t.length-i;n?(n=Number(n))>a&&(n=a):n=a;let r=e.length;for(n>r/2&&(n=r/2),o=0;o<n;++o){let n=parseInt(e.substr(2*o,2),16);if(n!=n)break;t[i+o]=n}return o}(this,t,e,i);case"utf8":case"utf-8":return o=e,a=i,t_(tB(t,this.length-o),this,o,a);case"ascii":case"latin1":case"binary":return r=e,s=i,t_(function(t){let e=[];for(let i=0;i<t.length;++i)e.push(255&t.charCodeAt(i));return e}(t),this,r,s);case"base64":// Warning: maxLength not taken into account in base64Write
return l=e,c=i,t_(tP(t),this,l,c);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return f=e,p=i,t_(function(t,e){let i,n;let o=[];for(let a=0;a<t.length&&!((e-=2)<0);++a)n=(i=t.charCodeAt(a))>>8,o.push(i%256),o.push(n);return o}(t,this.length-f),this,f,p);default:if(u)throw TypeError("Unknown encoding: "+n);n=(""+n).toLowerCase(),u=!0}},ts.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}},ts.prototype.slice=function(t,e){let i=this.length;t=~~t,e=void 0===e?i:~~e,t<0?(t+=i)<0&&(t=0):t>i&&(t=i),e<0?(e+=i)<0&&(e=0):e>i&&(e=i),e<t&&(e=t);let n=this.subarray(t,e);return(// Return an augmented `Uint8Array` instance
Object.setPrototypeOf(n,ts.prototype),n)},ts.prototype.readUintLE=ts.prototype.readUIntLE=function(t,e,i){t>>>=0,e>>>=0,i||tv(t,e,this.length);let n=this[t],o=1,a=0;for(;++a<e&&(o*=256);)n+=this[t+a]*o;return n},ts.prototype.readUintBE=ts.prototype.readUIntBE=function(t,e,i){t>>>=0,e>>>=0,i||tv(t,e,this.length);let n=this[t+--e],o=1;for(;e>0&&(o*=256);)n+=this[t+--e]*o;return n},ts.prototype.readUint8=ts.prototype.readUInt8=function(t,e){return t>>>=0,e||tv(t,1,this.length),this[t]},ts.prototype.readUint16LE=ts.prototype.readUInt16LE=function(t,e){return t>>>=0,e||tv(t,2,this.length),this[t]|this[t+1]<<8},ts.prototype.readUint16BE=ts.prototype.readUInt16BE=function(t,e){return t>>>=0,e||tv(t,2,this.length),this[t]<<8|this[t+1]},ts.prototype.readUint32LE=ts.prototype.readUInt32LE=function(t,e){return t>>>=0,e||tv(t,4,this.length),(this[t]|this[t+1]<<8|this[t+2]<<16)+16777216*this[t+3]},ts.prototype.readUint32BE=ts.prototype.readUInt32BE=function(t,e){return t>>>=0,e||tv(t,4,this.length),16777216*this[t]+(this[t+1]<<16|this[t+2]<<8|this[t+3])},ts.prototype.readBigUInt64LE=tj(function(t){tI(t>>>=0,"offset");let e=this[t],i=this[t+7];(void 0===e||void 0===i)&&tz(t,this.length-8);let n=e+256*this[++t]+65536*this[++t]+16777216*this[++t],o=this[++t]+256*this[++t]+65536*this[++t]+16777216*i;return BigInt(n)+(BigInt(o)<<BigInt(32))}),ts.prototype.readBigUInt64BE=tj(function(t){tI(t>>>=0,"offset");let e=this[t],i=this[t+7];(void 0===e||void 0===i)&&tz(t,this.length-8);let n=16777216*e+65536*this[++t]+256*this[++t]+this[++t],o=16777216*this[++t]+65536*this[++t]+256*this[++t]+i;return(BigInt(n)<<BigInt(32))+BigInt(o)}),ts.prototype.readIntLE=function(t,e,i){t>>>=0,e>>>=0,i||tv(t,e,this.length);let n=this[t],o=1,a=0;for(;++a<e&&(o*=256);)n+=this[t+a]*o;return n>=(o*=128)&&(n-=Math.pow(2,8*e)),n},ts.prototype.readIntBE=function(t,e,i){t>>>=0,e>>>=0,i||tv(t,e,this.length);let n=e,o=1,a=this[t+--n];for(;n>0&&(o*=256);)a+=this[t+--n]*o;return a>=(o*=128)&&(a-=Math.pow(2,8*e)),a},ts.prototype.readInt8=function(t,e){return(t>>>=0,e||tv(t,1,this.length),128&this[t])?-((255-this[t]+1)*1):this[t]},ts.prototype.readInt16LE=function(t,e){t>>>=0,e||tv(t,2,this.length);let i=this[t]|this[t+1]<<8;return 32768&i?4294901760|i:i},ts.prototype.readInt16BE=function(t,e){t>>>=0,e||tv(t,2,this.length);let i=this[t+1]|this[t]<<8;return 32768&i?4294901760|i:i},ts.prototype.readInt32LE=function(t,e){return t>>>=0,e||tv(t,4,this.length),this[t]|this[t+1]<<8|this[t+2]<<16|this[t+3]<<24},ts.prototype.readInt32BE=function(t,e){return t>>>=0,e||tv(t,4,this.length),this[t]<<24|this[t+1]<<16|this[t+2]<<8|this[t+3]},ts.prototype.readBigInt64LE=tj(function(t){tI(t>>>=0,"offset");let e=this[t],i=this[t+7];(void 0===e||void 0===i)&&tz(t,this.length-8);let n=this[t+4]+256*this[t+5]+65536*this[t+6]+(i<<24// Overflow
);return(BigInt(n)<<BigInt(32))+BigInt(e+256*this[++t]+65536*this[++t]+16777216*this[++t])}),ts.prototype.readBigInt64BE=tj(function(t){tI(t>>>=0,"offset");let e=this[t],i=this[t+7];(void 0===e||void 0===i)&&tz(t,this.length-8);let n=(e<<24)+// Overflow
65536*this[++t]+256*this[++t]+this[++t];return(BigInt(n)<<BigInt(32))+BigInt(16777216*this[++t]+65536*this[++t]+256*this[++t]+i)}),ts.prototype.readFloatLE=function(t,e){return t>>>=0,e||tv(t,4,this.length),p(this,t,!0,23,4)},ts.prototype.readFloatBE=function(t,e){return t>>>=0,e||tv(t,4,this.length),p(this,t,!1,23,4)},ts.prototype.readDoubleLE=function(t,e){return t>>>=0,e||tv(t,8,this.length),p(this,t,!0,52,8)},ts.prototype.readDoubleBE=function(t,e){return t>>>=0,e||tv(t,8,this.length),p(this,t,!1,52,8)},ts.prototype.writeUintLE=ts.prototype.writeUIntLE=function(t,e,i,n){if(t=+t,e>>>=0,i>>>=0,!n){let n=Math.pow(2,8*i)-1;tw(this,t,e,i,n,0)}let o=1,a=0;for(this[e]=255&t;++a<i&&(o*=256);)this[e+a]=t/o&255;return e+i},ts.prototype.writeUintBE=ts.prototype.writeUIntBE=function(t,e,i,n){if(t=+t,e>>>=0,i>>>=0,!n){let n=Math.pow(2,8*i)-1;tw(this,t,e,i,n,0)}let o=i-1,a=1;for(this[e+o]=255&t;--o>=0&&(a*=256);)this[e+o]=t/a&255;return e+i},ts.prototype.writeUint8=ts.prototype.writeUInt8=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,1,255,0),this[e]=255&t,e+1},ts.prototype.writeUint16LE=ts.prototype.writeUInt16LE=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,2,65535,0),this[e]=255&t,this[e+1]=t>>>8,e+2},ts.prototype.writeUint16BE=ts.prototype.writeUInt16BE=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,2,65535,0),this[e]=t>>>8,this[e+1]=255&t,e+2},ts.prototype.writeUint32LE=ts.prototype.writeUInt32LE=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,4,4294967295,0),this[e+3]=t>>>24,this[e+2]=t>>>16,this[e+1]=t>>>8,this[e]=255&t,e+4},ts.prototype.writeUint32BE=ts.prototype.writeUInt32BE=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,4,4294967295,0),this[e]=t>>>24,this[e+1]=t>>>16,this[e+2]=t>>>8,this[e+3]=255&t,e+4},ts.prototype.writeBigUInt64LE=tj(function(t,e=0){return tk(this,t,e,BigInt(0),BigInt("0xffffffffffffffff"))}),ts.prototype.writeBigUInt64BE=tj(function(t,e=0){return tS(this,t,e,BigInt(0),BigInt("0xffffffffffffffff"))}),ts.prototype.writeIntLE=function(t,e,i,n){if(t=+t,e>>>=0,!n){let n=Math.pow(2,8*i-1);tw(this,t,e,i,n-1,-n)}let o=0,a=1,r=0;for(this[e]=255&t;++o<i&&(a*=256);)t<0&&0===r&&0!==this[e+o-1]&&(r=1),this[e+o]=(t/a>>0)-r&255;return e+i},ts.prototype.writeIntBE=function(t,e,i,n){if(t=+t,e>>>=0,!n){let n=Math.pow(2,8*i-1);tw(this,t,e,i,n-1,-n)}let o=i-1,a=1,r=0;for(this[e+o]=255&t;--o>=0&&(a*=256);)t<0&&0===r&&0!==this[e+o+1]&&(r=1),this[e+o]=(t/a>>0)-r&255;return e+i},ts.prototype.writeInt8=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,1,127,-128),t<0&&(t=255+t+1),this[e]=255&t,e+1},ts.prototype.writeInt16LE=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,2,32767,-32768),this[e]=255&t,this[e+1]=t>>>8,e+2},ts.prototype.writeInt16BE=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,2,32767,-32768),this[e]=t>>>8,this[e+1]=255&t,e+2},ts.prototype.writeInt32LE=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,4,2147483647,-2147483648),this[e]=255&t,this[e+1]=t>>>8,this[e+2]=t>>>16,this[e+3]=t>>>24,e+4},ts.prototype.writeInt32BE=function(t,e,i){return t=+t,e>>>=0,i||tw(this,t,e,4,2147483647,-2147483648),t<0&&(t=4294967295+t+1),this[e]=t>>>24,this[e+1]=t>>>16,this[e+2]=t>>>8,this[e+3]=255&t,e+4},ts.prototype.writeBigInt64LE=tj(function(t,e=0){return tk(this,t,e,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),ts.prototype.writeBigInt64BE=tj(function(t,e=0){return tS(this,t,e,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),ts.prototype.writeFloatLE=function(t,e,i){return tE(this,t,e,!0,i)},ts.prototype.writeFloatBE=function(t,e,i){return tE(this,t,e,!1,i)},ts.prototype.writeDoubleLE=function(t,e,i){return tN(this,t,e,!0,i)},ts.prototype.writeDoubleBE=function(t,e,i){return tN(this,t,e,!1,i)},// copy(targetBuffer, targetStart=0, sourceStart=0, sourceEnd=buffer.length)
ts.prototype.copy=function(t,e,i,n){if(!ts.isBuffer(t))throw TypeError("argument should be a Buffer");// Copy 0 bytes; we're done
...
ts.prototype.fill=function(t,e,i,n){let o;// Handle string cases:
if("string"==typeof t){if("string"==typeof e?(n=e,e=0,i=this.length):"string"==typeof i&&(n=i,i=this.length),void 0!==n&&"string"!=typeof n)throw TypeError("encoding must be a string");if("string"==typeof n&&!ts.isEncoding(n))throw TypeError("Unknown encoding: "+n);if(1===t.length){let e=t.charCodeAt(0);("utf8"===n&&e<128||"latin1"===n)&&(t=e)}}else"number"==typeof t?t&=255:"boolean"==typeof t&&(t=Number(t));// Invalid ranges are not set to a default, so can range check early.
if(e<0||this.length<e||this.length<i)throw RangeError("Out of range index");if(i<=e)return this;if(e>>>=0,i=void 0===i?this.length:i>>>0,t||(t=0),"number"==typeof t)for(o=e;o<i;++o)this[o]=t;else{let a=ts.isBuffer(t)?t:ts.from(t,n),r=a.length;if(0===r)throw TypeError('The value "'+t+'" is invalid for argument "value"');for(o=0;o<i-e;++o)this[o+e]=a[o%r]}return this};// CUSTOM ERRORS
// =============
// Simplified versions from Node, changed for Buffer-only usage
const tT={};function tL(t,e,i){tT[t]=class extends i{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
this.name=`${this.name} [${t}]`,// Access the stack to generate the error message including the error code
// from the name.
this.stack// eslint-disable-line no-unused-expressions
,// Reset the name to the actual name.
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tA(t){let e="",i=t.length,n="-"===t[0]?1:0;for(;i>=n+4;i-=3)e=`_${t.slice(i-3,i)}${e}`;return`${t.slice(0,i)}${e}`}function tM(t,e,i,n,o,a){if(t>i||t<e){let n;let o="bigint"==typeof e?"n":"";throw n=a>3?0===e||e===BigInt(0)?`>= 0${o} and < 2${o} ** ${(a+1)*8}${o}`:`>= -(2${o} ** ${(a+1)*8-1}${o}) and < 2 ** ${(a+1)*8-1}${o}`:`>= ${e}${o} and <= ${i}${o}`,new tT.ERR_OUT_OF_RANGE("value",n,t)}tI(o,"offset"),(void 0===n[o]||void 0===n[o+a])&&tz(o,n.length-(a+1))}function tI(t,e){if("number"!=typeof t)throw new tT.ERR_INVALID_ARG_TYPE(e,"number",t)}function tz(t,e,i){if(Math.floor(t)!==t)throw tI(t,i),new tT.ERR_OUT_OF_RANGE(i||"offset","an integer",t);if(e<0)throw new tT.ERR_BUFFER_OUT_OF_BOUNDS;throw new tT.ERR_OUT_OF_RANGE(i||"offset",`>= ${i?1:0} and <= ${e}`,t)}tL("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tL("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tL("ERR_OUT_OF_RANGE",function(t,e,i){let n=`The value of "${t}" is out of range.`,o=i;return Number.isInteger(i)&&Math.abs(i)>4294967296?o=tA(String(i)):"bigint"==typeof i&&(o=String(i),(i>BigInt(2)**BigInt(32)||i<-(BigInt(2)**BigInt(32)))&&(o=tA(o)),o+="n"),n+=` It must be ${e}. Received ${o}`},RangeError);// HELPER FUNCTIONS
// ================
const tO=/[^+/0-9A-Za-z-_]/g;function tB(t,e){let i;e=e||1/0;let n=t.length,o=null,a=[];for(let r=0;r<n;++r){// is surrogate component
...
if(o=null,i<128){if((e-=1)<0)break;a.push(i)}else if(i<2048){if((e-=2)<0)break;a.push(i>>6|192,63&i|128)}else if(i<65536){if((e-=3)<0)break;a.push(i>>12|224,i>>6&63|128,63&i|128)}else if(i<1114112){if((e-=4)<0)break;a.push(i>>18|240,i>>12&63|128,i>>6&63|128,63&i|128)}else throw Error("Invalid code point")}return a}function tP(t){return function(t){var e,i,n=function(t){var e=t.length;if(e%4>0)throw Error("Invalid string. Length must be a multiple of 4");// Trim off extra bytes after placeholder bytes are found
// See: https://github.com/beatgammit/base64-js/issues/42
var i=t.indexOf("=");-1===i&&(i=e);var n=i===e?0:4-i%4;return[i,n]}(t),o=n[0],a=n[1],r=new te((o+a)*3/4-a),s=0,l=a>0?o-4:o;for(i=0;i<l;i+=4)e=tt[t.charCodeAt(i)]<<18|tt[t.charCodeAt(i+1)]<<12|tt[t.charCodeAt(i+2)]<<6|tt[t.charCodeAt(i+3)],r[s++]=e>>16&255,r[s++]=e>>8&255,r[s++]=255&e;return 2===a&&(e=tt[t.charCodeAt(i)]<<2|tt[t.charCodeAt(i+1)]>>4,r[s++]=255&e),1===a&&(e=tt[t.charCodeAt(i)]<<10|tt[t.charCodeAt(i+1)]<<4|tt[t.charCodeAt(i+2)]>>2,r[s++]=e>>8&255,r[s++]=255&e),r}(function(t){// Node converts strings with length < 2 to ''
...
for(;t.length%4!=0;)t+="=";return t}(t))}function t_(t,e,i,n){let o;for(o=0;o<n&&!(o+i>=e.length)&&!(o>=t.length);++o)e[o+i]=t[o];return o}// ArrayBuffer or Uint8Array objects from other contexts (i.e. iframes) do not pass
// the `instanceof` check but they should be treated as of that type.
// See: https://github.com/feross/buffer/issues/166
function tR(t,e){return t instanceof e||null!=t&&null!=t.constructor&&null!=t.constructor.name&&t.constructor.name===e.name}// Create lookup table for `toString('hex')`
// See: https://github.com/feross/buffer/issues/219
const tD=function(){let t="0123456789abcdef",e=Array(256);for(let i=0;i<16;++i){let n=16*i;for(let o=0;o<16;++o)e[n+o]=t[i]+t[o]}return e}();// Return not function with Error if BigInt not supported
function tj(t){return"undefined"==typeof BigInt?tW:t}function tW(){throw Error("BigInt not supported")}/**
 * Determines if the given thing is a array or js object.
 *
 * @param {string} thing - The object or array to be visited.
 *
 * @returns {boolean}
 */function tF(t){return Y.isPlainObject(t)||Y.isArray(t)}/**
 * It removes the brackets from the end of a string
 *
 * @param {string} key - The key of the parameter.
 *
 * @returns {string} the key without the brackets.
 */function t$(t){return Y.endsWith(t,"[]")?t.slice(0,-2):t}/**
 ...
 */function tU(t,e,i){return t?t.concat(e).map(function(t,e){return(// eslint-disable-next-line no-param-reassign
t=t$(t),!i&&e?"["+t+"]":t)}).join(i?".":""):e}const tH=Y.toFlatObject(Y,{},null,function(t){return/^is[A-Z]/.test(t)});var tX=/**
 ...
 *
 * @returns
 */function(t,e,i){if(!Y.isObject(t))throw TypeError("target must be an object");// eslint-disable-next-line no-param-reassign
e=e||new FormData,// eslint-disable-next-line no-param-reassign
i=Y.toFlatObject(i,{metaTokens:!0,dots:!1,indexes:!1},!1,function(t,e){// eslint-disable-next-line no-eq-null,eqeqeq
return!Y.isUndefined(e[t])});let n=i.metaTokens,o=i.visitor||f,a=i.dots,r=i.indexes,s=i.Blob||"undefined"!=typeof Blob&&Blob,l=s&&Y.isSpecCompliantForm(e);if(!Y.isFunction(o))throw TypeError("visitor must be a function");function c(t){if(null===t)return"";if(Y.isDate(t))return t.toISOString();if(!l&&Y.isBlob(t))throw new K("Blob is not supported. Use a Buffer instead.");return Y.isArrayBuffer(t)||Y.isTypedArray(t)?l&&"function"==typeof Blob?new Blob([t]):ts.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
   ...
   */function f(t,i,o){let s=t;if(t&&!o&&"object"==typeof t){if(Y.endsWith(i,"{}"))// eslint-disable-next-line no-param-reassign
i=n?i:i.slice(0,-2),// eslint-disable-next-line no-param-reassign
t=JSON.stringify(t);else{var l;if(Y.isArray(t)&&(l=t,Y.isArray(l)&&!l.some(tF))||(Y.isFileList(t)||Y.endsWith(i,"[]"))&&(s=Y.toArray(t)))return(// eslint-disable-next-line no-param-reassign
i=t$(i),s.forEach(function(t,n){Y.isUndefined(t)||null===t||e.append(!0===r?tU([i],n,a):null===r?i:i+"[]",c(t))}),!1)}}return!!tF(t)||(e.append(tU(o,i,a),c(t)),!1)}let p=[],d=Object.assign(tH,{defaultVisitor:f,convertValue:c,isVisitable:tF});if(!Y.isObject(t))throw TypeError("data must be an object");return!function t(i,n){if(!Y.isUndefined(i)){if(-1!==p.indexOf(i))throw Error("Circular reference detected in "+n.join("."));p.push(i),Y.forEach(i,function(i,a){let r=!(Y.isUndefined(i)||null===i)&&o.call(e,i,Y.isString(a)?a.trim():a,n,d);!0===r&&t(i,n?n.concat(a):[a])}),p.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tG(t,e){this._pairs=[],t&&tX(t,this,e)}const tV=tG.prototype;/**
 ...
 */function tY(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tK(t,e,i){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=i&&i.encode||tY,a=i&&i.serialize;if(n=a?a(e,i):Y.isURLSearchParams(e)?e.toString():new tG(e,i).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tV.append=function(t,e){this._pairs.push([t,e])},tV.toString=function(t){let e=t?function(e){return t.call(this,e,tq)}:tq;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tJ=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){Y.forEach(this.handlers,function(e){null!==e&&t(e)})}},tQ={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tZ="undefined"!=typeof URLSearchParams?URLSearchParams:tG,t0="undefined"!=typeof FormData?FormData:null,t1="undefined"!=typeof Blob?Blob:null;/**
 ...
 *
 * @returns {boolean}
 */const t2=("undefined"==typeof navigator||"ReactNative"!==(n=navigator.product)&&"NativeScript"!==n&&"NS"!==n)&&"undefined"!=typeof window&&"undefined"!=typeof document,t5="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var t6={classes:{URLSearchParams:tZ,FormData:t0,Blob:t1},isStandardBrowserEnv:t2,isStandardBrowserWebWorkerEnv:t5,protocols:["http","https","file","blob","url","data"]},t3=/**
 * It takes a FormData object and returns a JavaScript object
 *
 * @param {string} formData The FormData object to convert to JSON.
 *
 * @returns {Object<string, any> | null} The converted object.
 */function(t){if(Y.isFormData(t)&&Y.isFunction(t.entries)){let e={};return Y.forEachEntry(t,(t,i)=>{!function t(e,i,n,o){let a=e[o++],r=Number.isFinite(+a),s=o>=e.length;if(a=!a&&Y.isArray(n)?n.length:a,s)return Y.hasOwnProp(n,a)?n[a]=[n[a],i]:n[a]=i,!r;n[a]&&Y.isObject(n[a])||(n[a]=[]);let l=t(e,i,n[a],o);return l&&Y.isArray(n[a])&&(n[a]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(t){let e,i;let n={},o=Object.keys(t),a=o.length;for(e=0;e<a;e++)n[i=o[e]]=t[i];return n}(n[a])),!r}(Y.matchAll(/\w+|\[(\w*)]/g,t).map(t=>"[]"===t[0]?"":t[1]||t[0]),i,e,0)}),e}return null};const t4={transitional:tQ,adapter:t6.isNode?"http":"xhr",transformRequest:[function(t,e){let i;let n=e.getContentType()||"",o=n.indexOf("application/json")>-1,a=Y.isObject(t);a&&Y.isHTMLForm(t)&&(t=new FormData(t));let r=Y.isFormData(t);if(r)return o&&o?JSON.stringify(t3(t)):t;if(Y.isArrayBuffer(t)||Y.isBuffer(t)||Y.isStream(t)||Y.isFile(t)||Y.isBlob(t))return t;if(Y.isArrayBufferView(t))return t.buffer;if(Y.isURLSearchParams(t))return e.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();if(a){if(n.indexOf("application/x-www-form-urlencoded")>-1){var s,l;return(s=t,l=this.formSerializer,tX(s,new t6.classes.URLSearchParams,Object.assign({visitor:function(t,e,i,n){return t6.isNode&&Y.isBuffer(t)?(this.append(e,t.toString("base64")),!1):n.defaultVisitor.apply(this,arguments)}},l))).toString()}if((i=Y.isFileList(t))||n.indexOf("multipart/form-data")>-1){let e=this.env&&this.env.FormData;return tX(i?{"files[]":t}:t,e&&new e,this.formSerializer)}}return a||o?(e.setContentType("application/json",!1),/**
 ...
 */function(t,e,i){if(Y.isString(t))try{return(0,JSON.parse)(t),Y.trim(t)}catch(t){if("SyntaxError"!==t.name)throw t}return(0,JSON.stringify)(t)}(t)):t}],transformResponse:[function(t){let e=this.transitional||t4.transitional,i=e&&e.forcedJSONParsing,n="json"===this.responseType;if(t&&Y.isString(t)&&(i&&!this.responseType||n)){let i=e&&e.silentJSONParsing;try{return JSON.parse(t)}catch(t){if(!i&&n){if("SyntaxError"===t.name)throw K.from(t,K.ERR_BAD_RESPONSE,this,null,this.response);throw t}}}return t}],/**
   * A timeout in milliseconds to abort a request. If set to 0 (default) a
   * timeout is not created.
   */timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:t6.classes.FormData,Blob:t6.classes.Blob},validateStatus:function(t){return t>=200&&t<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};Y.forEach(["delete","get","head","post","put","patch"],t=>{t4.headers[t]={}});// RawAxiosHeaders whose duplicates are ignored by node
// c.f. https://nodejs.org/api/http.html#http_message_headers
const t8=Y.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */t9=t=>{let e,i,n;let o={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),i=t.substring(n+1).trim(),!e||o[e]&&t8[e]||("set-cookie"===e?o[e]?o[e].push(i):o[e]=[i]:o[e]=o[e]?o[e]+", "+i:i)}),o};const t7=Symbol("internals");function et(t){return t&&String(t).trim().toLowerCase()}function ee(t){return!1===t||null==t?t:Y.isArray(t)?t.map(ee):String(t)}const ei=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function en(t,e,i,n,o){if(Y.isFunction(n))return n.call(this,e,i);if(o&&(e=i),Y.isString(e)){if(Y.isString(n))return -1!==e.indexOf(n);if(Y.isRegExp(n))return n.test(e)}}class eo{constructor(t){t&&this.set(t)}set(t,e,i){let n=this;function o(t,e,i){let o=et(e);if(!o)throw Error("header name must be a non-empty string");let a=Y.findKey(n,o);a&&void 0!==n[a]&&!0!==i&&(void 0!==i||!1===n[a])||(n[a||e]=ee(t))}let a=(t,e)=>Y.forEach(t,(t,i)=>o(t,i,e));return Y.isPlainObject(t)||t instanceof this.constructor?a(t,e):Y.isString(t)&&(t=t.trim())&&!ei(t)?a(t9(t),e):null!=t&&o(e,t,i),this}get(t,e){if(t=et(t)){let i=Y.findKey(this,t);if(i){let t=this[i];if(!e)return t;if(!0===e)return function(t){let e;let i=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)i[e[1]]=e[2];return i}(t);if(Y.isFunction(e))return e.call(this,t,i);if(Y.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=et(t)){let i=Y.findKey(this,t);return!!(i&&void 0!==this[i]&&(!e||en(this,this[i],i,e)))}return!1}delete(t,e){let i=this,n=!1;function o(t){if(t=et(t)){let o=Y.findKey(i,t);o&&(!e||en(i,i[o],o,e))&&(delete i[o],n=!0)}}return Y.isArray(t)?t.forEach(o):o(t),n}clear(t){let e=Object.keys(this),i=e.length,n=!1;for(;i--;){let o=e[i];(!t||en(this,this[o],o,t,!0))&&(delete this[o],n=!0)}return n}normalize(t){let e=this,i={};return Y.forEach(this,(n,o)=>{let a=Y.findKey(i,o);if(a){e[a]=ee(n),delete e[o];return}let r=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,i)=>e.toUpperCase()+i):String(o).trim();r!==o&&delete e[o],e[r]=ee(n),i[r]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return Y.forEach(this,(i,n)=>{null!=i&&!1!==i&&(e[n]=t&&Y.isArray(i)?i.join(", "):i)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let i=new this(t);return e.forEach(t=>i.set(t)),i}static accessor(t){let e=this[t7]=this[t7]={accessors:{}},i=e.accessors,n=this.prototype;function o(t){let e=et(t);i[e]||(!function(t,e){let i=Y.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+i,{value:function(t,i,o){return this[n].call(this,e,t,i,o)},configurable:!0})})}(n,t),i[e]=!0)}return Y.isArray(t)?t.forEach(o):o(t),this}}function ea(t,e){let i=this||t4,n=e||i,o=eo.from(n.headers),a=n.data;return Y.forEach(t,function(t){a=t.call(i,a,o.normalize(),e?e.status:void 0)}),o.normalize(),a}function er(t){return!!(t&&t.__CANCEL__)}/**
 ...
 */function es(t,e,i){K.call(this,null==t?"canceled":t,K.ERR_CANCELED,e,i),this.name="CanceledError"}eo.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),Y.reduceDescriptors(eo.prototype,({value:t},e)=>{let i=e[0].toUpperCase()+e.slice(1);// map `set` => `Set`
return{get:()=>t,set(t){this[i]=t}}}),Y.freezeMethods(eo),Y.inherits(es,K,{__CANCEL__:!0});var el=t6.isStandardBrowserEnv?{write:function(t,e,i,n,o,a){let r=[];r.push(t+"="+encodeURIComponent(e)),Y.isNumber(i)&&r.push("expires="+new Date(i).toGMTString()),Y.isString(n)&&r.push("path="+n),Y.isString(o)&&r.push("domain="+o),!0===a&&r.push("secure"),document.cookie=r.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function ec(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var ef=t6.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
i.setAttribute("href",n),n=i.href),i.setAttribute("href",n),{href:i.href,protocol:i.protocol?i.protocol.replace(/:$/,""):"",host:i.host,search:i.search?i.search.replace(/^\?/,""):"",hash:i.hash?i.hash.replace(/^#/,""):"",hostname:i.hostname,port:i.port,pathname:"/"===i.pathname.charAt(0)?i.pathname:"/"+i.pathname}}/**
    ...
    */return t=n(window.location.href),function(e){let i=Y.isString(e)?n(e):e;return i.protocol===t.protocol&&i.host===t.host}}():function(){return!0},ep=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(t,e){let i;t=t||10;let n=Array(t),o=Array(t),a=0,r=0;return e=void 0!==e?e:1e3,function(s){let l=Date.now(),c=o[r];i||(i=l),n[a]=s,o[a]=l;let f=r,p=0;for(;f!==a;)p+=n[f++],f%=t;if((a=(a+1)%t)===r&&(r=(r+1)%t),l-i<e)return;let d=c&&l-c;return d?Math.round(1e3*p/d):void 0}};function ed(t,e){let i=0,n=ep(50,250);return o=>{let a=o.loaded,r=o.lengthComputable?o.total:void 0,s=a-i,l=n(s),c=a<=r;i=a;let f={loaded:a,total:r,progress:r?a/r:void 0,bytes:s,rate:l||void 0,estimated:l&&r&&c?(r-a)/l:void 0,event:o};f[e?"download":"upload"]=!0,t(f)}}const eu="undefined"!=typeof XMLHttpRequest;var em=eu&&function(t){return new Promise(function(e,i){let n,o=t.data,a=eo.from(t.headers).normalize(),r=t.responseType;function s(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}Y.isFormData(o)&&(t6.isStandardBrowserEnv||t6.isStandardBrowserWebWorkerEnv?a.setContentType(!1):a.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
if(t.auth){let e=t.auth.username||"",i=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";a.set("Authorization","Basic "+btoa(e+":"+i))}let c=ec(t.baseURL,t.url);function f(){if(!l)return;// Prepare the response
let n=eo.from("getAllResponseHeaders"in l&&l.getAllResponseHeaders()),o=r&&"text"!==r&&"json"!==r?l.response:l.responseText,a={data:o,status:l.status,statusText:l.statusText,headers:n,config:t,request:l};!function(t,e,i){let n=i.config.validateStatus;!i.status||!n||n(i.status)?t(i):e(new K("Request failed with status code "+i.status,[K.ERR_BAD_REQUEST,K.ERR_BAD_RESPONSE][Math.floor(i.status/100)-4],i.config,i.request,i))}(function(t){e(t),s()},function(t){i(t),s()},a),// Clean up request
l=null}// Add xsrf header
// This is only done if running in a standard browser environment.
// Specifically not if we're in a web worker, or react-native.
if(l.open(t.method.toUpperCase(),tK(c,t.params,t.paramsSerializer),!0),// Set the request timeout in MS
...
l.onabort=function(){l&&(i(new K("Request aborted",K.ECONNABORTED,t,l)),// Clean up request
l=null)},// Handle low level network errors
l.onerror=function(){// Real errors are hidden from us by the browser
// onerror should only fire if it's a network error
i(new K("Network Error",K.ERR_NETWORK,t,l)),// Clean up request
l=null},// Handle timeout
l.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tQ;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),i(new K(e,n.clarifyTimeoutError?K.ETIMEDOUT:K.ECONNABORTED,t,l)),// Clean up request
l=null},t6.isStandardBrowserEnv){// Add xsrf header
let e=(t.withCredentials||ef(c))&&t.xsrfCookieName&&el.read(t.xsrfCookieName);e&&a.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
void 0===o&&a.setContentType(null),"setRequestHeader"in l&&Y.forEach(a.toJSON(),function(t,e){l.setRequestHeader(e,t)}),Y.isUndefined(t.withCredentials)||(l.withCredentials=!!t.withCredentials),r&&"json"!==r&&(l.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&l.addEventListener("progress",ed(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&l.upload&&l.upload.addEventListener("progress",ed(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=e=>{l&&(i(!e||e.type?new es(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let p=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(c);if(p&&-1===t6.protocols.indexOf(p)){i(new K("Unsupported protocol "+p+":",K.ERR_BAD_REQUEST,t));return}// Send the request
l.send(o||null)})};const eh={http:null,xhr:em};Y.forEach(eh,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});var eg={getAdapter:t=>{let e,i;t=Y.isArray(t)?t:[t];let{length:n}=t;for(let o=0;o<n&&(e=t[o],!(i=Y.isString(e)?eh[e.toLowerCase()]:e));o++);if(!i){if(!1===i)throw new K(`Adapter ${e} is not supported by the environment`,"ERR_NOT_SUPPORT");throw Error(Y.hasOwnProp(eh,e)?`Adapter '${e}' is not available in the build`:`Unknown adapter '${e}'`)}if(!Y.isFunction(i))throw TypeError("adapter is not a function");return i},adapters:eh};/**
 * Throws a `CanceledError` if cancellation has been requested.
 *
 * @param {Object} config The config that is to be used for the request
 *
 * @returns {void}
 */function ey(t){if(t.cancelToken&&t.cancelToken.throwIfRequested(),t.signal&&t.signal.aborted)throw new es(null,t)}function ex(t){ey(t),t.headers=eo.from(t.headers),// Transform request data
t.data=ea.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=eg.getAdapter(t.adapter||t4.adapter);return e(t).then(function(e){return ey(t),// Transform response data
e.data=ea.call(t,t.transformResponse,e),e.headers=eo.from(e.headers),e},function(e){return!er(e)&&(ey(t),e&&e.response&&(e.response.data=ea.call(t,t.transformResponse,e.response),e.response.headers=eo.from(e.response.headers))),Promise.reject(e)})}const eb=t=>t instanceof eo?t.toJSON():t;function ev(t,e){// eslint-disable-next-line no-param-reassign
e=e||{};let i={};function n(t,e,i){return Y.isPlainObject(t)&&Y.isPlainObject(e)?Y.merge.call({caseless:i},t,e):Y.isPlainObject(e)?Y.merge({},e):Y.isArray(e)?e.slice():e}// eslint-disable-next-line consistent-return
function o(t,e,i){return Y.isUndefined(e)?Y.isUndefined(t)?void 0:n(void 0,t,i):n(t,e,i)}// eslint-disable-next-line consistent-return
function a(t,e){if(!Y.isUndefined(e))return n(void 0,e)}// eslint-disable-next-line consistent-return
function r(t,e){return Y.isUndefined(e)?Y.isUndefined(t)?void 0:n(void 0,t):n(void 0,e)}// eslint-disable-next-line consistent-return
function s(i,o,a){return a in e?n(i,o):a in t?n(void 0,i):void 0}let l={url:a,method:a,data:a,baseURL:r,transformRequest:r,transformResponse:r,paramsSerializer:r,timeout:r,timeoutMessage:r,withCredentials:r,adapter:r,responseType:r,xsrfCookieName:r,xsrfHeaderName:r,onUploadProgress:r,onDownloadProgress:r,decompress:r,maxContentLength:r,maxBodyLength:r,beforeRedirect:r,transport:r,httpAgent:r,httpsAgent:r,cancelToken:r,socketPath:r,responseEncoding:r,validateStatus:s,headers:(t,e)=>o(eb(t),eb(e),!0)};return Y.forEach(Object.keys(Object.assign({},t,e)),function(n){let a=l[n]||o,r=a(t[n],e[n],n);Y.isUndefined(r)&&a!==s||(i[n]=r)}),i}const ew="1.5.0",ek={};// eslint-disable-next-line func-names
["object","boolean","number","function","string","symbol"].forEach((t,e)=>{ek[t]=function(i){return typeof i===t||"a"+(e<1?"n ":" ")+t}});const eS={};/**
 ...
 *
 * @returns {function}
 */ek.transitional=function(t,e,i){function n(t,e){return"[Axios v"+ew+"] Transitional option '"+t+"'"+e+(i?". "+i:"")}// eslint-disable-next-line func-names
return(i,o,a)=>{if(!1===t)throw new K(n(o," has been removed"+(e?" in "+e:"")),K.ERR_DEPRECATED);return e&&!eS[o]&&(eS[o]=!0,// eslint-disable-next-line no-console
console.warn(n(o," has been deprecated since v"+e+" and will be removed in the near future"))),!t||t(i,o,a)}};var eC={assertOptions:/**
 ...
 *
 * @returns {object}
 */function(t,e,i){if("object"!=typeof t)throw new K("options must be an object",K.ERR_BAD_OPTION_VALUE);let n=Object.keys(t),o=n.length;for(;o-- >0;){let a=n[o],r=e[a];if(r){let e=t[a],i=void 0===e||r(e,a,t);if(!0!==i)throw new K("option "+a+" must be "+i,K.ERR_BAD_OPTION_VALUE);continue}if(!0!==i)throw new K("Unknown option "+a,K.ERR_BAD_OPTION)}},validators:ek};const eE=eC.validators;/**
 * Create a new instance of Axios
 *
 * @param {Object} instanceConfig The default config for the instance
 *
 * @return {Axios} A new instance of Axios
 */class eN{constructor(t){this.defaults=t,this.interceptors={request:new tJ,response:new tJ}}/**
   * Dispatch a request
   *
   ...
   */request(t,e){let i,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=ev(this.defaults,e);let{transitional:o,paramsSerializer:a,headers:r}=e;void 0!==o&&eC.assertOptions(o,{silentJSONParsing:eE.transitional(eE.boolean),forcedJSONParsing:eE.transitional(eE.boolean),clarifyTimeoutError:eE.transitional(eE.boolean)},!1),null!=a&&(Y.isFunction(a)?e.paramsSerializer={serialize:a}:eC.assertOptions(a,{encode:eE.function,serialize:eE.function},!0)),// Set config.method
e.method=(e.method||this.defaults.method||"get").toLowerCase();// Flatten headers
let s=r&&Y.merge(r.common,r[e.method]);r&&Y.forEach(["delete","get","head","post","put","patch","common"],t=>{delete r[t]}),e.headers=eo.concat(s,r);// filter out skipped interceptors
let l=[],c=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(c=c&&t.synchronous,l.unshift(t.fulfilled,t.rejected))});let f=[];this.interceptors.response.forEach(function(t){f.push(t.fulfilled,t.rejected)});let p=0;if(!c){let t=[ex.bind(this),void 0];for(t.unshift.apply(t,l),t.push.apply(t,f),n=t.length,i=Promise.resolve(e);p<n;)i=i.then(t[p++],t[p++]);return i}n=l.length;let d=e;for(p=0;p<n;){let t=l[p++],e=l[p++];try{d=t(d)}catch(t){e.call(this,t);break}}try{i=ex.call(this,d)}catch(t){return Promise.reject(t)}for(p=0,n=f.length;p<n;)i=i.then(f[p++],f[p++]);return i}getUri(t){t=ev(this.defaults,t);let e=ec(t.baseURL,t.url);return tK(e,t.params,t.paramsSerializer)}}Y.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/eN.prototype[t]=function(e,i){return this.request(ev(i||{},{method:t,url:e,data:(i||{}).data}))}}),Y.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(i,n,o){return this.request(ev(o||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:i,data:n}))}}eN.prototype[t]=e(),eN.prototype[t+"Form"]=e(!0)});/**
 * A `CancelToken` is an object that can be used to request cancellation of an operation.
 *
 * @param {Function} executor The executor function.
 *
 * @returns {CancelToken}
 */class eT{constructor(t){let e;if("function"!=typeof t)throw TypeError("executor must be a function.");this.promise=new Promise(function(t){e=t});let i=this;// eslint-disable-next-line func-names
...
let n=new Promise(t=>{i.subscribe(t),e=t}).then(t);return n.cancel=function(){i.unsubscribe(e)},n},t(function(t,n,o){i.reason||(i.reason=new es(t,n,o),e(i.reason))})}/**
   * Throws a `CanceledError` if cancellation has been requested.
 ...
 */function t(e){let i=new eN(e),n=y(eN.prototype.request,i);return Y.extend(n,eN.prototype,i,{allOwnKeys:!0}),Y.extend(n,i,null,{allOwnKeys:!0}),// Factory for creating new instances
n.create=function(i){return t(ev(e,i))},n}(t4);// Expose Axios class to allow class inheritance
eA.Axios=eN,// Expose Cancel & CancelToken
eA.CanceledError=es,eA.CancelToken=eT,eA.isCancel=er,eA.VERSION=ew,eA.toFormData=tX,// Expose AxiosError class
eA.AxiosError=K,// alias for CanceledError for backward compatibility
...
eA.isAxiosError=function(t){return Y.isObject(t)&&!0===t.isAxiosError},// Expose mergeConfig
eA.mergeConfig=ev,eA.AxiosHeaders=eo,eA.formToJSON=t=>t3(Y.isHTMLForm(t)?new FormData(t):t),eA.getAdapter=eg.getAdapter,eA.HttpStatusCode=eL,eA.default=eA;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
const{Axios:eM,AxiosError:eI,CanceledError:ez,isCancel:eO,CancelToken:eB,VERSION:eP,all:e_,Cancel:eR,isAxiosError:eD,spread:ej,toFormData:eW,AxiosHeaders:eF,HttpStatusCode:e$,formToJSON:eU,getAdapter:eH,mergeConfig:eX}=eA,eq="https://tasty-treats-backend.p.goit.global/api",eG={events:"/events",recipes:"/recipes",categories:"/categories",popular:"/recipes/popular",ingredients:"/ingredients",areas:"/areas",orders:"/orders/add"},eV=async()=>{let t=await eA.get(`${eq}${eG.events}`);return t},eY=async()=>{let t=await eA.get(`${eq}${eG.categories}`);return t},eK=async()=>{let t=await eA.get(`${eq}${eG.popular}`);return t},eJ=async t=>{let e=await eA.get(`${eq}${eG.recipes}/${t}`);return e},eQ=async()=>{let t=await eA.get(`${eq}${eG.ingredients}`);return t},eZ=async()=>{let t=await eA.get(`${eq}${eG.areas}`);return t},e0=async t=>{let e=await eA.post(`${eq}${eG.orders}`,t);return e},e1=async t=>{let e=await eA.get(`${eq}${eG.recipes}?${t}`);return e};function e2(t){"Success"===t.data.message?(0,g.Notify).success("Вітаємо, ваше замовлення прийнято!"):(0,g.Notify).warning("Вибачте, в цей час замовлення не приймаються!")}// ********************************************************
const e5=document.querySelector(".js-open-menu"),e6=document.querySelector(".js-close-menu"),e3=document.querySelector(".js-menu-container"),e4=document.querySelector(".basket-button");function e8(){let t=h.create(`
...
`,{onShow:t=>{document.addEventListener("keydown",a)}},{closeShow:t=>{document.removeEventListener("keydown",a)}});document.body.style.overflow="hidden",t.show();let e=document.querySelector(".header-form");!function(t){t.addEventListener("submit",function(t){t.preventDefault();let{name:e,phone:i,email:n,comment:o}=t.currentTarget.elements;e0({name:e.value,phone:i.value,email:n.value,comment:o.value}).then(e2).catch(t=>{console.log(t)})})}(e);let i=document.querySelector(".js-modal-close-btn"),n=document.querySelector(".header-form-btn"),o=document.querySelector(".header-modal");function a(e){if("Escape"===e.code)return t.close()}o.addEventListener("submit",t=>{t.preventDefault()}),i.addEventListener("click",()=>{document.body.style.overflow="auto",t.close()}),// питання чому не може спррацьовує на submit
n.addEventListener("click",()=>{document.body.style.overflow="auto",t.close()})}e5.addEventListener("click",function(){e3.classList.contains("is-open")||e3.classList.add("is-open")}),e6.addEventListener("click",function(){e3.classList.contains("is-open")&&e3.classList.remove("is-open")}),// ------------------МОДАЛКА-------------------
e4.addEventListener("click",e8);const e9=document.querySelector(".switcher-check"),e7=document.querySelector(".mob-switcher-check"),it=document.querySelector(".js-menu-container"),ie=document.querySelector(".header"),ii=document.querySelector("body"),io=document.querySelector(".recipes-all"),ia=document.querySelector(".popular-item-js"),ir=document.querySelector(".categories-btn-js"),is={DARK:"dark-theme"};e9.addEventListener("change",()=>{let t=ii.classList.contains(is.DARK);t?(ii.classList.remove(is.DARK),ie.classList.remove(is.DARK),io.classList.remove(is.DARK),ia.remove(is.DARK),ir.remove(is.DARK),it.classList.remove(is.DARK)):(ii.classList.add(is.DARK),ie.classList.add(is.DARK),io.classList.add(is.DARK),ia.add(is.DARK),ir.remove(is.DARK),it.classList.add(is.DARK));// localStorage.setItem('theme', isDarkMode ? Theme.LIGHT : Theme.DARK);
}),// ---------------Mob-Switcher------------------------------
e7.addEventListener("change",()=>{let t=ii.classList.contains(is.DARK);t?(ii.classList.remove(is.DARK),ie.classList.remove(is.DARK),it.classList.remove(is.DARK)):(ii.classList.add(is.DARK),ie.classList.add(is.DARK),it.classList.add(is.DARK));// localStorage.setItem('theme', isDarkMode ? Theme.LIGHT : Theme.DARK);
});const il=document.querySelector(".card-list"),ic=async(t,e,i,n,o,a)=>{// Праметри API запиту
let r=new URLSearchParams({limit:9}),s=await eA.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${r}`);return s};function ip(t){il.innerHTML=t.data.results.map(t=>`
    <li class="card-item">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join(""),function(){let t=document.querySelectorAll(".box-star");t.forEach(t=>{let e=t.previousElementSibling,i=Math.round(e.textContent),n=[...t.children];n.forEach((t,e)=>{e<i&&t.classList.add("yellow-star")})})}()}window.addEventListener("load",function(){ic().then(ip).catch(t=>{console.log(t)})});const id=new MutationObserver(function(){let t=document.querySelectorAll(".info-btn");// витягуємо всі кнопки
t.forEach(t=>{t.addEventListener("click",iu);// вішаємо слухача на кнопки
})});// створюємо екземпляр класу MutationObserver
function iu(t){let e=t.target.id;eJ(e).then(t=>{!function(t){let{data:{title:e,youtube:i,thumb:n,rating:o,time:a,ingredients:r,tags:s,instructions:l}}=t,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),f=h.create(`<div class="card-modal">
...
function(t){let e=document.querySelector(".box-stars");document.querySelector(".star");let i=[...e.children],n=Math.round(t);i.forEach((t,e)=>{e<n&&t.classList.add("yellow-star")})}(o),document.body.style.overflow="hidden";let p=document.querySelector(".js-card-close-btn");document.querySelector(".card-modal"),p.addEventListener("click",()=>{document.body.style.overflow="auto",f.close()})}(t);let e=document.querySelector(".basicLightbox");e.classList.add("correct-recipe")}).catch(t=>{console.log(t)})}id.observe(il,{// параметри MutationObserver
childList:!0,subtree:!0});var im={};window,im=/******/function(t){/******/// The module cache
...
ig.allCategiries.addEventListener("click",iE),ig.categories.addEventListener("click",iN),ig.popular.addEventListener("click",iL),// прибирання слухачів подій
window.addEventListener("unload",function(){ig.allCategiries.removeEventListener("click",iE),ig.categories.removeEventListener("click",iN),ig.popular.removeEventListener("click",iL),ik.off("afterMove",iC)}),eY().then(t=>{ig.categories.insertAdjacentHTML("beforeend",// формування розмітки переліку категорій
...
iS(),eK().then(t=>{ig.popular.insertAdjacentHTML("beforeend",t.data.map(t=>`
...
let e=ig.popular.querySelectorAll(".popular-button-js");e.forEach(t=>{t.addEventListener("click",iL)})}).catch(()=>{});const iz=iI();function iO(t){let e=/**
  |============================
  | Розмітка Swiper
  |============================
...
s=setTimeout(h,e),u(l))}return void 0===s&&(s=setTimeout(h,e)),r}return e=nN(e)||0,nE(i)&&(f=!!i.leading,a=(p="maxWait"in i)?nk(nN(i.maxWait)||0,e):a,d="trailing"in i?!!i.trailing:d),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nC())},y};const nT={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nT.form.addEventListener("submit",function(t){t.preventDefault()}),nT.time.addEventListener("change",function(t){iA("time",t.currentTarget.value),iS()}),nT.area.addEventListener("change",function(t){iA("area",t.currentTarget.value),iS()}),nT.ingredients.addEventListener("change",function(t){iA("ingredient",t.currentTarget.value),iS()}),nT.search.addEventListener("input",/*@__PURE__*/m(np)(()=>{iA("title",nT.search.value.trim()),iS()},300)),eZ().then(t=>{nT.area.innerHTML=t.data.map(({name:t})=>`<option class="filter-opt" value="${t}">${t}</option>`).join("")}).catch(t=>{console.log(t)}),eQ().then(t=>{nT.ingredients.innerHTML=t.data.map(({name:t,_id:e})=>`<option class="filter-opt" value="${e}">${t}</option>`).join("")}).catch(t=>{}),// ❗ Створення Time ❗
...
nT.resetBtn.addEventListener("click",function(t){iM("time"),iM("area"),iM("ingredient"),iM("title"),iS()}//# sourceMappingURL=index.cd7eff3b.js.map
);
//# sourceMappingURL=index.cd7eff3b.js.map
