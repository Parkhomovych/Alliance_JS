...
const eP={};function e_(e,t,i){eP[e]=class extends i{constructor(){super(),Object.defineProperty(this,"message",{value:t.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
...
// ================
const eW=/[^+/0-9A-Za-z-_]/g;function e$(e,t){let i;t=t||1/0;let n=e.length,r=null,a=[];for(let o=0;o<n;++o){// is surrogate component
...
let ic=window.innerWidth<768?6:window.innerWidth<1280?8:9,id=1,ip=window.innerWidth<768?2:3;// екземпляр класу з параметрами для запиту рецептів по філтру
const iu=new URLSearchParams({page:id,limit:ic}),im={totalItems:0,itemsPerPage:ic,visiblePages:ip,page:id},ih=new/*@__PURE__*/(f(io))(il.pagination,im);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
...
let t=il.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",iw)})}).catch(()=>{});const iC=iE();function iT(e){let t=/**
  |============================
  | Запит для Swiper
  |============================
*//**
...
nn.resetBtn.addEventListener("click",function(e){iS("time"),iS("area"),iS("ingredients"),ig()}//# sourceMappingURL=favorite.aeffc5c5.js.map
);
//# sourceMappingURL=favorite.aeffc5c5.js.map
