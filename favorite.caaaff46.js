var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},c={},l=t.parcelRequired7c6;// import { createMarkupCards } from './favorit-markup-cards'
...
function i(t){return t.map(t=>`
  ...
  <path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
    ...
    `).join("")}null==l&&((l=function(t){if(t in a)return a[t].exports;if(t in c){var l=c[t];delete c[t];var i={id:t,exports:{}};return a[t]=i,l.call(i.exports,i,i.exports),i.exports}var e=Error("Cannot find module '"+t+"'");throw e.code="MODULE_NOT_FOUND",e}).register=function(t,a){c[t]=a},t.parcelRequired7c6=l);var e=l("fAYBR"),s=l("5uEKZ");const o=(0,e.default)();let r=[];// const cardFavoriteLocal = localStorage.getItem("cardData");
// const cardFavorites = JSON.parse(cardFavoriteLocal);
// Дефолтне додавання всіх All  categories
...
//     }
// });
}//# sourceMappingURL=favorite.caaaff46.js.map
);
//# sourceMappingURL=favorite.caaaff46.js.map
