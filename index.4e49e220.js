...
let{toString:A}=Object.prototype,{getPrototypeOf:M}=Object,z=(r=Object.create(null),e=>{let t=A.call(e);return r[t]||(r[t]=t.slice(8,-1).toLowerCase())}),I=e=>(e=e.toLowerCase(),t=>z(t)===e),O=e=>t=>typeof t===e,{isArray:B}=Array,P=O("undefined"),_=I("ArrayBuffer"),R=O("string"),D=O("function"),j=O("number"),F=e=>null!==e&&"object"==typeof e,W=e=>{if("object"!==z(e))return!1;let t=M(e);return(null===t||t===Object.prototype||null===Object.getPrototypeOf(t))&&!(Symbol.toStringTag in e)&&!(Symbol.iterator in e)},$=I("Date"),U=I("File"),H=I("Blob"),X=I("FileList"),G=I("URLSearchParams");/**
 ...
 * @returns {any}
 */function q(e,t,{allOwnKeys:i=!1}={}){let n,r;// Don't bother if no value provided
...
let a=i?Object.getOwnPropertyNames(e):Object.keys(e),o=a.length;for(n=0;n<o;n++)r=a[n],t.call(null,e[r],r,e)}}}function V(e,t){let i;t=t.toLowerCase();let n=Object.keys(e),r=n.length;for(;r-- >0;)if(t===(i=n[r]).toLowerCase())return i;return null}let Y=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:d,K=e=>!P(e)&&e!==Y,J=(a="undefined"!=typeof Uint8Array&&M(Uint8Array),e=>a&&e instanceof a),Q=I("HTMLFormElement"),Z=(({hasOwnProperty:e})=>(t,i)=>e.call(t,i))(Object.prototype),ee=I("RegExp"),et=(e,t)=>{let i=Object.getOwnPropertyDescriptors(e),n={};q(i,(i,r)=>{let a;!1!==(a=t(i,r,e))&&(n[r]=a||i)}),Object.defineProperties(e,n)},ei="abcdefghijklmnopqrstuvwxyz",en="0123456789",er={DIGIT:en,ALPHA:ei,ALPHA_DIGIT:ei+ei.toUpperCase()+en},ea=I("AsyncFunction");var eo={isArray:B,isArrayBuffer:_,isBuffer:/**
 * Determine if a value is a Buffer
 *
 * @param {*} val The value to test
 *
 * @returns {boolean} True if value is a Buffer, otherwise false
 */function(e){return null!==e&&!P(e)&&null!==e.constructor&&!P(e.constructor)&&D(e.constructor.isBuffer)&&e.constructor.isBuffer(e)},isFormData:e=>{let t;return e&&("function"==typeof FormData&&e instanceof FormData||D(e.append)&&("formdata"===(t=z(e))||// detect form-data instance
 ...
 *
 * @returns {boolean}
 */function(e){return!!(e&&D(e.append)&&"FormData"===e[Symbol.toStringTag]&&e[Symbol.iterator])},toJSONObject:e=>{let t=Array(10),i=(e,n)=>{if(F(e)){if(t.indexOf(e)>=0)return;if(!("toJSON"in e)){t[n]=e;let r=B(e)?[]:{};return q(e,(e,t)=>{let a=i(e,n+1);P(a)||(r[t]=a)}),t[n]=void 0,r}}return e};return i(e,0)},isAsyncFn:ea,isThenable:e=>e&&(F(e)||D(e))&&D(e.then)&&D(e.catch)};/**
...
)r.push(function(e,t,i){for(var n,r=[],a=t;a<i;a+=3)r.push(ep[(n=(e[a]<<16&16711680)+(e[a+1]<<8&65280)+(255&e[a+2]))>>18&63]+ep[n>>12&63]+ep[n>>6&63]+ep[63&n]);return r.join("")}(e,a,a+16383>o?o:a+16383));return 1===n?r.push(ep[(t=e[i-1])>>2]+ep[t<<4&63]+"=="):2===n&&r.push(ep[(t=(e[i-2]<<8)+e[i-1])>>10]+ep[t>>4&63]+ep[t<<2&63]+"="),r.join("")};for(var ep=[],ed=[],ef="undefined"!=typeof Uint8Array?Uint8Array:Array,eu="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",em=0,eh=eu.length;em<eh;++em)ep[em]=eu[em],ed[eu.charCodeAt(em)]=em;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
ed["-".charCodeAt(0)]=62,ed["_".charCodeAt(0)]=63,c=function(e,t,i,n,r){var a,o,s=8*r-n-1,l=(1<<s)-1,c=l>>1,p=-7,d=i?r-1:0,f=i?-1:1,u=e[t+d];for(d+=f,a=u&(1<<-p)-1,u>>=-p,p+=s;p>0;a=256*a+e[t+d],d+=f,p-=8);for(o=a&(1<<-p)-1,a>>=-p,p+=n;p>0;o=256*o+e[t+d],d+=f,p-=8);if(0===a)a=1-c;else{if(a===l)return o?NaN:(u?-1:1)*(1/0);o+=Math.pow(2,n),a-=c}return(u?-1:1)*o*Math.pow(2,a-n)},p=function(e,t,i,n,r,a){var o,s,l,c=8*a-r-1,p=(1<<c)-1,d=p>>1,f=23===r?5960464477539062e-23:0,u=n?0:a-1,m=n?1:-1,h=t<0||0===t&&1/t<0?1:0;for(isNaN(t=Math.abs(t))||t===1/0?(s=isNaN(t)?1:0,o=p):(o=Math.floor(Math.log(t)/Math.LN2),t*(l=Math.pow(2,-o))<1&&(o--,l*=2),o+d>=1?t+=f/l:t+=f*Math.pow(2,1-d),t*l>=2&&(o++,l/=2),o+d>=p?(s=0,o=p):o+d>=1?(s=(t*l-1)*Math.pow(2,r),o+=d):(s=t*Math.pow(2,d-1)*Math.pow(2,r),o=0));r>=8;e[i+u]=255&s,u+=m,s/=256,r-=8);for(o=o<<r|s,c+=r;c>0;e[i+u]=255&o,u+=m,o/=256,c-=8);e[i+u-m]|=128*h};let eg="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
let t=new Uint8Array(e);return Object.setPrototypeOf(t,ex.prototype),t}/**
...
if("string"==typeof t&&(t=ex.from(t,n)),ex.isBuffer(t))return(// Special case: looking for empty string/buffer always fails
 ...
 */function ez(e,t,i){if(e%1!=0||e<0)throw RangeError("offset is not uint");if(e+t>i)throw RangeError("Trying to access beyond buffer length")}function eI(e,t,i,n,r,a){if(!ex.isBuffer(e))throw TypeError('"buffer" argument must be a Buffer instance');if(t>r||t<a)throw RangeError('"value" argument is out of bounds');if(i+n>e.length)throw RangeError("Index out of range")}function eO(e,t,i,n,r){eW(t,n,r,e,i,7);let a=Number(t&BigInt(4294967295));e[i++]=a,a>>=8,e[i++]=a,a>>=8,e[i++]=a,a>>=8,e[i++]=a;let o=Number(t>>BigInt(32)&BigInt(4294967295));return e[i++]=o,o>>=8,e[i++]=o,o>>=8,e[i++]=o,o>>=8,e[i++]=o,i}function eB(e,t,i,n,r){eW(t,n,r,e,i,7);let a=Number(t&BigInt(4294967295));e[i+7]=a,a>>=8,e[i+6]=a,a>>=8,e[i+5]=a,a>>=8,e[i+4]=a;let o=Number(t>>BigInt(32)&BigInt(4294967295));return e[i+3]=o,o>>=8,e[i+2]=o,o>>=8,e[i+1]=o,o>>=8,e[i]=o,i+8}function eP(e,t,i,n,r,a){if(i+n>e.length||i<0)throw RangeError("Index out of range")}function e_(e,t,i,n,r){return t=+t,i>>>=0,r||eP(e,t,i,4,34028234663852886e22,-34028234663852886e22),p(e,t,i,n,23,4),i+4}function eR(e,t,i,n,r){return t=+t,i>>>=0,r||eP(e,t,i,8,17976931348623157e292,-17976931348623157e292),p(e,t,i,n,52,8),i+8}/**
 ...
 */ex.TYPED_ARRAY_SUPPORT=function(){// Can typed array instances can be augmented?
try{let e=new Uint8Array(1),t={foo:function(){return 42}};return Object.setPrototypeOf(t,Uint8Array.prototype),Object.setPrototypeOf(e,t),42===e.foo()}catch(e){return!1}}(),ex.TYPED_ARRAY_SUPPORT||"undefined"==typeof console||"function"!=typeof console.error||console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support."),Object.defineProperty(ex.prototype,"parent",{enumerable:!0,get:function(){if(ex.isBuffer(this))return this.buffer}}),Object.defineProperty(ex.prototype,"offset",{enumerable:!0,get:function(){if(ex.isBuffer(this))return this.byteOffset}}),ex.poolSize=8192// not used by this implementation
,/**
 ...
 **/ex.from=function(e,t,i){return ey(e,t,i)},// Note: Change prototype *after* Buffer.from is defined to workaround Chrome bug:
// https://github.com/feross/buffer/pull/148
Object.setPrototypeOf(ex.prototype,Uint8Array.prototype),Object.setPrototypeOf(ex,Uint8Array),/**
 * Creates a new filled Buffer instance.
 * alloc(size[, fill[, encoding]])
 **/ex.alloc=function(e,t,i){return(ev(e),e<=0)?eb(e):void 0!==t?"string"==typeof i?eb(e).fill(t,i):eb(e).fill(t):eb(e)},/**
 * Equivalent to Buffer(num), by default creates a non-zero-filled Buffer instance.
 * */ex.allocUnsafe=function(e){return ew(e)},/**
 * Equivalent to SlowBuffer(num), by default creates a non-zero-filled Buffer instance.
 */ex.allocUnsafeSlow=function(e){return ew(e)},ex.isBuffer=function(e){return null!=e&&!0===e._isBuffer&&e!==ex.prototype// so Buffer.isBuffer(Buffer.prototype) will be false
},ex.compare=function(e,t){if(eV(e,Uint8Array)&&(e=ex.from(e,e.offset,e.byteLength)),eV(t,Uint8Array)&&(t=ex.from(t,t.offset,t.byteLength)),!ex.isBuffer(e)||!ex.isBuffer(t))throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(e===t)return 0;let i=e.length,n=t.length;for(let r=0,a=Math.min(i,n);r<a;++r)if(e[r]!==t[r]){i=e[r],n=t[r];break}return i<n?-1:n<i?1:0},ex.isEncoding=function(e){switch(String(e).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},ex.concat=function(e,t){let i;if(!Array.isArray(e))throw TypeError('"list" argument must be an Array of Buffers');if(0===e.length)return ex.alloc(0);if(void 0===t)for(i=0,t=0;i<e.length;++i)t+=e[i].length;let n=ex.allocUnsafe(t),r=0;for(i=0;i<e.length;++i){let t=e[i];if(eV(t,Uint8Array))r+t.length>n.length?(ex.isBuffer(t)||(t=ex.from(t)),t.copy(n,r)):Uint8Array.prototype.set.call(n,t,r);else if(ex.isBuffer(t))t.copy(n,r);else throw TypeError('"list" argument must be an Array of Buffers');r+=t.length}return n},ex.byteLength=eC,// This property is used by `Buffer.isBuffer` (and the `is-buffer` npm package)
// to detect a Buffer instance. It's not possible to use `instanceof Buffer`
// reliably in a browserify context because there could be multiple different
// copies of the 'buffer' package in use. This method works even for Buffer
// instances that were created from another copy of the `buffer` package.
// See: https://github.com/feross/buffer/issues/154
ex.prototype._isBuffer=!0,ex.prototype.swap16=function(){let e=this.length;if(e%2!=0)throw RangeError("Buffer size must be a multiple of 16-bits");for(let t=0;t<e;t+=2)eN(this,t,t+1);return this},ex.prototype.swap32=function(){let e=this.length;if(e%4!=0)throw RangeError("Buffer size must be a multiple of 32-bits");for(let t=0;t<e;t+=4)eN(this,t,t+3),eN(this,t+1,t+2);return this},ex.prototype.swap64=function(){let e=this.length;if(e%8!=0)throw RangeError("Buffer size must be a multiple of 64-bits");for(let t=0;t<e;t+=8)eN(this,t,t+7),eN(this,t+1,t+6),eN(this,t+2,t+5),eN(this,t+3,t+4);return this},ex.prototype.toString=function(){let e=this.length;return 0===e?"":0==arguments.length?eM(this,0,e):eT.apply(this,arguments)},ex.prototype.toLocaleString=ex.prototype.toString,ex.prototype.equals=function(e){if(!ex.isBuffer(e))throw TypeError("Argument must be a Buffer");return this===e||0===ex.compare(this,e)},ex.prototype.inspect=function(){let e="";return e=this.toString("hex",0,50).replace(/(.{2})/g,"$1 ").trim(),this.length>50&&(e+=" ... "),"<Buffer "+e+">"},eg&&(ex.prototype[eg]=ex.prototype.inspect),ex.prototype.compare=function(e,t,i,n,r){if(eV(e,Uint8Array)&&(e=ex.from(e,e.offset,e.byteLength)),!ex.isBuffer(e))throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof e);if(void 0===t&&(t=0),void 0===i&&(i=e?e.length:0),void 0===n&&(n=0),void 0===r&&(r=this.length),t<0||i>e.length||n<0||r>this.length)throw RangeError("out of range index");if(n>=r&&t>=i)return 0;if(n>=r)return -1;if(t>=i)return 1;if(t>>>=0,i>>>=0,n>>>=0,r>>>=0,this===e)return 0;let a=r-n,o=i-t,s=Math.min(a,o),l=this.slice(n,r),c=e.slice(t,i);for(let e=0;e<s;++e)if(l[e]!==c[e]){a=l[e],o=c[e];break}return a<o?-1:o<a?1:0},ex.prototype.includes=function(e,t,i){return -1!==this.indexOf(e,t,i)},ex.prototype.indexOf=function(e,t,i){return eL(this,e,t,i,!0)},ex.prototype.lastIndexOf=function(e,t,i){return eL(this,e,t,i,!1)},ex.prototype.write=function(e,t,i,n){var r,a,o,s,l,c,p,d;// Buffer#write(string)
if(void 0===t)n="utf8",i=this.length,t=0;else if(void 0===i&&"string"==typeof t)n=t,i=this.length,t=0;else if(isFinite(t))t>>>=0,isFinite(i)?(i>>>=0,void 0===n&&(n="utf8")):(n=i,i=void 0);else throw Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");let f=this.length-t;if((void 0===i||i>f)&&(i=f),e.length>0&&(i<0||t<0)||t>this.length)throw RangeError("Attempt to write outside buffer bounds");n||(n="utf8");let u=!1;for(;;)switch(n){case"hex":return function(e,t,i,n){let r;i=Number(i)||0;let a=e.length-i;n?(n=Number(n))>a&&(n=a):n=a;let o=t.length;for(n>o/2&&(n=o/2),r=0;r<n;++r){let n=parseInt(t.substr(2*r,2),16);if(n!=n)break;e[i+r]=n}return r}(this,e,t,i);case"utf8":case"utf-8":return r=t,a=i,eq(eX(e,this.length-r),this,r,a);case"ascii":case"latin1":case"binary":return o=t,s=i,eq(function(e){let t=[];for(let i=0;i<e.length;++i)t.push(255&e.charCodeAt(i));return t}(e),this,o,s);case"base64":// Warning: maxLength not taken into account in base64Write
return l=t,c=i,eq(eG(e),this,l,c);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return p=t,d=i,eq(function(e,t){let i,n;let r=[];for(let a=0;a<e.length&&!((t-=2)<0);++a)n=(i=e.charCodeAt(a))>>8,r.push(i%256),r.push(n);return r}(e,this.length-p),this,p,d);default:if(u)throw TypeError("Unknown encoding: "+n);n=(""+n).toLowerCase(),u=!0}},ex.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}},ex.prototype.slice=function(e,t){let i=this.length;e=~~e,t=void 0===t?i:~~t,e<0?(e+=i)<0&&(e=0):e>i&&(e=i),t<0?(t+=i)<0&&(t=0):t>i&&(t=i),t<e&&(t=e);let n=this.subarray(e,t);return(// Return an augmented `Uint8Array` instance
Object.setPrototypeOf(n,ex.prototype),n)},ex.prototype.readUintLE=ex.prototype.readUIntLE=function(e,t,i){e>>>=0,t>>>=0,i||ez(e,t,this.length);let n=this[e],r=1,a=0;for(;++a<t&&(r*=256);)n+=this[e+a]*r;return n},ex.prototype.readUintBE=ex.prototype.readUIntBE=function(e,t,i){e>>>=0,t>>>=0,i||ez(e,t,this.length);let n=this[e+--t],r=1;for(;t>0&&(r*=256);)n+=this[e+--t]*r;return n},ex.prototype.readUint8=ex.prototype.readUInt8=function(e,t){return e>>>=0,t||ez(e,1,this.length),this[e]},ex.prototype.readUint16LE=ex.prototype.readUInt16LE=function(e,t){return e>>>=0,t||ez(e,2,this.length),this[e]|this[e+1]<<8},ex.prototype.readUint16BE=ex.prototype.readUInt16BE=function(e,t){return e>>>=0,t||ez(e,2,this.length),this[e]<<8|this[e+1]},ex.prototype.readUint32LE=ex.prototype.readUInt32LE=function(e,t){return e>>>=0,t||ez(e,4,this.length),(this[e]|this[e+1]<<8|this[e+2]<<16)+16777216*this[e+3]},ex.prototype.readUint32BE=ex.prototype.readUInt32BE=function(e,t){return e>>>=0,t||ez(e,4,this.length),16777216*this[e]+(this[e+1]<<16|this[e+2]<<8|this[e+3])},ex.prototype.readBigUInt64LE=eK(function(e){e$(e>>>=0,"offset");let t=this[e],i=this[e+7];(void 0===t||void 0===i)&&eU(e,this.length-8);let n=t+256*this[++e]+65536*this[++e]+16777216*this[++e],r=this[++e]+256*this[++e]+65536*this[++e]+16777216*i;return BigInt(n)+(BigInt(r)<<BigInt(32))}),ex.prototype.readBigUInt64BE=eK(function(e){e$(e>>>=0,"offset");let t=this[e],i=this[e+7];(void 0===t||void 0===i)&&eU(e,this.length-8);let n=16777216*t+65536*this[++e]+256*this[++e]+this[++e],r=16777216*this[++e]+65536*this[++e]+256*this[++e]+i;return(BigInt(n)<<BigInt(32))+BigInt(r)}),ex.prototype.readIntLE=function(e,t,i){e>>>=0,t>>>=0,i||ez(e,t,this.length);let n=this[e],r=1,a=0;for(;++a<t&&(r*=256);)n+=this[e+a]*r;return n>=(r*=128)&&(n-=Math.pow(2,8*t)),n},ex.prototype.readIntBE=function(e,t,i){e>>>=0,t>>>=0,i||ez(e,t,this.length);let n=t,r=1,a=this[e+--n];for(;n>0&&(r*=256);)a+=this[e+--n]*r;return a>=(r*=128)&&(a-=Math.pow(2,8*t)),a},ex.prototype.readInt8=function(e,t){return(e>>>=0,t||ez(e,1,this.length),128&this[e])?-((255-this[e]+1)*1):this[e]},ex.prototype.readInt16LE=function(e,t){e>>>=0,t||ez(e,2,this.length);let i=this[e]|this[e+1]<<8;return 32768&i?4294901760|i:i},ex.prototype.readInt16BE=function(e,t){e>>>=0,t||ez(e,2,this.length);let i=this[e+1]|this[e]<<8;return 32768&i?4294901760|i:i},ex.prototype.readInt32LE=function(e,t){return e>>>=0,t||ez(e,4,this.length),this[e]|this[e+1]<<8|this[e+2]<<16|this[e+3]<<24},ex.prototype.readInt32BE=function(e,t){return e>>>=0,t||ez(e,4,this.length),this[e]<<24|this[e+1]<<16|this[e+2]<<8|this[e+3]},ex.prototype.readBigInt64LE=eK(function(e){e$(e>>>=0,"offset");let t=this[e],i=this[e+7];(void 0===t||void 0===i)&&eU(e,this.length-8);let n=this[e+4]+256*this[e+5]+65536*this[e+6]+(i<<24// Overflow
);return(BigInt(n)<<BigInt(32))+BigInt(t+256*this[++e]+65536*this[++e]+16777216*this[++e])}),ex.prototype.readBigInt64BE=eK(function(e){e$(e>>>=0,"offset");let t=this[e],i=this[e+7];(void 0===t||void 0===i)&&eU(e,this.length-8);let n=(t<<24)+// Overflow
65536*this[++e]+256*this[++e]+this[++e];return(BigInt(n)<<BigInt(32))+BigInt(16777216*this[++e]+65536*this[++e]+256*this[++e]+i)}),ex.prototype.readFloatLE=function(e,t){return e>>>=0,t||ez(e,4,this.length),c(this,e,!0,23,4)},ex.prototype.readFloatBE=function(e,t){return e>>>=0,t||ez(e,4,this.length),c(this,e,!1,23,4)},ex.prototype.readDoubleLE=function(e,t){return e>>>=0,t||ez(e,8,this.length),c(this,e,!0,52,8)},ex.prototype.readDoubleBE=function(e,t){return e>>>=0,t||ez(e,8,this.length),c(this,e,!1,52,8)},ex.prototype.writeUintLE=ex.prototype.writeUIntLE=function(e,t,i,n){if(e=+e,t>>>=0,i>>>=0,!n){let n=Math.pow(2,8*i)-1;eI(this,e,t,i,n,0)}let r=1,a=0;for(this[t]=255&e;++a<i&&(r*=256);)this[t+a]=e/r&255;return t+i},ex.prototype.writeUintBE=ex.prototype.writeUIntBE=function(e,t,i,n){if(e=+e,t>>>=0,i>>>=0,!n){let n=Math.pow(2,8*i)-1;eI(this,e,t,i,n,0)}let r=i-1,a=1;for(this[t+r]=255&e;--r>=0&&(a*=256);)this[t+r]=e/a&255;return t+i},ex.prototype.writeUint8=ex.prototype.writeUInt8=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,1,255,0),this[t]=255&e,t+1},ex.prototype.writeUint16LE=ex.prototype.writeUInt16LE=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,2,65535,0),this[t]=255&e,this[t+1]=e>>>8,t+2},ex.prototype.writeUint16BE=ex.prototype.writeUInt16BE=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,2,65535,0),this[t]=e>>>8,this[t+1]=255&e,t+2},ex.prototype.writeUint32LE=ex.prototype.writeUInt32LE=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,4,4294967295,0),this[t+3]=e>>>24,this[t+2]=e>>>16,this[t+1]=e>>>8,this[t]=255&e,t+4},ex.prototype.writeUint32BE=ex.prototype.writeUInt32BE=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,4,4294967295,0),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e,t+4},ex.prototype.writeBigUInt64LE=eK(function(e,t=0){return eO(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))}),ex.prototype.writeBigUInt64BE=eK(function(e,t=0){return eB(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))}),ex.prototype.writeIntLE=function(e,t,i,n){if(e=+e,t>>>=0,!n){let n=Math.pow(2,8*i-1);eI(this,e,t,i,n-1,-n)}let r=0,a=1,o=0;for(this[t]=255&e;++r<i&&(a*=256);)e<0&&0===o&&0!==this[t+r-1]&&(o=1),this[t+r]=(e/a>>0)-o&255;return t+i},ex.prototype.writeIntBE=function(e,t,i,n){if(e=+e,t>>>=0,!n){let n=Math.pow(2,8*i-1);eI(this,e,t,i,n-1,-n)}let r=i-1,a=1,o=0;for(this[t+r]=255&e;--r>=0&&(a*=256);)e<0&&0===o&&0!==this[t+r+1]&&(o=1),this[t+r]=(e/a>>0)-o&255;return t+i},ex.prototype.writeInt8=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,1,127,-128),e<0&&(e=255+e+1),this[t]=255&e,t+1},ex.prototype.writeInt16LE=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,2,32767,-32768),this[t]=255&e,this[t+1]=e>>>8,t+2},ex.prototype.writeInt16BE=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,2,32767,-32768),this[t]=e>>>8,this[t+1]=255&e,t+2},ex.prototype.writeInt32LE=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,4,2147483647,-2147483648),this[t]=255&e,this[t+1]=e>>>8,this[t+2]=e>>>16,this[t+3]=e>>>24,t+4},ex.prototype.writeInt32BE=function(e,t,i){return e=+e,t>>>=0,i||eI(this,e,t,4,2147483647,-2147483648),e<0&&(e=4294967295+e+1),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e,t+4},ex.prototype.writeBigInt64LE=eK(function(e,t=0){return eO(this,e,t,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),ex.prototype.writeBigInt64BE=eK(function(e,t=0){return eB(this,e,t,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),ex.prototype.writeFloatLE=function(e,t,i){return e_(this,e,t,!0,i)},ex.prototype.writeFloatBE=function(e,t,i){return e_(this,e,t,!1,i)},ex.prototype.writeDoubleLE=function(e,t,i){return eR(this,e,t,!0,i)},ex.prototype.writeDoubleBE=function(e,t,i){return eR(this,e,t,!1,i)},// copy(targetBuffer, targetStart=0, sourceStart=0, sourceEnd=buffer.length)
ex.prototype.copy=function(e,t,i,n){if(!ex.isBuffer(e))throw TypeError("argument should be a Buffer");// Copy 0 bytes; we're done
...
ex.prototype.fill=function(e,t,i,n){let r;// Handle string cases:
if("string"==typeof e){if("string"==typeof t?(n=t,t=0,i=this.length):"string"==typeof i&&(n=i,i=this.length),void 0!==n&&"string"!=typeof n)throw TypeError("encoding must be a string");if("string"==typeof n&&!ex.isEncoding(n))throw TypeError("Unknown encoding: "+n);if(1===e.length){let t=e.charCodeAt(0);("utf8"===n&&t<128||"latin1"===n)&&(e=t)}}else"number"==typeof e?e&=255:"boolean"==typeof e&&(e=Number(e));// Invalid ranges are not set to a default, so can range check early.
if(t<0||this.length<t||this.length<i)throw RangeError("Out of range index");if(i<=t)return this;if(t>>>=0,i=void 0===i?this.length:i>>>0,e||(e=0),"number"==typeof e)for(r=t;r<i;++r)this[r]=e;else{let a=ex.isBuffer(e)?e:ex.from(e,n),o=a.length;if(0===o)throw TypeError('The value "'+e+'" is invalid for argument "value"');for(r=0;r<i-t;++r)this[r+t]=a[r%o]}return this};// CUSTOM ERRORS
// =============
// Simplified versions from Node, changed for Buffer-only usage
let eD={};function ej(e,t,i){eD[e]=class extends i{constructor(){super(),Object.defineProperty(this,"message",{value:t.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
...
// ================
let eH=/[^+/0-9A-Za-z-_]/g;function eX(e,t){let i;t=t||1/0;let n=e.length,r=null,a=[];for(let o=0;o<n;++o){// is surrogate component
...
if(r=null,i<128){if((t-=1)<0)break;a.push(i)}else if(i<2048){if((t-=2)<0)break;a.push(i>>6|192,63&i|128)}else if(i<65536){if((t-=3)<0)break;a.push(i>>12|224,i>>6&63|128,63&i|128)}else if(i<1114112){if((t-=4)<0)break;a.push(i>>18|240,i>>12&63|128,i>>6&63|128,63&i|128)}else throw Error("Invalid code point")}return a}function eG(e){return function(e){var t,i,n=function(e){var t=e.length;if(t%4>0)throw Error("Invalid string. Length must be a multiple of 4");// Trim off extra bytes after placeholder bytes are found
// See: https://github.com/beatgammit/base64-js/issues/42
var i=e.indexOf("=");-1===i&&(i=t);var n=i===t?0:4-i%4;return[i,n]}(e),r=n[0],a=n[1],o=new ef((r+a)*3/4-a),s=0,l=a>0?r-4:r;for(i=0;i<l;i+=4)t=ed[e.charCodeAt(i)]<<18|ed[e.charCodeAt(i+1)]<<12|ed[e.charCodeAt(i+2)]<<6|ed[e.charCodeAt(i+3)],o[s++]=t>>16&255,o[s++]=t>>8&255,o[s++]=255&t;return 2===a&&(t=ed[e.charCodeAt(i)]<<2|ed[e.charCodeAt(i+1)]>>4,o[s++]=255&t),1===a&&(t=ed[e.charCodeAt(i)]<<10|ed[e.charCodeAt(i+1)]<<4|ed[e.charCodeAt(i+2)]>>2,o[s++]=t>>8&255,o[s++]=255&t),o}(function(e){// Node converts strings with length < 2 to ''
...
for(;e.length%4!=0;)e+="=";return e}(e))}function eq(e,t,i,n){let r;for(r=0;r<n&&!(r+i>=t.length)&&!(r>=e.length);++r)t[r+i]=e[r];return r}// ArrayBuffer or Uint8Array objects from other contexts (i.e. iframes) do not pass
...
let eY=function(){let e="0123456789abcdef",t=Array(256);for(let i=0;i<16;++i){let n=16*i;for(let r=0;r<16;++r)t[n+r]=e[i]+e[r]}return t}();// Return not function with Error if BigInt not supported
...
e=eZ(e),!i&&t?"["+e+"]":e)}).join(i?".":""):t}let e1=eo.toFlatObject(eo,{},null,function(e){return/^is[A-Z]/.test(e)});var e2=/**
...
return!eo.isUndefined(t[e])});let n=i.metaTokens,r=i.visitor||p,a=i.dots,o=i.indexes,s=i.Blob||"undefined"!=typeof Blob&&Blob,l=s&&eo.isSpecCompliantForm(t);if(!eo.isFunction(r))throw TypeError("visitor must be a function");function c(e){if(null===e)return"";if(eo.isDate(e))return e.toISOString();if(!l&&eo.isBlob(e))throw new es("Blob is not supported. Use a Buffer instead.");return eo.isArrayBuffer(e)||eo.isTypedArray(e)?l&&"function"==typeof Blob?new Blob([e]):ex.from(e):e}/**
   ...
   */function p(e,i,r){let s=e;if(e&&!r&&"object"==typeof e){if(eo.endsWith(i,"{}"))// eslint-disable-next-line no-param-reassign
...
i=eZ(i),s.forEach(function(e,n){eo.isUndefined(e)||null===e||t.append(!0===o?e0([i],n,a):null===o?i:i+"[]",c(e))}),!1)}}return!!eQ(e)||(t.append(e0(r,i,a),c(e)),!1)}let d=[],f=Object.assign(e1,{defaultVisitor:p,convertValue:c,isVisitable:eQ});if(!eo.isObject(e))throw TypeError("data must be an object");return!function e(i,n){if(!eo.isUndefined(i)){if(-1!==d.indexOf(i))throw Error("Circular reference detected in "+n.join("."));d.push(i),eo.forEach(i,function(i,a){let o=!(eo.isUndefined(i)||null===i)&&r.call(t,i,eo.isString(a)?a.trim():a,n,f);!0===o&&e(i,n?n.concat(a):[a])}),d.pop()}}(e),t};/**
 ...
 *
 * @returns {void}
 */function e6(e,t){this._pairs=[],e&&e2(e,this,t)}let e3=e6.prototype;/**
 ...
 *
 * @returns {boolean}
 */let tn=("undefined"==typeof navigator||"ReactNative"!==(n=navigator.product)&&"NativeScript"!==n&&"NS"!==n)&&"undefined"!=typeof window&&"undefined"!=typeof document,tr="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
...
let tl=eo.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */tc=e=>{let t,i,n;let r={};return e&&e.split("\n").forEach(function(e){n=e.indexOf(":"),t=e.substring(0,n).trim().toLowerCase(),i=e.substring(n+1).trim(),!t||r[t]&&tl[t]||("set-cookie"===t?r[t]?r[t].push(i):r[t]=[i]:r[t]=r[t]?r[t]+", "+i:i)}),r};let tp=Symbol("internals");function td(e){return e&&String(e).trim().toLowerCase()}function tf(e){return!1===e||null==e?e:eo.isArray(e)?e.map(tf):String(e)}let tu=e=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim());function tm(e,t,i,n,r){if(eo.isFunction(n))return n.call(this,t,i);if(r&&(t=i),eo.isString(t)){if(eo.isString(n))return -1!==t.indexOf(n);if(eo.isRegExp(n))return n.test(t)}}class th{constructor(e){e&&this.set(e)}set(e,t,i){let n=this;function r(e,t,i){let r=td(t);if(!r)throw Error("header name must be a non-empty string");let a=eo.findKey(n,r);a&&void 0!==n[a]&&!0!==i&&(void 0!==i||!1===n[a])||(n[a||t]=tf(e))}let a=(e,t)=>eo.forEach(e,(e,i)=>r(e,i,t));return eo.isPlainObject(e)||e instanceof this.constructor?a(e,t):eo.isString(e)&&(e=e.trim())&&!tu(e)?a(tc(e),t):null!=e&&r(t,e,i),this}get(e,t){if(e=td(e)){let i=eo.findKey(this,e);if(i){let e=this[i];if(!t)return e;if(!0===t)return function(e){let t;let i=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;t=n.exec(e);)i[t[1]]=t[2];return i}(e);if(eo.isFunction(t))return t.call(this,e,i);if(eo.isRegExp(t))return t.exec(e);throw TypeError("parser must be boolean|regexp|function")}}}has(e,t){if(e=td(e)){let i=eo.findKey(this,e);return!!(i&&void 0!==this[i]&&(!t||tm(this,this[i],i,t)))}return!1}delete(e,t){let i=this,n=!1;function r(e){if(e=td(e)){let r=eo.findKey(i,e);r&&(!t||tm(i,i[r],r,t))&&(delete i[r],n=!0)}}return eo.isArray(e)?e.forEach(r):r(e),n}clear(e){let t=Object.keys(this),i=t.length,n=!1;for(;i--;){let r=t[i];(!e||tm(this,this[r],r,e,!0))&&(delete this[r],n=!0)}return n}normalize(e){let t=this,i={};return eo.forEach(this,(n,r)=>{let a=eo.findKey(i,r);if(a){t[a]=tf(n),delete t[r];return}let o=e?r.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(e,t,i)=>t.toUpperCase()+i):String(r).trim();o!==r&&delete t[r],t[o]=tf(n),i[o]=!0}),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){let t=Object.create(null);return eo.forEach(this,(i,n)=>{null!=i&&!1!==i&&(t[n]=e&&eo.isArray(i)?i.join(", "):i)}),t}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([e,t])=>e+": "+t).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static concat(e,...t){let i=new this(e);return t.forEach(e=>i.set(e)),i}static accessor(e){let t=this[tp]=this[tp]={accessors:{}},i=t.accessors,n=this.prototype;function r(e){let t=td(e);i[t]||(!function(e,t){let i=eo.toCamelCase(" "+t);["get","set","has"].forEach(n=>{Object.defineProperty(e,n+i,{value:function(e,i,r){return this[n].call(this,t,e,i,r)},configurable:!0})})}(n,e),i[t]=!0)}return eo.isArray(e)?e.forEach(r):r(e),this}}function tg(e,t){let i=this||ts,n=t||i,r=th.from(n.headers),a=n.data;return eo.forEach(e,function(e){a=e.call(i,a,r.normalize(),t?t.status:void 0)}),r.normalize(),a}function tb(e){return!!(e&&e.__CANCEL__)}/**
...
let t=(e.withCredentials||tw(c))&&e.xsrfCookieName&&ty.read(e.xsrfCookieName);t&&a.set(e.xsrfHeaderName,t)}// Remove Content-Type if data is undefined
...
n=t=>{l&&(i(!t||t.type?new tx(null,e,l):t),l.abort(),l=null)},e.cancelToken&&e.cancelToken.subscribe(n),e.signal&&(e.signal.aborted?n():e.signal.addEventListener("abort",n)));let d=function(e){let t=/^([-+\w]{1,25})(:?\/\/|:)/.exec(e);return t&&t[1]||""}(c);if(d&&-1===ta.protocols.indexOf(d)){i(new es("Unsupported protocol "+d+":",es.ERR_BAD_REQUEST,e));return}// Send the request
l.send(r||null)})};let tT={http:null,xhr:tC};eo.forEach(tT,(e,t)=>{if(e){try{Object.defineProperty(e,"name",{value:t})}catch(e){// eslint-disable-next-line no-empty
 ...
 *
 * @returns {void}
 */function tL(e){if(e.cancelToken&&e.cancelToken.throwIfRequested(),e.signal&&e.signal.aborted)throw new tx(null,e)}function tA(e){tL(e),e.headers=th.from(e.headers),// Transform request data
...
t.data=tg.call(e,e.transformResponse,t),t.headers=th.from(t.headers),t},function(t){return!tb(t)&&(tL(e),t&&t.response&&(t.response.data=tg.call(e,e.transformResponse,t.response),t.response.headers=th.from(t.response.headers))),Promise.reject(t)})}let tM=e=>e instanceof th?e.toJSON():e;function tz(e,t){// eslint-disable-next-line no-param-reassign
 ...
 *
 * @returns {function}
 */tO.transitional=function(e,t,i){function n(e,t){return"[Axios v"+tI+"] Transitional option '"+e+"'"+t+(i?". "+i:"")}// eslint-disable-next-line func-names
 ...
 *
 * @returns {object}
 */function(e,t,i){if("object"!=typeof e)throw new es("options must be an object",es.ERR_BAD_OPTION_VALUE);let n=Object.keys(e),r=n.length;for(;r-- >0;){let a=n[r],o=t[a];if(o){let t=e[a],i=void 0===t||o(t,a,e);if(!0!==i)throw new es("option "+a+" must be "+i,es.ERR_BAD_OPTION_VALUE);continue}if(!0!==i)throw new es("Unknown option "+a,es.ERR_BAD_OPTION)}},validators:tO};let t_=tP.validators;/**
...
let l=[],c=!0;this.interceptors.request.forEach(function(e){("function"!=typeof e.runWhen||!1!==e.runWhen(t))&&(c=c&&e.synchronous,l.unshift(e.fulfilled,e.rejected))});let p=[];this.interceptors.response.forEach(function(e){p.push(e.fulfilled,e.rejected)});let d=0;if(!c){let e=[tA.bind(this),void 0];for(e.unshift.apply(e,l),e.push.apply(e,p),n=e.length,i=Promise.resolve(t);d<n;)i=i.then(e[d++],e[d++]);return i}n=l.length;let f=t;for(d=0;d<n;){let e=l[d++],t=l[d++];try{f=e(f)}catch(e){t.call(this,e);break}}try{i=tA.call(this,f)}catch(e){return Promise.reject(e)}for(d=0,n=p.length;d<n;)i=i.then(p[d++],p[d++]);return i}getUri(e){e=tz(this.defaults,e);let t=tv(e.baseURL,e.url);return e8(t,e.params,e.paramsSerializer)}}eo.forEach(["delete","get","head","options"],function(e){/*eslint func-names:0*/tR.prototype[e]=function(t,i){return this.request(tz(i||{},{method:e,url:t,data:(i||{}).data}))}}),eo.forEach(["post","put","patch"],function(e){/*eslint func-names:0*/function t(t){return function(i,n,r){return this.request(tz(r||{},{method:e,headers:t?{"Content-Type":"multipart/form-data"}:{},url:i,data:n}))}}tR.prototype[e]=t(),tR.prototype[e+"Form"]=t(!0)});/**
...
let n=new Promise(e=>{i.subscribe(e),t=e}).then(e);return n.cancel=function(){i.unsubscribe(t)},n},e(function(e,n,r){i.reason||(i.reason=new tx(e,n,r),t(i.reason))})}/**
   * Throws a `CanceledError` if cancellation has been requested.
...
n.create=function(i){return e(tz(t,i))},n}(ts);// Expose Axios class to allow class inheritance
tF.Axios=tR,// Expose Cancel & CancelToken
tF.CanceledError=tx,tF.CancelToken=tD,tF.isCancel=tb,tF.VERSION=tI,tF.toFormData=e2,// Expose AxiosError class
...
tF.mergeConfig=tz,tF.AxiosHeaders=th,tF.formToJSON=e=>to(eo.isHTMLForm(e)?new FormData(e):e),tF.getAdapter=tN.getAdapter,tF.HttpStatusCode=tj,tF.default=tF;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:tW,AxiosError:t$,CanceledError:tU,isCancel:tH,CancelToken:tX,VERSION:tG,all:tq,Cancel:tV,isAxiosError:tY,spread:tK,toFormData:tJ,AxiosHeaders:tQ,HttpStatusCode:tZ,formToJSON:t0,getAdapter:t1,mergeConfig:t2}=tF,t5="https://tasty-treats-backend.p.goit.global/api",t6={events:"/events",recipes:"/recipes",categories:"/categories",popular:"/recipes/popular"},t3=async()=>{let e=await tF.get(`${t5}${t6.events}`);return e},t4=async()=>{let e=await tF.get(`${t5}${t6.categories}`);return e},t8=async()=>{let e=await tF.get(`${t5}${t6.popular}`);return e},t9=async e=>{let t=await tF.get(`${t5}${t6.recipes}/${e}`);return t},t7=async e=>{let t=await tF.get(`${t5}${t6.recipes}?${e}`);return t},ie=document.querySelector(".card-list"),it=async(e,t,i,n,r,a)=>{// Праметри API запиту
let o=new URLSearchParams({limit:9}),s=await tF.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${o}`);return s};function ii(e){ie.innerHTML=e.data.results.map(e=>`
    <li class="card-item">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join(""),function(){let e=document.querySelectorAll(".box-star");e.forEach(e=>{let t=e.previousElementSibling,i=Math.round(t.textContent),n=[...e.children];n.forEach((e,t)=>{t<i&&e.classList.add("yellow-star")})})}()}window.addEventListener("load",function(){it().then(ii).catch(e=>{console.log(e)})});let ir=new MutationObserver(function(){let e=document.querySelectorAll(".info-btn");// витягуємо всі кнопки
e.forEach(e=>{e.addEventListener("click",ia);// вішаємо слухача на кнопки
})});// створюємо екземпляр класу MutationObserver
function ia(e){let t=e.target.id;t9(t).then(e=>{!function(e){let{data:{title:t,youtube:i,thumb:n,rating:r,time:a,ingredients:o,tags:s,instructions:l}}=e,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),p=u.create(`<div class="card-modal">
...
function(e){let t=document.querySelector(".box-stars");document.querySelector(".star");let i=[...t.children],n=Math.round(e);i.forEach((e,t)=>{t<n&&e.classList.add("yellow-star")})}(r),document.body.style.overflow="hidden";let d=document.querySelector(".js-card-close-btn");document.querySelector(".card-modal"),d.addEventListener("click",()=>{document.body.style.overflow="auto",p.close()})}(e);let t=document.querySelector(".basicLightbox");t.classList.add("correct-recipe")}).catch(e=>{console.log(e)})}ir.observe(ie,{// параметри MutationObserver
childList:!0,subtree:!0});var io={};window,io=/******/function(e){/******/// The module cache
...
ig(),t8().then(e=>{il.popular.insertAdjacentHTML("beforeend",e.data.map(e=>`
...
let t=il.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",iw)})}).catch(()=>{});let iE=iS();function iC(e){let t=/**
  |============================
  | Запит для Swiper
  |============================
*//**
...
*/function(e){let{cook:t,topic:i}=e;return e.map(e=>`<div class="swiper-slide">
        ...
        </div>`).join("")}(e.data);iE.markupSwiper.insertAdjacentHTML("afterbegin",t)}/**
  |============================
  | Бібліотека Swiper
  |============================
*//**
 ...
 *//* eslint-disable no-param-reassign */function iT(e){return null!==e&&"object"==typeof e&&"constructor"in e&&e.constructor===Object}function iN(e,t){void 0===e&&(e={}),void 0===t&&(t={}),Object.keys(t).forEach(i=>{void 0===e[i]?e[i]=t[i]:iT(t[i])&&iT(e[i])&&Object.keys(t[i]).length>0&&iN(e[i],t[i])})}// Прослуховувачі подій
window.addEventListener("load",function(){t3().then(iC).catch(e=>{console.log(e)})}),iE.orderBtnHero.addEventListener("click",function(){x()});let iL={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector:()=>null,querySelectorAll:()=>[],getElementById:()=>null,createEvent:()=>({initEvent(){}}),createElement:()=>({children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName:()=>[]}),createElementNS:()=>({}),importNode:()=>null,location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function iA(){let e="undefined"!=typeof document?document:{};return iN(e,iL),e}let iM={document:iL,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle:()=>({getPropertyValue:()=>""}),Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia:()=>({}),requestAnimationFrame:e=>"undefined"==typeof setTimeout?(e(),null):setTimeout(e,0),cancelAnimationFrame(e){"undefined"!=typeof setTimeout&&clearTimeout(e)}};function iz(){let e="undefined"!=typeof window?window:{};return iN(e,iM),e}function iI(e,t){return void 0===t&&(t=0),setTimeout(e,t)}function iO(){return Date.now()}function iB(e){return"object"==typeof e&&null!==e&&e.constructor&&"Object"===Object.prototype.toString.call(e).slice(8,-1)}function iP(){let e=Object(arguments.length<=0?void 0:arguments[0]),t=["__proto__","constructor","prototype"];for(let i=1;i<arguments.length;i+=1){let n=i<0||arguments.length<=i?void 0:arguments[i];if(null!=n&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType)){let i=Object.keys(Object(n)).filter(e=>0>t.indexOf(e));for(let t=0,r=i.length;t<r;t+=1){let r=i[t],a=Object.getOwnPropertyDescriptor(n,r);void 0!==a&&a.enumerable&&(iB(e[r])&&iB(n[r])?n[r].__swiper__?e[r]=n[r]:iP(e[r],n[r]):!iB(e[r])&&iB(n[r])?(e[r]={},n[r].__swiper__?e[r]=n[r]:iP(e[r],n[r])):e[r]=n[r])}}}return e}function i_(e,t,i){e.style.setProperty(t,i)}function iR(e){let t,{swiper:i,targetPosition:n,side:r}=e,a=iz(),o=-i.translate,s=null,l=i.params.speed;i.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(i.cssModeFrameID);let c=n>o?"next":"prev",p=(e,t)=>"next"===c&&e>=t||"prev"===c&&e<=t,d=()=>{t=new Date().getTime(),null===s&&(s=t);let e=Math.max(Math.min((t-s)/l,1),0),c=o+(.5-Math.cos(e*Math.PI)/2)*(n-o);if(p(c,n)&&(c=n),i.wrapperEl.scrollTo({[r]:c}),p(c,n)){i.wrapperEl.style.overflow="hidden",i.wrapperEl.style.scrollSnapType="",setTimeout(()=>{i.wrapperEl.style.overflow="",i.wrapperEl.scrollTo({[r]:c})}),a.cancelAnimationFrame(i.cssModeFrameID);return}i.cssModeFrameID=a.requestAnimationFrame(d)};d()}function iD(e,t){return void 0===t&&(t=""),[...e.children].filter(e=>e.matches(t))}function ij(e,t){void 0===t&&(t=[]);let i=document.createElement(e);return i.classList.add(...Array.isArray(t)?t:[t]),i}function iF(e,t){let i=iz();return i.getComputedStyle(e,null).getPropertyValue(t)}function iW(e){let t,i=e;if(i){// eslint-disable-next-line
for(t=0;null!==(i=i.previousSibling);)1===i.nodeType&&(t+=1);return t}}function i$(e,t){let i=[],n=e.parentElement;// eslint-disable-line
for(;n;)t?n.matches(t)&&i.push(n):i.push(n),n=n.parentElement;return i}function iU(e,t,i){let n=iz();return i?e["width"===t?"offsetWidth":"offsetHeight"]+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-right":"margin-top"))+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-left":"margin-bottom")):e.offsetWidth}function iH(){return e||(e=function(){let e=iz(),t=iA();return{smoothScroll:t.documentElement&&t.documentElement.style&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)}}()),e}let iX=(e,t)=>{if(!e||e.destroyed||!e.params)return;let i=t.closest(e.isElement?"swiper-slide":`.${e.params.slideClass}`);if(i){let t=i.querySelector(`.${e.params.lazyPreloaderClass}`);!t&&e.isElement&&(t=i.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`)),t&&t.remove()}},iG=(e,t)=>{if(!e.slides[t])return;let i=e.slides[t].querySelector('[loading="lazy"]');i&&i.removeAttribute("loading")},iq=e=>{if(!e||e.destroyed||!e.params)return;let t=e.params.lazyPreloadPrevNext,i=e.slides.length;if(!i||!t||t<0)return;t=Math.min(t,i);let n="auto"===e.params.slidesPerView?e.slidesPerViewDynamic():Math.ceil(e.params.slidesPerView),r=e.activeIndex;if(e.params.grid&&e.params.grid.rows>1){let i=[r-t];i.push(...Array.from({length:t}).map((e,t)=>r+n+t)),e.slides.forEach((t,n)=>{i.includes(t.column)&&iG(e,n)});return}let a=r+n-1;if(e.params.rewind||e.params.loop)for(let n=r-t;n<=a+t;n+=1){let t=(n%i+i)%i;(t<r||t>a)&&iG(e,t)}else for(let n=Math.max(r-t,0);n<=Math.min(a+t,i-1);n+=1)n!==r&&(n>a||n<r)&&iG(e,n)};function iV(e){let{swiper:t,runCallbacks:i,direction:n,step:r}=e,{activeIndex:a,previousIndex:o}=t,s=n;if(s||(s=a>o?"next":a<o?"prev":"reset"),t.emit(`transition${r}`),i&&a!==o){if("reset"===s){t.emit(`slideResetTransition${r}`);return}t.emit(`slideChangeTransition${r}`),"next"===s?t.emit(`slideNextTransition${r}`):t.emit(`slidePrevTransition${r}`)}}function iY(e){let t=iA(),i=iz(),n=this.touchEventsData;n.evCache.push(e);let{params:r,touches:a,enabled:o}=this;if(!o||!r.simulateTouch&&"mouse"===e.pointerType||this.animating&&r.preventInteractionOnTransition)return;!this.animating&&r.cssMode&&r.loop&&this.loopFix();let s=e;s.originalEvent&&(s=s.originalEvent);let l=s.target;if("wrapper"===r.touchEventsTarget&&!this.wrapperEl.contains(l)||"which"in s&&3===s.which||"button"in s&&s.button>0||n.isTouched&&n.isMoved)return;// change target el for shadow root component
...
e.allowSlidePrev=r,e.allowSlideNext=n,e.params.watchOverflow&&a!==e.snapGrid&&e.checkOverflow()}function iZ(e){this.enabled&&!this.allowClick&&(this.params.preventClicks&&e.preventDefault(),this.params.preventClicksPropagation&&this.animating&&(e.stopPropagation(),e.stopImmediatePropagation()))}function i0(){let{wrapperEl:e,rtlTranslate:t,enabled:i}=this;if(!i)return;this.previousTranslate=this.translate,this.isHorizontal()?this.translate=-e.scrollLeft:this.translate=-e.scrollTop,0===this.translate&&(this.translate=0),this.updateActiveIndex(),this.updateSlidesClasses();let n=this.maxTranslate()-this.minTranslate();(0===n?0:(this.translate-this.minTranslate())/n)!==this.progress&&this.updateProgress(t?-this.translate:this.translate),this.emit("setTranslate",this.translate,!1)}function i1(e){iX(this,e.target),!this.params.cssMode&&("auto"===this.params.slidesPerView||this.params.autoHeight)&&this.update()}let i2=!1;function i5(){}let i6=(e,t)=>{let i=iA(),{params:n,el:r,wrapperEl:a,device:o}=e,s=!!n.nested,l="on"===t?"addEventListener":"removeEventListener";// Touch Events
...
r[l]("load",e.onLoad,{capture:!0})},i3=(e,t)=>e.grid&&t.grid&&t.grid.rows>1;var i4={init:!0,direction:"horizontal",oneWayMovement:!1,touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",// Overrides
...
imagesToLoad:[],imagesLoaded:0}),c.emit("_swiper"),c.params.init&&c.init(),c)}getSlideIndex(e){let{slidesEl:t,params:i}=this,n=iD(t,`.${i.slideClass}, swiper-slide`),r=iW(n[0]);return iW(e)-r}getSlideIndexByData(e){return this.getSlideIndex(this.slides.filter(t=>1*t.getAttribute("data-swiper-slide-index")===e)[0])}recalcSlides(){let{slidesEl:e,params:t}=this;this.slides=iD(e,`.${t.slideClass}, swiper-slide`)}enable(){this.enabled||(this.enabled=!0,this.params.grabCursor&&this.setGrabCursor(),this.emit("enable"))}disable(){this.enabled&&(this.enabled=!1,this.params.grabCursor&&this.unsetGrabCursor(),this.emit("disable"))}setProgress(e,t){e=Math.min(Math.max(e,0),1);let i=this.minTranslate(),n=this.maxTranslate(),r=(n-i)*e+i;this.translateTo(r,void 0===t?0:t),this.updateActiveIndex(),this.updateSlidesClasses()}emitContainerClasses(){let e=this;if(!e.params._emitClasses||!e.el)return;let t=e.el.className.split(" ").filter(t=>0===t.indexOf("swiper")||0===t.indexOf(e.params.containerModifierClass));e.emit("_containerClasses",t.join(" "))}getSlideClasses(e){let t=this;return t.destroyed?"":e.className.split(" ").filter(e=>0===e.indexOf("swiper-slide")||0===e.indexOf(t.params.slideClass)).join(" ")}emitSlidesClasses(){let e=this;if(!e.params._emitClasses||!e.el)return;let t=[];e.slides.forEach(i=>{let n=e.getSlideClasses(i);t.push({slideEl:i,classNames:n}),e.emit("_slideClass",i,n)}),e.emit("_slideClasses",t)}slidesPerViewDynamic(e,t){void 0===e&&(e="current"),void 0===t&&(t=!1);let{params:i,slides:n,slidesGrid:r,slidesSizesGrid:a,size:o,activeIndex:s}=this,l=1;if(i.centeredSlides){let e,t=n[s]?n[s].swiperSlideSize:0;for(let i=s+1;i<n.length;i+=1)n[i]&&!e&&(t+=n[i].swiperSlideSize,l+=1,t>o&&(e=!0));for(let i=s-1;i>=0;i-=1)n[i]&&!e&&(t+=n[i].swiperSlideSize,l+=1,t>o&&(e=!0))}else // eslint-disable-next-line
...
return e}return iD(i,n())[0]})();return!r&&t.params.createElements&&(r=ij("div",t.params.wrapperClass),i.append(r),iD(i,`.${t.params.slideClass}`).forEach(e=>{r.append(e)})),Object.assign(t,{el:i,wrapperEl:r,slidesEl:t.isElement&&!i.parentNode.host.slideSlots?i.parentNode.host:r,hostEl:t.isElement?i.parentNode.host:i,mounted:!0,// RTL
rtl:"rtl"===i.dir.toLowerCase()||"rtl"===iF(i,"direction"),rtlTranslate:"horizontal"===t.params.direction&&("rtl"===i.dir.toLowerCase()||"rtl"===iF(i,"direction")),wrongRTL:"-webkit-box"===iF(r,"display")}),!0}init(e){let t=this;if(t.initialized)return t;let i=t.mount(e);if(!1===i)return t;t.emit("beforeInit"),t.params.breakpoints&&t.setBreakpoint(),// Add Classes
...
t.attachEvents();let n=[...t.el.querySelectorAll('[loading="lazy"]')];return t.isElement&&n.push(...t.hostEl.querySelectorAll('[loading="lazy"]')),n.forEach(e=>{e.complete?iX(t,e):e.addEventListener("load",e=>{iX(t,e.target)})}),iq(t),// Init Flag
t.initialized=!0,iq(t),// Emit
...
}})}(i)),i.destroyed=!0),null}static extendDefaults(e){iP(i9,e)}static get extendedDefaults(){return i9}static get defaults(){return i4}static installModule(e){i7.prototype.__modules__||(i7.prototype.__modules__=[]);let t=i7.prototype.__modules__;"function"==typeof e&&0>t.indexOf(e)&&t.push(e)}static use(e){return Array.isArray(e)?e.forEach(e=>i7.installModule(e)):i7.installModule(e),i7}}function ne(e){return void 0===e&&(e=""),`.${e.trim().replace(/([\.:!+\/])/g,"\\$1")// eslint-disable-line
.replace(/ /g,".")}`}Object.keys(i8).forEach(e=>{Object.keys(i8[e]).forEach(t=>{i7.prototype[t]=i8[e][t]})}),i7.use([function(e){let{swiper:t,on:i,emit:n}=e,r=iz(),a=null,o=null,s=()=>{t&&!t.destroyed&&t.initialized&&(n("beforeResize"),n("resize"))},l=()=>{t&&!t.destroyed&&t.initialized&&(a=new ResizeObserver(e=>{o=r.requestAnimationFrame(()=>{let{width:i,height:n}=t,r=i,a=n;e.forEach(e=>{let{contentBoxSize:i,contentRect:n,target:o}=e;o&&o!==t.el||(r=n?n.width:(i[0]||i).inlineSize,a=n?n.height:(i[0]||i).blockSize)}),(r!==i||a!==n)&&s()})})).observe(t.el)},c=()=>{o&&r.cancelAnimationFrame(o),a&&a.unobserve&&t.el&&(a.unobserve(t.el),a=null)},p=()=>{t&&!t.destroyed&&t.initialized&&n("orientationchange")};i("init",()=>{if(t.params.resizeObserver&&void 0!==r.ResizeObserver){l();return}r.addEventListener("resize",s),r.addEventListener("orientationchange",p)}),i("destroy",()=>{c(),r.removeEventListener("resize",s),r.removeEventListener("orientationchange",p)})},function(e){let{swiper:t,extendParams:i,on:n,emit:r}=e,a=[],o=iz(),s=function(e,i){void 0===i&&(i={});let n=o.MutationObserver||o.WebkitMutationObserver,s=new n(e=>{// The observerUpdate event should only be triggered
// once despite the number of mutations.  Additional
// triggers are redundant and are very costly
if(t.__preventObserver__)return;if(1===e.length){r("observerUpdate",e[0]);return}let i=function(){r("observerUpdate",e[0])};o.requestAnimationFrame?o.requestAnimationFrame(i):o.setTimeout(i,0)});s.observe(e,{attributes:void 0===i.attributes||i.attributes,childList:void 0===i.childList||i.childList,characterData:void 0===i.characterData||i.characterData}),a.push(s)};i({observer:!1,observeParents:!1,observeSlideChildren:!1}),n("init",()=>{if(t.params.observer){if(t.params.observeParents){let e=i$(t.hostEl);for(let t=0;t<e.length;t+=1)s(e[t])}// Observe container
s(t.hostEl,{childList:t.params.observeSlideChildren}),// Observe wrapper
s(t.wrapperEl,{attributes:!1})}}),n("destroy",()=>{a.forEach(e=>{e.disconnect()}),a.splice(0,a.length)})}]),i7.use([function(e){let t,{swiper:i,extendParams:n,on:r,emit:a}=e,o="swiper-pagination";n({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
dynamicBullets:!1,dynamicMainBullets:1,formatFractionCurrent:e=>e,formatFractionTotal:e=>e,bulletClass:`${o}-bullet`,bulletActiveClass:`${o}-bullet-active`,modifierClass:`${o}-`,currentClass:`${o}-current`,totalClass:`${o}-total`,hiddenClass:`${o}-hidden`,progressbarFillClass:`${o}-progressbar-fill`,progressbarOppositeClass:`${o}-progressbar-opposite`,clickableClass:`${o}-clickable`,lockClass:`${o}-lock`,horizontalClass:`${o}-horizontal`,verticalClass:`${o}-vertical`,paginationDisabledClass:`${o}-disabled`}}),i.pagination={el:null,bullets:[]};let s=0,l=e=>(Array.isArray(e)?e:[e]).filter(e=>!!e);function c(){return!i.params.pagination.el||!i.pagination.el||Array.isArray(i.pagination.el)&&0===i.pagination.el.length}function p(e,t){let{bulletActiveClass:n}=i.params.pagination;e&&(e=e[`${"prev"===t?"previous":"next"}ElementSibling`])&&(e.classList.add(`${n}-${t}`),(e=e[`${"prev"===t?"previous":"next"}ElementSibling`])&&e.classList.add(`${n}-${t}-${t}`))}function d(e){let t=e.target.closest(ne(i.params.pagination.bulletClass));if(!t)return;e.preventDefault();let n=iW(t)*i.params.slidesPerGroup;if(i.params.loop){if(i.realIndex===n)return;let e=i.realIndex,t=i.getSlideIndexByData(n),r=i.getSlideIndexByData(i.realIndex);if(t>i.slides.length-i.loopedSlides){let n=i.activeIndex;i.loopFix({direction:t>r?"next":"prev",activeSlideIndex:t,slideTo:!1});let a=i.activeIndex;n===a&&i.slideToLoop(e,0,!1,!0)}i.slideToLoop(n)}else i.slideTo(n)}function f(){let e,n;// Render || Update Pagination bullets/items
