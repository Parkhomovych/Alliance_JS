...
if(!a("body"))return!1;t||p.Notify.init({});// create a backup for new settings
...
if(t.showOnlyTheLastOne&&f>0)for(var L=e.document.querySelectorAll("[id^="+t.ID+"-]:not([id="+t.ID+"-"+f+"])"),A=0;A<L.length;A++){var I=L[A];null!==I.parentNode&&I.parentNode.removeChild(I)}// notify - show only the last one: end
// extend new settings with the backup settings
t=s(!0,t,u)},p={Notify:{// Init
...
success:function(e,t,n){d(i.Success,e,t,n)},// Failure
failure:function(e,t,n){d(i.Failure,e,t,n)},// Warning
warning:function(e,t,n){d(i.Warning,e,t,n)},// Info
info:function(e,t,n){d(i.Info,e,t,n)}}};return"object"==typeof e.Notiflix?s(!0,e.Notiflix,{Notify:p.Notify}):{Notify:p.Notify}},"function"==typeof define&&define.amd?define([],function(){return r(a)}):"object"==typeof y?y=r(a):a.Notiflix=r(a);// utils is a library of generic helper functions non-specific to axios
let{toString:b}=Object.prototype,{getPrototypeOf:v}=Object,w=(s=Object.create(null),e=>{let t=b.call(e);return s[t]||(s[t]=t.slice(8,-1).toLowerCase())}),k=e=>(e=e.toLowerCase(),t=>w(t)===e),S=e=>t=>typeof t===e,{isArray:C}=Array,E=S("undefined"),N=k("ArrayBuffer"),T=S("string"),L=S("function"),A=S("number"),I=e=>null!==e&&"object"==typeof e,M=e=>{if("object"!==w(e))return!1;let t=v(e);return(null===t||t===Object.prototype||null===Object.getPrototypeOf(t))&&!(Symbol.toStringTag in e)&&!(Symbol.iterator in e)},z=k("Date"),O=k("File"),B=k("Blob"),P=k("FileList"),_=k("URLSearchParams");/**
 ...
 */function(e){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(e):e&&e.buffer&&N(e.buffer)},isString:T,isNumber:A,isBoolean:e=>!0===e||!1===e,isObject:I,isPlainObject:M,isUndefined:E,isDate:z,isFile:O,isBlob:B,isRegExp:H,isFunction:L,isStream:e=>I(e)&&L(e.pipe),isURLSearchParams:_,isTypedArray:F,isFileList:P,forEach:R,merge:/**
 ...
 *
 * @returns {boolean}
 */function(e){return!!(e&&L(e.append)&&"FormData"===e[Symbol.toStringTag]&&e[Symbol.iterator])},toJSONObject:e=>{let t=Array(10),i=(e,n)=>{if(I(e)){if(t.indexOf(e)>=0)return;if(!("toJSON"in e)){t[n]=e;let o=C(e)?[]:{};return R(e,(e,t)=>{let a=i(e,n+1);E(a)||(o[t]=a)}),t[n]=void 0,o}}return e};return i(e,0)},isAsyncFn:Y,isThenable:e=>e&&(I(e)||L(e))&&L(e.then)&&L(e.catch)};/**
...
J.from=(e,t,i,n,o,a)=>{let r=Object.create(Q);return K.toFlatObject(e,r,function(e){return e!==Error.prototype},e=>"isAxiosError"!==e),J.call(r,e.message,t,i,n,o),r.cause=e,r.name=e.name,a&&Object.assign(r,a),r},d=function(e){// go through the array every three bytes, we'll deal with trailing stuff later
...
et["-".charCodeAt(0)]=62,et["_".charCodeAt(0)]=63,p=function(e,t,i,n,o){var a,r,s=8*o-n-1,l=(1<<s)-1,c=l>>1,f=-7,d=i?o-1:0,p=i?-1:1,u=e[t+d];for(d+=p,a=u&(1<<-f)-1,u>>=-f,f+=s;f>0;a=256*a+e[t+d],d+=p,f-=8);for(r=a&(1<<-f)-1,a>>=-f,f+=n;f>0;r=256*r+e[t+d],d+=p,f-=8);if(0===a)a=1-c;else{if(a===l)return r?NaN:(u?-1:1)*(1/0);r+=Math.pow(2,n),a-=c}return(u?-1:1)*r*Math.pow(2,a-n)},u=function(e,t,i,n,o,a){var r,s,l,c=8*a-o-1,f=(1<<c)-1,d=f>>1,p=23===o?5960464477539062e-23:0,u=n?0:a-1,m=n?1:-1,h=t<0||0===t&&1/t<0?1:0;for(isNaN(t=Math.abs(t))||t===1/0?(s=isNaN(t)?1:0,r=f):(r=Math.floor(Math.log(t)/Math.LN2),t*(l=Math.pow(2,-r))<1&&(r--,l*=2),r+d>=1?t+=p/l:t+=p*Math.pow(2,1-d),t*l>=2&&(r++,l/=2),r+d>=f?(s=0,r=f):r+d>=1?(s=(t*l-1)*Math.pow(2,o),r+=d):(s=t*Math.pow(2,d-1)*Math.pow(2,o),r=0));o>=8;e[i+u]=255&s,u+=m,s/=256,o-=8);for(r=r<<o|s,c+=o;c>0;e[i+u]=255&r,u+=m,r/=256,c-=8);e[i+u-m]|=128*h};let er="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
(i>>>=0)<=(t>>>=0)))return"";for(e||(e="utf8");;)switch(e){case"hex":return function(e,t,i){let n=e.length;(!t||t<0)&&(t=0),(!i||i<0||i>n)&&(i=n);let o="";for(let n=t;n<i;++n)o+=ej[e[n]];return o}(this,t,i);case"utf8":case"utf-8":return ev(this,t,i);case"ascii":return function(e,t,i){let n="";i=Math.min(e.length,i);for(let o=t;o<i;++o)n+=String.fromCharCode(127&e[o]);return n}(this,t,i);case"latin1":case"binary":return function(e,t,i){let n="";i=Math.min(e.length,i);for(let o=t;o<i;++o)n+=String.fromCharCode(e[o]);return n}(this,t,i);case"base64":var o,a;return o=t,a=i,0===o&&a===this.length?d(this):d(this.slice(o,a));case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return function(e,t,i){let n=e.slice(t,i),o="";// If bytes.length is odd, the last 8 bits must be ignored (same as node.js)
 ...
 */function ew(e,t,i){if(e%1!=0||e<0)throw RangeError("offset is not uint");if(e+t>i)throw RangeError("Trying to access beyond buffer length")}function ek(e,t,i,n,o,a){if(!el.isBuffer(e))throw TypeError('"buffer" argument must be a Buffer instance');if(t>o||t<a)throw RangeError('"value" argument is out of bounds');if(i+n>e.length)throw RangeError("Index out of range")}function eS(e,t,i,n,o){eM(t,n,o,e,i,7);let a=Number(t&BigInt(4294967295));e[i++]=a,a>>=8,e[i++]=a,a>>=8,e[i++]=a,a>>=8,e[i++]=a;let r=Number(t>>BigInt(32)&BigInt(4294967295));return e[i++]=r,r>>=8,e[i++]=r,r>>=8,e[i++]=r,r>>=8,e[i++]=r,i}function eC(e,t,i,n,o){eM(t,n,o,e,i,7);let a=Number(t&BigInt(4294967295));e[i+7]=a,a>>=8,e[i+6]=a,a>>=8,e[i+5]=a,a>>=8,e[i+4]=a;let r=Number(t>>BigInt(32)&BigInt(4294967295));return e[i+3]=r,r>>=8,e[i+2]=r,r>>=8,e[i+1]=r,r>>=8,e[i]=r,i+8}function eE(e,t,i,n,o,a){if(i+n>e.length||i<0)throw RangeError("Index out of range")}function eN(e,t,i,n,o){return t=+t,i>>>=0,o||eE(e,t,i,4,34028234663852886e22,-34028234663852886e22),u(e,t,i,n,23,4),i+4}function eT(e,t,i,n,o){return t=+t,i>>>=0,o||eE(e,t,i,8,17976931348623157e292,-17976931348623157e292),u(e,t,i,n,52,8),i+8}/**
 ...
 * */el.allocUnsafe=function(e){return ed(e)},/**
 * Equivalent to SlowBuffer(num), by default creates a non-zero-filled Buffer instance.
 */el.allocUnsafeSlow=function(e){return ed(e)},el.isBuffer=function(e){return null!=e&&!0===e._isBuffer&&e!==el.prototype// so Buffer.isBuffer(Buffer.prototype) will be false
...
delete this.name}get code(){return e}set code(e){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:e,writable:!0})}toString(){return`${this.name} [${e}]: ${this.message}`}}}function eI(e){let t="",i=e.length,n="-"===e[0]?1:0;for(;i>=n+4;i-=3)t=`_${e.slice(i-3,i)}${t}`;return`${e.slice(0,i)}${t}`}function eM(e,t,i,n,o,a){if(e>i||e<t){let n;let o="bigint"==typeof t?"n":"";throw n=a>3?0===t||t===BigInt(0)?`>= 0${o} and < 2${o} ** ${(a+1)*8}${o}`:`>= -(2${o} ** ${(a+1)*8-1}${o}) and < 2 ** ${(a+1)*8-1}${o}`:`>= ${t}${o} and <= ${i}${o}`,new eL.ERR_OUT_OF_RANGE("value",n,e)}ez(o,"offset"),(void 0===n[o]||void 0===n[o+a])&&eO(o,n.length-(a+1))}function ez(e,t){if("number"!=typeof e)throw new eL.ERR_INVALID_ARG_TYPE(t,"number",e)}function eO(e,t,i){if(Math.floor(e)!==e)throw ez(e,i),new eL.ERR_OUT_OF_RANGE(i||"offset","an integer",e);if(t<0)throw new eL.ERR_BUFFER_OUT_OF_BOUNDS;throw new eL.ERR_OUT_OF_RANGE(i||"offset",`>= ${i?1:0} and <= ${t}`,e)}eA("ERR_BUFFER_OUT_OF_BOUNDS",function(e){return e?`${e} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),eA("ERR_INVALID_ARG_TYPE",function(e,t){return`The "${e}" argument must be of type number. Received type ${typeof t}`},TypeError),eA("ERR_OUT_OF_RANGE",function(e,t,i){let n=`The value of "${e}" is out of range.`,o=i;return Number.isInteger(i)&&Math.abs(i)>4294967296?o=eI(String(i)):"bigint"==typeof i&&(o=String(i),(i>BigInt(2)**BigInt(32)||i<-(BigInt(2)**BigInt(32)))&&(o=eI(o)),o+="n"),n+=` It must be ${t}. Received ${o}`},RangeError);// HELPER FUNCTIONS
// ================
...
i=eU(i),s.forEach(function(e,n){K.isUndefined(e)||null===e||t.append(!0===r?eH([i],n,a):null===r?i:i+"[]",c(e))}),!1)}}return!!e$(e)||(t.append(eH(o,i,a),c(e)),!1)}let d=[],p=Object.assign(eX,{defaultVisitor:f,convertValue:c,isVisitable:e$});if(!K.isObject(e))throw TypeError("data must be an object");return!function e(i,n){if(!K.isUndefined(i)){if(-1!==d.indexOf(i))throw Error("Circular reference detected in "+n.join("."));d.push(i),K.forEach(i,function(i,a){let r=!(K.isUndefined(i)||null===i)&&o.call(t,i,K.isString(a)?a.trim():a,n,p);!0===r&&e(i,n?n.concat(a):[a])}),d.pop()}}(e),t};/**
...
i.setAttribute("href",n),n=i.href),i.setAttribute("href",n),{href:i.href,protocol:i.protocol?i.protocol.replace(/:$/,""):"",host:i.host,search:i.search?i.search.replace(/^\?/,""):"",hash:i.hash?i.hash.replace(/^#/,""):"",hostname:i.hostname,port:i.port,pathname:"/"===i.pathname.charAt(0)?i.pathname:"/"+i.pathname}}/**
    ...
    */return e=n(window.location.href),function(t){let i=K.isString(t)?n(t):t;return i.protocol===e.protocol&&i.host===e.host}}():function(){return!0},tp=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(e,t){let i;e=e||10;let n=Array(e),o=Array(e),a=0,r=0;return t=void 0!==t?t:1e3,function(s){let l=Date.now(),c=o[r];i||(i=l),n[a]=s,o[a]=l;let f=r,d=0;for(;f!==a;)d+=n[f++],f%=e;if((a=(a+1)%e)===r&&(r=(r+1)%e),l-i<t)return;let p=c&&l-c;return p?Math.round(1e3*d/p):void 0}};function tu(e,t){let i=0,n=tp(50,250);return o=>{let a=o.loaded,r=o.lengthComputable?o.total:void 0,s=a-i,l=n(s),c=a<=r;i=a;let f={loaded:a,total:r,progress:r?a/r:void 0,bytes:s,rate:l||void 0,estimated:l&&r&&c?(r-a)/l:void 0,event:o};f[t?"download":"upload"]=!0,e(f)}}let tm="undefined"!=typeof XMLHttpRequest;var th=tm&&function(e){return new Promise(function(t,i){let n,o=e.data,a=ta.from(e.headers).normalize(),r=e.responseType;function s(){e.cancelToken&&e.cancelToken.unsubscribe(n),e.signal&&e.signal.removeEventListener("abort",n)}K.isFormData(o)&&(e3.isStandardBrowserEnv||e3.isStandardBrowserWebWorkerEnv?a.setContentType(!1):a.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
...
let t=(e.withCredentials||td(c))&&e.xsrfCookieName&&tc.read(e.xsrfCookieName);t&&a.set(e.xsrfHeaderName,t)}// Remove Content-Type if data is undefined
...
n=t=>{l&&(i(!t||t.type?new tl(null,e,l):t),l.abort(),l=null)},e.cancelToken&&e.cancelToken.subscribe(n),e.signal&&(e.signal.aborted?n():e.signal.addEventListener("abort",n)));let d=function(e){let t=/^([-+\w]{1,25})(:?\/\/|:)/.exec(e);return t&&t[1]||""}(c);if(d&&-1===e3.protocols.indexOf(d)){i(new J("Unsupported protocol "+d+":",J.ERR_BAD_REQUEST,e));return}// Send the request
...
tI.Axios=tT,// Expose Cancel & CancelToken
tI.CanceledError=tl,tI.CancelToken=tL,tI.isCancel=ts,tI.VERSION=tk,tI.toFormData=eq,// Expose AxiosError class
tI.AxiosError=J,// alias for CanceledError for backward compatibility
tI.Cancel=tI.CanceledError,// Expose all/spread
tI.all=function(e){return Promise.all(e)},tI.spread=function(e){return function(t){return e.apply(null,t)}},// Expose isAxiosError
tI.isAxiosError=function(e){return K.isObject(e)&&!0===e.isAxiosError},// Expose mergeConfig
tI.mergeConfig=tw,tI.AxiosHeaders=ta,tI.formToJSON=e=>e4(K.isHTMLForm(e)?new FormData(e):e),tI.getAdapter=ty.getAdapter,tI.HttpStatusCode=tA,tI.default=tI;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:tM,AxiosError:tz,CanceledError:tO,isCancel:tB,CancelToken:tP,VERSION:t_,all:tR,Cancel:tD,isAxiosError:tj,spread:tW,toFormData:tF,AxiosHeaders:t$,HttpStatusCode:tU,formToJSON:tH,getAdapter:tX,mergeConfig:tq}=tI,tG="https://tasty-treats-backend.p.goit.global/api",tV={events:"/events",recipes:"/recipes",categories:"/categories",popular:"/recipes/popular",ingredients:"/ingredients",areas:"/areas",orders:"/orders/add"},tY=async()=>{let e=await tI.get(`${tG}${tV.events}`);return e},tK=async()=>{let e=await tI.get(`${tG}${tV.categories}`);return e},tJ=async()=>{let e=await tI.get(`${tG}${tV.popular}`);return e},tQ=async e=>{let t=await tI.get(`${tG}${tV.recipes}/${e}`);return t},tZ=async()=>{let e=await tI.get(`${tG}${tV.ingredients}`);return e},t0=async()=>{let e=await tI.get(`${tG}${tV.areas}`);return e},t1=async e=>{let t=await tI.post(`${tG}${tV.orders}`,e);return t},t2=async e=>{let t=await tI.get(`${tG}${tV.recipes}?${e}`);return t};function t5(e){"Success"===e.data.message?(0,y.Notify).success("Вітаємо, ваше замовлення прийнято!"):(0,y.Notify).warning("Вибачте, в цей час замовлення не приймаються!")}// ********************************************************
...
let s=new URLSearchParams({limit:e}),l=await tI.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${s}`);return l};function id(e){il.innerHTML=e.map(e=>`
    ...
    function(e){let t=ir.findIndex(({_id:t})=>t===e);return(console.log(t),t>-1&&ir[t].favorit)?" add-fill":""}(e._id)}" data-set="${e._id}" viewBox="0 0 32 32">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join(""),function(){let e=document.querySelectorAll(".box-star");e.forEach(e=>{let t=e.previousElementSibling,i=Math.round(t.textContent),n=[...e.children];n.forEach((e,t)=>{t<i&&e.classList.add("yellow-star")})})}()}window.addEventListener("load",function(){ic().then(id).catch(e=>{console.log(e)})}),il.addEventListener("click",function(e){if("BUTTON"===e.target.nodeName){let t=e.target;console.log(t)}if("svg"===e.target.nodeName){let t=e.target.dataset.set;t&&(// перемикач фаворита, повертає frue|false 
function(e){console.log(e),console.log(ir);let t=ir.findIndex(({_id:t})=>t===e);(console.log(t),t<0)?// додати фаворіта 
function(e){let t=ir.findIndex(({_id:t})=>t===e);t<0&&tQ(e).then(({data:e})=>(e.favorit=!0,ir.push(e),ir)).then(e=>{ia("cardData",e)}).catch(()=>{console.log(error)})}(e):ir[t].favorit?ir[t].favorit=!1:ir[t].favorit=!0}(t),console.log(t))}});let ip=new MutationObserver(function(){let e=document.querySelectorAll(".info-btn");// витягуємо всі кнопки
e.forEach(e=>{e.addEventListener("click",iu);// вішаємо слухача на кнопки
})});// створюємо екземпляр класу MutationObserver
function iu(e){let t=e.target.id;tQ(t).then(e=>{im(e);let t=document.querySelector(".basicLightbox");t.classList.add("correct-recipe")}).catch(e=>{console.log(e)})}function im(e){let{data:{title:t,youtube:i,thumb:n,rating:o,time:a,ingredients:r,tags:s,instructions:l}}=e,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),f=g.create(`<div class="card-modal">
...
`,{onShow:e=>{document.addEventListener("keydown",d)}},{closeShow:e=>{document.removeEventListener("keydown",d)}});function d(e){if("Escape"===e.code)return f.close()}f.show(),// Функція для Tags
...
function(e){let t=document.querySelector(".box-stars");document.querySelector(".star");let i=[...t.children],n=Math.round(e);i.forEach((e,t)=>{t<n&&e.classList.add("yellow-star")})}(o),document.body.style.overflow="hidden";let p=document.querySelector(".js-card-close-btn");document.querySelector(".card-modal"),p.addEventListener("click",()=>{document.body.style.overflow="auto",f.close()})}ip.observe(il,{// параметри MutationObserver
 ...
 * @private
 */d.prototype._memorizeContext=function(e){var t,i;o(e)&&(t=this._safeContext(),(i=this._indexOfContext(e))>-1?t[i][1]+=1:t.push([e,1]))},/**
 * Forget supplied context object
 * @param {object} ctx - context object to forget
 * @private
 */d.prototype._forgetContext=function(e){var t,i;o(e)&&(t=this._safeContext(),(i=this._indexOfContext(e))>-1&&(t[i][1]-=1,t[i][1]<=0&&t.splice(i,1)))},/**
 * Bind event handler
 ...
 * @param {function|object} [handler] - handler function or context
 * @param {object} [context] - context for binding
 */d.prototype.once=function(e,t,i){var n=this;if(r(e)){i=t,c(e,function(e,t){n.once(t,e,i)});return}this.on(e,function o(){t.apply(i,arguments),n.off(e,o,i)},i)},/**
 ...
 * @private
 */d.prototype._matchHandlerAndContext=function(e,t){var i=this;return function(n){var o=e===n.handler,a=t===n.context,r=o&&a;return r&&i._forgetContext(n.context),r}},/**
 * Unbind event by event name
 * @param {string} eventName - custom event name to unbind
 * @param {function} [handler] - handler function
 * @private
 */d.prototype._offByEventName=function(e,t){var i=this,n=l(t),o=i._matchHandler(t);c(e=e.split(f),function(e){var t=i._safeEvent(e);n?i._spliceMatches(t,o):(c(t,function(e){i._forgetContext(e.context)}),i.events[e]=[])})},/**
 ...
 * CustomEvents.off();
 */d.prototype.off=function(e,t){a(e)?this._offByEventName(e,t):arguments.length?l(e)?this._offByHandler(e):r(e)&&this._offByObject(e,t):(// [syntax 8]
 ...
 *     // doSomething
 * }
 */d.prototype.invoke=function(e){var t,i,n,o;if(!this.hasListener(e))return!0;for(t=this._safeEvent(e),i=Array.prototype.slice.call(arguments,1),n=0;t[n];){if(!1===(o=t[n]).handler.apply(o.context,i))return!1;n+=1}return!0},/**
 ...
 * @private
 */// eslint-disable-next-line complexity
function x(e,t){var i,n=t[e];return"true"===e?n=!0:"false"===e?n=!1:u.test(e)?n=e.replace(m,""):c.test(e)?n=x((i=e.split(f))[0],t)[x(i[1],t)]:d.test(e)?n=x((i=e.split(p))[0],t)[i[1]]:h.test(e)&&(n=parseFloat(e)),n}/**
 ...
 *     dh: 'dh'
 * });
 */function(e,t){var i=document.createElement("img"),o="";return n(t,function(e,t){o+="&"+t+"="+e}),o=o.substring(1),i.src=e+"?"+o,i.style.display="none",document.body.appendChild(i),document.body.removeChild(i),i};/***/}]);// посилання на Dom
let ig={allCategiries:document.querySelector(".categories-btn-all-js"),categories:document.querySelector(".categories-js"),popular:document.querySelector(".popular-change-js"),paginationShow:document.querySelector("#tui-pagination-container"),pagination:document.getElementById("tui-pagination-container")},iy=window.innerWidth<768?6:window.innerWidth<1280?8:9,ix=1,ib=window.innerWidth<768?2:3,iv=new URLSearchParams({page:ix,limit:iy}),iw={totalItems:0,itemsPerPage:iy,visiblePages:ib,page:ix},ik=new/*@__PURE__*/(h(ih))(ig.pagination,iw);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
function iS(){ik.off("afterMove",iC),iA("page",1),t2(iv).then(e=>{id(e.data.results),// встановлення слухача пагінації, відображення її
function(e){if(ik.reset(e*iy),e>1){ik.on("afterMove",iC),ig.paginationShow.classList.remove("is-hidden");return}ig.paginationShow.classList.contains("is-hidden")||ig.paginationShow.classList.add("is-hidden"),e||/*@__PURE__*/h(io).Notify.info("Вибачте, згідно параметрів пошуку рецептів не знайдено")}(e.data.totalPages)}).catch(()=>{})}// перемальовка рецептів при зміщенні пагінації
function iC(){iA("page",ix=ik.getCurrentPage()),t2(iv).then(e=>{id(e.data.results)}).catch(()=>{})}// вибір "всіх категорій" по натисканню "AllCategories"
function iE(){iT(),ig.allCategiries.classList.add("is-active"),iI("category"),iS()}// вибір конкретної категорії
...
function iL(e){if("BUTTON"!==e.currentTarget.nodeName)return;let t=e.currentTarget.dataset.set;!function(e){tQ(e).then(e=>{im(e);let t=document.querySelector(".basicLightbox");t.classList.add("correct-recipe")}).catch(e=>{console.log(e)})}(t)}// додавання/зміна параметру в об'єкт для пошуку рецепту
function iA(e,t){iv.has(e)&&iv.delete(e),iv.append(e,t)}// вилучення параметра в об'єкті пошуку рецепту
function iI(e){for(;iv.has(e);)iv.delete(e)}/**
  |============================
  | Refs hero
  |============================
*/function iM(){return{swiperJs:document.querySelector(".swiper"),pagination:document.querySelector(".swiper-pagination"),eventSwiper:document.querySelector(".hero-swiper"),markupSwiper:document.querySelector(".swiper-wrapper"),orderBtnHero:document.querySelector(".btn-hero"),message:document.querySelector(".header-form"),btnMessage:document.querySelector(".header-form-btn")}}// слухачі подій
...
window.addEventListener("unload",function(){ig.allCategiries.removeEventListener("click",iE),ig.categories.removeEventListener("click",iN),ig.popular.removeEventListener("click",iL),ik.off("afterMove",iC)}),tK().then(e=>{ig.categories.insertAdjacentHTML("beforeend",// формування розмітки переліку категорій
...
iS(),tJ().then(e=>{ig.popular.insertAdjacentHTML("beforeend",e.data.map(e=>`
...
let t=ig.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",iL)})}).catch(()=>{});let iz=iM();function iO(e){let t=/**
  |============================
  | Розмітка Swiper
  |============================
...
window.addEventListener("load",function(){tY().then(iO).catch(e=>{console.log(e)})}),iz.orderBtnHero.addEventListener("click",function(){t9();// const modalMessage = document.querySelector('.header-form');
...
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType)){let i=Object.keys(Object(n)).filter(e=>0>t.indexOf(e));for(let t=0,o=i.length;t<o;t+=1){let o=i[t],a=Object.getOwnPropertyDescriptor(n,o);void 0!==a&&a.enumerable&&(i$(e[o])&&i$(n[o])?n[o].__swiper__?e[o]=n[o]:iU(e[o],n[o]):!i$(e[o])&&i$(n[o])?(e[o]={},n[o].__swiper__?e[o]=n[o]:iU(e[o],n[o])):e[o]=n[o])}}}return e}function iH(e,t,i){e.style.setProperty(t,i)}function iX(e){let t,{swiper:i,targetPosition:n,side:o}=e,a=ij(),r=-i.translate,s=null,l=i.params.speed;i.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(i.cssModeFrameID);let c=n>r?"next":"prev",f=(e,t)=>"next"===c&&e>=t||"prev"===c&&e<=t,d=()=>{t=new Date().getTime(),null===s&&(s=t);let e=Math.max(Math.min((t-s)/l,1),0),c=r+(.5-Math.cos(e*Math.PI)/2)*(n-r);if(f(c,n)&&(c=n),i.wrapperEl.scrollTo({[o]:c}),f(c,n)){i.wrapperEl.style.overflow="hidden",i.wrapperEl.style.scrollSnapType="",setTimeout(()=>{i.wrapperEl.style.overflow="",i.wrapperEl.scrollTo({[o]:c})}),a.cancelAnimationFrame(i.cssModeFrameID);return}i.cssModeFrameID=a.requestAnimationFrame(d)};d()}function iq(e,t){return void 0===t&&(t=""),[...e.children].filter(e=>e.matches(t))}function iG(e,t){void 0===t&&(t=[]);let i=document.createElement(e);return i.classList.add(...Array.isArray(t)?t:[t]),i}function iV(e,t){let i=ij();return i.getComputedStyle(e,null).getPropertyValue(t)}function iY(e){let t,i=e;if(i){// eslint-disable-next-line
for(t=0;null!==(i=i.previousSibling);)1===i.nodeType&&(t+=1);return t}}function iK(e,t){let i=[],n=e.parentElement;// eslint-disable-line
for(;n;)t?n.matches(t)&&i.push(n):i.push(n),n=n.parentElement;return i}function iJ(e,t,i){let n=ij();return i?e["width"===t?"offsetWidth":"offsetHeight"]+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-right":"margin-top"))+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-left":"margin-bottom")):e.offsetWidth}function iQ(){return t||(t=function(){let e=ij(),t=iR();return{smoothScroll:t.documentElement&&t.documentElement.style&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)}}()),t}let iZ=(e,t)=>{if(!e||e.destroyed||!e.params)return;let i=t.closest(e.isElement?"swiper-slide":`.${e.params.slideClass}`);if(i){let t=i.querySelector(`.${e.params.lazyPreloaderClass}`);!t&&e.isElement&&(t=i.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`)),t&&t.remove()}},i0=(e,t)=>{if(!e.slides[t])return;let i=e.slides[t].querySelector('[loading="lazy"]');i&&i.removeAttribute("loading")},i1=e=>{if(!e||e.destroyed||!e.params)return;let t=e.params.lazyPreloadPrevNext,i=e.slides.length;if(!i||!t||t<0)return;t=Math.min(t,i);let n="auto"===e.params.slidesPerView?e.slidesPerViewDynamic():Math.ceil(e.params.slidesPerView),o=e.activeIndex;if(e.params.grid&&e.params.grid.rows>1){let i=[o-t];i.push(...Array.from({length:t}).map((e,t)=>o+n+t)),e.slides.forEach((t,n)=>{i.includes(t.column)&&i0(e,n)});return}let a=o+n-1;if(e.params.rewind||e.params.loop)for(let n=o-t;n<=a+t;n+=1){let t=(n%i+i)%i;(t<o||t>a)&&i0(e,t)}else for(let n=Math.max(o-t,0);n<=Math.min(a+t,i-1);n+=1)n!==o&&(n>a||n<o)&&i0(e,n)};function i2(e){let{swiper:t,runCallbacks:i,direction:n,step:o}=e,{activeIndex:a,previousIndex:r}=t,s=n;if(s||(s=a>r?"next":a<r?"prev":"reset"),t.emit(`transition${o}`),i&&a!==r){if("reset"===s){t.emit(`slideResetTransition${o}`);return}t.emit(`slideChangeTransition${o}`),"next"===s?t.emit(`slideNextTransition${o}`):t.emit(`slidePrevTransition${o}`)}}function i5(e){let t=iR(),i=ij(),n=this.touchEventsData;n.evCache.push(e);let{params:o,touches:a,enabled:r}=this;if(!r||!o.simulateTouch&&"mouse"===e.pointerType||this.animating&&o.preventInteractionOnTransition)return;!this.animating&&o.cssMode&&o.loop&&this.loopFix();let s=e;s.originalEvent&&(s=s.originalEvent);let l=s.target;if("wrapper"===o.touchEventsTarget&&!this.wrapperEl.contains(l)||"which"in s&&3===s.which||"button"in s&&s.button>0||n.isTouched&&n.isMoved)return;// change target el for shadow root component
let c=!!o.noSwipingClass&&""!==o.noSwipingClass,f=e.composedPath?e.composedPath():e.path;c&&s.target&&s.target.shadowRoot&&f&&(l=f[0]);let d=o.noSwipingSelector?o.noSwipingSelector:`.${o.noSwipingClass}`,p=!!(s.target&&s.target.shadowRoot);// use closestElement for shadow root element to get the actual closest for nested shadow root element
...
let y=(t-l[u])/m,x=u<a.slidesPerGroupSkip-1?1:a.slidesPerGroup;if(p>a.longSwipesMs){// Long touches
...
i.forEach(e=>{e.classList.remove(t.slideVisibleClass)}),this.visibleSlidesIndexes=[],this.visibleSlides=[];let r=t.spaceBetween;"string"==typeof r&&r.indexOf("%")>=0?r=parseFloat(r.replace("%",""))/100*this.size:"string"==typeof r&&(r=parseFloat(r));for(let e=0;e<i.length;e+=1){let s=i[e],l=s.swiperSlideOffset;t.cssMode&&t.centeredSlides&&(l-=i[0].swiperSlideOffset);let c=(a+(t.centeredSlides?this.minTranslate():0)-l)/(s.swiperSlideSize+r),f=(a-o[0]+(t.centeredSlides?this.minTranslate():0)-l)/(s.swiperSlideSize+r),d=-(a-l),p=d+this.slidesSizesGrid[e],u=d>=0&&d<this.size-1||p>1&&p<=this.size||d<=0&&p>=this.size;u&&(this.visibleSlides.push(s),this.visibleSlidesIndexes.push(e),i[e].classList.add(t.slideVisibleClass)),s.progress=n?-c:c,s.originalProgress=n?-f:f}},updateProgress:function(e){if(void 0===e){let t=this.rtlTranslate?-1:1;// eslint-disable-next-line
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nN(e){if("number"==typeof e)return e;if("symbol"==typeof(t=e)||t&&"object"==typeof t&&"[object Symbol]"==nw.call(t))return np;if(nE(e)){var t,i="function"==typeof e.valueOf?e.valueOf():e;e=nE(i)?i+"":i}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(nu,"");var n=nh.test(e);return n||ng.test(e)?ny(e.slice(2),n?2:8):nm.test(e)?np:+e}nd=/**
 ...
 */function(e,t,i){var n,o,a,r,s,l,c=0,f=!1,d=!1,p=!0;if("function"!=typeof e)throw TypeError("Expected a function");function u(t){var i=n,a=o;return n=o=void 0,c=t,r=e.apply(a,i)}function m(e){var i=e-l,n=e-c;// Either this is the first call, activity has stopped and we're at the
// trailing edge, the system time has gone backwards and we're treating
// it as the trailing edge, or we've hit the `maxWait` limit.
return void 0===l||i>=t||i<0||d&&n>=a}function h(){var e,i,n,o=nC();if(m(o))return g(o);// Restart the timer.
s=setTimeout(h,(e=o-l,i=o-c,n=t-e,d?nS(n,a-i):n))}function g(e){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(s=void 0,p&&n)?u(e):(n=o=void 0,r))}function y(){var e,i=nC(),a=m(i);if(n=arguments,o=this,l=i,a){if(void 0===s)return(// Reset any `maxWait` timer.
c=e=l,// Start the timer for the trailing edge.
s=setTimeout(h,t),f?u(e):r);if(d)return(// Handle invocations in a tight loop.
s=setTimeout(h,t),u(l))}return void 0===s&&(s=setTimeout(h,t)),r}return t=nN(t)||0,nE(i)&&(f=!!i.leading,a=(d="maxWait"in i)?nk(nN(i.maxWait)||0,t):a,p="trailing"in i?!!i.trailing:p),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nC())},y};let nT={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nT.form.addEventListener("submit",function(e){e.preventDefault()}),nT.time.addEventListener("change",function(e){iA("time",e.currentTarget.value),iS()}),nT.area.addEventListener("change",function(e){iA("area",e.currentTarget.value),iS()}),nT.ingredients.addEventListener("change",function(e){iA("ingredient",e.currentTarget.value),iS()}),nT.search.addEventListener("input",/*@__PURE__*/h(nd)(()=>{iA("title",nT.search.value.trim()),iS()},300)),t0().then(e=>{nT.area.innerHTML=e.data.map(({name:e})=>`<option class="filter-opt" value="${e}">${e}</option>`).join("")}).catch(e=>{console.log(e)}),tZ().then(e=>{nT.ingredients.innerHTML=e.data.map(({name:e,_id:t})=>`<option class="filter-opt" value="${t}">${e}</option>`).join("")}).catch(e=>{}),// ❗ Створення Time ❗
...
nT.resetBtn.addEventListener("click",function(e){iI("time"),iI("area"),iI("ingredient"),iI("title"),iS()})}();//# sourceMappingURL=index.e6f9df34.js.map

//# sourceMappingURL=index.e6f9df34.js.map
