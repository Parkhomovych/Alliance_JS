...
if(e.showOnlyTheLastOne&&f>0)for(var L=t.document.querySelectorAll("[id^="+e.ID+"-]:not([id="+e.ID+"-"+f+"])"),A=0;A<L.length;A++){var I=L[A];null!==I.parentNode&&I.parentNode.removeChild(I)}// notify - show only the last one: end
...
info:function(t,e,n){d(i.Info,t,e,n)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Notify:p.Notify}):{Notify:p.Notify}},"function"==typeof define&&define.amd?define([],function(){return a(o)}):"object"==typeof g?g=a(o):o.Notiflix=a(o);// utils is a library of generic helper functions non-specific to axios
let{toString:x}=Object.prototype,{getPrototypeOf:b}=Object,v=(r=Object.create(null),t=>{let e=x.call(t);return r[e]||(r[e]=e.slice(8,-1).toLowerCase())}),w=t=>(t=t.toLowerCase(),e=>v(e)===t),k=t=>e=>typeof e===t,{isArray:S}=Array,C=k("undefined"),E=w("ArrayBuffer"),N=k("string"),T=k("function"),L=k("number"),A=t=>null!==t&&"object"==typeof t,I=t=>{if("object"!==v(t))return!1;let e=b(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},M=w("Date"),z=w("File"),O=w("Blob"),B=w("FileList"),P=w("URLSearchParams");/**
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&E(t.buffer)},isString:N,isNumber:L,isBoolean:t=>!0===t||!1===t,isObject:A,isPlainObject:I,isUndefined:C,isDate:M,isFile:z,isBlob:O,isRegExp:U,isFunction:T,isStream:t=>A(t)&&T(t.pipe),isURLSearchParams:P,isTypedArray:W,isFileList:B,forEach:_,merge:/**
...
tt["-".charCodeAt(0)]=62,tt["_".charCodeAt(0)]=63,d=function(t,e,i,n,o){var a,r,s=8*o-n-1,l=(1<<s)-1,c=l>>1,f=-7,d=i?o-1:0,p=i?-1:1,u=t[e+d];for(d+=p,a=u&(1<<-f)-1,u>>=-f,f+=s;f>0;a=256*a+t[e+d],d+=p,f-=8);for(r=a&(1<<-f)-1,a>>=-f,f+=n;f>0;r=256*r+t[e+d],d+=p,f-=8);if(0===a)a=1-c;else{if(a===l)return r?NaN:(u?-1:1)*(1/0);r+=Math.pow(2,n),a-=c}return(u?-1:1)*r*Math.pow(2,a-n)},p=function(t,e,i,n,o,a){var r,s,l,c=8*a-o-1,f=(1<<c)-1,d=f>>1,p=23===o?5960464477539062e-23:0,u=n?0:a-1,m=n?1:-1,h=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,r=f):(r=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-r))<1&&(r--,l*=2),r+d>=1?e+=p/l:e+=p*Math.pow(2,1-d),e*l>=2&&(r++,l/=2),r+d>=f?(s=0,r=f):r+d>=1?(s=(e*l-1)*Math.pow(2,o),r+=d):(s=e*Math.pow(2,d-1)*Math.pow(2,o),r=0));o>=8;t[i+u]=255&s,u+=m,s/=256,o-=8);for(r=r<<o|s,c+=o;c>0;t[i+u]=255&r,u+=m,r/=256,c-=8);t[i+u-m]|=128*h};let ta="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
let tT={};function tL(t,e,i){tT[t]=class extends i{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
this.name=`${this.name} [${t}]`,// Access the stack to generate the error message including the error code
// from the name.
this.stack// eslint-disable-line no-unused-expressions
,// Reset the name to the actual name.
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tA(t){let e="",i=t.length,n="-"===t[0]?1:0;for(;i>=n+4;i-=3)e=`_${t.slice(i-3,i)}${e}`;return`${t.slice(0,i)}${e}`}function tI(t,e,i,n,o,a){if(t>i||t<e){let n;let o="bigint"==typeof e?"n":"";throw n=a>3?0===e||e===BigInt(0)?`>= 0${o} and < 2${o} ** ${(a+1)*8}${o}`:`>= -(2${o} ** ${(a+1)*8-1}${o}) and < 2 ** ${(a+1)*8-1}${o}`:`>= ${e}${o} and <= ${i}${o}`,new tT.ERR_OUT_OF_RANGE("value",n,t)}tM(o,"offset"),(void 0===n[o]||void 0===n[o+a])&&tz(o,n.length-(a+1))}function tM(t,e){if("number"!=typeof t)throw new tT.ERR_INVALID_ARG_TYPE(e,"number",t)}function tz(t,e,i){if(Math.floor(t)!==t)throw tM(t,i),new tT.ERR_OUT_OF_RANGE(i||"offset","an integer",t);if(e<0)throw new tT.ERR_BUFFER_OUT_OF_BOUNDS;throw new tT.ERR_OUT_OF_RANGE(i||"offset",`>= ${i?1:0} and <= ${e}`,t)}tL("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tL("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tL("ERR_OUT_OF_RANGE",function(t,e,i){let n=`The value of "${t}" is out of range.`,o=i;return Number.isInteger(i)&&Math.abs(i)>4294967296?o=tA(String(i)):"bigint"==typeof i&&(o=String(i),(i>BigInt(2)**BigInt(32)||i<-(BigInt(2)**BigInt(32)))&&(o=tA(o)),o+="n"),n+=` It must be ${e}. Received ${o}`},RangeError);// HELPER FUNCTIONS
// ================
let tO=/[^+/0-9A-Za-z-_]/g;function tB(t,e){let i;e=e||1/0;let n=t.length,o=null,a=[];for(let r=0;r<n;++r){// is surrogate component
...
let tD=function(){let t="0123456789abcdef",e=Array(256);for(let i=0;i<16;++i){let n=16*i;for(let o=0;o<16;++o)e[n+o]=t[i]+t[o]}return e}();// Return not function with Error if BigInt not supported
...
t=t$(t),!i&&e?"["+t+"]":t)}).join(i?".":""):e}let tH=Y.toFlatObject(Y,{},null,function(t){return/^is[A-Z]/.test(t)});var tX=/**
...
i=t$(i),s.forEach(function(t,n){Y.isUndefined(t)||null===t||e.append(!0===r?tU([i],n,a):null===r?i:i+"[]",c(t))}),!1)}}return!!tF(t)||(e.append(tU(o,i,a),c(t)),!1)}let d=[],p=Object.assign(tH,{defaultVisitor:f,convertValue:c,isVisitable:tF});if(!Y.isObject(t))throw TypeError("data must be an object");return!function t(i,n){if(!Y.isUndefined(i)){if(-1!==d.indexOf(i))throw Error("Circular reference detected in "+n.join("."));d.push(i),Y.forEach(i,function(i,a){let r=!(Y.isUndefined(i)||null===i)&&o.call(e,i,Y.isString(a)?a.trim():a,n,p);!0===r&&t(i,n?n.concat(a):[a])}),d.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tG(t,e){this._pairs=[],t&&tX(t,this,e)}let tV=tG.prototype;/**
 ...
 *
 * @returns {boolean}
 */let t2=("undefined"==typeof navigator||"ReactNative"!==(n=navigator.product)&&"NativeScript"!==n&&"NS"!==n)&&"undefined"!=typeof window&&"undefined"!=typeof document,t5="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
...
let t8=Y.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
...
i.setAttribute("href",n),n=i.href),i.setAttribute("href",n),{href:i.href,protocol:i.protocol?i.protocol.replace(/:$/,""):"",host:i.host,search:i.search?i.search.replace(/^\?/,""):"",hash:i.hash?i.hash.replace(/^#/,""):"",hostname:i.hostname,port:i.port,pathname:"/"===i.pathname.charAt(0)?i.pathname:"/"+i.pathname}}/**
    ...
    */return t=n(window.location.href),function(e){let i=Y.isString(e)?n(e):e;return i.protocol===t.protocol&&i.host===t.host}}():function(){return!0},ed=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(t,e){let i;t=t||10;let n=Array(t),o=Array(t),a=0,r=0;return e=void 0!==e?e:1e3,function(s){let l=Date.now(),c=o[r];i||(i=l),n[a]=s,o[a]=l;let f=r,d=0;for(;f!==a;)d+=n[f++],f%=t;if((a=(a+1)%t)===r&&(r=(r+1)%t),l-i<e)return;let p=c&&l-c;return p?Math.round(1e3*d/p):void 0}};function ep(t,e){let i=0,n=ed(50,250);return o=>{let a=o.loaded,r=o.lengthComputable?o.total:void 0,s=a-i,l=n(s),c=a<=r;i=a;let f={loaded:a,total:r,progress:r?a/r:void 0,bytes:s,rate:l||void 0,estimated:l&&r&&c?(r-a)/l:void 0,event:o};f[e?"download":"upload"]=!0,t(f)}}let eu="undefined"!=typeof XMLHttpRequest;var em=eu&&function(t){return new Promise(function(e,i){let n,o=t.data,a=eo.from(t.headers).normalize(),r=t.responseType;function s(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}Y.isFormData(o)&&(t6.isStandardBrowserEnv||t6.isStandardBrowserWebWorkerEnv?a.setContentType(!1):a.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
...
void 0===o&&a.setContentType(null),"setRequestHeader"in l&&Y.forEach(a.toJSON(),function(t,e){l.setRequestHeader(e,t)}),Y.isUndefined(t.withCredentials)||(l.withCredentials=!!t.withCredentials),r&&"json"!==r&&(l.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&l.addEventListener("progress",ep(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&l.upload&&l.upload.addEventListener("progress",ep(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=e=>{l&&(i(!e||e.type?new es(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let d=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(c);if(d&&-1===t6.protocols.indexOf(d)){i(new K("Unsupported protocol "+d+":",K.ERR_BAD_REQUEST,t));return}// Send the request
l.send(o||null)})};let eh={http:null,xhr:em};Y.forEach(eh,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
e.data=ea.call(t,t.transformResponse,e),e.headers=eo.from(e.headers),e},function(e){return!er(e)&&(ey(t),e&&e.response&&(e.response.data=ea.call(t,t.transformResponse,e.response),e.response.headers=eo.from(e.response.headers))),Promise.reject(e)})}let eb=t=>t instanceof eo?t.toJSON():t;function ev(t,e){// eslint-disable-next-line no-param-reassign
...
function(){let t=ia.filter(({favorit:t})=>t);t.length!=ia.length&&io("cardData",ia=t),ia.length}(),t.map(t=>`
    ...
    <div class="photo-card">
        ...
        <button type="button" class="btn-favorite" >
                <svg class="icon-favorite${// атрибут класу для фавориту 
    function(t){let e=ia.findIndex(({_id:e})=>e===t);return e>-1&&ia[e].favorit?" add-fill":""}(t._id)}" data-set="${t._id}" viewBox="0 0 32 32">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join("")),function(){let t=document.querySelectorAll(".box-star");t.forEach(t=>{let e=t.previousElementSibling,i=Math.round(e.textContent),n=[...t.children];n.forEach((t,e)=>{e<i&&t.classList.add("yellow-star")})})}()}function id(t){eJ(t).then(t=>{!function(t){let{data:{title:e,youtube:i,thumb:n,rating:o,time:a,ingredients:r,tags:s,instructions:l}}=t,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),f=h.create(`<div class="card-modal">
...
function(t){let e=document.querySelector(".box-stars");document.querySelector(".star");let i=[...e.children],n=Math.round(t);i.forEach((t,e)=>{e<n&&t.classList.add("yellow-star")})}(o),document.body.style.overflow="hidden";let p=document.querySelector(".js-card-close-btn");document.querySelector(".card-modal"),p.addEventListener("click",()=>{document.body.style.overflow="auto",f.close()})}(t);let e=document.querySelector(".basicLightbox");e.classList.add("correct-recipe")}).catch(t=>{console.log(t)})}375>=window.outerWidth||window.outerWidth,il.addEventListener("click",function(t){if("BUTTON"===t.target.nodeName){let e=t.target.dataset.set;e&&id(t.target.dataset.set)}if("svg"===t.target.nodeName){let e=t.target.dataset.set;if(e){let t=is.querySelector(`svg[data-set="${e}"]`);// додати фаворіта 
(function(t){let e=ia.findIndex(({_id:e})=>e===t);e<0&&eJ(t).then(({data:t})=>(t.favorit=!0,ia.push(t),ia)).then(t=>{io("cardData",t)}).catch(()=>{console.log(error)})})(e),t.classList.add("add-fill")}}if("path"===t.target.nodeName){let e=t.target.farthestViewportElement.dataset.set;if(e){let t=is.querySelector(`svg[data-set="${e}"]`);// деактивувати фаворіта 
(function(t){let e=ia.findIndex(({_id:e})=>e===t);e>-1&&(ia[e].favorit=!1)})(e),t.classList.remove("add-fill")}}});var ip={};window,ip=/******/function(t){/******/// The module cache
 ...
 *     dh: 'dh'
 * });
 */function(t,e){var i=document.createElement("img"),o="";return n(e,function(t,e){o+="&"+e+"="+t}),o=o.substring(1),i.src=t+"?"+o,i.style.display="none",document.body.appendChild(i),document.body.removeChild(i),i};/***/}]);// посилання на Dom
let iu={allCategiries:document.querySelector(".categories-btn-all-js"),categories:document.querySelector(".categories-js"),popular:document.querySelector(".popular-change-js"),paginationShow:document.querySelector("#tui-pagination-container"),pagination:document.getElementById("tui-pagination-container")},im=window.innerWidth<768?6:window.innerWidth<1280?8:9,ih=1,ig=window.innerWidth<768?2:3,iy=new URLSearchParams({page:ih,limit:im}),ix={totalItems:0,itemsPerPage:im,visiblePages:ig,page:ih},ib=new/*@__PURE__*/(m(ip))(iu.pagination,ix);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
function iv(){ib.off("afterMove",iw),iN("page",1),e1(iy).then(t=>{ic(t.data.results),// встановлення слухача пагінації, відображення її
function(t){if(ib.reset(t*im),t>1){ib.on("afterMove",iw),iu.paginationShow.classList.remove("is-hidden");return}iu.paginationShow.classList.contains("is-hidden")||iu.paginationShow.classList.add("is-hidden"),t||/*@__PURE__*/m(ii).Notify.info("Вибачте, згідно параметрів пошуку рецептів не знайдено")}(t.data.totalPages)}).catch(()=>{})}// перемальовка рецептів при зміщенні пагінації
function iw(){iN("page",ih=ib.getCurrentPage()),e1(iy).then(t=>{ic(t.data.results)}).catch(()=>{})}// вибір "всіх категорій" по натисканню "AllCategories"
function ik(){iC(),iu.allCategiries.classList.add("is-active"),iT("category"),iv()}// вибір конкретної категорії
function iS(t){if("BUTTON"!==t.target.nodeName)return;iu.allCategiries.classList.contains("is-active")&&iu.allCategiries.classList.remove("is-active"),iC(),t.target.classList.add("is-active");let e=t.target.dataset.set;iN("category",e),iv()}// знімаємо помітку з активної категорії
function iC(){let t=iu.categories.querySelector(".is-active");t&&t.classList.remove("is-active")}// обробка вибору популярного рецепту
function iE(t){if("BUTTON"!==t.currentTarget.nodeName)return;let e=t.currentTarget.dataset.set;id(e)}// додавання/зміна параметру в об'єкт для пошуку рецепту
function iN(t,e){iy.has(t)&&iy.delete(t),iy.append(t,e)}// вилучення параметра в об'єкті пошуку рецепту
function iT(t){for(;iy.has(t);)iy.delete(t)}/**
  |============================
  | Refs hero
  |============================
...
iu.allCategiries.addEventListener("click",ik),iu.categories.addEventListener("click",iS),iu.popular.addEventListener("click",iE),// прибирання слухачів подій
window.addEventListener("unload",function(){iu.allCategiries.removeEventListener("click",ik),iu.categories.removeEventListener("click",iS),iu.popular.removeEventListener("click",iE),ib.off("afterMove",iw)}),eY().then(t=>{iu.categories.insertAdjacentHTML("beforeend",// формування розмітки переліку категорій
...
iv(),eK().then(t=>{iu.popular.insertAdjacentHTML("beforeend",t.data.map(t=>`
...
let e=iu.popular.querySelectorAll(".popular-button-js");e.forEach(t=>{t.addEventListener("click",iE)})}).catch(()=>{});let iA=iL();function iI(t){let e=/**
  |============================
  | Розмітка Swiper
  |============================
 ...
 * _.isObject(null);
 * // => false
 */function nk(t){var e=typeof t;return!!t&&("object"==e||"function"==e)}/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nS(t){if("number"==typeof t)return t;if("symbol"==typeof(e=t)||e&&"object"==typeof e&&"[object Symbol]"==nx.call(e))return nc;if(nk(t)){var e,i="function"==typeof t.valueOf?t.valueOf():t;t=nk(i)?i+"":i}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(nf,"");var n=np.test(t);return n||nu.test(t)?nm(t.slice(2),n?2:8):nd.test(t)?nc:+t}nl=/**
...
return void 0===l||i>=e||i<0||d&&n>=a}function h(){var t,i,n,o=nw();if(m(o))return g(o);// Restart the timer.
s=setTimeout(h,(t=o-l,i=o-c,n=e-t,d?nv(n,a-i):n))}function g(t){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(s=void 0,p&&n)?u(t):(n=o=void 0,r))}function y(){var t,i=nw(),a=m(i);if(n=arguments,o=this,l=i,a){if(void 0===s)return(// Reset any `maxWait` timer.
c=t=l,// Start the timer for the trailing edge.
s=setTimeout(h,e),f?u(t):r);if(d)return(// Handle invocations in a tight loop.
s=setTimeout(h,e),u(l))}return void 0===s&&(s=setTimeout(h,e)),r}return e=nS(e)||0,nk(i)&&(f=!!i.leading,a=(d="maxWait"in i)?nb(nS(i.maxWait)||0,e):a,p="trailing"in i?!!i.trailing:p),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nw())},y};let nC={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nC.form.addEventListener("submit",function(t){t.preventDefault()}),nC.time.addEventListener("change",function(t){iN("time",t.currentTarget.value),iv()}),nC.area.addEventListener("change",function(t){iN("area",t.currentTarget.value),iv()}),nC.ingredients.addEventListener("change",function(t){iN("ingredient",t.currentTarget.value),iv()}),nC.search.addEventListener("input",/*@__PURE__*/m(nl)(()=>{iN("title",nC.search.value.trim()),iv()},300)),eZ().then(t=>{nC.area.innerHTML=t.data.map(({name:t})=>`<option class="filter-opt" value="${t}">${t}</option>`).join("")}).catch(t=>{console.log(t)}),eQ().then(t=>{nC.ingredients.innerHTML=t.data.map(({name:t,_id:e})=>`<option class="filter-opt" value="${e}">${t}</option>`).join("")}).catch(t=>{}),// ❗ Створення Time ❗
function(){let t="";// ❗ ДОРОБИТИ ПРАВИЛЬНУ ЛОГІКУ ЧАСУ ❗
for(let e=0;e<220;e+=5)e%10==0&&(t+=`<option class="filter-opt" value="${e}">${e}</option>`);nC.time.insertAdjacentHTML("beforeend",t)}(),// ❗ Створення js-reset-filter-btn ❗
nC.resetBtn.addEventListener("click",function(t){iT("time"),iT("area"),iT("ingredient"),iT("title"),iv()})}();//# sourceMappingURL=index.4d557d07.js.map

//# sourceMappingURL=index.4d557d07.js.map
