...
info:function(e,t,n){p(i.Info,e,t,n)}}};return"object"==typeof e.Notiflix?s(!0,e.Notiflix,{Notify:d.Notify}):{Notify:d.Notify}},"function"==typeof define&&define.amd?define([],function(){return a(o)}):"object"==typeof g?g=a(o):o.Notiflix=a(o);// utils is a library of generic helper functions non-specific to axios
let{toString:x}=Object.prototype,{getPrototypeOf:b}=Object,v=(r=Object.create(null),e=>{let t=x.call(e);return r[t]||(r[t]=t.slice(8,-1).toLowerCase())}),w=e=>(e=e.toLowerCase(),t=>v(t)===e),k=e=>t=>typeof t===e,{isArray:S}=Array,C=k("undefined"),E=w("ArrayBuffer"),N=k("string"),T=k("function"),L=k("number"),A=e=>null!==e&&"object"==typeof e,M=e=>{if("object"!==v(e))return!1;let t=b(e);return(null===t||t===Object.prototype||null===Object.getPrototypeOf(t))&&!(Symbol.toStringTag in e)&&!(Symbol.iterator in e)},I=w("Date"),z=w("File"),O=w("Blob"),B=w("FileList"),P=w("URLSearchParams");/**
 ...
 * @returns {any}
 */function _(e,t,{allOwnKeys:i=!1}={}){let n,o;// Don't bother if no value provided
if(null!=e){if("object"!=typeof e&&/*eslint no-param-reassign:0*/(e=[e]),S(e))for(n=0,o=e.length;n<o;n++)t.call(null,e[n],n,e);else{let o;// Iterate over object keys
let a=i?Object.getOwnPropertyNames(e):Object.keys(e),r=a.length;for(n=0;n<r;n++)o=a[n],t.call(null,e[o],o,e)}}}function R(e,t){let i;t=t.toLowerCase();let n=Object.keys(e),o=n.length;for(;o-- >0;)if(t===(i=n[o]).toLowerCase())return i;return null}let D=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:u,j=e=>!C(e)&&e!==D,W=(s="undefined"!=typeof Uint8Array&&b(Uint8Array),e=>s&&e instanceof s),F=w("HTMLFormElement"),$=(({hasOwnProperty:e})=>(t,i)=>e.call(t,i))(Object.prototype),U=w("RegExp"),H=(e,t)=>{let i=Object.getOwnPropertyDescriptors(e),n={};_(i,(i,o)=>{let a;!1!==(a=t(i,o,e))&&(n[o]=a||i)}),Object.defineProperties(e,n)},X="abcdefghijklmnopqrstuvwxyz",q="0123456789",G={DIGIT:q,ALPHA:X,ALPHA_DIGIT:X+X.toUpperCase()+q},V=w("AsyncFunction");var Y={isArray:S,isArrayBuffer:E,isBuffer:/**
 * Determine if a value is a Buffer
 *
 * @param {*} val The value to test
 *
 * @returns {boolean} True if value is a Buffer, otherwise false
 */function(e){return null!==e&&!C(e)&&null!==e.constructor&&!C(e.constructor)&&T(e.constructor.isBuffer)&&e.constructor.isBuffer(e)},isFormData:e=>{let t;return e&&("function"==typeof FormData&&e instanceof FormData||T(e.append)&&("formdata"===(t=v(e))||// detect form-data instance
 ...
 */function(e){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(e):e&&e.buffer&&E(e.buffer)},isString:N,isNumber:L,isBoolean:e=>!0===e||!1===e,isObject:A,isPlainObject:M,isUndefined:C,isDate:I,isFile:z,isBlob:O,isRegExp:U,isFunction:T,isStream:e=>A(e)&&T(e.pipe),isURLSearchParams:P,isTypedArray:W,isFileList:B,forEach:_,merge:/**
 ...
 */function e(){let{caseless:t}=j(this)&&this||{},i={},n=(n,o)=>{let a=t&&R(i,o)||o;M(i[a])&&M(n)?i[a]=e(i[a],n):M(n)?i[a]=e({},n):S(n)?i[a]=n.slice():i[a]=n};for(let e=0,t=arguments.length;e<t;e++)arguments[e]&&_(arguments[e],n);return i},extend:(e,t,i,{allOwnKeys:n}={})=>(_(t,(t,n)=>{i&&T(t)?e[n]=y(t,i):e[n]=t},{allOwnKeys:n}),e),trim:e=>e.trim?e.trim():e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""),stripBOM:e=>(65279===e.charCodeAt(0)&&(e=e.slice(1)),e),inherits:(e,t,i,n)=>{e.prototype=Object.create(t.prototype,n),e.prototype.constructor=e,Object.defineProperty(e,"super",{value:t.prototype}),i&&Object.assign(e.prototype,i)},toFlatObject:(e,t,i,n)=>{let o,a,r;let s={};// eslint-disable-next-line no-eq-null,eqeqeq
if(t=t||{},null==e)return t;do{for(a=(o=Object.getOwnPropertyNames(e)).length;a-- >0;)r=o[a],(!n||n(r,e,t))&&!s[r]&&(t[r]=e[r],s[r]=!0);e=!1!==i&&b(e)}while(e&&(!i||i(e,t))&&e!==Object.prototype)return t},kindOf:v,kindOfTest:w,endsWith:(e,t,i)=>{e=String(e),(void 0===i||i>e.length)&&(i=e.length),i-=t.length;let n=e.indexOf(t,i);return -1!==n&&n===i},toArray:e=>{if(!e)return null;if(S(e))return e;let t=e.length;if(!L(t))return null;let i=Array(t);for(;t-- >0;)i[t]=e[t];return i},forEachEntry:(e,t)=>{let i;let n=e&&e[Symbol.iterator],o=n.call(e);for(;(i=o.next())&&!i.done;){let n=i.value;t.call(e,n[0],n[1])}},matchAll:(e,t)=>{let i;let n=[];for(;null!==(i=e.exec(t));)n.push(i);return n},isHTMLForm:F,hasOwnProperty:$,hasOwnProp:$,reduceDescriptors:H,freezeMethods:e=>{H(e,(t,i)=>{// skip restricted props in strict mode
if(T(e)&&-1!==["arguments","caller","callee"].indexOf(i))return!1;let n=e[i];if(T(n)){if(t.enumerable=!1,"writable"in t){t.writable=!1;return}t.set||(t.set=()=>{throw Error("Can not rewrite read-only method '"+i+"'")})}})},toObjectSet:(e,t)=>{let i={};return(e=>{e.forEach(e=>{i[e]=!0})})(S(e)?e:String(e).split(t)),i},toCamelCase:e=>e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(e,t,i){return t.toUpperCase()+i}),noop:()=>{},toFiniteNumber:(e,t)=>Number.isFinite(e=+e)?e:t,findKey:R,global:D,isContextDefined:j,ALPHABET:G,generateString:(e=16,t=G.ALPHA_DIGIT)=>{let i="",{length:n}=t;for(;e--;)i+=t[Math.random()*n|0];return i},isSpecCompliantForm:/**
 * If the thing is a FormData object, return true, otherwise return false.
 *
 * @param {unknown} thing - The thing to check.
 *
 * @returns {boolean}
 */function(e){return!!(e&&T(e.append)&&"FormData"===e[Symbol.toStringTag]&&e[Symbol.iterator])},toJSONObject:e=>{let t=Array(10),i=(e,n)=>{if(A(e)){if(t.indexOf(e)>=0)return;if(!("toJSON"in e)){t[n]=e;let o=S(e)?[]:{};return _(e,(e,t)=>{let a=i(e,n+1);C(a)||(o[t]=a)}),t[n]=void 0,o}}return e};return i(e,0)},isAsyncFn:V,isThenable:e=>e&&(A(e)||T(e))&&T(e.then)&&T(e.catch)};/**
 ...
 */function K(e,t,i,n,o){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack,this.message=e,this.name="AxiosError",t&&(this.code=t),i&&(this.config=i),n&&(this.request=n),o&&(this.response=o)}Y.inherits(K,Error,{toJSON:function(){return{// Standard
message:this.message,name:this.name,// Microsoft
description:this.description,number:this.number,// Mozilla
fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,// Axios
config:Y.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});let J=K.prototype,Q={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(e=>{Q[e]={value:e}}),Object.defineProperties(K,Q),Object.defineProperty(J,"isAxiosError",{value:!0}),// eslint-disable-next-line func-names
K.from=(e,t,i,n,o,a)=>{let r=Object.create(J);return Y.toFlatObject(e,r,function(e){return e!==Error.prototype},e=>"isAxiosError"!==e),K.call(r,e.message,t,i,n,o),r.cause=e,r.name=e.name,a&&Object.assign(r,a),r},f=function(e){// go through the array every three bytes, we'll deal with trailing stuff later
for(var t,i=e.length,n=i%3// if we have 1 byte left, pad 2 bytes
,o=[],a=0,r=i-n;a<r;a+=16383// must be multiple of 3
)o.push(function(e,t,i){for(var n,o=[],a=t;a<i;a+=3)o.push(Z[(n=(e[a]<<16&16711680)+(e[a+1]<<8&65280)+(255&e[a+2]))>>18&63]+Z[n>>12&63]+Z[n>>6&63]+Z[63&n]);return o.join("")}(e,a,a+16383>r?r:a+16383));return 1===n?o.push(Z[(t=e[i-1])>>2]+Z[t<<4&63]+"=="):2===n&&o.push(Z[(t=(e[i-2]<<8)+e[i-1])>>10]+Z[t>>4&63]+Z[t<<2&63]+"="),o.join("")};for(var Z=[],ee=[],et="undefined"!=typeof Uint8Array?Uint8Array:Array,ei="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",en=0,eo=ei.length;en<eo;++en)Z[en]=ei[en],ee[ei.charCodeAt(en)]=en;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
ee["-".charCodeAt(0)]=62,ee["_".charCodeAt(0)]=63,p=function(e,t,i,n,o){var a,r,s=8*o-n-1,l=(1<<s)-1,c=l>>1,f=-7,p=i?o-1:0,d=i?-1:1,u=e[t+p];for(p+=d,a=u&(1<<-f)-1,u>>=-f,f+=s;f>0;a=256*a+e[t+p],p+=d,f-=8);for(r=a&(1<<-f)-1,a>>=-f,f+=n;f>0;r=256*r+e[t+p],p+=d,f-=8);if(0===a)a=1-c;else{if(a===l)return r?NaN:(u?-1:1)*(1/0);r+=Math.pow(2,n),a-=c}return(u?-1:1)*r*Math.pow(2,a-n)},d=function(e,t,i,n,o,a){var r,s,l,c=8*a-o-1,f=(1<<c)-1,p=f>>1,d=23===o?5960464477539062e-23:0,u=n?0:a-1,m=n?1:-1,h=t<0||0===t&&1/t<0?1:0;for(isNaN(t=Math.abs(t))||t===1/0?(s=isNaN(t)?1:0,r=f):(r=Math.floor(Math.log(t)/Math.LN2),t*(l=Math.pow(2,-r))<1&&(r--,l*=2),r+p>=1?t+=d/l:t+=d*Math.pow(2,1-p),t*l>=2&&(r++,l/=2),r+p>=f?(s=0,r=f):r+p>=1?(s=(t*l-1)*Math.pow(2,o),r+=p):(s=t*Math.pow(2,p-1)*Math.pow(2,o),r=0));o>=8;e[i+u]=255&s,u+=m,s/=256,o-=8);for(r=r<<o|s,c+=o;c>0;e[i+u]=255&r,u+=m,r/=256,c-=8);e[i+u-m]|=128*h};let ea="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
 ...
 */function es(e,t,i){// Common case.
if("number"==typeof e){if("string"==typeof t)throw TypeError('The "string" argument must be of type string. Received type number');return ef(e)}return el(e,t,i)}function el(e,t,i){if("string"==typeof e)return function(e,t){if(("string"!=typeof t||""===t)&&(t="utf8"),!es.isEncoding(t))throw TypeError("Unknown encoding: "+t);let i=0|em(e,t),n=er(i),o=n.write(e,t);return o!==i&&// cause everything after the first invalid character to be ignored. (e.g.
// 'abxxcd' will be treated as 'ab')
(n=n.slice(0,o)),n}(e,t);if(ArrayBuffer.isView(e))return function(e){if(eR(e,Uint8Array)){let t=new Uint8Array(e);return ed(t.buffer,t.byteOffset,t.byteLength)}return ep(e)}(e);if(null==e)throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof e);if(eR(e,ArrayBuffer)||e&&eR(e.buffer,ArrayBuffer)||"undefined"!=typeof SharedArrayBuffer&&(eR(e,SharedArrayBuffer)||e&&eR(e.buffer,SharedArrayBuffer)))return ed(e,t,i);if("number"==typeof e)throw TypeError('The "value" argument must not be of type number. Received type number');let n=e.valueOf&&e.valueOf();if(null!=n&&n!==e)return es.from(n,t,i);let o=function(e){var t;if(es.isBuffer(e)){let t=0|eu(e.length),i=er(t);return 0===i.length||e.copy(i,0,0,t),i}return void 0!==e.length?"number"!=typeof e.length||(t=e.length)!=t// eslint-disable-line no-self-compare
?er(0):ep(e):"Buffer"===e.type&&Array.isArray(e.data)?ep(e.data):void 0}(e);if(o)return o;if("undefined"!=typeof Symbol&&null!=Symbol.toPrimitive&&"function"==typeof e[Symbol.toPrimitive])return es.from(e[Symbol.toPrimitive]("string"),t,i);throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof e)}function ec(e){if("number"!=typeof e)throw TypeError('"size" argument must be of type number');if(e<0)throw RangeError('The value "'+e+'" is invalid for option "size"')}function ef(e){return ec(e),er(e<0?0:0|eu(e))}function ep(e){let t=e.length<0?0:0|eu(e.length),i=er(t);for(let n=0;n<t;n+=1)i[n]=255&e[n];return i}function ed(e,t,i){let n;if(t<0||e.byteLength<t)throw RangeError('"offset" is outside of buffer bounds');if(e.byteLength<t+(i||0))throw RangeError('"length" is outside of buffer bounds');return(// Return an augmented `Uint8Array` instance
Object.setPrototypeOf(n=void 0===t&&void 0===i?new Uint8Array(e):void 0===i?new Uint8Array(e,t):new Uint8Array(e,t,i),es.prototype),n)}function eu(e){// Note: cannot use `length < K_MAX_LENGTH` here because that fails when
// length is NaN (which is otherwise coerced to zero.)
if(e>=2147483647)throw RangeError("Attempt to allocate Buffer larger than maximum size: 0x7fffffff bytes");return 0|e}function em(e,t){if(es.isBuffer(e))return e.length;if(ArrayBuffer.isView(e)||eR(e,ArrayBuffer))return e.byteLength;if("string"!=typeof e)throw TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof e);let i=e.length,n=arguments.length>2&&!0===arguments[2];if(!n&&0===i)return 0;// Use a for loop to avoid recursion
let o=!1;for(;;)switch(t){case"ascii":case"latin1":case"binary":return i;case"utf8":case"utf-8":return eB(e).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*i;case"hex":return i>>>1;case"base64":return eP(e).length;default:if(o)return n?-1:eB(e).length// assume utf8
;t=(""+t).toLowerCase(),o=!0}}function eh(e,t,i){let n=!1;// Return early if start > this.length. Done here to prevent potential uint32
// coercion fail below.
...
(i>>>=0)<=(t>>>=0)))return"";for(e||(e="utf8");;)switch(e){case"hex":return function(e,t,i){let n=e.length;(!t||t<0)&&(t=0),(!i||i<0||i>n)&&(i=n);let o="";for(let n=t;n<i;++n)o+=eD[e[n]];return o}(this,t,i);case"utf8":case"utf-8":return eb(this,t,i);case"ascii":return function(e,t,i){let n="";i=Math.min(e.length,i);for(let o=t;o<i;++o)n+=String.fromCharCode(127&e[o]);return n}(this,t,i);case"latin1":case"binary":return function(e,t,i){let n="";i=Math.min(e.length,i);for(let o=t;o<i;++o)n+=String.fromCharCode(e[o]);return n}(this,t,i);case"base64":var o,a;return o=t,a=i,0===o&&a===this.length?f(this):f(this.slice(o,a));case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return function(e,t,i){let n=e.slice(t,i),o="";// If bytes.length is odd, the last 8 bits must be ignored (same as node.js)
for(let e=0;e<n.length-1;e+=2)o+=String.fromCharCode(n[e]+256*n[e+1]);return o}(this,t,i);default:if(n)throw TypeError("Unknown encoding: "+e);e=(e+"").toLowerCase(),n=!0}}function eg(e,t,i){let n=e[t];e[t]=e[i],e[i]=n}// Finds either the first index of `val` in `buffer` at offset >= `byteOffset`,
...
function ey(e,t,i,n,o){var a;// Empty buffer means no match
...
if("string"==typeof t&&(t=es.from(t,n)),es.isBuffer(t))return(// Special case: looking for empty string/buffer always fails
0===t.length?-1:ex(e,t,i,n,o));if("number"==typeof t)return(t&=255// Search for a byte value [0-255]
,"function"==typeof Uint8Array.prototype.indexOf)?o?Uint8Array.prototype.indexOf.call(e,t,i):Uint8Array.prototype.lastIndexOf.call(e,t,i):ex(e,[t],i,n,o);throw TypeError("val must be string, number or Buffer")}function ex(e,t,i,n,o){let a,r=1,s=e.length,l=t.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(e.length<2||t.length<2)return -1;r=2,s/=2,l/=2,i/=2}function c(e,t){return 1===r?e[t]:e.readUInt16BE(t*r)}if(o){let n=-1;for(a=i;a<s;a++)if(c(e,a)===c(t,-1===n?0:a-n)){if(-1===n&&(n=a),a-n+1===l)return n*r}else -1!==n&&(a-=a-n),n=-1}else for(i+l>s&&(i=s-l),a=i;a>=0;a--){let i=!0;for(let n=0;n<l;n++)if(c(e,a+n)!==c(t,n)){i=!1;break}if(i)return a}return -1}function eb(e,t,i){i=Math.min(e.length,i);let n=[],o=t;for(;o<i;){let t=e[o],a=null,r=t>239?4:t>223?3:t>191?2:1;if(o+r<=i){let i,n,s,l;switch(r){case 1:t<128&&(a=t);break;case 2:(192&(i=e[o+1]))==128&&(l=(31&t)<<6|63&i)>127&&(a=l);break;case 3:i=e[o+1],n=e[o+2],(192&i)==128&&(192&n)==128&&(l=(15&t)<<12|(63&i)<<6|63&n)>2047&&(l<55296||l>57343)&&(a=l);break;case 4:i=e[o+1],n=e[o+2],s=e[o+3],(192&i)==128&&(192&n)==128&&(192&s)==128&&(l=(15&t)<<18|(63&i)<<12|(63&n)<<6|63&s)>65535&&l<1114112&&(a=l)}}null===a?(// we did not generate a valid codePoint so insert a
 ...
 */function ev(e,t,i){if(e%1!=0||e<0)throw RangeError("offset is not uint");if(e+t>i)throw RangeError("Trying to access beyond buffer length")}function ew(e,t,i,n,o,a){if(!es.isBuffer(e))throw TypeError('"buffer" argument must be a Buffer instance');if(t>o||t<a)throw RangeError('"value" argument is out of bounds');if(i+n>e.length)throw RangeError("Index out of range")}function ek(e,t,i,n,o){eM(t,n,o,e,i,7);let a=Number(t&BigInt(4294967295));e[i++]=a,a>>=8,e[i++]=a,a>>=8,e[i++]=a,a>>=8,e[i++]=a;let r=Number(t>>BigInt(32)&BigInt(4294967295));return e[i++]=r,r>>=8,e[i++]=r,r>>=8,e[i++]=r,r>>=8,e[i++]=r,i}function eS(e,t,i,n,o){eM(t,n,o,e,i,7);let a=Number(t&BigInt(4294967295));e[i+7]=a,a>>=8,e[i+6]=a,a>>=8,e[i+5]=a,a>>=8,e[i+4]=a;let r=Number(t>>BigInt(32)&BigInt(4294967295));return e[i+3]=r,r>>=8,e[i+2]=r,r>>=8,e[i+1]=r,r>>=8,e[i]=r,i+8}function eC(e,t,i,n,o,a){if(i+n>e.length||i<0)throw RangeError("Index out of range")}function eE(e,t,i,n,o){return t=+t,i>>>=0,o||eC(e,t,i,4,34028234663852886e22,-34028234663852886e22),d(e,t,i,n,23,4),i+4}function eN(e,t,i,n,o){return t=+t,i>>>=0,o||eC(e,t,i,8,17976931348623157e292,-17976931348623157e292),d(e,t,i,n,52,8),i+8}/**
 ...
 **/es.from=function(e,t,i){return el(e,t,i)},// Note: Change prototype *after* Buffer.from is defined to workaround Chrome bug:
// https://github.com/feross/buffer/pull/148
Object.setPrototypeOf(es.prototype,Uint8Array.prototype),Object.setPrototypeOf(es,Uint8Array),/**
 * Creates a new filled Buffer instance.
 * alloc(size[, fill[, encoding]])
 **/es.alloc=function(e,t,i){return(ec(e),e<=0)?er(e):void 0!==t?"string"==typeof i?er(e).fill(t,i):er(e).fill(t):er(e)},/**
 * Equivalent to Buffer(num), by default creates a non-zero-filled Buffer instance.
 * */es.allocUnsafe=function(e){return ef(e)},/**
 * Equivalent to SlowBuffer(num), by default creates a non-zero-filled Buffer instance.
 */es.allocUnsafeSlow=function(e){return ef(e)},es.isBuffer=function(e){return null!=e&&!0===e._isBuffer&&e!==es.prototype// so Buffer.isBuffer(Buffer.prototype) will be false
},es.compare=function(e,t){if(eR(e,Uint8Array)&&(e=es.from(e,e.offset,e.byteLength)),eR(t,Uint8Array)&&(t=es.from(t,t.offset,t.byteLength)),!es.isBuffer(e)||!es.isBuffer(t))throw TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(e===t)return 0;let i=e.length,n=t.length;for(let o=0,a=Math.min(i,n);o<a;++o)if(e[o]!==t[o]){i=e[o],n=t[o];break}return i<n?-1:n<i?1:0},es.isEncoding=function(e){switch(String(e).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},es.concat=function(e,t){let i;if(!Array.isArray(e))throw TypeError('"list" argument must be an Array of Buffers');if(0===e.length)return es.alloc(0);if(void 0===t)for(i=0,t=0;i<e.length;++i)t+=e[i].length;let n=es.allocUnsafe(t),o=0;for(i=0;i<e.length;++i){let t=e[i];if(eR(t,Uint8Array))o+t.length>n.length?(es.isBuffer(t)||(t=es.from(t)),t.copy(n,o)):Uint8Array.prototype.set.call(n,t,o);else if(es.isBuffer(t))t.copy(n,o);else throw TypeError('"list" argument must be an Array of Buffers');o+=t.length}return n},es.byteLength=em,// This property is used by `Buffer.isBuffer` (and the `is-buffer` npm package)
// to detect a Buffer instance. It's not possible to use `instanceof Buffer`
// reliably in a browserify context because there could be multiple different
// copies of the 'buffer' package in use. This method works even for Buffer
// instances that were created from another copy of the `buffer` package.
// See: https://github.com/feross/buffer/issues/154
es.prototype._isBuffer=!0,es.prototype.swap16=function(){let e=this.length;if(e%2!=0)throw RangeError("Buffer size must be a multiple of 16-bits");for(let t=0;t<e;t+=2)eg(this,t,t+1);return this},es.prototype.swap32=function(){let e=this.length;if(e%4!=0)throw RangeError("Buffer size must be a multiple of 32-bits");for(let t=0;t<e;t+=4)eg(this,t,t+3),eg(this,t+1,t+2);return this},es.prototype.swap64=function(){let e=this.length;if(e%8!=0)throw RangeError("Buffer size must be a multiple of 64-bits");for(let t=0;t<e;t+=8)eg(this,t,t+7),eg(this,t+1,t+6),eg(this,t+2,t+5),eg(this,t+3,t+4);return this},es.prototype.toString=function(){let e=this.length;return 0===e?"":0==arguments.length?eb(this,0,e):eh.apply(this,arguments)},es.prototype.toLocaleString=es.prototype.toString,es.prototype.equals=function(e){if(!es.isBuffer(e))throw TypeError("Argument must be a Buffer");return this===e||0===es.compare(this,e)},es.prototype.inspect=function(){let e="";return e=this.toString("hex",0,50).replace(/(.{2})/g,"$1 ").trim(),this.length>50&&(e+=" ... "),"<Buffer "+e+">"},ea&&(es.prototype[ea]=es.prototype.inspect),es.prototype.compare=function(e,t,i,n,o){if(eR(e,Uint8Array)&&(e=es.from(e,e.offset,e.byteLength)),!es.isBuffer(e))throw TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof e);if(void 0===t&&(t=0),void 0===i&&(i=e?e.length:0),void 0===n&&(n=0),void 0===o&&(o=this.length),t<0||i>e.length||n<0||o>this.length)throw RangeError("out of range index");if(n>=o&&t>=i)return 0;if(n>=o)return -1;if(t>=i)return 1;if(t>>>=0,i>>>=0,n>>>=0,o>>>=0,this===e)return 0;let a=o-n,r=i-t,s=Math.min(a,r),l=this.slice(n,o),c=e.slice(t,i);for(let e=0;e<s;++e)if(l[e]!==c[e]){a=l[e],r=c[e];break}return a<r?-1:r<a?1:0},es.prototype.includes=function(e,t,i){return -1!==this.indexOf(e,t,i)},es.prototype.indexOf=function(e,t,i){return ey(this,e,t,i,!0)},es.prototype.lastIndexOf=function(e,t,i){return ey(this,e,t,i,!1)},es.prototype.write=function(e,t,i,n){var o,a,r,s,l,c,f,p;// Buffer#write(string)
if(void 0===t)n="utf8",i=this.length,t=0;else if(void 0===i&&"string"==typeof t)n=t,i=this.length,t=0;else if(isFinite(t))t>>>=0,isFinite(i)?(i>>>=0,void 0===n&&(n="utf8")):(n=i,i=void 0);else throw Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");let d=this.length-t;if((void 0===i||i>d)&&(i=d),e.length>0&&(i<0||t<0)||t>this.length)throw RangeError("Attempt to write outside buffer bounds");n||(n="utf8");let u=!1;for(;;)switch(n){case"hex":return function(e,t,i,n){let o;i=Number(i)||0;let a=e.length-i;n?(n=Number(n))>a&&(n=a):n=a;let r=t.length;for(n>r/2&&(n=r/2),o=0;o<n;++o){let n=parseInt(t.substr(2*o,2),16);if(n!=n)break;e[i+o]=n}return o}(this,e,t,i);case"utf8":case"utf-8":return o=t,a=i,e_(eB(e,this.length-o),this,o,a);case"ascii":case"latin1":case"binary":return r=t,s=i,e_(function(e){let t=[];for(let i=0;i<e.length;++i)t.push(255&e.charCodeAt(i));return t}(e),this,r,s);case"base64":// Warning: maxLength not taken into account in base64Write
return l=t,c=i,e_(eP(e),this,l,c);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return f=t,p=i,e_(function(e,t){let i,n;let o=[];for(let a=0;a<e.length&&!((t-=2)<0);++a)n=(i=e.charCodeAt(a))>>8,o.push(i%256),o.push(n);return o}(e,this.length-f),this,f,p);default:if(u)throw TypeError("Unknown encoding: "+n);n=(""+n).toLowerCase(),u=!0}},es.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}},es.prototype.slice=function(e,t){let i=this.length;e=~~e,t=void 0===t?i:~~t,e<0?(e+=i)<0&&(e=0):e>i&&(e=i),t<0?(t+=i)<0&&(t=0):t>i&&(t=i),t<e&&(t=e);let n=this.subarray(e,t);return(// Return an augmented `Uint8Array` instance
Object.setPrototypeOf(n,es.prototype),n)},es.prototype.readUintLE=es.prototype.readUIntLE=function(e,t,i){e>>>=0,t>>>=0,i||ev(e,t,this.length);let n=this[e],o=1,a=0;for(;++a<t&&(o*=256);)n+=this[e+a]*o;return n},es.prototype.readUintBE=es.prototype.readUIntBE=function(e,t,i){e>>>=0,t>>>=0,i||ev(e,t,this.length);let n=this[e+--t],o=1;for(;t>0&&(o*=256);)n+=this[e+--t]*o;return n},es.prototype.readUint8=es.prototype.readUInt8=function(e,t){return e>>>=0,t||ev(e,1,this.length),this[e]},es.prototype.readUint16LE=es.prototype.readUInt16LE=function(e,t){return e>>>=0,t||ev(e,2,this.length),this[e]|this[e+1]<<8},es.prototype.readUint16BE=es.prototype.readUInt16BE=function(e,t){return e>>>=0,t||ev(e,2,this.length),this[e]<<8|this[e+1]},es.prototype.readUint32LE=es.prototype.readUInt32LE=function(e,t){return e>>>=0,t||ev(e,4,this.length),(this[e]|this[e+1]<<8|this[e+2]<<16)+16777216*this[e+3]},es.prototype.readUint32BE=es.prototype.readUInt32BE=function(e,t){return e>>>=0,t||ev(e,4,this.length),16777216*this[e]+(this[e+1]<<16|this[e+2]<<8|this[e+3])},es.prototype.readBigUInt64LE=ej(function(e){eI(e>>>=0,"offset");let t=this[e],i=this[e+7];(void 0===t||void 0===i)&&ez(e,this.length-8);let n=t+256*this[++e]+65536*this[++e]+16777216*this[++e],o=this[++e]+256*this[++e]+65536*this[++e]+16777216*i;return BigInt(n)+(BigInt(o)<<BigInt(32))}),es.prototype.readBigUInt64BE=ej(function(e){eI(e>>>=0,"offset");let t=this[e],i=this[e+7];(void 0===t||void 0===i)&&ez(e,this.length-8);let n=16777216*t+65536*this[++e]+256*this[++e]+this[++e],o=16777216*this[++e]+65536*this[++e]+256*this[++e]+i;return(BigInt(n)<<BigInt(32))+BigInt(o)}),es.prototype.readIntLE=function(e,t,i){e>>>=0,t>>>=0,i||ev(e,t,this.length);let n=this[e],o=1,a=0;for(;++a<t&&(o*=256);)n+=this[e+a]*o;return n>=(o*=128)&&(n-=Math.pow(2,8*t)),n},es.prototype.readIntBE=function(e,t,i){e>>>=0,t>>>=0,i||ev(e,t,this.length);let n=t,o=1,a=this[e+--n];for(;n>0&&(o*=256);)a+=this[e+--n]*o;return a>=(o*=128)&&(a-=Math.pow(2,8*t)),a},es.prototype.readInt8=function(e,t){return(e>>>=0,t||ev(e,1,this.length),128&this[e])?-((255-this[e]+1)*1):this[e]},es.prototype.readInt16LE=function(e,t){e>>>=0,t||ev(e,2,this.length);let i=this[e]|this[e+1]<<8;return 32768&i?4294901760|i:i},es.prototype.readInt16BE=function(e,t){e>>>=0,t||ev(e,2,this.length);let i=this[e+1]|this[e]<<8;return 32768&i?4294901760|i:i},es.prototype.readInt32LE=function(e,t){return e>>>=0,t||ev(e,4,this.length),this[e]|this[e+1]<<8|this[e+2]<<16|this[e+3]<<24},es.prototype.readInt32BE=function(e,t){return e>>>=0,t||ev(e,4,this.length),this[e]<<24|this[e+1]<<16|this[e+2]<<8|this[e+3]},es.prototype.readBigInt64LE=ej(function(e){eI(e>>>=0,"offset");let t=this[e],i=this[e+7];(void 0===t||void 0===i)&&ez(e,this.length-8);let n=this[e+4]+256*this[e+5]+65536*this[e+6]+(i<<24// Overflow
);return(BigInt(n)<<BigInt(32))+BigInt(t+256*this[++e]+65536*this[++e]+16777216*this[++e])}),es.prototype.readBigInt64BE=ej(function(e){eI(e>>>=0,"offset");let t=this[e],i=this[e+7];(void 0===t||void 0===i)&&ez(e,this.length-8);let n=(t<<24)+// Overflow
65536*this[++e]+256*this[++e]+this[++e];return(BigInt(n)<<BigInt(32))+BigInt(16777216*this[++e]+65536*this[++e]+256*this[++e]+i)}),es.prototype.readFloatLE=function(e,t){return e>>>=0,t||ev(e,4,this.length),p(this,e,!0,23,4)},es.prototype.readFloatBE=function(e,t){return e>>>=0,t||ev(e,4,this.length),p(this,e,!1,23,4)},es.prototype.readDoubleLE=function(e,t){return e>>>=0,t||ev(e,8,this.length),p(this,e,!0,52,8)},es.prototype.readDoubleBE=function(e,t){return e>>>=0,t||ev(e,8,this.length),p(this,e,!1,52,8)},es.prototype.writeUintLE=es.prototype.writeUIntLE=function(e,t,i,n){if(e=+e,t>>>=0,i>>>=0,!n){let n=Math.pow(2,8*i)-1;ew(this,e,t,i,n,0)}let o=1,a=0;for(this[t]=255&e;++a<i&&(o*=256);)this[t+a]=e/o&255;return t+i},es.prototype.writeUintBE=es.prototype.writeUIntBE=function(e,t,i,n){if(e=+e,t>>>=0,i>>>=0,!n){let n=Math.pow(2,8*i)-1;ew(this,e,t,i,n,0)}let o=i-1,a=1;for(this[t+o]=255&e;--o>=0&&(a*=256);)this[t+o]=e/a&255;return t+i},es.prototype.writeUint8=es.prototype.writeUInt8=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,1,255,0),this[t]=255&e,t+1},es.prototype.writeUint16LE=es.prototype.writeUInt16LE=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,2,65535,0),this[t]=255&e,this[t+1]=e>>>8,t+2},es.prototype.writeUint16BE=es.prototype.writeUInt16BE=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,2,65535,0),this[t]=e>>>8,this[t+1]=255&e,t+2},es.prototype.writeUint32LE=es.prototype.writeUInt32LE=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,4,4294967295,0),this[t+3]=e>>>24,this[t+2]=e>>>16,this[t+1]=e>>>8,this[t]=255&e,t+4},es.prototype.writeUint32BE=es.prototype.writeUInt32BE=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,4,4294967295,0),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e,t+4},es.prototype.writeBigUInt64LE=ej(function(e,t=0){return ek(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))}),es.prototype.writeBigUInt64BE=ej(function(e,t=0){return eS(this,e,t,BigInt(0),BigInt("0xffffffffffffffff"))}),es.prototype.writeIntLE=function(e,t,i,n){if(e=+e,t>>>=0,!n){let n=Math.pow(2,8*i-1);ew(this,e,t,i,n-1,-n)}let o=0,a=1,r=0;for(this[t]=255&e;++o<i&&(a*=256);)e<0&&0===r&&0!==this[t+o-1]&&(r=1),this[t+o]=(e/a>>0)-r&255;return t+i},es.prototype.writeIntBE=function(e,t,i,n){if(e=+e,t>>>=0,!n){let n=Math.pow(2,8*i-1);ew(this,e,t,i,n-1,-n)}let o=i-1,a=1,r=0;for(this[t+o]=255&e;--o>=0&&(a*=256);)e<0&&0===r&&0!==this[t+o+1]&&(r=1),this[t+o]=(e/a>>0)-r&255;return t+i},es.prototype.writeInt8=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,1,127,-128),e<0&&(e=255+e+1),this[t]=255&e,t+1},es.prototype.writeInt16LE=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,2,32767,-32768),this[t]=255&e,this[t+1]=e>>>8,t+2},es.prototype.writeInt16BE=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,2,32767,-32768),this[t]=e>>>8,this[t+1]=255&e,t+2},es.prototype.writeInt32LE=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,4,2147483647,-2147483648),this[t]=255&e,this[t+1]=e>>>8,this[t+2]=e>>>16,this[t+3]=e>>>24,t+4},es.prototype.writeInt32BE=function(e,t,i){return e=+e,t>>>=0,i||ew(this,e,t,4,2147483647,-2147483648),e<0&&(e=4294967295+e+1),this[t]=e>>>24,this[t+1]=e>>>16,this[t+2]=e>>>8,this[t+3]=255&e,t+4},es.prototype.writeBigInt64LE=ej(function(e,t=0){return ek(this,e,t,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),es.prototype.writeBigInt64BE=ej(function(e,t=0){return eS(this,e,t,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),es.prototype.writeFloatLE=function(e,t,i){return eE(this,e,t,!0,i)},es.prototype.writeFloatBE=function(e,t,i){return eE(this,e,t,!1,i)},es.prototype.writeDoubleLE=function(e,t,i){return eN(this,e,t,!0,i)},es.prototype.writeDoubleBE=function(e,t,i){return eN(this,e,t,!1,i)},// copy(targetBuffer, targetStart=0, sourceStart=0, sourceEnd=buffer.length)
es.prototype.copy=function(e,t,i,n){if(!es.isBuffer(e))throw TypeError("argument should be a Buffer");// Copy 0 bytes; we're done
...
es.prototype.fill=function(e,t,i,n){let o;// Handle string cases:
if("string"==typeof e){if("string"==typeof t?(n=t,t=0,i=this.length):"string"==typeof i&&(n=i,i=this.length),void 0!==n&&"string"!=typeof n)throw TypeError("encoding must be a string");if("string"==typeof n&&!es.isEncoding(n))throw TypeError("Unknown encoding: "+n);if(1===e.length){let t=e.charCodeAt(0);("utf8"===n&&t<128||"latin1"===n)&&(e=t)}}else"number"==typeof e?e&=255:"boolean"==typeof e&&(e=Number(e));// Invalid ranges are not set to a default, so can range check early.
if(t<0||this.length<t||this.length<i)throw RangeError("Out of range index");if(i<=t)return this;if(t>>>=0,i=void 0===i?this.length:i>>>0,e||(e=0),"number"==typeof e)for(o=t;o<i;++o)this[o]=e;else{let a=es.isBuffer(e)?e:es.from(e,n),r=a.length;if(0===r)throw TypeError('The value "'+e+'" is invalid for argument "value"');for(o=0;o<i-t;++o)this[o+t]=a[o%r]}return this};// CUSTOM ERRORS
// =============
// Simplified versions from Node, changed for Buffer-only usage
let eT={};function eL(e,t,i){eT[e]=class extends i{constructor(){super(),Object.defineProperty(this,"message",{value:t.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
this.name=`${this.name} [${e}]`,// Access the stack to generate the error message including the error code
// from the name.
this.stack// eslint-disable-line no-unused-expressions
,// Reset the name to the actual name.
delete this.name}get code(){return e}set code(e){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:e,writable:!0})}toString(){return`${this.name} [${e}]: ${this.message}`}}}function eA(e){let t="",i=e.length,n="-"===e[0]?1:0;for(;i>=n+4;i-=3)t=`_${e.slice(i-3,i)}${t}`;return`${e.slice(0,i)}${t}`}function eM(e,t,i,n,o,a){if(e>i||e<t){let n;let o="bigint"==typeof t?"n":"";throw n=a>3?0===t||t===BigInt(0)?`>= 0${o} and < 2${o} ** ${(a+1)*8}${o}`:`>= -(2${o} ** ${(a+1)*8-1}${o}) and < 2 ** ${(a+1)*8-1}${o}`:`>= ${t}${o} and <= ${i}${o}`,new eT.ERR_OUT_OF_RANGE("value",n,e)}eI(o,"offset"),(void 0===n[o]||void 0===n[o+a])&&ez(o,n.length-(a+1))}function eI(e,t){if("number"!=typeof e)throw new eT.ERR_INVALID_ARG_TYPE(t,"number",e)}function ez(e,t,i){if(Math.floor(e)!==e)throw eI(e,i),new eT.ERR_OUT_OF_RANGE(i||"offset","an integer",e);if(t<0)throw new eT.ERR_BUFFER_OUT_OF_BOUNDS;throw new eT.ERR_OUT_OF_RANGE(i||"offset",`>= ${i?1:0} and <= ${t}`,e)}eL("ERR_BUFFER_OUT_OF_BOUNDS",function(e){return e?`${e} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),eL("ERR_INVALID_ARG_TYPE",function(e,t){return`The "${e}" argument must be of type number. Received type ${typeof t}`},TypeError),eL("ERR_OUT_OF_RANGE",function(e,t,i){let n=`The value of "${e}" is out of range.`,o=i;return Number.isInteger(i)&&Math.abs(i)>4294967296?o=eA(String(i)):"bigint"==typeof i&&(o=String(i),(i>BigInt(2)**BigInt(32)||i<-(BigInt(2)**BigInt(32)))&&(o=eA(o)),o+="n"),n+=` It must be ${t}. Received ${o}`},RangeError);// HELPER FUNCTIONS
// ================
let eO=/[^+/0-9A-Za-z-_]/g;function eB(e,t){let i;t=t||1/0;let n=e.length,o=null,a=[];for(let r=0;r<n;++r){// is surrogate component
...
if(o=null,i<128){if((t-=1)<0)break;a.push(i)}else if(i<2048){if((t-=2)<0)break;a.push(i>>6|192,63&i|128)}else if(i<65536){if((t-=3)<0)break;a.push(i>>12|224,i>>6&63|128,63&i|128)}else if(i<1114112){if((t-=4)<0)break;a.push(i>>18|240,i>>12&63|128,i>>6&63|128,63&i|128)}else throw Error("Invalid code point")}return a}function eP(e){return function(e){var t,i,n=function(e){var t=e.length;if(t%4>0)throw Error("Invalid string. Length must be a multiple of 4");// Trim off extra bytes after placeholder bytes are found
// See: https://github.com/beatgammit/base64-js/issues/42
var i=e.indexOf("=");-1===i&&(i=t);var n=i===t?0:4-i%4;return[i,n]}(e),o=n[0],a=n[1],r=new et((o+a)*3/4-a),s=0,l=a>0?o-4:o;for(i=0;i<l;i+=4)t=ee[e.charCodeAt(i)]<<18|ee[e.charCodeAt(i+1)]<<12|ee[e.charCodeAt(i+2)]<<6|ee[e.charCodeAt(i+3)],r[s++]=t>>16&255,r[s++]=t>>8&255,r[s++]=255&t;return 2===a&&(t=ee[e.charCodeAt(i)]<<2|ee[e.charCodeAt(i+1)]>>4,r[s++]=255&t),1===a&&(t=ee[e.charCodeAt(i)]<<10|ee[e.charCodeAt(i+1)]<<4|ee[e.charCodeAt(i+2)]>>2,r[s++]=t>>8&255,r[s++]=255&t),r}(function(e){// Node converts strings with length < 2 to ''
...
for(;e.length%4!=0;)e+="=";return e}(e))}function e_(e,t,i,n){let o;for(o=0;o<n&&!(o+i>=t.length)&&!(o>=e.length);++o)t[o+i]=e[o];return o}// ArrayBuffer or Uint8Array objects from other contexts (i.e. iframes) do not pass
...
let eD=function(){let e="0123456789abcdef",t=Array(256);for(let i=0;i<16;++i){let n=16*i;for(let o=0;o<16;++o)t[n+o]=e[i]+e[o]}return t}();// Return not function with Error if BigInt not supported
function ej(e){return"undefined"==typeof BigInt?eW:e}function eW(){throw Error("BigInt not supported")}/**
 * Determines if the given thing is a array or js object.
 *
 * @param {string} thing - The object or array to be visited.
 *
 * @returns {boolean}
 */function eF(e){return Y.isPlainObject(e)||Y.isArray(e)}/**
 * It removes the brackets from the end of a string
 *
 * @param {string} key - The key of the parameter.
 *
 * @returns {string} the key without the brackets.
 */function e$(e){return Y.endsWith(e,"[]")?e.slice(0,-2):e}/**
 ...
 */function eU(e,t,i){return e?e.concat(t).map(function(e,t){return(// eslint-disable-next-line no-param-reassign
e=e$(e),!i&&t?"["+e+"]":e)}).join(i?".":""):t}let eH=Y.toFlatObject(Y,{},null,function(e){return/^is[A-Z]/.test(e)});var eX=/**
 ...
 *
 * @returns
 */function(e,t,i){if(!Y.isObject(e))throw TypeError("target must be an object");// eslint-disable-next-line no-param-reassign
t=t||new FormData,// eslint-disable-next-line no-param-reassign
i=Y.toFlatObject(i,{metaTokens:!0,dots:!1,indexes:!1},!1,function(e,t){// eslint-disable-next-line no-eq-null,eqeqeq
return!Y.isUndefined(t[e])});let n=i.metaTokens,o=i.visitor||f,a=i.dots,r=i.indexes,s=i.Blob||"undefined"!=typeof Blob&&Blob,l=s&&Y.isSpecCompliantForm(t);if(!Y.isFunction(o))throw TypeError("visitor must be a function");function c(e){if(null===e)return"";if(Y.isDate(e))return e.toISOString();if(!l&&Y.isBlob(e))throw new K("Blob is not supported. Use a Buffer instead.");return Y.isArrayBuffer(e)||Y.isTypedArray(e)?l&&"function"==typeof Blob?new Blob([e]):es.from(e):e}/**
   * Default visitor.
   *
   * @param {*} value
   ...
   */function f(e,i,o){let s=e;if(e&&!o&&"object"==typeof e){if(Y.endsWith(i,"{}"))// eslint-disable-next-line no-param-reassign
i=n?i:i.slice(0,-2),// eslint-disable-next-line no-param-reassign
e=JSON.stringify(e);else{var l;if(Y.isArray(e)&&(l=e,Y.isArray(l)&&!l.some(eF))||(Y.isFileList(e)||Y.endsWith(i,"[]"))&&(s=Y.toArray(e)))return(// eslint-disable-next-line no-param-reassign
i=e$(i),s.forEach(function(e,n){Y.isUndefined(e)||null===e||t.append(!0===r?eU([i],n,a):null===r?i:i+"[]",c(e))}),!1)}}return!!eF(e)||(t.append(eU(o,i,a),c(e)),!1)}let p=[],d=Object.assign(eH,{defaultVisitor:f,convertValue:c,isVisitable:eF});if(!Y.isObject(e))throw TypeError("data must be an object");return!function e(i,n){if(!Y.isUndefined(i)){if(-1!==p.indexOf(i))throw Error("Circular reference detected in "+n.join("."));p.push(i),Y.forEach(i,function(i,a){let r=!(Y.isUndefined(i)||null===i)&&o.call(t,i,Y.isString(a)?a.trim():a,n,d);!0===r&&e(i,n?n.concat(a):[a])}),p.pop()}}(e),t};/**
 ...
 *
 * @returns {void}
 */function eG(e,t){this._pairs=[],e&&eX(e,this,t)}let eV=eG.prototype;/**
 ...
 */function eY(e){return encodeURIComponent(e).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function eK(e,t,i){let n;/*eslint no-param-reassign:0*/if(!t)return e;let o=i&&i.encode||eY,a=i&&i.serialize;if(n=a?a(t,i):Y.isURLSearchParams(t)?t.toString():new eG(t,i).toString(o)){let t=e.indexOf("#");-1!==t&&(e=e.slice(0,t)),e+=(-1===e.indexOf("?")?"?":"&")+n}return e}eV.append=function(e,t){this._pairs.push([e,t])},eV.toString=function(e){let t=e?function(t){return e.call(this,t,eq)}:eq;return this._pairs.map(function(e){return t(e[0])+"="+t(e[1])},"").join("&")};var eJ=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(e){Y.forEach(this.handlers,function(t){null!==t&&e(t)})}},eQ={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},eZ="undefined"!=typeof URLSearchParams?URLSearchParams:eG,e0="undefined"!=typeof FormData?FormData:null,e1="undefined"!=typeof Blob?Blob:null;/**
 ...
 *
 * @returns {boolean}
 */let e2=("undefined"==typeof navigator||"ReactNative"!==(n=navigator.product)&&"NativeScript"!==n&&"NS"!==n)&&"undefined"!=typeof window&&"undefined"!=typeof document,e5="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var e6={classes:{URLSearchParams:eZ,FormData:e0,Blob:e1},isStandardBrowserEnv:e2,isStandardBrowserWebWorkerEnv:e5,protocols:["http","https","file","blob","url","data"]},e3=/**
 * It takes a FormData object and returns a JavaScript object
 *
 * @param {string} formData The FormData object to convert to JSON.
 *
 * @returns {Object<string, any> | null} The converted object.
 */function(e){if(Y.isFormData(e)&&Y.isFunction(e.entries)){let t={};return Y.forEachEntry(e,(e,i)=>{!function e(t,i,n,o){let a=t[o++],r=Number.isFinite(+a),s=o>=t.length;if(a=!a&&Y.isArray(n)?n.length:a,s)return Y.hasOwnProp(n,a)?n[a]=[n[a],i]:n[a]=i,!r;n[a]&&Y.isObject(n[a])||(n[a]=[]);let l=e(t,i,n[a],o);return l&&Y.isArray(n[a])&&(n[a]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(e){let t,i;let n={},o=Object.keys(e),a=o.length;for(t=0;t<a;t++)n[i=o[t]]=e[i];return n}(n[a])),!r}(Y.matchAll(/\w+|\[(\w*)]/g,e).map(e=>"[]"===e[0]?"":e[1]||e[0]),i,t,0)}),t}return null};let e4={transitional:eQ,adapter:e6.isNode?"http":"xhr",transformRequest:[function(e,t){let i;let n=t.getContentType()||"",o=n.indexOf("application/json")>-1,a=Y.isObject(e);a&&Y.isHTMLForm(e)&&(e=new FormData(e));let r=Y.isFormData(e);if(r)return o&&o?JSON.stringify(e3(e)):e;if(Y.isArrayBuffer(e)||Y.isBuffer(e)||Y.isStream(e)||Y.isFile(e)||Y.isBlob(e))return e;if(Y.isArrayBufferView(e))return e.buffer;if(Y.isURLSearchParams(e))return t.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),e.toString();if(a){if(n.indexOf("application/x-www-form-urlencoded")>-1){var s,l;return(s=e,l=this.formSerializer,eX(s,new e6.classes.URLSearchParams,Object.assign({visitor:function(e,t,i,n){return e6.isNode&&Y.isBuffer(e)?(this.append(t,e.toString("base64")),!1):n.defaultVisitor.apply(this,arguments)}},l))).toString()}if((i=Y.isFileList(e))||n.indexOf("multipart/form-data")>-1){let t=this.env&&this.env.FormData;return eX(i?{"files[]":e}:e,t&&new t,this.formSerializer)}}return a||o?(t.setContentType("application/json",!1),/**
 ...
 */function(e,t,i){if(Y.isString(e))try{return(0,JSON.parse)(e),Y.trim(e)}catch(e){if("SyntaxError"!==e.name)throw e}return(0,JSON.stringify)(e)}(e)):e}],transformResponse:[function(e){let t=this.transitional||e4.transitional,i=t&&t.forcedJSONParsing,n="json"===this.responseType;if(e&&Y.isString(e)&&(i&&!this.responseType||n)){let i=t&&t.silentJSONParsing;try{return JSON.parse(e)}catch(e){if(!i&&n){if("SyntaxError"===e.name)throw K.from(e,K.ERR_BAD_RESPONSE,this,null,this.response);throw e}}}return e}],/**
   * A timeout in milliseconds to abort a request. If set to 0 (default) a
   * timeout is not created.
   */timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:e6.classes.FormData,Blob:e6.classes.Blob},validateStatus:function(e){return e>=200&&e<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};Y.forEach(["delete","get","head","post","put","patch"],e=>{e4.headers[e]={}});// RawAxiosHeaders whose duplicates are ignored by node
// c.f. https://nodejs.org/api/http.html#http_message_headers
let e8=Y.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */e9=e=>{let t,i,n;let o={};return e&&e.split("\n").forEach(function(e){n=e.indexOf(":"),t=e.substring(0,n).trim().toLowerCase(),i=e.substring(n+1).trim(),!t||o[t]&&e8[t]||("set-cookie"===t?o[t]?o[t].push(i):o[t]=[i]:o[t]=o[t]?o[t]+", "+i:i)}),o};let e7=Symbol("internals");function te(e){return e&&String(e).trim().toLowerCase()}function tt(e){return!1===e||null==e?e:Y.isArray(e)?e.map(tt):String(e)}let ti=e=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim());function tn(e,t,i,n,o){if(Y.isFunction(n))return n.call(this,t,i);if(o&&(t=i),Y.isString(t)){if(Y.isString(n))return -1!==t.indexOf(n);if(Y.isRegExp(n))return n.test(t)}}class to{constructor(e){e&&this.set(e)}set(e,t,i){let n=this;function o(e,t,i){let o=te(t);if(!o)throw Error("header name must be a non-empty string");let a=Y.findKey(n,o);a&&void 0!==n[a]&&!0!==i&&(void 0!==i||!1===n[a])||(n[a||t]=tt(e))}let a=(e,t)=>Y.forEach(e,(e,i)=>o(e,i,t));return Y.isPlainObject(e)||e instanceof this.constructor?a(e,t):Y.isString(e)&&(e=e.trim())&&!ti(e)?a(e9(e),t):null!=e&&o(t,e,i),this}get(e,t){if(e=te(e)){let i=Y.findKey(this,e);if(i){let e=this[i];if(!t)return e;if(!0===t)return function(e){let t;let i=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;t=n.exec(e);)i[t[1]]=t[2];return i}(e);if(Y.isFunction(t))return t.call(this,e,i);if(Y.isRegExp(t))return t.exec(e);throw TypeError("parser must be boolean|regexp|function")}}}has(e,t){if(e=te(e)){let i=Y.findKey(this,e);return!!(i&&void 0!==this[i]&&(!t||tn(this,this[i],i,t)))}return!1}delete(e,t){let i=this,n=!1;function o(e){if(e=te(e)){let o=Y.findKey(i,e);o&&(!t||tn(i,i[o],o,t))&&(delete i[o],n=!0)}}return Y.isArray(e)?e.forEach(o):o(e),n}clear(e){let t=Object.keys(this),i=t.length,n=!1;for(;i--;){let o=t[i];(!e||tn(this,this[o],o,e,!0))&&(delete this[o],n=!0)}return n}normalize(e){let t=this,i={};return Y.forEach(this,(n,o)=>{let a=Y.findKey(i,o);if(a){t[a]=tt(n),delete t[o];return}let r=e?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(e,t,i)=>t.toUpperCase()+i):String(o).trim();r!==o&&delete t[o],t[r]=tt(n),i[r]=!0}),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){let t=Object.create(null);return Y.forEach(this,(i,n)=>{null!=i&&!1!==i&&(t[n]=e&&Y.isArray(i)?i.join(", "):i)}),t}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([e,t])=>e+": "+t).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static concat(e,...t){let i=new this(e);return t.forEach(e=>i.set(e)),i}static accessor(e){let t=this[e7]=this[e7]={accessors:{}},i=t.accessors,n=this.prototype;function o(e){let t=te(e);i[t]||(!function(e,t){let i=Y.toCamelCase(" "+t);["get","set","has"].forEach(n=>{Object.defineProperty(e,n+i,{value:function(e,i,o){return this[n].call(this,t,e,i,o)},configurable:!0})})}(n,e),i[t]=!0)}return Y.isArray(e)?e.forEach(o):o(e),this}}function ta(e,t){let i=this||e4,n=t||i,o=to.from(n.headers),a=n.data;return Y.forEach(e,function(e){a=e.call(i,a,o.normalize(),t?t.status:void 0)}),o.normalize(),a}function tr(e){return!!(e&&e.__CANCEL__)}/**
 ...
 */function ts(e,t,i){K.call(this,null==e?"canceled":e,K.ERR_CANCELED,t,i),this.name="CanceledError"}to.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),Y.reduceDescriptors(to.prototype,({value:e},t)=>{let i=t[0].toUpperCase()+t.slice(1);// map `set` => `Set`
return{get:()=>e,set(e){this[i]=e}}}),Y.freezeMethods(to),Y.inherits(ts,K,{__CANCEL__:!0});var tl=e6.isStandardBrowserEnv?{write:function(e,t,i,n,o,a){let r=[];r.push(e+"="+encodeURIComponent(t)),Y.isNumber(i)&&r.push("expires="+new Date(i).toGMTString()),Y.isString(n)&&r.push("path="+n),Y.isString(o)&&r.push("domain="+o),!0===a&&r.push("secure"),document.cookie=r.join("; ")},read:function(e){let t=document.cookie.match(RegExp("(^|;\\s*)("+e+")=([^;]*)"));return t?decodeURIComponent(t[3]):null},remove:function(e){this.write(e,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function tc(e,t){return e&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(t)?t?e.replace(/\/+$/,"")+"/"+t.replace(/^\/+/,""):e:t}var tf=e6.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
i.setAttribute("href",n),n=i.href),i.setAttribute("href",n),{href:i.href,protocol:i.protocol?i.protocol.replace(/:$/,""):"",host:i.host,search:i.search?i.search.replace(/^\?/,""):"",hash:i.hash?i.hash.replace(/^#/,""):"",hostname:i.hostname,port:i.port,pathname:"/"===i.pathname.charAt(0)?i.pathname:"/"+i.pathname}}/**
    ...
    */return e=n(window.location.href),function(t){let i=Y.isString(t)?n(t):t;return i.protocol===e.protocol&&i.host===e.host}}():function(){return!0},tp=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(e,t){let i;e=e||10;let n=Array(e),o=Array(e),a=0,r=0;return t=void 0!==t?t:1e3,function(s){let l=Date.now(),c=o[r];i||(i=l),n[a]=s,o[a]=l;let f=r,p=0;for(;f!==a;)p+=n[f++],f%=e;if((a=(a+1)%e)===r&&(r=(r+1)%e),l-i<t)return;let d=c&&l-c;return d?Math.round(1e3*p/d):void 0}};function td(e,t){let i=0,n=tp(50,250);return o=>{let a=o.loaded,r=o.lengthComputable?o.total:void 0,s=a-i,l=n(s),c=a<=r;i=a;let f={loaded:a,total:r,progress:r?a/r:void 0,bytes:s,rate:l||void 0,estimated:l&&r&&c?(r-a)/l:void 0,event:o};f[t?"download":"upload"]=!0,e(f)}}let tu="undefined"!=typeof XMLHttpRequest;var tm=tu&&function(e){return new Promise(function(t,i){let n,o=e.data,a=to.from(e.headers).normalize(),r=e.responseType;function s(){e.cancelToken&&e.cancelToken.unsubscribe(n),e.signal&&e.signal.removeEventListener("abort",n)}Y.isFormData(o)&&(e6.isStandardBrowserEnv||e6.isStandardBrowserWebWorkerEnv?a.setContentType(!1):a.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
if(e.auth){let t=e.auth.username||"",i=e.auth.password?unescape(encodeURIComponent(e.auth.password)):"";a.set("Authorization","Basic "+btoa(t+":"+i))}let c=tc(e.baseURL,e.url);function f(){if(!l)return;// Prepare the response
let n=to.from("getAllResponseHeaders"in l&&l.getAllResponseHeaders()),o=r&&"text"!==r&&"json"!==r?l.response:l.responseText,a={data:o,status:l.status,statusText:l.statusText,headers:n,config:e,request:l};!function(e,t,i){let n=i.config.validateStatus;!i.status||!n||n(i.status)?e(i):t(new K("Request failed with status code "+i.status,[K.ERR_BAD_REQUEST,K.ERR_BAD_RESPONSE][Math.floor(i.status/100)-4],i.config,i.request,i))}(function(e){t(e),s()},function(e){i(e),s()},a),// Clean up request
l=null}// Add xsrf header
// This is only done if running in a standard browser environment.
// Specifically not if we're in a web worker, or react-native.
if(l.open(e.method.toUpperCase(),eK(c,e.params,e.paramsSerializer),!0),// Set the request timeout in MS
...
l.onabort=function(){l&&(i(new K("Request aborted",K.ECONNABORTED,e,l)),// Clean up request
l=null)},// Handle low level network errors
l.onerror=function(){// Real errors are hidden from us by the browser
// onerror should only fire if it's a network error
i(new K("Network Error",K.ERR_NETWORK,e,l)),// Clean up request
l=null},// Handle timeout
l.ontimeout=function(){let t=e.timeout?"timeout of "+e.timeout+"ms exceeded":"timeout exceeded",n=e.transitional||eQ;e.timeoutErrorMessage&&(t=e.timeoutErrorMessage),i(new K(t,n.clarifyTimeoutError?K.ETIMEDOUT:K.ECONNABORTED,e,l)),// Clean up request
l=null},e6.isStandardBrowserEnv){// Add xsrf header
let t=(e.withCredentials||tf(c))&&e.xsrfCookieName&&tl.read(e.xsrfCookieName);t&&a.set(e.xsrfHeaderName,t)}// Remove Content-Type if data is undefined
void 0===o&&a.setContentType(null),"setRequestHeader"in l&&Y.forEach(a.toJSON(),function(e,t){l.setRequestHeader(t,e)}),Y.isUndefined(e.withCredentials)||(l.withCredentials=!!e.withCredentials),r&&"json"!==r&&(l.responseType=e.responseType),"function"==typeof e.onDownloadProgress&&l.addEventListener("progress",td(e.onDownloadProgress,!0)),"function"==typeof e.onUploadProgress&&l.upload&&l.upload.addEventListener("progress",td(e.onUploadProgress)),(e.cancelToken||e.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=t=>{l&&(i(!t||t.type?new ts(null,e,l):t),l.abort(),l=null)},e.cancelToken&&e.cancelToken.subscribe(n),e.signal&&(e.signal.aborted?n():e.signal.addEventListener("abort",n)));let p=function(e){let t=/^([-+\w]{1,25})(:?\/\/|:)/.exec(e);return t&&t[1]||""}(c);if(p&&-1===e6.protocols.indexOf(p)){i(new K("Unsupported protocol "+p+":",K.ERR_BAD_REQUEST,e));return}// Send the request
l.send(o||null)})};let th={http:null,xhr:tm};Y.forEach(th,(e,t)=>{if(e){try{Object.defineProperty(e,"name",{value:t})}catch(e){// eslint-disable-next-line no-empty
}Object.defineProperty(e,"adapterName",{value:t})}});var tg={getAdapter:e=>{let t,i;e=Y.isArray(e)?e:[e];let{length:n}=e;for(let o=0;o<n&&(t=e[o],!(i=Y.isString(t)?th[t.toLowerCase()]:t));o++);if(!i){if(!1===i)throw new K(`Adapter ${t} is not supported by the environment`,"ERR_NOT_SUPPORT");throw Error(Y.hasOwnProp(th,t)?`Adapter '${t}' is not available in the build`:`Unknown adapter '${t}'`)}if(!Y.isFunction(i))throw TypeError("adapter is not a function");return i},adapters:th};/**
 * Throws a `CanceledError` if cancellation has been requested.
 *
 * @param {Object} config The config that is to be used for the request
 *
 * @returns {void}
 */function ty(e){if(e.cancelToken&&e.cancelToken.throwIfRequested(),e.signal&&e.signal.aborted)throw new ts(null,e)}function tx(e){ty(e),e.headers=to.from(e.headers),// Transform request data
e.data=ta.call(e,e.transformRequest),-1!==["post","put","patch"].indexOf(e.method)&&e.headers.setContentType("application/x-www-form-urlencoded",!1);let t=tg.getAdapter(e.adapter||e4.adapter);return t(e).then(function(t){return ty(e),// Transform response data
t.data=ta.call(e,e.transformResponse,t),t.headers=to.from(t.headers),t},function(t){return!tr(t)&&(ty(e),t&&t.response&&(t.response.data=ta.call(e,e.transformResponse,t.response),t.response.headers=to.from(t.response.headers))),Promise.reject(t)})}let tb=e=>e instanceof to?e.toJSON():e;function tv(e,t){// eslint-disable-next-line no-param-reassign
t=t||{};let i={};function n(e,t,i){return Y.isPlainObject(e)&&Y.isPlainObject(t)?Y.merge.call({caseless:i},e,t):Y.isPlainObject(t)?Y.merge({},t):Y.isArray(t)?t.slice():t}// eslint-disable-next-line consistent-return
function o(e,t,i){return Y.isUndefined(t)?Y.isUndefined(e)?void 0:n(void 0,e,i):n(e,t,i)}// eslint-disable-next-line consistent-return
function a(e,t){if(!Y.isUndefined(t))return n(void 0,t)}// eslint-disable-next-line consistent-return
function r(e,t){return Y.isUndefined(t)?Y.isUndefined(e)?void 0:n(void 0,e):n(void 0,t)}// eslint-disable-next-line consistent-return
function s(i,o,a){return a in t?n(i,o):a in e?n(void 0,i):void 0}let l={url:a,method:a,data:a,baseURL:r,transformRequest:r,transformResponse:r,paramsSerializer:r,timeout:r,timeoutMessage:r,withCredentials:r,adapter:r,responseType:r,xsrfCookieName:r,xsrfHeaderName:r,onUploadProgress:r,onDownloadProgress:r,decompress:r,maxContentLength:r,maxBodyLength:r,beforeRedirect:r,transport:r,httpAgent:r,httpsAgent:r,cancelToken:r,socketPath:r,responseEncoding:r,validateStatus:s,headers:(e,t)=>o(tb(e),tb(t),!0)};return Y.forEach(Object.keys(Object.assign({},e,t)),function(n){let a=l[n]||o,r=a(e[n],t[n],n);Y.isUndefined(r)&&a!==s||(i[n]=r)}),i}let tw="1.5.0",tk={};// eslint-disable-next-line func-names
["object","boolean","number","function","string","symbol"].forEach((e,t)=>{tk[e]=function(i){return typeof i===e||"a"+(t<1?"n ":" ")+e}});let tS={};/**
 ...
 *
 * @returns {function}
 */tk.transitional=function(e,t,i){function n(e,t){return"[Axios v"+tw+"] Transitional option '"+e+"'"+t+(i?". "+i:"")}// eslint-disable-next-line func-names
return(i,o,a)=>{if(!1===e)throw new K(n(o," has been removed"+(t?" in "+t:"")),K.ERR_DEPRECATED);return t&&!tS[o]&&(tS[o]=!0,// eslint-disable-next-line no-console
console.warn(n(o," has been deprecated since v"+t+" and will be removed in the near future"))),!e||e(i,o,a)}};var tC={assertOptions:/**
 ...
 *
 * @returns {object}
 */function(e,t,i){if("object"!=typeof e)throw new K("options must be an object",K.ERR_BAD_OPTION_VALUE);let n=Object.keys(e),o=n.length;for(;o-- >0;){let a=n[o],r=t[a];if(r){let t=e[a],i=void 0===t||r(t,a,e);if(!0!==i)throw new K("option "+a+" must be "+i,K.ERR_BAD_OPTION_VALUE);continue}if(!0!==i)throw new K("Unknown option "+a,K.ERR_BAD_OPTION)}},validators:tk};let tE=tC.validators;/**
 * Create a new instance of Axios
 *
 * @param {Object} instanceConfig The default config for the instance
 *
 * @return {Axios} A new instance of Axios
 */class tN{constructor(e){this.defaults=e,this.interceptors={request:new eJ,response:new eJ}}/**
   * Dispatch a request
   *
   ...
   */request(e,t){let i,n;"string"==typeof e?(t=t||{}).url=e:t=e||{},t=tv(this.defaults,t);let{transitional:o,paramsSerializer:a,headers:r}=t;void 0!==o&&tC.assertOptions(o,{silentJSONParsing:tE.transitional(tE.boolean),forcedJSONParsing:tE.transitional(tE.boolean),clarifyTimeoutError:tE.transitional(tE.boolean)},!1),null!=a&&(Y.isFunction(a)?t.paramsSerializer={serialize:a}:tC.assertOptions(a,{encode:tE.function,serialize:tE.function},!0)),// Set config.method
t.method=(t.method||this.defaults.method||"get").toLowerCase();// Flatten headers
let s=r&&Y.merge(r.common,r[t.method]);r&&Y.forEach(["delete","get","head","post","put","patch","common"],e=>{delete r[e]}),t.headers=to.concat(s,r);// filter out skipped interceptors
let l=[],c=!0;this.interceptors.request.forEach(function(e){("function"!=typeof e.runWhen||!1!==e.runWhen(t))&&(c=c&&e.synchronous,l.unshift(e.fulfilled,e.rejected))});let f=[];this.interceptors.response.forEach(function(e){f.push(e.fulfilled,e.rejected)});let p=0;if(!c){let e=[tx.bind(this),void 0];for(e.unshift.apply(e,l),e.push.apply(e,f),n=e.length,i=Promise.resolve(t);p<n;)i=i.then(e[p++],e[p++]);return i}n=l.length;let d=t;for(p=0;p<n;){let e=l[p++],t=l[p++];try{d=e(d)}catch(e){t.call(this,e);break}}try{i=tx.call(this,d)}catch(e){return Promise.reject(e)}for(p=0,n=f.length;p<n;)i=i.then(f[p++],f[p++]);return i}getUri(e){e=tv(this.defaults,e);let t=tc(e.baseURL,e.url);return eK(t,e.params,e.paramsSerializer)}}Y.forEach(["delete","get","head","options"],function(e){/*eslint func-names:0*/tN.prototype[e]=function(t,i){return this.request(tv(i||{},{method:e,url:t,data:(i||{}).data}))}}),Y.forEach(["post","put","patch"],function(e){/*eslint func-names:0*/function t(t){return function(i,n,o){return this.request(tv(o||{},{method:e,headers:t?{"Content-Type":"multipart/form-data"}:{},url:i,data:n}))}}tN.prototype[e]=t(),tN.prototype[e+"Form"]=t(!0)});/**
 * A `CancelToken` is an object that can be used to request cancellation of an operation.
 *
 * @param {Function} executor The executor function.
 *
 * @returns {CancelToken}
 */class tT{constructor(e){let t;if("function"!=typeof e)throw TypeError("executor must be a function.");this.promise=new Promise(function(e){t=e});let i=this;// eslint-disable-next-line func-names
...
let n=new Promise(e=>{i.subscribe(e),t=e}).then(e);return n.cancel=function(){i.unsubscribe(t)},n},e(function(e,n,o){i.reason||(i.reason=new ts(e,n,o),t(i.reason))})}/**
   * Throws a `CanceledError` if cancellation has been requested.
 ...
 */function e(t){let i=new tN(t),n=y(tN.prototype.request,i);return Y.extend(n,tN.prototype,i,{allOwnKeys:!0}),Y.extend(n,i,null,{allOwnKeys:!0}),// Factory for creating new instances
n.create=function(i){return e(tv(t,i))},n}(e4);// Expose Axios class to allow class inheritance
tA.Axios=tN,// Expose Cancel & CancelToken
tA.CanceledError=ts,tA.CancelToken=tT,tA.isCancel=tr,tA.VERSION=tw,tA.toFormData=eX,// Expose AxiosError class
tA.AxiosError=K,// alias for CanceledError for backward compatibility
...
tA.isAxiosError=function(e){return Y.isObject(e)&&!0===e.isAxiosError},// Expose mergeConfig
tA.mergeConfig=tv,tA.AxiosHeaders=to,tA.formToJSON=e=>e3(Y.isHTMLForm(e)?new FormData(e):e),tA.getAdapter=tg.getAdapter,tA.HttpStatusCode=tL,tA.default=tA;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:tM,AxiosError:tI,CanceledError:tz,isCancel:tO,CancelToken:tB,VERSION:tP,all:t_,Cancel:tR,isAxiosError:tD,spread:tj,toFormData:tW,AxiosHeaders:tF,HttpStatusCode:t$,formToJSON:tU,getAdapter:tH,mergeConfig:tX}=tA,tq="https://tasty-treats-backend.p.goit.global/api",tG={events:"/events",recipes:"/recipes",categories:"/categories",popular:"/recipes/popular",ingredients:"/ingredients",areas:"/areas",orders:"/orders/add"},tV=async()=>{let e=await tA.get(`${tq}${tG.events}`);return e},tY=async()=>{let e=await tA.get(`${tq}${tG.categories}`);return e},tK=async()=>{let e=await tA.get(`${tq}${tG.popular}`);return e},tJ=async e=>{let t=await tA.get(`${tq}${tG.recipes}/${e}`);return t},tQ=async()=>{let e=await tA.get(`${tq}${tG.ingredients}`);return e},tZ=async()=>{let e=await tA.get(`${tq}${tG.areas}`);return e},t0=async e=>{let t=await tA.post(`${tq}${tG.orders}`,e);return t},t1=async e=>{let t=await tA.get(`${tq}${tG.recipes}?${e}`);return t};function t2(e){"Success"===e.data.message?(0,g.Notify).success("Вітаємо, ваше замовлення прийнято!"):(0,g.Notify).warning("Вибачте, в цей час замовлення не приймаються!")}// ********************************************************
let t5=document.querySelector(".js-open-menu"),t6=document.querySelector(".js-close-menu"),t3=document.querySelector(".js-menu-container"),t4=document.querySelector(".basket-button");function t8(){let e=h.create(`
...
`,{onShow:e=>{document.addEventListener("keydown",a)}},{closeShow:e=>{document.removeEventListener("keydown",a)}});document.body.style.overflow="hidden",e.show();let t=document.querySelector(".header-form");!function(e){e.addEventListener("submit",function(e){e.preventDefault();let{name:t,phone:i,email:n,comment:o}=e.currentTarget.elements;t0({name:t.value,phone:i.value,email:n.value,comment:o.value}).then(t2).catch(e=>{console.log(e)})})}(t);let i=document.querySelector(".js-modal-close-btn"),n=document.querySelector(".header-form-btn"),o=document.querySelector(".header-modal");function a(t){if("Escape"===t.code)return e.close()}o.addEventListener("submit",e=>{e.preventDefault()}),i.addEventListener("click",()=>{document.body.style.overflow="auto",e.close()}),// питання чому не може спррацьовує на submit
n.addEventListener("click",()=>{document.body.style.overflow="auto",e.close()})}t5.addEventListener("click",function(){t3.classList.contains("is-open")||t3.classList.add("is-open")}),t6.addEventListener("click",function(){t3.classList.contains("is-open")&&t3.classList.remove("is-open")}),// ------------------МОДАЛКА-------------------
t4.addEventListener("click",t8);let t9=document.querySelector(".switcher-check"),t7=document.querySelector(".mob-switcher-check"),ie=document.querySelector(".js-menu-container"),it=document.querySelector(".header"),ii=document.querySelector("body"),io=document.querySelector(".recipes-all"),ia=document.querySelector(".popular-item-js"),ir=document.querySelector(".categories-btn-js"),is={DARK:"dark-theme"};t9.addEventListener("change",()=>{let e=ii.classList.contains(is.DARK);e?(ii.classList.remove(is.DARK),it.classList.remove(is.DARK),io.classList.remove(is.DARK),ia.remove(is.DARK),ir.remove(is.DARK),ie.classList.remove(is.DARK)):(ii.classList.add(is.DARK),it.classList.add(is.DARK),io.classList.add(is.DARK),ia.add(is.DARK),ir.remove(is.DARK),ie.classList.add(is.DARK));// localStorage.setItem('theme', isDarkMode ? Theme.LIGHT : Theme.DARK);
}),// ---------------Mob-Switcher------------------------------
t7.addEventListener("change",()=>{let e=ii.classList.contains(is.DARK);e?(ii.classList.remove(is.DARK),it.classList.remove(is.DARK),ie.classList.remove(is.DARK)):(ii.classList.add(is.DARK),it.classList.add(is.DARK),ie.classList.add(is.DARK));// localStorage.setItem('theme', isDarkMode ? Theme.LIGHT : Theme.DARK);
});let il=document.querySelector(".card-list"),ic=async(e,t,i,n,o,a)=>{// Праметри API запиту
let r=new URLSearchParams({limit:9}),s=await tA.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${r}`);return s};function ip(e){il.innerHTML=e.data.results.map(e=>`
    <li class="card-item">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join(""),function(){let e=document.querySelectorAll(".box-star");e.forEach(e=>{let t=e.previousElementSibling,i=Math.round(t.textContent),n=[...e.children];n.forEach((e,t)=>{t<i&&e.classList.add("yellow-star")})})}()}window.addEventListener("load",function(){ic().then(ip).catch(e=>{console.log(e)})});let id=new MutationObserver(function(){let e=document.querySelectorAll(".info-btn");// витягуємо всі кнопки
e.forEach(e=>{e.addEventListener("click",iu);// вішаємо слухача на кнопки
})});// створюємо екземпляр класу MutationObserver
function iu(e){let t=e.target.id;tJ(t).then(e=>{!function(e){let{data:{title:t,youtube:i,thumb:n,rating:o,time:a,ingredients:r,tags:s,instructions:l}}=e,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),f=h.create(`<div class="card-modal">
...
function(e){let t=document.querySelector(".box-stars");document.querySelector(".star");let i=[...t.children],n=Math.round(e);i.forEach((e,t)=>{t<n&&e.classList.add("yellow-star")})}(o),document.body.style.overflow="hidden";let p=document.querySelector(".js-card-close-btn");document.querySelector(".card-modal"),p.addEventListener("click",()=>{document.body.style.overflow="auto",f.close()})}(e);let t=document.querySelector(".basicLightbox");t.classList.add("correct-recipe")}).catch(e=>{console.log(e)})}id.observe(il,{// параметри MutationObserver
childList:!0,subtree:!0});var im={};window,im=/******/function(e){/******/// The module cache
...
window.addEventListener("unload",function(){ig.allCategiries.removeEventListener("click",iE),ig.categories.removeEventListener("click",iN),ig.popular.removeEventListener("click",iL),ik.off("afterMove",iC)}),tY().then(e=>{ig.categories.insertAdjacentHTML("beforeend",// формування розмітки переліку категорій
...
iS(),tK().then(e=>{ig.popular.insertAdjacentHTML("beforeend",e.data.map(e=>`
...
let t=ig.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",iL)})}).catch(()=>{});let iz=iI();function iO(e){let t=/**
  |============================
  | Розмітка Swiper
  |============================
*/function(e){let{cook:t,topic:i}=e;return e.map(e=>`<div class="swiper-slide">
        ...
        </div>`).join("")}(e.data);iz.markupSwiper.insertAdjacentHTML("afterbegin",t)}/**
  |============================
  | Бібліотека Swiper
  |============================
*//**
 ...
 *//* eslint-disable no-param-reassign */function iB(e){return null!==e&&"object"==typeof e&&"constructor"in e&&e.constructor===Object}function iP(e,t){void 0===e&&(e={}),void 0===t&&(t={}),Object.keys(t).forEach(i=>{void 0===e[i]?e[i]=t[i]:iB(t[i])&&iB(e[i])&&Object.keys(t[i]).length>0&&iP(e[i],t[i])})}// Прослуховувачі подій
window.addEventListener("load",function(){tV().then(iO).catch(e=>{console.log(e)})}),iz.orderBtnHero.addEventListener("click",function(){t8();// const modalMessage = document.querySelector('.header-form');
// callMassageAdd(modalMessage);
});let i_={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector:()=>null,querySelectorAll:()=>[],getElementById:()=>null,createEvent:()=>({initEvent(){}}),createElement:()=>({children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName:()=>[]}),createElementNS:()=>({}),importNode:()=>null,location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function iR(){let e="undefined"!=typeof document?document:{};return iP(e,i_),e}let iD={document:i_,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle:()=>({getPropertyValue:()=>""}),Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia:()=>({}),requestAnimationFrame:e=>"undefined"==typeof setTimeout?(e(),null):setTimeout(e,0),cancelAnimationFrame(e){"undefined"!=typeof setTimeout&&clearTimeout(e)}};function ij(){let e="undefined"!=typeof window?window:{};return iP(e,iD),e}function iW(e,t){return void 0===t&&(t=0),setTimeout(e,t)}function iF(){return Date.now()}function i$(e){return"object"==typeof e&&null!==e&&e.constructor&&"Object"===Object.prototype.toString.call(e).slice(8,-1)}function iU(){let e=Object(arguments.length<=0?void 0:arguments[0]),t=["__proto__","constructor","prototype"];for(let i=1;i<arguments.length;i+=1){let n=i<0||arguments.length<=i?void 0:arguments[i];if(null!=n&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType)){let i=Object.keys(Object(n)).filter(e=>0>t.indexOf(e));for(let t=0,o=i.length;t<o;t+=1){let o=i[t],a=Object.getOwnPropertyDescriptor(n,o);void 0!==a&&a.enumerable&&(i$(e[o])&&i$(n[o])?n[o].__swiper__?e[o]=n[o]:iU(e[o],n[o]):!i$(e[o])&&i$(n[o])?(e[o]={},n[o].__swiper__?e[o]=n[o]:iU(e[o],n[o])):e[o]=n[o])}}}return e}function iH(e,t,i){e.style.setProperty(t,i)}function iX(e){let t,{swiper:i,targetPosition:n,side:o}=e,a=ij(),r=-i.translate,s=null,l=i.params.speed;i.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(i.cssModeFrameID);let c=n>r?"next":"prev",f=(e,t)=>"next"===c&&e>=t||"prev"===c&&e<=t,p=()=>{t=new Date().getTime(),null===s&&(s=t);let e=Math.max(Math.min((t-s)/l,1),0),c=r+(.5-Math.cos(e*Math.PI)/2)*(n-r);if(f(c,n)&&(c=n),i.wrapperEl.scrollTo({[o]:c}),f(c,n)){i.wrapperEl.style.overflow="hidden",i.wrapperEl.style.scrollSnapType="",setTimeout(()=>{i.wrapperEl.style.overflow="",i.wrapperEl.scrollTo({[o]:c})}),a.cancelAnimationFrame(i.cssModeFrameID);return}i.cssModeFrameID=a.requestAnimationFrame(p)};p()}function iq(e,t){return void 0===t&&(t=""),[...e.children].filter(e=>e.matches(t))}function iG(e,t){void 0===t&&(t=[]);let i=document.createElement(e);return i.classList.add(...Array.isArray(t)?t:[t]),i}function iV(e,t){let i=ij();return i.getComputedStyle(e,null).getPropertyValue(t)}function iY(e){let t,i=e;if(i){// eslint-disable-next-line
for(t=0;null!==(i=i.previousSibling);)1===i.nodeType&&(t+=1);return t}}function iK(e,t){let i=[],n=e.parentElement;// eslint-disable-line
for(;n;)t?n.matches(t)&&i.push(n):i.push(n),n=n.parentElement;return i}function iJ(e,t,i){let n=ij();return i?e["width"===t?"offsetWidth":"offsetHeight"]+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-right":"margin-top"))+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-left":"margin-bottom")):e.offsetWidth}function iQ(){return e||(e=function(){let e=ij(),t=iR();return{smoothScroll:t.documentElement&&t.documentElement.style&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)}}()),e}let iZ=(e,t)=>{if(!e||e.destroyed||!e.params)return;let i=t.closest(e.isElement?"swiper-slide":`.${e.params.slideClass}`);if(i){let t=i.querySelector(`.${e.params.lazyPreloaderClass}`);!t&&e.isElement&&(t=i.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`)),t&&t.remove()}},i0=(e,t)=>{if(!e.slides[t])return;let i=e.slides[t].querySelector('[loading="lazy"]');i&&i.removeAttribute("loading")},i1=e=>{if(!e||e.destroyed||!e.params)return;let t=e.params.lazyPreloadPrevNext,i=e.slides.length;if(!i||!t||t<0)return;t=Math.min(t,i);let n="auto"===e.params.slidesPerView?e.slidesPerViewDynamic():Math.ceil(e.params.slidesPerView),o=e.activeIndex;if(e.params.grid&&e.params.grid.rows>1){let i=[o-t];i.push(...Array.from({length:t}).map((e,t)=>o+n+t)),e.slides.forEach((t,n)=>{i.includes(t.column)&&i0(e,n)});return}let a=o+n-1;if(e.params.rewind||e.params.loop)for(let n=o-t;n<=a+t;n+=1){let t=(n%i+i)%i;(t<o||t>a)&&i0(e,t)}else for(let n=Math.max(o-t,0);n<=Math.min(a+t,i-1);n+=1)n!==o&&(n>a||n<o)&&i0(e,n)};function i2(e){let{swiper:t,runCallbacks:i,direction:n,step:o}=e,{activeIndex:a,previousIndex:r}=t,s=n;if(s||(s=a>r?"next":a<r?"prev":"reset"),t.emit(`transition${o}`),i&&a!==r){if("reset"===s){t.emit(`slideResetTransition${o}`);return}t.emit(`slideChangeTransition${o}`),"next"===s?t.emit(`slideNextTransition${o}`):t.emit(`slidePrevTransition${o}`)}}function i5(e){let t=iR(),i=ij(),n=this.touchEventsData;n.evCache.push(e);let{params:o,touches:a,enabled:r}=this;if(!r||!o.simulateTouch&&"mouse"===e.pointerType||this.animating&&o.preventInteractionOnTransition)return;!this.animating&&o.cssMode&&o.loop&&this.loopFix();let s=e;s.originalEvent&&(s=s.originalEvent);let l=s.target;if("wrapper"===o.touchEventsTarget&&!this.wrapperEl.contains(l)||"which"in s&&3===s.which||"button"in s&&s.button>0||n.isTouched&&n.isMoved)return;// change target el for shadow root component
...
e.allowSlidePrev=o,e.allowSlideNext=n,e.params.watchOverflow&&a!==e.snapGrid&&e.checkOverflow()}function i8(e){this.enabled&&!this.allowClick&&(this.params.preventClicks&&e.preventDefault(),this.params.preventClicksPropagation&&this.animating&&(e.stopPropagation(),e.stopImmediatePropagation()))}function i9(){let{wrapperEl:e,rtlTranslate:t,enabled:i}=this;if(!i)return;this.previousTranslate=this.translate,this.isHorizontal()?this.translate=-e.scrollLeft:this.translate=-e.scrollTop,0===this.translate&&(this.translate=0),this.updateActiveIndex(),this.updateSlidesClasses();let n=this.maxTranslate()-this.minTranslate();(0===n?0:(this.translate-this.minTranslate())/n)!==this.progress&&this.updateProgress(t?-this.translate:this.translate),this.emit("setTranslate",this.translate,!1)}function i7(e){iZ(this,e.target),!this.params.cssMode&&("auto"===this.params.slidesPerView||this.params.autoHeight)&&this.update()}let ne=!1;function nt(){}let ni=(e,t)=>{let i=iR(),{params:n,el:o,wrapperEl:a,device:r}=e,s=!!n.nested,l="on"===t?"addEventListener":"removeEventListener";// Touch Events
o[l]("pointerdown",e.onTouchStart,{passive:!1}),i[l]("pointermove",e.onTouchMove,{passive:!1,capture:s}),i[l]("pointerup",e.onTouchEnd,{passive:!0}),i[l]("pointercancel",e.onTouchEnd,{passive:!0}),i[l]("pointerout",e.onTouchEnd,{passive:!0}),i[l]("pointerleave",e.onTouchEnd,{passive:!0}),i[l]("contextmenu",e.onTouchEnd,{passive:!0}),(n.preventClicks||n.preventClicksPropagation)&&o[l]("click",e.onClick,!0),n.cssMode&&a[l]("scroll",e.onScroll),n.updateOnWindowResize?e[t](r.ios||r.android?"resize orientationchange observerUpdate":"resize observerUpdate",i4,!0):e[t]("observerUpdate",i4,!0),// Images loader
o[l]("load",e.onLoad,{capture:!0})},nn=(e,t)=>e.grid&&t.grid&&t.grid.rows>1;var no={init:!0,direction:"horizontal",oneWayMovement:!1,touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",// Overrides
...
r.updateProgress(a),s.cssMode){let e=r.isHorizontal();if(0===t)l[e?"scrollLeft":"scrollTop"]=-a;else{if(!r.support.smoothScroll)return iX({swiper:r,targetPosition:-a,side:e?"left":"top"}),!0;l.scrollTo({[e?"left":"top"]:-a,behavior:"smooth"})}return!0}return 0===t?(r.setTransition(0),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",t,o),r.emit("transitionEnd"))):(r.setTransition(t),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",t,o),r.emit("transitionStart")),r.animating||(r.animating=!0,r.onTranslateToWrapperTransitionEnd||(r.onTranslateToWrapperTransitionEnd=function(e){r&&!r.destroyed&&e.target===this&&(r.wrapperEl.removeEventListener("transitionend",r.onTranslateToWrapperTransitionEnd),r.onTranslateToWrapperTransitionEnd=null,delete r.onTranslateToWrapperTransitionEnd,i&&r.emit("transitionEnd"))}),r.wrapperEl.addEventListener("transitionend",r.onTranslateToWrapperTransitionEnd))),!0}},transition:{setTransition:function(e,t){this.params.cssMode||(this.wrapperEl.style.transitionDuration=`${e}ms`,this.wrapperEl.style.transitionDelay=0===e?"0ms":""),this.emit("setTransition",e,t)},transitionStart:function(e,t){void 0===e&&(e=!0);let{params:i}=this;i.cssMode||(i.autoHeight&&this.updateAutoHeight(),i2({swiper:this,runCallbacks:e,direction:t,step:"Start"}))},transitionEnd:function(e,t){void 0===e&&(e=!0);let{params:i}=this;this.animating=!1,i.cssMode||(this.setTransition(0),i2({swiper:this,runCallbacks:e,direction:t,step:"End"}))}},slide:{slideTo:function(e,t,i,n,o){let a;void 0===e&&(e=0),void 0===t&&(t=this.params.speed),void 0===i&&(i=!0),"string"==typeof e&&(e=parseInt(e,10));let r=this,s=e;s<0&&(s=0);let{params:l,snapGrid:c,slidesGrid:f,previousIndex:p,activeIndex:d,rtlTranslate:u,wrapperEl:m,enabled:h}=r;if(r.animating&&l.preventInteractionOnTransition||!h&&!n&&!o)return!1;let g=Math.min(r.params.slidesPerGroupSkip,s),y=g+Math.floor((s-g)/r.params.slidesPerGroup);y>=c.length&&(y=c.length-1);let x=-c[y];// Normalize slideIndex
...
imagesToLoad:[],imagesLoaded:0}),c.emit("_swiper"),c.params.init&&c.init(),c)}getSlideIndex(e){let{slidesEl:t,params:i}=this,n=iq(t,`.${i.slideClass}, swiper-slide`),o=iY(n[0]);return iY(e)-o}getSlideIndexByData(e){return this.getSlideIndex(this.slides.filter(t=>1*t.getAttribute("data-swiper-slide-index")===e)[0])}recalcSlides(){let{slidesEl:e,params:t}=this;this.slides=iq(e,`.${t.slideClass}, swiper-slide`)}enable(){this.enabled||(this.enabled=!0,this.params.grabCursor&&this.setGrabCursor(),this.emit("enable"))}disable(){this.enabled&&(this.enabled=!1,this.params.grabCursor&&this.unsetGrabCursor(),this.emit("disable"))}setProgress(e,t){e=Math.min(Math.max(e,0),1);let i=this.minTranslate(),n=this.maxTranslate(),o=(n-i)*e+i;this.translateTo(o,void 0===t?0:t),this.updateActiveIndex(),this.updateSlidesClasses()}emitContainerClasses(){let e=this;if(!e.params._emitClasses||!e.el)return;let t=e.el.className.split(" ").filter(t=>0===t.indexOf("swiper")||0===t.indexOf(e.params.containerModifierClass));e.emit("_containerClasses",t.join(" "))}getSlideClasses(e){let t=this;return t.destroyed?"":e.className.split(" ").filter(e=>0===e.indexOf("swiper-slide")||0===e.indexOf(t.params.slideClass)).join(" ")}emitSlidesClasses(){let e=this;if(!e.params._emitClasses||!e.el)return;let t=[];e.slides.forEach(i=>{let n=e.getSlideClasses(i);t.push({slideEl:i,classNames:n}),e.emit("_slideClass",i,n)}),e.emit("_slideClasses",t)}slidesPerViewDynamic(e,t){void 0===e&&(e="current"),void 0===t&&(t=!1);let{params:i,slides:n,slidesGrid:o,slidesSizesGrid:a,size:r,activeIndex:s}=this,l=1;if(i.centeredSlides){let e,t=n[s]?n[s].swiperSlideSize:0;for(let i=s+1;i<n.length;i+=1)n[i]&&!e&&(t+=n[i].swiperSlideSize,l+=1,t>r&&(e=!0));for(let i=s-1;i>=0;i-=1)n[i]&&!e&&(t+=n[i].swiperSlideSize,l+=1,t>r&&(e=!0))}else // eslint-disable-next-line
...
return e}return iq(i,n())[0]})();return!o&&t.params.createElements&&(o=iG("div",t.params.wrapperClass),i.append(o),iq(i,`.${t.params.slideClass}`).forEach(e=>{o.append(e)})),Object.assign(t,{el:i,wrapperEl:o,slidesEl:t.isElement&&!i.parentNode.host.slideSlots?i.parentNode.host:o,hostEl:t.isElement?i.parentNode.host:i,mounted:!0,// RTL
rtl:"rtl"===i.dir.toLowerCase()||"rtl"===iV(i,"direction"),rtlTranslate:"horizontal"===t.params.direction&&("rtl"===i.dir.toLowerCase()||"rtl"===iV(i,"direction")),wrongRTL:"-webkit-box"===iV(o,"display")}),!0}init(e){let t=this;if(t.initialized)return t;let i=t.mount(e);if(!1===i)return t;t.emit("beforeInit"),t.params.breakpoints&&t.setBreakpoint(),// Add Classes
...
t.attachEvents();let n=[...t.el.querySelectorAll('[loading="lazy"]')];return t.isElement&&n.push(...t.hostEl.querySelectorAll('[loading="lazy"]')),n.forEach(e=>{e.complete?iZ(t,e):e.addEventListener("load",e=>{iZ(t,e.target)})}),i1(t),// Init Flag
t.initialized=!0,i1(t),// Emit
...
}})}(i)),i.destroyed=!0),null}static extendDefaults(e){iU(nr,e)}static get extendedDefaults(){return nr}static get defaults(){return no}static installModule(e){ns.prototype.__modules__||(ns.prototype.__modules__=[]);let t=ns.prototype.__modules__;"function"==typeof e&&0>t.indexOf(e)&&t.push(e)}static use(e){return Array.isArray(e)?e.forEach(e=>ns.installModule(e)):ns.installModule(e),ns}}function nl(e){return void 0===e&&(e=""),`.${e.trim().replace(/([\.:!+\/])/g,"\\$1")// eslint-disable-line
.replace(/ /g,".")}`}Object.keys(na).forEach(e=>{Object.keys(na[e]).forEach(t=>{ns.prototype[t]=na[e][t]})}),ns.use([function(e){let{swiper:t,on:i,emit:n}=e,o=ij(),a=null,r=null,s=()=>{t&&!t.destroyed&&t.initialized&&(n("beforeResize"),n("resize"))},l=()=>{t&&!t.destroyed&&t.initialized&&(a=new ResizeObserver(e=>{r=o.requestAnimationFrame(()=>{let{width:i,height:n}=t,o=i,a=n;e.forEach(e=>{let{contentBoxSize:i,contentRect:n,target:r}=e;r&&r!==t.el||(o=n?n.width:(i[0]||i).inlineSize,a=n?n.height:(i[0]||i).blockSize)}),(o!==i||a!==n)&&s()})})).observe(t.el)},c=()=>{r&&o.cancelAnimationFrame(r),a&&a.unobserve&&t.el&&(a.unobserve(t.el),a=null)},f=()=>{t&&!t.destroyed&&t.initialized&&n("orientationchange")};i("init",()=>{if(t.params.resizeObserver&&void 0!==o.ResizeObserver){l();return}o.addEventListener("resize",s),o.addEventListener("orientationchange",f)}),i("destroy",()=>{c(),o.removeEventListener("resize",s),o.removeEventListener("orientationchange",f)})},function(e){let{swiper:t,extendParams:i,on:n,emit:o}=e,a=[],r=ij(),s=function(e,i){void 0===i&&(i={});let n=r.MutationObserver||r.WebkitMutationObserver,s=new n(e=>{// The observerUpdate event should only be triggered
// once despite the number of mutations.  Additional
// triggers are redundant and are very costly
if(t.__preventObserver__)return;if(1===e.length){o("observerUpdate",e[0]);return}let i=function(){o("observerUpdate",e[0])};r.requestAnimationFrame?r.requestAnimationFrame(i):r.setTimeout(i,0)});s.observe(e,{attributes:void 0===i.attributes||i.attributes,childList:void 0===i.childList||i.childList,characterData:void 0===i.characterData||i.characterData}),a.push(s)};i({observer:!1,observeParents:!1,observeSlideChildren:!1}),n("init",()=>{if(t.params.observer){if(t.params.observeParents){let e=iK(t.hostEl);for(let t=0;t<e.length;t+=1)s(e[t])}// Observe container
s(t.hostEl,{childList:t.params.observeSlideChildren}),// Observe wrapper
s(t.wrapperEl,{attributes:!1})}}),n("destroy",()=>{a.forEach(e=>{e.disconnect()}),a.splice(0,a.length)})}]),ns.use([function(e){let t,{swiper:i,extendParams:n,on:o,emit:a}=e,r="swiper-pagination";n({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
dynamicBullets:!1,dynamicMainBullets:1,formatFractionCurrent:e=>e,formatFractionTotal:e=>e,bulletClass:`${r}-bullet`,bulletActiveClass:`${r}-bullet-active`,modifierClass:`${r}-`,currentClass:`${r}-current`,totalClass:`${r}-total`,hiddenClass:`${r}-hidden`,progressbarFillClass:`${r}-progressbar-fill`,progressbarOppositeClass:`${r}-progressbar-opposite`,clickableClass:`${r}-clickable`,lockClass:`${r}-lock`,horizontalClass:`${r}-horizontal`,verticalClass:`${r}-vertical`,paginationDisabledClass:`${r}-disabled`}}),i.pagination={el:null,bullets:[]};let s=0,l=e=>(Array.isArray(e)?e:[e]).filter(e=>!!e);function c(){return!i.params.pagination.el||!i.pagination.el||Array.isArray(i.pagination.el)&&0===i.pagination.el.length}function f(e,t){let{bulletActiveClass:n}=i.params.pagination;e&&(e=e[`${"prev"===t?"previous":"next"}ElementSibling`])&&(e.classList.add(`${n}-${t}`),(e=e[`${"prev"===t?"previous":"next"}ElementSibling`])&&e.classList.add(`${n}-${t}-${t}`))}function p(e){let t=e.target.closest(nl(i.params.pagination.bulletClass));if(!t)return;e.preventDefault();let n=iY(t)*i.params.slidesPerGroup;if(i.params.loop){if(i.realIndex===n)return;let e=i.realIndex,t=i.getSlideIndexByData(n),o=i.getSlideIndexByData(i.realIndex);if(t>i.slides.length-i.loopedSlides){let n=i.activeIndex;i.loopFix({direction:t>o?"next":"prev",activeSlideIndex:t,slideTo:!1});let a=i.activeIndex;n===a&&i.slideToLoop(e,0,!1,!0)}i.slideToLoop(n)}else i.slideTo(n)}function d(){let e,n;// Render || Update Pagination bullets/items
 ...
 * _.isObject(null);
 * // => false
 */function nE(e){var t=typeof e;return!!e&&("object"==t||"function"==t)}/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nN(e){if("number"==typeof e)return e;if("symbol"==typeof(t=e)||t&&"object"==typeof t&&"[object Symbol]"==nw.call(t))return nd;if(nE(e)){var t,i="function"==typeof e.valueOf?e.valueOf():e;e=nE(i)?i+"":i}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(nu,"");var n=nh.test(e);return n||ng.test(e)?ny(e.slice(2),n?2:8):nm.test(e)?nd:+e}np=/**
...
return void 0===l||i>=t||i<0||p&&n>=a}function h(){var e,i,n,o=nC();if(m(o))return g(o);// Restart the timer.
s=setTimeout(h,(e=o-l,i=o-c,n=t-e,p?nS(n,a-i):n))}function g(e){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(s=void 0,d&&n)?u(e):(n=o=void 0,r))}function y(){var e,i=nC(),a=m(i);if(n=arguments,o=this,l=i,a){if(void 0===s)return(// Reset any `maxWait` timer.
c=e=l,// Start the timer for the trailing edge.
s=setTimeout(h,t),f?u(e):r);if(p)return(// Handle invocations in a tight loop.
s=setTimeout(h,t),u(l))}return void 0===s&&(s=setTimeout(h,t)),r}return t=nN(t)||0,nE(i)&&(f=!!i.leading,a=(p="maxWait"in i)?nk(nN(i.maxWait)||0,t):a,d="trailing"in i?!!i.trailing:d),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nC())},y};let nT={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nT.form.addEventListener("submit",function(e){e.preventDefault()}),nT.time.addEventListener("change",function(e){iA("time",e.currentTarget.value),iS()}),nT.area.addEventListener("change",function(e){iA("area",e.currentTarget.value),iS()}),nT.ingredients.addEventListener("change",function(e){iA("ingredient",e.currentTarget.value),iS()}),nT.search.addEventListener("input",/*@__PURE__*/m(np)(()=>{iA("title",nT.search.value.trim()),iS()},300)),tZ().then(e=>{nT.area.innerHTML=e.data.map(({name:e})=>`<option class="filter-opt" value="${e}">${e}</option>`).join("")}).catch(e=>{console.log(e)}),tQ().then(e=>{nT.ingredients.innerHTML=e.data.map(({name:e,_id:t})=>`<option class="filter-opt" value="${t}">${e}</option>`).join("")}).catch(e=>{}),// ❗ Створення Time ❗
function(){let e="";// ❗ ДОРОБИТИ ПРАВИЛЬНУ ЛОГІКУ ЧАСУ ❗
for(let t=0;t<220;t+=5)t%10==0&&(e+=`<option class="filter-opt" value="${t}">${t}</option>`);nT.time.insertAdjacentHTML("beforeend",e)}(),// ❗ Створення js-reset-filter-btn ❗
nT.resetBtn.addEventListener("click",function(e){iM("time"),iM("area"),iM("ingredient"),iM("title"),iS()})}();//# sourceMappingURL=index.632420d5.js.map

//# sourceMappingURL=index.632420d5.js.map
