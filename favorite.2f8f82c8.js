...
is.allCategiries.addEventListener("click",ib),is.categories.addEventListener("click",ix),is.popular.addEventListener("click",iv),// прибирання слухачів подій
window.addEventListener("unload",function(){is.allCategiries.removeEventListener("click",ib),is.categories.removeEventListener("click",ix),is.popular.removeEventListener("click",iv),im.off("afterMove",ig)}),t9().then(e=>{is.categories.insertAdjacentHTML("beforeend",// формування розмітки переліку категорій
...
ni.resetBtn.addEventListener("click",function(e){ik("time"),ik("area"),ik("ingredients"),ih()})}();//# sourceMappingURL=favorite.2f8f82c8.js.map

//# sourceMappingURL=favorite.2f8f82c8.js.map
