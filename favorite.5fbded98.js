...
const id=new URLSearchParams({page:ic,limit:il}),iu={totalItems:0,itemsPerPage:il,visiblePages:ip,page:ic},im=new/*@__PURE__*/(f(ia))(is.pagination,iu);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
...
ni.resetBtn.addEventListener("click",function(e){ik("time"),ik("area"),ik("ingredients"),ih()}//# sourceMappingURL=favorite.5fbded98.js.map
);
//# sourceMappingURL=favorite.5fbded98.js.map
