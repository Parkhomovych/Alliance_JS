...
t.data=tg.call(e,e.transformResponse,t),t.headers=th.from(t.headers),t},function(t){return!tb(t)&&(tL(e),t&&t.response&&(t.response.data=tg.call(e,e.transformResponse,t.response),t.response.headers=th.from(t.response.headers))),Promise.reject(t)})}let tM=e=>e instanceof th?e.toJSON():e;function tI(e,t){// eslint-disable-next-line no-param-reassign
...
let t=ip.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",iE)})}).catch(()=>{});let iL=iN();function iA(e){let t=/**
  |============================
  | Запит для Swiper
  |============================
*//**
...
no.resetBtn.addEventListener("click",function(e){iT("time"),iT("area"),iT("ingredients"),ix()})}();//# sourceMappingURL=favorite.53d6029b.js.map

//# sourceMappingURL=favorite.53d6029b.js.map
