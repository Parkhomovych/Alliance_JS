 ...
 * @returns {any}
 */function $(e,t,{allOwnKeys:i=!1}={}){let n,r;// Don't bother if no value provided
 ...
 *
 * @returns {boolean}
 */function(e){return!!(e&&B(e.append)&&"FormData"===e[Symbol.toStringTag]&&e[Symbol.iterator])},toJSONObject:e=>{let t=Array(10),i=(e,n)=>{if(R(e)){if(t.indexOf(e)>=0)return;if(!("toJSON"in e)){t[n]=e;let r=I(e)?[]:{};return $(e,(e,t)=>{let o=i(e,n+1);z(o)||(r[t]=o)}),t[n]=void 0,r}}return e};return i(e,0)},isAsyncFn:ei,isThenable:e=>e&&(R(e)||B(e))&&B(e.then)&&B(e.catch)};/**
...
let eB={};function e_(e,t,i){eB[e]=class extends i{constructor(){super(),Object.defineProperty(this,"message",{value:t.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
...
// ================
let eW=/[^+/0-9A-Za-z-_]/g;function eU(e,t){let i;t=t||1/0;let n=e.length,r=null,o=[];for(let a=0;a<n;++a){// is surrogate component
...
for(;e.length%4!=0;)e+="=";return e}(e))}function e$(e,t,i,n){let r;for(r=0;r<n&&!(r+i>=t.length)&&!(r>=e.length);++r)t[r+i]=e[r];return r}// ArrayBuffer or Uint8Array objects from other contexts (i.e. iframes) do not pass
...
let to=en.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
...
t.data=tu.call(e,e.transformResponse,t),t.headers=tp.from(t.headers),t},function(t){return!tm(t)&&(tC(e),t&&t.response&&(t.response.data=tu.call(e,e.transformResponse,t.response),t.response.headers=tp.from(t.response.headers))),Promise.reject(t)})}let tN=e=>e instanceof tp?e.toJSON():e;function tL(e,t){// eslint-disable-next-line no-param-reassign
...
let{Axios:tD,AxiosError:tj,CanceledError:tF,isCancel:tW,CancelToken:tU,VERSION:tH,all:t$,Cancel:tX,isAxiosError:tG,spread:tq,toFormData:tV,AxiosHeaders:tY,HttpStatusCode:tK,formToJSON:tJ,getAdapter:tQ,mergeConfig:tZ}=tR,t0=document.querySelector(".card-list"),t1=async(e,t,i,n,r,o)=>{// Праметри API запиту
...
let is={allCategiries:document.querySelector(".categories-btn-all-js"),categories:document.querySelector(".categories-js"),popular:document.querySelector(".popular-change-js"),paginationShow:document.querySelector("#tui-pagination-container"),pagination:document.getElementById("tui-pagination-container"),recepies:document.querySelector(".recepies-js")},il=window.innerWidth<768?6:window.innerWidth<1280?8:9,ic=1,id=window.innerWidth<768?2:3,ip=new URLSearchParams({page:ic,limit:il}),iu={totalItems:0,itemsPerPage:il,visiblePages:id,page:ic},im=new/*@__PURE__*/(p(ia))(is.pagination,iu);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
function ih(){im.off("afterMove",ig),ib("page",1),ir(ip).then(e=>{t2(e),// встановлення слухача пагінації, відображення її
function(e){if(im.reset(e*il),e>1){im.on("afterMove",ig),is.paginationShow.classList.remove("is-hidden");return}is.paginationShow.classList.contains("is-hidden")||is.paginationShow.classList.add("is-hidden"),e||/*@__PURE__*/p(io).Notify.info("Вибачте, згідно параметрів пошуку рецептів не знайдено")}(e.data.totalPages)}).catch(()=>{})}// перемальовка рецептів при зміщенні пагінації
function ig(){ib("page",ic=im.getCurrentPage()),ir(ip).then(e=>{t2(e)}).catch(()=>{})}// знімаємо помітку з активної категорії
function ix(){let e=is.categories.querySelector(".is-active");e&&e.classList.remove("is-active")}// додавання/зміна параметру в об'єкт для пошуку рецепту
function ib(e,t){ip.has(e)&&ip.delete(e),ip.append(e,t)}/**
  |============================
  | Refs hero
  |============================
...
function(){ix(),is.allCategiries.classList.add("is-active"),// вилучення параметра в об'єкті пошуку рецепту
function(e){for(;ip.has(e);)ip.delete(e);console.log(ip.toString())}("category"),ih()}),is.categories.addEventListener("click",// вибір конкретної категорії
function(e){if("BUTTON"!==e.target.nodeName){console.log(e.target.nodeName);return}is.allCategiries.classList.contains("is-active")&&is.allCategiries.classList.remove("is-active"),ix(),e.target.classList.add("is-active");let t=e.target.dataset.set;ib("category",t),ih()}),is.popular.addEventListener("click",// обробка вибору популярного рецепту
...
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType)){let i=Object.keys(Object(n)).filter(e=>0>t.indexOf(e));for(let t=0,r=i.length;t<r;t+=1){let r=i[t],o=Object.getOwnPropertyDescriptor(n,r);void 0!==o&&o.enumerable&&(iM(e[r])&&iM(n[r])?n[r].__swiper__?e[r]=n[r]:iI(e[r],n[r]):!iM(e[r])&&iM(n[r])?(e[r]={},n[r].__swiper__?e[r]=n[r]:iI(e[r],n[r])):e[r]=n[r])}}}return e}function iz(e,t,i){e.style.setProperty(t,i)}function iO(e){let t,{swiper:i,targetPosition:n,side:r}=e,o=iN(),a=-i.translate,s=null,l=i.params.speed;i.wrapperEl.style.scrollSnapType="none",o.cancelAnimationFrame(i.cssModeFrameID);let c=n>a?"next":"prev",f=(e,t)=>"next"===c&&e>=t||"prev"===c&&e<=t,d=()=>{t=new Date().getTime(),null===s&&(s=t);let e=Math.max(Math.min((t-s)/l,1),0),c=a+(.5-Math.cos(e*Math.PI)/2)*(n-a);if(f(c,n)&&(c=n),i.wrapperEl.scrollTo({[r]:c}),f(c,n)){i.wrapperEl.style.overflow="hidden",i.wrapperEl.style.scrollSnapType="",setTimeout(()=>{i.wrapperEl.style.overflow="",i.wrapperEl.scrollTo({[r]:c})}),o.cancelAnimationFrame(i.cssModeFrameID);return}i.cssModeFrameID=o.requestAnimationFrame(d)};d()}function iP(e,t){return void 0===t&&(t=""),[...e.children].filter(e=>e.matches(t))}function iB(e,t){let i=iN();return i.getComputedStyle(e,null).getPropertyValue(t)}function i_(e){let t,i=e;if(i){// eslint-disable-next-line
for(t=0;null!==(i=i.previousSibling);)1===i.nodeType&&(t+=1);return t}}function iR(e,t,i){let n=iN();return i?e["width"===t?"offsetWidth":"offsetHeight"]+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-right":"margin-top"))+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-left":"margin-bottom")):e.offsetWidth}function iD(){return e||(e=function(){let e=iN(),t=iC();return{smoothScroll:t.documentElement&&t.documentElement.style&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)}}()),e}let ij=(e,t)=>{if(!e||e.destroyed||!e.params)return;let i=t.closest(e.isElement?"swiper-slide":`.${e.params.slideClass}`);if(i){let t=i.querySelector(`.${e.params.lazyPreloaderClass}`);!t&&e.isElement&&(t=i.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`)),t&&t.remove()}},iF=(e,t)=>{if(!e.slides[t])return;let i=e.slides[t].querySelector('[loading="lazy"]');i&&i.removeAttribute("loading")},iW=e=>{if(!e||e.destroyed||!e.params)return;let t=e.params.lazyPreloadPrevNext,i=e.slides.length;if(!i||!t||t<0)return;t=Math.min(t,i);let n="auto"===e.params.slidesPerView?e.slidesPerViewDynamic():Math.ceil(e.params.slidesPerView),r=e.activeIndex;if(e.params.grid&&e.params.grid.rows>1){let i=[r-t];i.push(...Array.from({length:t}).map((e,t)=>r+n+t)),e.slides.forEach((t,n)=>{i.includes(t.column)&&iF(e,n)});return}let o=r+n-1;if(e.params.rewind||e.params.loop)for(let n=r-t;n<=o+t;n+=1){let t=(n%i+i)%i;(t<r||t>o)&&iF(e,t)}else for(let n=Math.max(r-t,0);n<=Math.min(o+t,i-1);n+=1)n!==r&&(n>o||n<r)&&iF(e,n)};function iU(e){let{swiper:t,runCallbacks:i,direction:n,step:r}=e,{activeIndex:o,previousIndex:a}=t,s=n;if(s||(s=o>a?"next":o<a?"prev":"reset"),t.emit(`transition${r}`),i&&o!==a){if("reset"===s){t.emit(`slideResetTransition${r}`);return}t.emit(`slideChangeTransition${r}`),"next"===s?t.emit(`slideNextTransition${r}`):t.emit(`slidePrevTransition${r}`)}}function iH(e){let t=iC(),i=iN(),n=this.touchEventsData;n.evCache.push(e);let{params:r,touches:o,enabled:a}=this;if(!a||!r.simulateTouch&&"mouse"===e.pointerType||this.animating&&r.preventInteractionOnTransition)return;!this.animating&&r.cssMode&&r.loop&&this.loopFix();let s=e;s.originalEvent&&(s=s.originalEvent);let l=s.target;if("wrapper"===r.touchEventsTarget&&!this.wrapperEl.contains(l)||"which"in s&&3===s.which||"button"in s&&s.button>0||n.isTouched&&n.isMoved)return;// change target el for shadow root component
...
e.allowSlidePrev=r,e.allowSlideNext=n,e.params.watchOverflow&&o!==e.snapGrid&&e.checkOverflow()}function iq(e){this.enabled&&!this.allowClick&&(this.params.preventClicks&&e.preventDefault(),this.params.preventClicksPropagation&&this.animating&&(e.stopPropagation(),e.stopImmediatePropagation()))}function iV(){let{wrapperEl:e,rtlTranslate:t,enabled:i}=this;if(!i)return;this.previousTranslate=this.translate,this.isHorizontal()?this.translate=-e.scrollLeft:this.translate=-e.scrollTop,0===this.translate&&(this.translate=0),this.updateActiveIndex(),this.updateSlidesClasses();let n=this.maxTranslate()-this.minTranslate();(0===n?0:(this.translate-this.minTranslate())/n)!==this.progress&&this.updateProgress(t?-this.translate:this.translate),this.emit("setTranslate",this.translate,!1)}function iY(e){ij(this,e.target),!this.params.cssMode&&("auto"===this.params.slidesPerView||this.params.autoHeight)&&this.update()}let iK=!1;function iJ(){}let iQ=(e,t)=>{let i=iC(),{params:n,el:r,wrapperEl:o,device:a}=e,s=!!n.nested,l="on"===t?"addEventListener":"removeEventListener";// Touch Events
r[l]("pointerdown",e.onTouchStart,{passive:!1}),i[l]("pointermove",e.onTouchMove,{passive:!1,capture:s}),i[l]("pointerup",e.onTouchEnd,{passive:!0}),i[l]("pointercancel",e.onTouchEnd,{passive:!0}),i[l]("pointerout",e.onTouchEnd,{passive:!0}),i[l]("pointerleave",e.onTouchEnd,{passive:!0}),i[l]("contextmenu",e.onTouchEnd,{passive:!0}),(n.preventClicks||n.preventClicksPropagation)&&r[l]("click",e.onClick,!0),n.cssMode&&o[l]("scroll",e.onScroll),n.updateOnWindowResize?e[t](a.ios||a.android?"resize orientationchange observerUpdate":"resize observerUpdate",iG,!0):e[t]("observerUpdate",iG,!0),// Images loader
r[l]("load",e.onLoad,{capture:!0})},iZ=(e,t)=>e.grid&&t.grid&&t.grid.rows>1;var i0={init:!0,direction:"horizontal",oneWayMovement:!1,touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",// Overrides
...
return e}return iP(i,n())[0]})();return!r&&t.params.createElements&&(r=function(e,t){void 0===t&&(t=[]);let i=document.createElement("div");return i.classList.add(...Array.isArray(t)?t:[t]),i}(0,t.params.wrapperClass),i.append(r),iP(i,`.${t.params.slideClass}`).forEach(e=>{r.append(e)})),Object.assign(t,{el:i,wrapperEl:r,slidesEl:t.isElement&&!i.parentNode.host.slideSlots?i.parentNode.host:r,hostEl:t.isElement?i.parentNode.host:i,mounted:!0,// RTL
...
t.attachEvents();let n=[...t.el.querySelectorAll('[loading="lazy"]')];return t.isElement&&n.push(...t.hostEl.querySelectorAll('[loading="lazy"]')),n.forEach(e=>{e.complete?ij(t,e):e.addEventListener("load",e=>{ij(t,e.target)})}),iW(t),// Init Flag
t.initialized=!0,iW(t),// Emit
...
}})}(i)),i.destroyed=!0),null}static extendDefaults(e){iI(i2,e)}static get extendedDefaults(){return i2}static get defaults(){return i0}static installModule(e){i5.prototype.__modules__||(i5.prototype.__modules__=[]);let t=i5.prototype.__modules__;"function"==typeof e&&0>t.indexOf(e)&&t.push(e)}static use(e){return Array.isArray(e)?e.forEach(e=>i5.installModule(e)):i5.installModule(e),i5}}Object.keys(i1).forEach(e=>{Object.keys(i1[e]).forEach(t=>{i5.prototype[t]=i1[e][t]})}),i5.use([function(e){let{swiper:t,on:i,emit:n}=e,r=iN(),o=null,a=null,s=()=>{t&&!t.destroyed&&t.initialized&&(n("beforeResize"),n("resize"))},l=()=>{t&&!t.destroyed&&t.initialized&&(o=new ResizeObserver(e=>{a=r.requestAnimationFrame(()=>{let{width:i,height:n}=t,r=i,o=n;e.forEach(e=>{let{contentBoxSize:i,contentRect:n,target:a}=e;a&&a!==t.el||(r=n?n.width:(i[0]||i).inlineSize,o=n?n.height:(i[0]||i).blockSize)}),(r!==i||o!==n)&&s()})})).observe(t.el)},c=()=>{a&&r.cancelAnimationFrame(a),o&&o.unobserve&&t.el&&(o.unobserve(t.el),o=null)},f=()=>{t&&!t.destroyed&&t.initialized&&n("orientationchange")};i("init",()=>{if(t.params.resizeObserver&&void 0!==r.ResizeObserver){l();return}r.addEventListener("resize",s),r.addEventListener("orientationchange",f)}),i("destroy",()=>{c(),r.removeEventListener("resize",s),r.removeEventListener("orientationchange",f)})},function(e){let{swiper:t,extendParams:i,on:n,emit:r}=e,o=[],a=iN(),s=function(e,i){void 0===i&&(i={});let n=a.MutationObserver||a.WebkitMutationObserver,s=new n(e=>{// The observerUpdate event should only be triggered
...
s(t.wrapperEl,{attributes:!1})}}),n("destroy",()=>{o.forEach(e=>{e.disconnect()}),o.splice(0,o.length)})}]);let i6=iy();new i5(i6.swiperJs,{pagination:{el:i6.pagination,type:"bullets",clickable:!0},direction:"horizontal",loop:!0,slidesPerView:"auto",noSwiping:!0,noSwipingClass:"no-swipe",speed:700,spaceBetween:16});let i3={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
i3.form.addEventListener("submit",function(e){e.preventDefault(),console.log(category),e.preventDefault(),console.log(category),t7().then(e=>{}).catch(e=>{})}),i3.search.addEventListener("input",function(e){}),i3.time.addEventListener("change",function(e){}),i3.area.addEventListener("change",function(e){}),i3.ingredients.addEventListener("change",function(e){}),ii().then(e=>{i3.area.innerHTML=e.data.map(({name:e,id:t})=>`<option class="filter-opt" value="${t}">${e}</option>`).join("")}).catch(e=>{console.log(e)}),it().then(e=>{i3.ingredients.innerHTML=e.data.map(({name:e,id:t})=>`<option class="filter-opt" value="${t}">${e}</option>`).join("")}).catch(e=>{}),// ❗ Створення Time ❗
function(){let e=0;for(let t=0;t<16;t+=1)i3.time.insertAdjacentHTML("beforeend",`<option class="filter-opt" value="">${e+=10}</option>`)}(),// ❗ Створення js-reset-filter-btn ❗
i3.resetBtn.addEventListener("click",function(e){})}();//# sourceMappingURL=favorite.585d840a.js.map

//# sourceMappingURL=favorite.585d840a.js.map
