...
let id=window.innerWidth<768?6:window.innerWidth<1280?8:9,ip=1,iu=window.innerWidth<768?2:3;// екземпляр класу з параметрами для запиту рецептів по філтру
const im=new URLSearchParams({page:ip,limit:id}),ih={totalItems:0,itemsPerPage:id,visiblePages:iu,page:ip},ig=new/*@__PURE__*/(f(is))(ic.pagination,ih);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
...
let t=ic.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",ik)})}).catch(()=>{});const iT=iC();function iN(e){let t=/**
  |============================
  | Запит для Swiper
  |============================
*//**
...
nr.resetBtn.addEventListener("click",function(e){iE("time"),iE("area"),iE("ingredients"),ib()}//# sourceMappingURL=favorite.3d451b9c.js.map
);
//# sourceMappingURL=favorite.3d451b9c.js.map
