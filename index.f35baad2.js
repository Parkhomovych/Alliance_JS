 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nT(t){if("number"==typeof t)return t;if("symbol"==typeof(e=t)||e&&"object"==typeof e&&"[object Symbol]"==nk.call(e))return nu;if(nN(t)){var e,i="function"==typeof t.valueOf?t.valueOf():t;t=nN(i)?i+"":i}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(nm,"");var n=ng.test(t);return n||ny.test(t)?nx(t.slice(2),n?2:8):nh.test(t)?nu:+t}nd=/**
...
return void 0===l||i>=e||i<0||p&&n>=a}function h(){var t,i,n,o=nE();if(m(o))return g(o);// Restart the timer.
s=setTimeout(h,(t=o-l,i=o-c,n=e-t,p?nC(n,a-i):n))}function g(t){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(s=void 0,d&&n)?u(t):(n=o=void 0,r))}function y(){var t,i=nE(),a=m(i);if(n=arguments,o=this,l=i,a){if(void 0===s)return(// Reset any `maxWait` timer.
c=t=l,// Start the timer for the trailing edge.
s=setTimeout(h,e),f?u(t):r);if(p)return(// Handle invocations in a tight loop.
s=setTimeout(h,e),u(l))}return void 0===s&&(s=setTimeout(h,e)),r}return e=nT(e)||0,nN(i)&&(f=!!i.leading,a=(p="maxWait"in i)?nS(nT(i.maxWait)||0,e):a,d="trailing"in i?!!i.trailing:d),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nE())},y};let nL={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nL.form.addEventListener("submit",function(t){t.preventDefault()}),nL.time.addEventListener("change",function(t){iT("time",t.currentTarget.value),iw()}),nL.area.addEventListener("change",function(t){iT("area",t.currentTarget.value),iw()}),nL.ingredients.addEventListener("change",function(t){iT("ingredient",t.currentTarget.value),iw()}),nL.search.addEventListener("input",/*@__PURE__*/m(nd)(()=>{iT("title",nL.search.value.trim()),iw()},300)),ii().then(t=>{nL.area.innerHTML=t.data.map(({name:t})=>`<option class="filter-opt" value="${t}">${t}</option>`).join("")}).catch(t=>{console.log(t)}),ie().then(t=>{nL.ingredients.innerHTML=t.data.map(({name:t,_id:e})=>`<option class="filter-opt" value="${e}">${t}</option>`).join("")}).catch(t=>{}),// ❗ Створення Time ❗
...
nL.resetBtn.addEventListener("click",function(t){iL("time"),iL("area"),iL("ingredient"),iL("title"),iw()})}();//# sourceMappingURL=index.f35baad2.js.map

//# sourceMappingURL=index.f35baad2.js.map
