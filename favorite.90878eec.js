...
// ================
let eW=/[^+/0-9A-Za-z-_]/g;function eU(e,t){let i;t=t||1/0;let n=e.length,r=null,a=[];for(let o=0;o<n;++o){// is surrogate component
...
let{Axios:tD,AxiosError:tj,CanceledError:tF,isCancel:tW,CancelToken:tU,VERSION:t$,all:tH,Cancel:tX,isAxiosError:tG,spread:tq,toFormData:tV,AxiosHeaders:tY,HttpStatusCode:tK,formToJSON:tJ,getAdapter:tQ,mergeConfig:tZ}=tR,t0=document.querySelector(".card-list"),t1=async(e,t,i,n,r,a)=>{// Праметри API запиту
...
let ii={allCategiries:document.querySelector(".categories-btn-all-js"),categories:document.querySelector(".categories-js"),popular:document.querySelector(".popular-change-js"),paginationShow:document.querySelector("#tui-pagination-container"),pagination:document.getElementById("tui-pagination-container")},ir=window.innerWidth<768?6:window.innerWidth<1280?8:9,ia=1,io=window.innerWidth<768?2:3,is=new URLSearchParams({page:ia,limit:ir}),il={totalItems:0,itemsPerPage:ir,visiblePages:io,page:ia},ic=new/*@__PURE__*/(f(it))(ii.pagination,il);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
...
let t=ii.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",ig)})}).catch(()=>{});let iy=ix();function iv(e){let t=/**
  |============================
  | Запит для Swiper
  |============================
*//**
