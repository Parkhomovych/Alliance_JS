...
const{Axios:tD,AxiosError:tj,CanceledError:tF,isCancel:tW,CancelToken:tU,VERSION:tH,all:t$,Cancel:tX,isAxiosError:tG,spread:tq,toFormData:tV,AxiosHeaders:tY,HttpStatusCode:tK,formToJSON:tJ,getAdapter:tQ,mergeConfig:tZ}=tR,t0=document.querySelector(".card-list"),t1=async(e,t,i,n,r,o)=>{// Праметри API запиту
...
let il=window.innerWidth<768?6:window.innerWidth<1280?8:9,ic=1,id=window.innerWidth<768?2:3;// екземпляр класу з параметрами для запиту рецептів по філтру
const ip=new URLSearchParams({page:ic,limit:il}),iu={totalItems:0,itemsPerPage:il,visiblePages:id,page:ic},im=new/*@__PURE__*/(p(ia))(is.pagination,iu);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
...
s(t.wrapperEl,{attributes:!1})}}),n("destroy",()=>{o.forEach(e=>{e.disconnect()}),o.splice(0,o.length)})}]);const i6=iy();new i5(i6.swiperJs,{pagination:{el:i6.pagination,type:"bullets",clickable:!0},direction:"horizontal",loop:!0,slidesPerView:"auto",noSwiping:!0,noSwipingClass:"no-swipe",speed:700,spaceBetween:16});const i3={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
...
i3.resetBtn.addEventListener("click",function(e){}//# sourceMappingURL=favorite.b7f855ba.js.map
);
//# sourceMappingURL=favorite.b7f855ba.js.map
