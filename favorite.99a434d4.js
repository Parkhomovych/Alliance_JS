...
function(e){let{data:t}=e,i=t.map(({name:e})=>`<li class="categories-list-js"><button type="button" data-set="${e}" class="categories-btn-js">${e}</button></li>`).join("");return i}(e))}).catch(()=>{}),ie().then(e=>{is.popular.insertAdjacentHTML("beforeend",e.data.map(e=>`
     <li class="popular-item-js">
        ...
        </li> `).join(""))}).catch(()=>{});const iv=iy();function iw(e){let t=/**
  |============================
  | Запит для Swiper
  |============================
*//**
...
i9.resetBtn.addEventListener("click",function(e){}//# sourceMappingURL=favorite.99a434d4.js.map
);
//# sourceMappingURL=favorite.99a434d4.js.map
