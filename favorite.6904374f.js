...
const{Axios:tD,AxiosError:tj,CanceledError:tF,isCancel:tW,CancelToken:t$,VERSION:tU,all:tH,Cancel:tX,isAxiosError:tG,spread:tq,toFormData:tV,AxiosHeaders:tY,HttpStatusCode:tK,formToJSON:tJ,getAdapter:tQ,mergeConfig:tZ}=tR,t0=document.querySelector(".card-list"),t1=async(e,t,i,n,r,a)=>{// Праметри API запиту
...
const is={allCategiries:document.querySelector(".categories-btn-all-js"),categories:document.querySelector(".categories-js"),popular:document.querySelector(".popular-change-js"),paginationShow:document.querySelector("#tui-pagination-container"),pagination:document.getElementById("tui-pagination-container")};// налаштування початкових значень в залежносты від ширини вьюпорту
let il=window.innerWidth<768?6:window.innerWidth<1280?8:9,ic=1,ip=window.innerWidth<768?2:3;// екземпляр класу з параметрами для запиту рецептів по філтру
const id=new URLSearchParams({page:ic,limit:il}),iu={totalItems:0,itemsPerPage:il,visiblePages:ip,page:ic},im=new/*@__PURE__*/(f(io))(is.pagination,iu);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
...
let t=is.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",iv)})}).catch(()=>{});const iE=iS();function iC(e){let t=/**
  |============================
  | Запит для Swiper
  |============================
*//**
...
ni.resetBtn.addEventListener("click",function(e){ik("time"),ik("area"),ik("ingredients"),ih()});let nn=(e=>{try{let t=localStorage.getItem(e);return null===t?void 0:JSON.parse(t)}catch(e){console.error("Get state error: ",e.message),(0,ia.Notify).failure("Something went wrong. Please try again")}})("cardData"),nr=0;nn&&(nr=nn.length);const na=document.getElementById("pagination"),no={totalItems:nr,itemsPerPage:12,visiblePages:window.innerWidth<768?2:3,page:1,centerAlign:!0,firstItemClassName:"tui-first-child",lastItemClassName:"tui-last-child",template:{page:'<a href="#" class="tui-page-btn current-page">{{page}}</a>',currentPage:'<span class="tui-page-btn tui-is-selected">{{page}}</span>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}};new/*@__PURE__*/(f(io))(na,no);//# sourceMappingURL=favorite.6904374f.js.map

//# sourceMappingURL=favorite.6904374f.js.map
