...
config:tl.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});let tf=tc.prototype,tp={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(t=>{tp[t]={value:t}}),Object.defineProperties(tc,tp),Object.defineProperty(tf,"isAxiosError",{value:!0}),// eslint-disable-next-line func-names
tc.from=(t,e,i,n,o,a)=>{let r=Object.create(tf);return tl.toFlatObject(t,r,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),tc.call(r,t.message,e,i,n,o),r.cause=t,r.name=t.name,a&&Object.assign(r,a),r},f=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
...
tu["-".charCodeAt(0)]=62,tu["_".charCodeAt(0)]=63,p=function(t,e,i,n,o){var a,r,s=8*o-n-1,l=(1<<s)-1,c=l>>1,f=-7,p=i?o-1:0,d=i?-1:1,u=t[e+p];for(p+=d,a=u&(1<<-f)-1,u>>=-f,f+=s;f>0;a=256*a+t[e+p],p+=d,f-=8);for(r=a&(1<<-f)-1,a>>=-f,f+=n;f>0;r=256*r+t[e+p],p+=d,f-=8);if(0===a)a=1-c;else{if(a===l)return r?NaN:(u?-1:1)*(1/0);r+=Math.pow(2,n),a-=c}return(u?-1:1)*r*Math.pow(2,a-n)},d=function(t,e,i,n,o,a){var r,s,l,c=8*a-o-1,f=(1<<c)-1,p=f>>1,d=23===o?5960464477539062e-23:0,u=n?0:a-1,m=n?1:-1,h=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,r=f):(r=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-r))<1&&(r--,l*=2),r+p>=1?e+=d/l:e+=d*Math.pow(2,1-p),e*l>=2&&(r++,l/=2),r+p>=f?(s=0,r=f):r+p>=1?(s=(e*l-1)*Math.pow(2,o),r+=p):(s=e*Math.pow(2,p-1)*Math.pow(2,o),r=0));o>=8;t[i+u]=255&s,u+=m,s/=256,o-=8);for(r=r<<o|s,c+=o;c>0;t[i+u]=255&r,u+=m,r/=256,c-=8);t[i+u-m]|=128*h};let tx="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
(i>>>=0)<=(e>>>=0)))return"";for(t||(t="utf8");;)switch(t){case"hex":return function(t,e,i){let n=t.length;(!e||e<0)&&(e=0),(!i||i<0||i>n)&&(i=n);let o="";for(let n=e;n<i;++n)o+=tJ[t[n]];return o}(this,e,i);case"utf8":case"utf-8":return tz(this,e,i);case"ascii":return function(t,e,i){let n="";i=Math.min(t.length,i);for(let o=e;o<i;++o)n+=String.fromCharCode(127&t[o]);return n}(this,e,i);case"latin1":case"binary":return function(t,e,i){let n="";i=Math.min(t.length,i);for(let o=e;o<i;++o)n+=String.fromCharCode(t[o]);return n}(this,e,i);case"base64":var o,a;return o=e,a=i,0===o&&a===this.length?f(this):f(this.slice(o,a));case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return function(t,e,i){let n=t.slice(e,i),o="";// If bytes.length is odd, the last 8 bits must be ignored (same as node.js)
...
function tM(t,e,i,n,o){var a;// Empty buffer means no match
...
return l=e,c=i,tY(tV(t),this,l,c);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return f=e,p=i,tY(function(t,e){let i,n;let o=[];for(let a=0;a<t.length&&!((e-=2)<0);++a)n=(i=t.charCodeAt(a))>>8,o.push(i%256),o.push(n);return o}(t,this.length-f),this,f,p);default:if(u)throw TypeError("Unknown encoding: "+n);n=(""+n).toLowerCase(),u=!0}},tv.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}},tv.prototype.slice=function(t,e){let i=this.length;t=~~t,e=void 0===e?i:~~e,t<0?(t+=i)<0&&(t=0):t>i&&(t=i),e<0?(e+=i)<0&&(e=0):e>i&&(e=i),e<t&&(e=t);let n=this.subarray(t,e);return(// Return an augmented `Uint8Array` instance
...
return!tl.isUndefined(e[t])});let n=i.metaTokens,o=i.visitor||f,a=i.dots,r=i.indexes,s=i.Blob||"undefined"!=typeof Blob&&Blob,l=s&&tl.isSpecCompliantForm(e);if(!tl.isFunction(o))throw TypeError("visitor must be a function");function c(t){if(null===t)return"";if(tl.isDate(t))return t.toISOString();if(!l&&tl.isBlob(t))throw new tc("Blob is not supported. Use a Buffer instead.");return tl.isArrayBuffer(t)||tl.isTypedArray(t)?l&&"function"==typeof Blob?new Blob([t]):tv.from(t):t}/**
   ...
   */function f(t,i,o){let s=t;if(t&&!o&&"object"==typeof t){if(tl.endsWith(i,"{}"))// eslint-disable-next-line no-param-reassign
...
i=t1(i),s.forEach(function(t,n){tl.isUndefined(t)||null===t||e.append(!0===r?t2([i],n,a):null===r?i:i+"[]",c(t))}),!1)}}return!!t0(t)||(e.append(t2(o,i,a),c(t)),!1)}let p=[],d=Object.assign(t5,{defaultVisitor:f,convertValue:c,isVisitable:t0});if(!tl.isObject(t))throw TypeError("data must be an object");return!function t(i,n){if(!tl.isUndefined(i)){if(-1!==p.indexOf(i))throw Error("Circular reference detected in "+n.join("."));p.push(i),tl.forEach(i,function(i,a){let r=!(tl.isUndefined(i)||null===i)&&o.call(e,i,tl.isString(a)?a.trim():a,n,d);!0===r&&t(i,n?n.concat(a):[a])}),p.pop()}}(t),e};/**
...
let ef=tl.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */ep=t=>{let e,i,n;let o={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),i=t.substring(n+1).trim(),!e||o[e]&&ef[e]||("set-cookie"===e?o[e]?o[e].push(i):o[e]=[i]:o[e]=o[e]?o[e]+", "+i:i)}),o};let ed=Symbol("internals");function eu(t){return t&&String(t).trim().toLowerCase()}function em(t){return!1===t||null==t?t:tl.isArray(t)?t.map(em):String(t)}let eh=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function eg(t,e,i,n,o){if(tl.isFunction(n))return n.call(this,e,i);if(o&&(e=i),tl.isString(e)){if(tl.isString(n))return -1!==e.indexOf(n);if(tl.isRegExp(n))return n.test(e)}}class ey{constructor(t){t&&this.set(t)}set(t,e,i){let n=this;function o(t,e,i){let o=eu(e);if(!o)throw Error("header name must be a non-empty string");let a=tl.findKey(n,o);a&&void 0!==n[a]&&!0!==i&&(void 0!==i||!1===n[a])||(n[a||e]=em(t))}let a=(t,e)=>tl.forEach(t,(t,i)=>o(t,i,e));return tl.isPlainObject(t)||t instanceof this.constructor?a(t,e):tl.isString(t)&&(t=t.trim())&&!eh(t)?a(ep(t),e):null!=t&&o(e,t,i),this}get(t,e){if(t=eu(t)){let i=tl.findKey(this,t);if(i){let t=this[i];if(!e)return t;if(!0===e)return function(t){let e;let i=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)i[e[1]]=e[2];return i}(t);if(tl.isFunction(e))return e.call(this,t,i);if(tl.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=eu(t)){let i=tl.findKey(this,t);return!!(i&&void 0!==this[i]&&(!e||eg(this,this[i],i,e)))}return!1}delete(t,e){let i=this,n=!1;function o(t){if(t=eu(t)){let o=tl.findKey(i,t);o&&(!e||eg(i,i[o],o,e))&&(delete i[o],n=!0)}}return tl.isArray(t)?t.forEach(o):o(t),n}clear(t){let e=Object.keys(this),i=e.length,n=!1;for(;i--;){let o=e[i];(!t||eg(this,this[o],o,t,!0))&&(delete this[o],n=!0)}return n}normalize(t){let e=this,i={};return tl.forEach(this,(n,o)=>{let a=tl.findKey(i,o);if(a){e[a]=em(n),delete e[o];return}let r=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,i)=>e.toUpperCase()+i):String(o).trim();r!==o&&delete e[o],e[r]=em(n),i[r]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return tl.forEach(this,(i,n)=>{null!=i&&!1!==i&&(e[n]=t&&tl.isArray(i)?i.join(", "):i)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let i=new this(t);return e.forEach(t=>i.set(t)),i}static accessor(t){let e=this[ed]=this[ed]={accessors:{}},i=e.accessors,n=this.prototype;function o(t){let e=eu(t);i[e]||(!function(t,e){let i=tl.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+i,{value:function(t,i,o){return this[n].call(this,e,t,i,o)},configurable:!0})})}(n,t),i[e]=!0)}return tl.isArray(t)?t.forEach(o):o(t),this}}function ex(t,e){let i=this||ec,n=e||i,o=ey.from(n.headers),a=n.data;return tl.forEach(t,function(t){a=t.call(i,a,o.normalize(),e?e.status:void 0)}),o.normalize(),a}function eb(t){return!!(t&&t.__CANCEL__)}/**
 ...
 * @returns {Function}
 */function(t,e){let i;t=t||10;let n=Array(t),o=Array(t),a=0,r=0;return e=void 0!==e?e:1e3,function(s){let l=Date.now(),c=o[r];i||(i=l),n[a]=s,o[a]=l;let f=r,p=0;for(;f!==a;)p+=n[f++],f%=t;if((a=(a+1)%t)===r&&(r=(r+1)%t),l-i<e)return;let d=c&&l-c;return d?Math.round(1e3*p/d):void 0}};function eE(t,e){let i=0,n=eC(50,250);return o=>{let a=o.loaded,r=o.lengthComputable?o.total:void 0,s=a-i,l=n(s),c=a<=r;i=a;let f={loaded:a,total:r,progress:r?a/r:void 0,bytes:s,rate:l||void 0,estimated:l&&r&&c?(r-a)/l:void 0,event:o};f[e?"download":"upload"]=!0,t(f)}}let eN="undefined"!=typeof XMLHttpRequest;var eT=eN&&function(t){return new Promise(function(e,i){let n,o=t.data,a=ey.from(t.headers).normalize(),r=t.responseType;function s(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}tl.isFormData(o)&&(es.isStandardBrowserEnv||es.isStandardBrowserWebWorkerEnv?a.setContentType(!1):a.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
if(t.auth){let e=t.auth.username||"",i=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";a.set("Authorization","Basic "+btoa(e+":"+i))}let c=ek(t.baseURL,t.url);function f(){if(!l)return;// Prepare the response
...
n=e=>{l&&(i(!e||e.type?new ev(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let p=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(c);if(p&&-1===es.protocols.indexOf(p)){i(new tc("Unsupported protocol "+p+":",tc.ERR_BAD_REQUEST,t));return}// Send the request
 ...
 *
 * @returns {void}
 */function eM(t){if(t.cancelToken&&t.cancelToken.throwIfRequested(),t.signal&&t.signal.aborted)throw new ev(null,t)}function eI(t){eM(t),t.headers=ey.from(t.headers),// Transform request data
t.data=ex.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=eA.getAdapter(t.adapter||ec.adapter);return e(t).then(function(e){return eM(t),// Transform response data
e.data=ex.call(t,t.transformResponse,e),e.headers=ey.from(e.headers),e},function(e){return!eb(e)&&(eM(t),e&&e.response&&(e.response.data=ex.call(t,t.transformResponse,e.response),e.response.headers=ey.from(e.response.headers))),Promise.reject(e)})}let ez=t=>t instanceof ey?t.toJSON():t;function eO(t,e){// eslint-disable-next-line no-param-reassign
 ...
 */function t(e){let i=new ej(e),n=M(ej.prototype.request,i);return tl.extend(n,ej.prototype,i,{allOwnKeys:!0}),tl.extend(n,i,null,{allOwnKeys:!0}),// Factory for creating new instances
...
let{Axios:eU,AxiosError:eH,CanceledError:eX,isCancel:eq,CancelToken:eG,VERSION:eV,all:eY,Cancel:eK,isAxiosError:eJ,spread:eQ,toFormData:eZ,AxiosHeaders:e0,HttpStatusCode:e1,formToJSON:e2,getAdapter:e5,mergeConfig:e6}=e$,e3="https://tasty-treats-backend.p.goit.global/api",e4={events:"/events",recipes:"/recipes",categories:"/categories",popular:"/recipes/popular",ingredients:"/ingredients",areas:"/areas",orders:"/orders/add"},e8=async()=>{let t=await e$.get(`${e3}${e4.events}`);return t},e9=async()=>{let t=await e$.get(`${e3}${e4.categories}`);return t},e7=async()=>{let t=await e$.get(`${e3}${e4.popular}`);return t},it=async t=>{let e=await e$.get(`${e3}${e4.recipes}/${t}`);return e},ie=async()=>{let t=await e$.get(`${e3}${e4.ingredients}`);return t},ii=async()=>{let t=await e$.get(`${e3}${e4.areas}`);return t},io=async t=>{let e=await e$.post(`${e3}${e4.orders}`,t);return e},ia=async t=>{let e=await e$.get(`${e3}${e4.recipes}?${t}`);return e},ir=document.querySelector(".card-list"),is=async(t,e,i,n,o,a)=>{// Праметри API запиту
let r=new URLSearchParams({limit:9}),s=await e$.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${r}`);return s};function il(t){ir.innerHTML=t.data.results.map(t=>`
    <li class="card-item">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join(""),function(){let t=document.querySelectorAll(".box-star");t.forEach(t=>{let e=t.previousElementSibling,i=Math.round(e.textContent),n=[...t.children];n.forEach((t,e)=>{e<i&&t.classList.add("yellow-star")})})}()}window.addEventListener("load",function(){is().then(il).catch(t=>{console.log(t)})});let ic=new MutationObserver(function(){let t=document.querySelectorAll(".info-btn");// витягуємо всі кнопки
t.forEach(t=>{t.addEventListener("click",ip);// вішаємо слухача на кнопки
})});// створюємо екземпляр класу MutationObserver
function ip(t){let e=t.target.id;it(e).then(t=>{!function(t){let{data:{title:e,youtube:i,thumb:n,rating:o,time:a,ingredients:r,tags:s,instructions:l}}=t,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),f=h.create(`<div class="card-modal">
...
function(t){let e=document.querySelector(".box-stars");document.querySelector(".star");let i=[...e.children],n=Math.round(t);i.forEach((t,e)=>{e<n&&t.classList.add("yellow-star")})}(o),document.body.style.overflow="hidden";let p=document.querySelector(".js-card-close-btn");document.querySelector(".card-modal"),p.addEventListener("click",()=>{document.body.style.overflow="auto",f.close()})}(t);let e=document.querySelector(".basicLightbox");e.classList.add("correct-recipe")}).catch(t=>{console.log(t)})}ic.observe(ir,{// параметри MutationObserver
childList:!0,subtree:!0});var id={};window,id=/******/function(t){/******/// The module cache
 ...
 */p.mixin=function(t){n(t.prototype,p.prototype)},/**
 * Get HandlerItem object
 * @param {function} handler - handler function
 * @param {object} [context] - context for handler
 * @returns {HandlerItem} HandlerItem object
 * @private
 */p.prototype._getHandlerItem=function(t,e){var i={handler:t};return e&&(i.context=e),i},/**
 * Get event object safely
 * @param {string} [eventName] - create sub event map if not exist.
 * @returns {(object|array)} event object. if you supplied `eventName`
 *  parameter then make new array and return it
 * @private
 */p.prototype._safeEvent=function(t){var e,i=this.events;return i||(i=this.events={}),t&&((e=i[t])||(e=[],i[t]=e),i=e),i},/**
 ...
 * @private
 */p.prototype._indexOfContext=function(t){for(var e=this._safeContext(),i=0;e[i];){if(t===e[i][0])return i;i+=1}return -1},/**
 * Memorize supplied context for recognize supplied object is context or
 *  name: handler pair object when off()
 * @param {object} ctx - context object to memorize
 * @private
 */p.prototype._memorizeContext=function(t){var e,i;o(t)&&(e=this._safeContext(),(i=this._indexOfContext(t))>-1?e[i][1]+=1:e.push([t,1]))},/**
 * Forget supplied context object
 * @param {object} ctx - context object to forget
 * @private
 */p.prototype._forgetContext=function(t){var e,i;o(t)&&(e=this._safeContext(),(i=this._indexOfContext(t))>-1&&(e[i][1]-=1,e[i][1]<=0&&e.splice(i,1)))},/**
 * Bind event handler
 ...
 * @private
 */p.prototype._bindEvent=function(t,e,i){var n=this._safeEvent(t);this._memorizeContext(i),n.push(this._getHandlerItem(e,i))},/**
 * Bind event handlers
 * @param {(string|{name:string, handler:function})} eventName - custom
 *  event name or an object {eventName: handler}
 * @param {(function|object)} [handler] - handler function or context
 ...
 *     'play': handler
 * }, myObj);
 */p.prototype.on=function(t,e,i){var n=this;a(t)?c(// [syntax 1, 2]
 ...
 * @param {function|object} [handler] - handler function or context
 * @param {object} [context] - context for binding
 */p.prototype.once=function(t,e,i){var n=this;if(r(t)){i=e,c(t,function(t,e){n.once(e,t,i)});return}this.on(t,function o(){e.apply(i,arguments),n.off(t,o,i)},i)},/**
 * Splice supplied array by callback result
 * @param {array} arr - array to splice
 * @param {function} predicate - function return boolean
 * @private
 */p.prototype._spliceMatches=function(t,e){var i,n=0;if(s(t))for(i=t.length;n<i;n+=1)!0===e(t[n])&&(t.splice(n,1),i-=1,n-=1)},/**
 * Get matcher for unbind specific handler events
 * @param {function} handler - handler function
 * @returns {function} handler matcher
 * @private
 */p.prototype._matchHandler=function(t){var e=this;return function(i){var n=t===i.handler;return n&&e._forgetContext(i.context),n}},/**
 * Get matcher for unbind specific context events
 * @param {object} context - context
 * @returns {function} object matcher
 * @private
 */p.prototype._matchContext=function(t){var e=this;return function(i){var n=t===i.context;return n&&e._forgetContext(i.context),n}},/**
 * Get matcher for unbind specific hander, context pair events
 * @param {function} handler - handler function
 * @param {object} context - context
 * @returns {function} handler, context matcher
 * @private
 */p.prototype._matchHandlerAndContext=function(t,e){var i=this;return function(n){var o=t===n.handler,a=e===n.context,r=o&&a;return r&&i._forgetContext(n.context),r}},/**
 * Unbind event by event name
 * @param {string} eventName - custom event name to unbind
 * @param {function} [handler] - handler function
 * @private
 */p.prototype._offByEventName=function(t,e){var i=this,n=l(e),o=i._matchHandler(e);c(t=t.split(f),function(t){var e=i._safeEvent(t);n?i._spliceMatches(e,o):(c(e,function(t){i._forgetContext(t.context)}),i.events[t]=[])})},/**
 * Unbind event by handler function
 * @param {function} handler - handler function
 * @private
 */p.prototype._offByHandler=function(t){var e=this,i=this._matchHandler(t);c(this._safeEvent(),function(t){e._spliceMatches(t,i)})},/**
 * Unbind event by object(name: handler pair object or context object)
 * @param {object} obj - context or {name: handler} pair object
 * @param {function} handler - handler function
 * @private
 */p.prototype._offByObject=function(t,e){var i,n=this;0>this._indexOfContext(t)?c(t,function(t,e){n.off(e,t)}):a(e)?(i=this._matchContext(t),n._spliceMatches(this._safeEvent(e),i)):l(e)?(i=this._matchHandlerAndContext(e,t),c(this._safeEvent(),function(t){n._spliceMatches(t,i)})):(i=this._matchContext(t),c(this._safeEvent(),function(t){n._spliceMatches(t,i)}))},/**
 ...
 * CustomEvents.off();
 */p.prototype.off=function(t,e){a(t)?this._offByEventName(t,e):arguments.length?l(t)?this._offByHandler(t):r(t)&&this._offByObject(t,e):(// [syntax 8]
 ...
 *     // doSomething
 * }
 */p.prototype.invoke=function(t){var e,i,n,o;if(!this.hasListener(t))return!0;for(e=this._safeEvent(t),i=Array.prototype.slice.call(arguments,1),n=0;e[n];){if(!1===(o=e[n]).handler.apply(o.context,i))return!1;n+=1}return!0},/**
 ...
 */p.prototype.getListenerLength=function(t){return this._safeEvent(t).length},t.exports=p;/***/},/* 14 *//***/function(t,e,i){/**
...
return e.prototype=t,new e};/***/},/* 20 *//***/function(t,e,i){var n=i(3),o=i(7),a=i(21),r=i(22),s=i(24),l=i(25),c=i(0),f=i(4),p=i(28),d=i(9),u={page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'},m=["first","prev","next","last"],h=["prev","next"],g=o(/** @lends View.prototype */{init:function(t,e,i){/**
     ...
     * @private
     */_setRootElement:function(t){if(f(t)?t=document.getElementById(t)||document.querySelector(t):t.jquery&&(t=t[0]),!p(t))throw Error("The container element is invalid.");this._containerElement=t},/**
 ...
 * @private
 */// eslint-disable-next-line complexity
function x(t,e){var i,n=e[t];return"true"===t?n=!0:"false"===t?n=!1:u.test(t)?n=t.replace(m,""):c.test(t)?n=x((i=t.split(f))[0],e)[x(i[1],e)]:p.test(t)?n=x((i=t.split(d))[0],e)[i[1]]:h.test(t)&&(n=parseFloat(t)),n}/**
...
iw(),e7().then(t=>{im.popular.insertAdjacentHTML("beforeend",t.data.map(t=>`
...
let e=im.popular.querySelectorAll(".popular-button-js");e.forEach(t=>{t.addEventListener("click",iN)})}).catch(()=>{});// Визов функції відправлення messages on backend
var iA={};function iM(t){"Success"===t.data.message?(0,iA.Notify).success("Вітаємо, ваше замовлення прийнято!"):(0,iA.Notify).warning("Вибачте, в цей час замовлення не приймаються!")}/**
  |============================
  | Refs hero
  |============================
*/function iI(){return{swiperJs:document.querySelector(".swiper"),pagination:document.querySelector(".swiper-pagination"),eventSwiper:document.querySelector(".hero-swiper"),markupSwiper:document.querySelector(".swiper-wrapper"),orderBtnHero:document.querySelector(".btn-hero"),message:document.querySelector(".header-form"),btnMessage:document.querySelector(".header-form-btn")}}l=void 0!==u?u:"undefined"!=typeof window?window:iA,c=function(t){// COMMON: SSR check: begin
...
success:function(t,e,n){p(i.Success,t,e,n)},// Failure
failure:function(t,e,n){p(i.Failure,t,e,n)},// Warning
warning:function(t,e,n){p(i.Warning,t,e,n)},// Info
info:function(t,e,n){p(i.Info,t,e,n)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Notify:d.Notify}):{Notify:d.Notify}},"function"==typeof define&&define.amd?define([],function(){return c(l)}):"object"==typeof iA?iA=c(l):l.Notiflix=c(l);let iz=iI();function iO(t){let e=/**
  |============================
  | Розмітка Swiper
  |============================
*/function(t){let{cook:e,topic:i}=t;return t.map(t=>`<div class="swiper-slide">
        ...
        </div>`).join("")}(t.data);iz.markupSwiper.insertAdjacentHTML("afterbegin",e)}/**
  |============================
  | Бібліотека Swiper
  |============================
*//**
 ...
 *//* eslint-disable no-param-reassign */function iB(t){return null!==t&&"object"==typeof t&&"constructor"in t&&t.constructor===Object}function iP(t,e){void 0===t&&(t={}),void 0===e&&(e={}),Object.keys(e).forEach(i=>{void 0===t[i]?t[i]=e[i]:iB(e[i])&&iB(t[i])&&Object.keys(e[i]).length>0&&iP(t[i],e[i])})}// Прослуховувачі подій
window.addEventListener("load",function(){e8().then(iO).catch(t=>{console.log(t)})}),iz.orderBtnHero.addEventListener("click",function(){v();let t=document.querySelector(".header-form");!function(t){t.addEventListener("submit",function(t){t.preventDefault();let{name:e,phone:i,email:n,comment:o}=t.currentTarget.elements;io({name:e.value,phone:i.value,email:n.value,comment:o.value}).then(iM).catch(t=>{console.log(t)})})}(t)});let i_={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector:()=>null,querySelectorAll:()=>[],getElementById:()=>null,createEvent:()=>({initEvent(){}}),createElement:()=>({children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName:()=>[]}),createElementNS:()=>({}),importNode:()=>null,location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function iR(){let t="undefined"!=typeof document?document:{};return iP(t,i_),t}let iD={document:i_,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle:()=>({getPropertyValue:()=>""}),Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia:()=>({}),requestAnimationFrame:t=>"undefined"==typeof setTimeout?(t(),null):setTimeout(t,0),cancelAnimationFrame(t){"undefined"!=typeof setTimeout&&clearTimeout(t)}};function ij(){let t="undefined"!=typeof window?window:{};return iP(t,iD),t}function iW(t,e){return void 0===e&&(e=0),setTimeout(t,e)}function iF(){return Date.now()}function i$(t){return"object"==typeof t&&null!==t&&t.constructor&&"Object"===Object.prototype.toString.call(t).slice(8,-1)}function iU(){let t=Object(arguments.length<=0?void 0:arguments[0]),e=["__proto__","constructor","prototype"];for(let i=1;i<arguments.length;i+=1){let n=i<0||arguments.length<=i?void 0:arguments[i];if(null!=n&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType)){let i=Object.keys(Object(n)).filter(t=>0>e.indexOf(t));for(let e=0,o=i.length;e<o;e+=1){let o=i[e],a=Object.getOwnPropertyDescriptor(n,o);void 0!==a&&a.enumerable&&(i$(t[o])&&i$(n[o])?n[o].__swiper__?t[o]=n[o]:iU(t[o],n[o]):!i$(t[o])&&i$(n[o])?(t[o]={},n[o].__swiper__?t[o]=n[o]:iU(t[o],n[o])):t[o]=n[o])}}}return t}function iH(t,e,i){t.style.setProperty(e,i)}function iX(t){let e,{swiper:i,targetPosition:n,side:o}=t,a=ij(),r=-i.translate,s=null,l=i.params.speed;i.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(i.cssModeFrameID);let c=n>r?"next":"prev",f=(t,e)=>"next"===c&&t>=e||"prev"===c&&t<=e,p=()=>{e=new Date().getTime(),null===s&&(s=e);let t=Math.max(Math.min((e-s)/l,1),0),c=r+(.5-Math.cos(t*Math.PI)/2)*(n-r);if(f(c,n)&&(c=n),i.wrapperEl.scrollTo({[o]:c}),f(c,n)){i.wrapperEl.style.overflow="hidden",i.wrapperEl.style.scrollSnapType="",setTimeout(()=>{i.wrapperEl.style.overflow="",i.wrapperEl.scrollTo({[o]:c})}),a.cancelAnimationFrame(i.cssModeFrameID);return}i.cssModeFrameID=a.requestAnimationFrame(p)};p()}function iq(t,e){return void 0===e&&(e=""),[...t.children].filter(t=>t.matches(e))}function iG(t,e){void 0===e&&(e=[]);let i=document.createElement(t);return i.classList.add(...Array.isArray(e)?e:[e]),i}function iV(t,e){let i=ij();return i.getComputedStyle(t,null).getPropertyValue(e)}function iY(t){let e,i=t;if(i){// eslint-disable-next-line
for(e=0;null!==(i=i.previousSibling);)1===i.nodeType&&(e+=1);return e}}function iK(t,e){let i=[],n=t.parentElement;// eslint-disable-line
for(;n;)e?n.matches(e)&&i.push(n):i.push(n),n=n.parentElement;return i}function iJ(t,e,i){let n=ij();return i?t["width"===e?"offsetWidth":"offsetHeight"]+parseFloat(n.getComputedStyle(t,null).getPropertyValue("width"===e?"margin-right":"margin-top"))+parseFloat(n.getComputedStyle(t,null).getPropertyValue("width"===e?"margin-left":"margin-bottom")):t.offsetWidth}function iQ(){return t||(t=function(){let t=ij(),e=iR();return{smoothScroll:e.documentElement&&e.documentElement.style&&"scrollBehavior"in e.documentElement.style,touch:!!("ontouchstart"in t||t.DocumentTouch&&e instanceof t.DocumentTouch)}}()),t}let iZ=(t,e)=>{if(!t||t.destroyed||!t.params)return;let i=e.closest(t.isElement?"swiper-slide":`.${t.params.slideClass}`);if(i){let e=i.querySelector(`.${t.params.lazyPreloaderClass}`);!e&&t.isElement&&(e=i.shadowRoot.querySelector(`.${t.params.lazyPreloaderClass}`)),e&&e.remove()}},i0=(t,e)=>{if(!t.slides[e])return;let i=t.slides[e].querySelector('[loading="lazy"]');i&&i.removeAttribute("loading")},i1=t=>{if(!t||t.destroyed||!t.params)return;let e=t.params.lazyPreloadPrevNext,i=t.slides.length;if(!i||!e||e<0)return;e=Math.min(e,i);let n="auto"===t.params.slidesPerView?t.slidesPerViewDynamic():Math.ceil(t.params.slidesPerView),o=t.activeIndex;if(t.params.grid&&t.params.grid.rows>1){let i=[o-e];i.push(...Array.from({length:e}).map((t,e)=>o+n+e)),t.slides.forEach((e,n)=>{i.includes(e.column)&&i0(t,n)});return}let a=o+n-1;if(t.params.rewind||t.params.loop)for(let n=o-e;n<=a+e;n+=1){let e=(n%i+i)%i;(e<o||e>a)&&i0(t,e)}else for(let n=Math.max(o-e,0);n<=Math.min(a+e,i-1);n+=1)n!==o&&(n>a||n<o)&&i0(t,n)};function i2(t){let{swiper:e,runCallbacks:i,direction:n,step:o}=t,{activeIndex:a,previousIndex:r}=e,s=n;if(s||(s=a>r?"next":a<r?"prev":"reset"),e.emit(`transition${o}`),i&&a!==r){if("reset"===s){e.emit(`slideResetTransition${o}`);return}e.emit(`slideChangeTransition${o}`),"next"===s?e.emit(`slideNextTransition${o}`):e.emit(`slidePrevTransition${o}`)}}function i5(t){let e=iR(),i=ij(),n=this.touchEventsData;n.evCache.push(t);let{params:o,touches:a,enabled:r}=this;if(!r||!o.simulateTouch&&"mouse"===t.pointerType||this.animating&&o.preventInteractionOnTransition)return;!this.animating&&o.cssMode&&o.loop&&this.loopFix();let s=t;s.originalEvent&&(s=s.originalEvent);let l=s.target;if("wrapper"===o.touchEventsTarget&&!this.wrapperEl.contains(l)||"which"in s&&3===s.which||"button"in s&&s.button>0||n.isTouched&&n.isMoved)return;// change target el for shadow root component
let c=!!o.noSwipingClass&&""!==o.noSwipingClass,f=t.composedPath?t.composedPath():t.path;c&&s.target&&s.target.shadowRoot&&f&&(l=f[0]);let p=o.noSwipingSelector?o.noSwipingSelector:`.${o.noSwipingClass}`,d=!!(s.target&&s.target.shadowRoot);// use closestElement for shadow root element to get the actual closest for nested shadow root element
...
function(t,e){return void 0===e&&(e=this),function e(i){if(!i||i===iR()||i===ij())return null;i.assignedSlot&&(i=i.assignedSlot);let n=i.closest(t);return n||i.getRootNode?n||e(i.getRootNode().host):null}(e)}(p,l):l.closest(p))){this.allowClick=!0;return}if(o.swipeHandler&&!l.closest(o.swipeHandler))return;a.currentX=s.pageX,a.currentY=s.pageY;let u=a.currentX,m=a.currentY,h=o.edgeSwipeDetection||o.iOSEdgeSwipeDetection,g=o.edgeSwipeThreshold||o.iOSEdgeSwipeThreshold;if(h&&(u<=g||u>=i.innerWidth-g)){if("prevent"!==h)return;t.preventDefault()}Object.assign(n,{isTouched:!0,isMoved:!1,allowTouchCallbacks:!0,isScrolling:void 0,startMoving:void 0}),a.startX=u,a.startY=m,n.touchStartTime=iF(),this.allowClick=!0,this.updateSize(),this.swipeDirection=void 0,o.threshold>0&&(n.allowThresholdMove=!1);let y=!0;l.matches(n.focusableElements)&&(y=!1,"SELECT"===l.nodeName&&(n.isTouched=!1)),e.activeElement&&e.activeElement.matches(n.focusableElements)&&e.activeElement!==l&&e.activeElement.blur();let x=y&&this.allowTouchMove&&o.touchStartPreventDefault;(o.touchStartForcePreventDefault||x)&&!l.isContentEditable&&s.preventDefault(),o.freeMode&&o.freeMode.enabled&&this.freeMode&&this.animating&&!o.cssMode&&this.freeMode.onTouchStart(),this.emit("touchStart",s)}function i6(t){let e;let i=iR(),n=this.touchEventsData,{params:o,touches:a,rtlTranslate:r,enabled:s}=this;if(!s||!o.simulateTouch&&"mouse"===t.pointerType)return;let l=t;if(l.originalEvent&&(l=l.originalEvent),!n.isTouched){n.startMoving&&n.isScrolling&&this.emit("touchMoveOpposite",l);return}let c=n.evCache.findIndex(t=>t.pointerId===l.pointerId);c>=0&&(n.evCache[c]=l);let f=n.evCache.length>1?n.evCache[0]:l,p=f.pageX,d=f.pageY;if(l.preventedByNestedSwiper){a.startX=p,a.startY=d;return}if(!this.allowTouchMove){l.target.matches(n.focusableElements)||(this.allowClick=!1),n.isTouched&&(Object.assign(a,{startX:p,startY:d,prevX:this.touches.currentX,prevY:this.touches.currentY,currentX:p,currentY:d}),n.touchStartTime=iF());return}if(o.touchReleaseOnEdges&&!o.loop){if(this.isVertical()){if(d<a.startY&&this.translate<=this.maxTranslate()||d>a.startY&&this.translate>=this.minTranslate()){n.isTouched=!1,n.isMoved=!1;return}}else if(p<a.startX&&this.translate<=this.maxTranslate()||p>a.startX&&this.translate>=this.minTranslate())return}if(i.activeElement&&l.target===i.activeElement&&l.target.matches(n.focusableElements)){n.isMoved=!0,this.allowClick=!1;return}if(n.allowTouchCallbacks&&this.emit("touchMove",l),l.targetTouches&&l.targetTouches.length>1)return;a.currentX=p,a.currentY=d;let u=a.currentX-a.startX,m=a.currentY-a.startY;if(this.params.threshold&&Math.sqrt(u**2+m**2)<this.params.threshold)return;if(void 0===n.isScrolling){let t;this.isHorizontal()&&a.currentY===a.startY||this.isVertical()&&a.currentX===a.startX?n.isScrolling=!1:u*u+m*m>=25&&(t=180*Math.atan2(Math.abs(m),Math.abs(u))/Math.PI,n.isScrolling=this.isHorizontal()?t>o.touchAngle:90-t>o.touchAngle)}if(n.isScrolling&&this.emit("touchMoveOpposite",l),void 0===n.startMoving&&(a.currentX!==a.startX||a.currentY!==a.startY)&&(n.startMoving=!0),n.isScrolling||this.zoom&&this.params.zoom&&this.params.zoom.enabled&&n.evCache.length>1){n.isTouched=!1;return}if(!n.startMoving)return;this.allowClick=!1,!o.cssMode&&l.cancelable&&l.preventDefault(),o.touchMoveStopPropagation&&!o.nested&&l.stopPropagation();let h=this.isHorizontal()?u:m,g=this.isHorizontal()?a.currentX-a.previousX:a.currentY-a.previousY;o.oneWayMovement&&(h=Math.abs(h)*(r?1:-1),g=Math.abs(g)*(r?1:-1)),a.diff=h,h*=o.touchRatio,r&&(h=-h,g=-g);let y=this.touchesDirection;this.swipeDirection=h>0?"prev":"next",this.touchesDirection=g>0?"prev":"next";let x=this.params.loop&&!o.cssMode;if(!n.isMoved){if(x&&this.loopFix({direction:this.swipeDirection}),n.startTranslate=this.getTranslate(),this.setTransition(0),this.animating){let t=new window.CustomEvent("transitionend",{bubbles:!0,cancelable:!0});this.wrapperEl.dispatchEvent(t)}n.allowMomentumBounce=!1,o.grabCursor&&(!0===this.allowSlideNext||!0===this.allowSlidePrev)&&this.setGrabCursor(!0),this.emit("sliderFirstMove",l)}n.isMoved&&y!==this.touchesDirection&&x&&Math.abs(h)>=1&&(// need another loop fix
...
t.allowSlidePrev=o,t.allowSlideNext=n,t.params.watchOverflow&&a!==t.snapGrid&&t.checkOverflow()}function i8(t){this.enabled&&!this.allowClick&&(this.params.preventClicks&&t.preventDefault(),this.params.preventClicksPropagation&&this.animating&&(t.stopPropagation(),t.stopImmediatePropagation()))}function i9(){let{wrapperEl:t,rtlTranslate:e,enabled:i}=this;if(!i)return;this.previousTranslate=this.translate,this.isHorizontal()?this.translate=-t.scrollLeft:this.translate=-t.scrollTop,0===this.translate&&(this.translate=0),this.updateActiveIndex(),this.updateSlidesClasses();let n=this.maxTranslate()-this.minTranslate();(0===n?0:(this.translate-this.minTranslate())/n)!==this.progress&&this.updateProgress(e?-this.translate:this.translate),this.emit("setTranslate",this.translate,!1)}function i7(t){iZ(this,t.target),!this.params.cssMode&&("auto"===this.params.slidesPerView||this.params.autoHeight)&&this.update()}let nt=!1;function ne(){}let ni=(t,e)=>{let i=iR(),{params:n,el:o,wrapperEl:a,device:r}=t,s=!!n.nested,l="on"===e?"addEventListener":"removeEventListener";// Touch Events
o[l]("pointerdown",t.onTouchStart,{passive:!1}),i[l]("pointermove",t.onTouchMove,{passive:!1,capture:s}),i[l]("pointerup",t.onTouchEnd,{passive:!0}),i[l]("pointercancel",t.onTouchEnd,{passive:!0}),i[l]("pointerout",t.onTouchEnd,{passive:!0}),i[l]("pointerleave",t.onTouchEnd,{passive:!0}),i[l]("contextmenu",t.onTouchEnd,{passive:!0}),(n.preventClicks||n.preventClicksPropagation)&&o[l]("click",t.onClick,!0),n.cssMode&&a[l]("scroll",t.onScroll),n.updateOnWindowResize?t[e](r.ios||r.android?"resize orientationchange observerUpdate":"resize observerUpdate",i4,!0):t[e]("observerUpdate",i4,!0),// Images loader
o[l]("load",t.onLoad,{capture:!0})},nn=(t,e)=>t.grid&&e.grid&&e.grid.rows>1;var no={init:!0,direction:"horizontal",oneWayMovement:!1,touchEventsTarget:"wrapper",initialSlide:0,speed:300,cssMode:!1,updateOnWindowResize:!0,resizeObserver:!0,nested:!1,createElements:!1,enabled:!0,focusableElements:"input, select, option, textarea, button, video, label",// Overrides
...
r.updateProgress(a),s.cssMode){let t=r.isHorizontal();if(0===e)l[t?"scrollLeft":"scrollTop"]=-a;else{if(!r.support.smoothScroll)return iX({swiper:r,targetPosition:-a,side:t?"left":"top"}),!0;l.scrollTo({[t?"left":"top"]:-a,behavior:"smooth"})}return!0}return 0===e?(r.setTransition(0),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",e,o),r.emit("transitionEnd"))):(r.setTransition(e),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",e,o),r.emit("transitionStart")),r.animating||(r.animating=!0,r.onTranslateToWrapperTransitionEnd||(r.onTranslateToWrapperTransitionEnd=function(t){r&&!r.destroyed&&t.target===this&&(r.wrapperEl.removeEventListener("transitionend",r.onTranslateToWrapperTransitionEnd),r.onTranslateToWrapperTransitionEnd=null,delete r.onTranslateToWrapperTransitionEnd,i&&r.emit("transitionEnd"))}),r.wrapperEl.addEventListener("transitionend",r.onTranslateToWrapperTransitionEnd))),!0}},transition:{setTransition:function(t,e){this.params.cssMode||(this.wrapperEl.style.transitionDuration=`${t}ms`,this.wrapperEl.style.transitionDelay=0===t?"0ms":""),this.emit("setTransition",t,e)},transitionStart:function(t,e){void 0===t&&(t=!0);let{params:i}=this;i.cssMode||(i.autoHeight&&this.updateAutoHeight(),i2({swiper:this,runCallbacks:t,direction:e,step:"Start"}))},transitionEnd:function(t,e){void 0===t&&(t=!0);let{params:i}=this;this.animating=!1,i.cssMode||(this.setTransition(0),i2({swiper:this,runCallbacks:t,direction:e,step:"End"}))}},slide:{slideTo:function(t,e,i,n,o){let a;void 0===t&&(t=0),void 0===e&&(e=this.params.speed),void 0===i&&(i=!0),"string"==typeof t&&(t=parseInt(t,10));let r=this,s=t;s<0&&(s=0);let{params:l,snapGrid:c,slidesGrid:f,previousIndex:p,activeIndex:d,rtlTranslate:u,wrapperEl:m,enabled:h}=r;if(r.animating&&l.preventInteractionOnTransition||!h&&!n&&!o)return!1;let g=Math.min(r.params.slidesPerGroupSkip,s),y=g+Math.floor((s-g)/r.params.slidesPerGroup);y>=c.length&&(y=c.length-1);let x=-c[y];// Normalize slideIndex
...
return t}return iq(i,n())[0]})();return!o&&e.params.createElements&&(o=iG("div",e.params.wrapperClass),i.append(o),iq(i,`.${e.params.slideClass}`).forEach(t=>{o.append(t)})),Object.assign(e,{el:i,wrapperEl:o,slidesEl:e.isElement&&!i.parentNode.host.slideSlots?i.parentNode.host:o,hostEl:e.isElement?i.parentNode.host:i,mounted:!0,// RTL
rtl:"rtl"===i.dir.toLowerCase()||"rtl"===iV(i,"direction"),rtlTranslate:"horizontal"===e.params.direction&&("rtl"===i.dir.toLowerCase()||"rtl"===iV(i,"direction")),wrongRTL:"-webkit-box"===iV(o,"display")}),!0}init(t){let e=this;if(e.initialized)return e;let i=e.mount(t);if(!1===i)return e;e.emit("beforeInit"),e.params.breakpoints&&e.setBreakpoint(),// Add Classes
...
e.attachEvents();let n=[...e.el.querySelectorAll('[loading="lazy"]')];return e.isElement&&n.push(...e.hostEl.querySelectorAll('[loading="lazy"]')),n.forEach(t=>{t.complete?iZ(e,t):t.addEventListener("load",t=>{iZ(e,t.target)})}),i1(e),// Init Flag
e.initialized=!0,i1(e),// Emit
...
}})}(i)),i.destroyed=!0),null}static extendDefaults(t){iU(nr,t)}static get extendedDefaults(){return nr}static get defaults(){return no}static installModule(t){ns.prototype.__modules__||(ns.prototype.__modules__=[]);let e=ns.prototype.__modules__;"function"==typeof t&&0>e.indexOf(t)&&e.push(t)}static use(t){return Array.isArray(t)?t.forEach(t=>ns.installModule(t)):ns.installModule(t),ns}}function nl(t){return void 0===t&&(t=""),`.${t.trim().replace(/([\.:!+\/])/g,"\\$1")// eslint-disable-line
.replace(/ /g,".")}`}Object.keys(na).forEach(t=>{Object.keys(na[t]).forEach(e=>{ns.prototype[e]=na[t][e]})}),ns.use([function(t){let{swiper:e,on:i,emit:n}=t,o=ij(),a=null,r=null,s=()=>{e&&!e.destroyed&&e.initialized&&(n("beforeResize"),n("resize"))},l=()=>{e&&!e.destroyed&&e.initialized&&(a=new ResizeObserver(t=>{r=o.requestAnimationFrame(()=>{let{width:i,height:n}=e,o=i,a=n;t.forEach(t=>{let{contentBoxSize:i,contentRect:n,target:r}=t;r&&r!==e.el||(o=n?n.width:(i[0]||i).inlineSize,a=n?n.height:(i[0]||i).blockSize)}),(o!==i||a!==n)&&s()})})).observe(e.el)},c=()=>{r&&o.cancelAnimationFrame(r),a&&a.unobserve&&e.el&&(a.unobserve(e.el),a=null)},f=()=>{e&&!e.destroyed&&e.initialized&&n("orientationchange")};i("init",()=>{if(e.params.resizeObserver&&void 0!==o.ResizeObserver){l();return}o.addEventListener("resize",s),o.addEventListener("orientationchange",f)}),i("destroy",()=>{c(),o.removeEventListener("resize",s),o.removeEventListener("orientationchange",f)})},function(t){let{swiper:e,extendParams:i,on:n,emit:o}=t,a=[],r=ij(),s=function(t,i){void 0===i&&(i={});let n=r.MutationObserver||r.WebkitMutationObserver,s=new n(t=>{// The observerUpdate event should only be triggered
// once despite the number of mutations.  Additional
// triggers are redundant and are very costly
if(e.__preventObserver__)return;if(1===t.length){o("observerUpdate",t[0]);return}let i=function(){o("observerUpdate",t[0])};r.requestAnimationFrame?r.requestAnimationFrame(i):r.setTimeout(i,0)});s.observe(t,{attributes:void 0===i.attributes||i.attributes,childList:void 0===i.childList||i.childList,characterData:void 0===i.characterData||i.characterData}),a.push(s)};i({observer:!1,observeParents:!1,observeSlideChildren:!1}),n("init",()=>{if(e.params.observer){if(e.params.observeParents){let t=iK(e.hostEl);for(let e=0;e<t.length;e+=1)s(t[e])}// Observe container
s(e.hostEl,{childList:e.params.observeSlideChildren}),// Observe wrapper
s(e.wrapperEl,{attributes:!1})}}),n("destroy",()=>{a.forEach(t=>{t.disconnect()}),a.splice(0,a.length)})}]),ns.use([function(t){let e,{swiper:i,extendParams:n,on:o,emit:a}=t,r="swiper-pagination";n({pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
dynamicBullets:!1,dynamicMainBullets:1,formatFractionCurrent:t=>t,formatFractionTotal:t=>t,bulletClass:`${r}-bullet`,bulletActiveClass:`${r}-bullet-active`,modifierClass:`${r}-`,currentClass:`${r}-current`,totalClass:`${r}-total`,hiddenClass:`${r}-hidden`,progressbarFillClass:`${r}-progressbar-fill`,progressbarOppositeClass:`${r}-progressbar-opposite`,clickableClass:`${r}-clickable`,lockClass:`${r}-lock`,horizontalClass:`${r}-horizontal`,verticalClass:`${r}-vertical`,paginationDisabledClass:`${r}-disabled`}}),i.pagination={el:null,bullets:[]};let s=0,l=t=>(Array.isArray(t)?t:[t]).filter(t=>!!t);function c(){return!i.params.pagination.el||!i.pagination.el||Array.isArray(i.pagination.el)&&0===i.pagination.el.length}function f(t,e){let{bulletActiveClass:n}=i.params.pagination;t&&(t=t[`${"prev"===e?"previous":"next"}ElementSibling`])&&(t.classList.add(`${n}-${e}`),(t=t[`${"prev"===e?"previous":"next"}ElementSibling`])&&t.classList.add(`${n}-${e}-${e}`))}function p(t){let e=t.target.closest(nl(i.params.pagination.bulletClass));if(!e)return;t.preventDefault();let n=iY(e)*i.params.slidesPerGroup;if(i.params.loop){if(i.realIndex===n)return;let t=i.realIndex,e=i.getSlideIndexByData(n),o=i.getSlideIndexByData(i.realIndex);if(e>i.slides.length-i.loopedSlides){let n=i.activeIndex;i.loopFix({direction:e>o?"next":"prev",activeSlideIndex:e,slideTo:!1});let a=i.activeIndex;n===a&&i.slideToLoop(t,0,!1,!0)}i.slideToLoop(n)}else i.slideTo(n)}function d(){let t,n;// Render || Update Pagination bullets/items
 ...
 * _.isObject(null);
 * // => false
 */function nE(t){var e=typeof t;return!!t&&("object"==e||"function"==e)}/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nN(t){if("number"==typeof t)return t;if("symbol"==typeof(e=t)||e&&"object"==typeof e&&"[object Symbol]"==nw.call(e))return nd;if(nE(t)){var e,i="function"==typeof t.valueOf?t.valueOf():t;t=nE(i)?i+"":i}if("string"!=typeof t)return 0===t?t:+t;t=t.replace(nu,"");var n=nh.test(t);return n||ng.test(t)?ny(t.slice(2),n?2:8):nm.test(t)?nd:+t}np=/**
 ...
 */function(t,e,i){var n,o,a,r,s,l,c=0,f=!1,p=!1,d=!0;if("function"!=typeof t)throw TypeError("Expected a function");function u(e){var i=n,a=o;return n=o=void 0,c=e,r=t.apply(a,i)}function m(t){var i=t-l,n=t-c;// Either this is the first call, activity has stopped and we're at the
// trailing edge, the system time has gone backwards and we're treating
// it as the trailing edge, or we've hit the `maxWait` limit.
return void 0===l||i>=e||i<0||p&&n>=a}function h(){var t,i,n,o=nC();if(m(o))return g(o);// Restart the timer.
s=setTimeout(h,(t=o-l,i=o-c,n=e-t,p?nS(n,a-i):n))}function g(t){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(s=void 0,d&&n)?u(t):(n=o=void 0,r))}function y(){var t,i=nC(),a=m(i);if(n=arguments,o=this,l=i,a){if(void 0===s)return(// Reset any `maxWait` timer.
c=t=l,// Start the timer for the trailing edge.
s=setTimeout(h,e),f?u(t):r);if(p)return(// Handle invocations in a tight loop.
s=setTimeout(h,e),u(l))}return void 0===s&&(s=setTimeout(h,e)),r}return e=nN(e)||0,nE(i)&&(f=!!i.leading,a=(p="maxWait"in i)?nk(nN(i.maxWait)||0,e):a,d="trailing"in i?!!i.trailing:d),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nC())},y};let nT={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nT.form.addEventListener("submit",function(t){t.preventDefault()}),nT.time.addEventListener("change",function(t){iT("time",t.currentTarget.value),iw()}),nT.area.addEventListener("change",function(t){iT("area",t.currentTarget.value),iw()}),nT.ingredients.addEventListener("change",function(t){iT("ingredient",t.currentTarget.value),iw()}),nT.search.addEventListener("input",/*@__PURE__*/m(np)(()=>{iT("title",nT.search.value.trim()),iw()},300)),ii().then(t=>{nT.area.innerHTML=t.data.map(({name:t})=>`<option class="filter-opt" value="${t}">${t}</option>`).join("")}).catch(t=>{console.log(t)}),ie().then(t=>{nT.ingredients.innerHTML=t.data.map(({name:t,_id:e})=>`<option class="filter-opt" value="${e}">${t}</option>`).join("")}).catch(t=>{}),// ❗ Створення Time ❗
function(){let t="";// ❗ ДОРОБИТИ ПРАВИЛЬНУ ЛОГІКУ ЧАСУ ❗
for(let e=0;e<220;e+=5)e%10==0&&(t+=`<option class="filter-opt" value="${e}">${e}</option>`);nT.time.insertAdjacentHTML("beforeend",t)}(),// ❗ Створення js-reset-filter-btn ❗
nT.resetBtn.addEventListener("click",function(t){iL("time"),iL("area"),iL("ingredient"),iL("title"),iw()})}();//# sourceMappingURL=index.fdd34f0a.js.map

//# sourceMappingURL=index.fdd34f0a.js.map
