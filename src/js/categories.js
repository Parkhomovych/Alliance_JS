...
import { searchEvents, searchCategories, searchRecipesFilter, searchRecipesPopular, searchRecipesId, searchRecipesIdRating, searchIngredients, searchAreas, searchAddOrders, searchRecipesFlexFilter } from './createAPI'
import {createMarkup} from "../markup-card.js"
...
searchRecipesPopular().then((popular) => {
    ...
    refs.popular.insertAdjacentHTML('beforeend', makeMarkupPopular(popular.data));
}).catch(() => { });
