...
let s=new URLSearchParams({limit:e}),l=await tI.get(`https://tasty-treats-backend.p.goit.global/api/recipes?${s}`);return l};function ih(e){iu.innerHTML=e.map(e=>`
    ...
    function(e){let t=id.findIndex(({_id:t})=>t===e);return(console.log(t),t>-1&&id[t].favorit)?" add-fill":""}(e._id)}" data-set="${e._id}" viewBox="0 0 32 32">
...
<path d="M13.826 3.262c0.684-2.106 3.663-2.106 4.348 0l1.932 5.945c0.306 0.942 1.184 1.579 2.174 1.579h6.251c2.214 0 3.135 2.833 1.344 4.135l-5.057 3.674c-0.801 0.582-1.136 1.614-0.83 2.556l1.931 5.945c0.684 2.106-1.726 3.857-3.517 2.555l-5.057-3.674c-0.801-0.582-1.886-0.582-2.687 0l-5.057 3.674c-1.791 1.302-4.202-0.45-3.517-2.555l1.932-5.945c0.306-0.942-0.029-1.973-0.83-2.556l-5.057-3.674c-1.791-1.302-0.871-4.135 1.344-4.135h6.251c0.99 0 1.868-0.638 2.174-1.579l1.932-5.945z"></path>
  ...
  `).join(""),function(){let e=document.querySelectorAll(".box-star");e.forEach(e=>{let t=e.previousElementSibling,i=Math.round(t.textContent),n=[...e.children];n.forEach((e,t)=>{t<i&&e.classList.add("yellow-star")})})}()}window.addEventListener("load",function(){im().then(ih).catch(e=>{console.log(e)})});let ig=new MutationObserver(function(){let e=document.querySelectorAll(".info-btn");// витягуємо всі кнопки
e.forEach(e=>{e.addEventListener("click",iy);// вішаємо слухача на кнопки
})});// створюємо екземпляр класу MutationObserver
function iy(e){let t=e.target.id;tQ(t).then(e=>{ix(e);let t=document.querySelector(".basicLightbox");t.classList.add("correct-recipe")}).catch(e=>{console.log(e)})}function ix(e){let{data:{title:t,youtube:i,thumb:n,rating:o,time:a,ingredients:r,tags:s,instructions:l}}=e,c=i.replace("https://www.youtube.com/watch?v=","https://www.youtube.com/embed/"),f=g.create(`<div class="card-modal">
...
function(e){let t=document.querySelector(".box-stars");document.querySelector(".star");let i=[...t.children],n=Math.round(e);i.forEach((e,t)=>{t<n&&e.classList.add("yellow-star")})}(o),document.body.style.overflow="hidden";let p=document.querySelector(".js-card-close-btn");document.querySelector(".card-modal"),p.addEventListener("click",()=>{document.body.style.overflow="auto",f.close()})}ig.observe(iu,{// параметри MutationObserver
childList:!0,subtree:!0});var ib={};window,ib=/******/function(e){/******/// The module cache
...
let iv={allCategiries:document.querySelector(".categories-btn-all-js"),categories:document.querySelector(".categories-js"),popular:document.querySelector(".popular-change-js"),paginationShow:document.querySelector("#tui-pagination-container"),pagination:document.getElementById("tui-pagination-container")},iw=window.innerWidth<768?6:window.innerWidth<1280?8:9,ik=1,iS=window.innerWidth<768?2:3,iC=new URLSearchParams({page:ik,limit:iw}),iE={totalItems:0,itemsPerPage:iw,visiblePages:iS,page:ik},iN=new/*@__PURE__*/(h(ib))(iv.pagination,iE);// перемальовка блоку рецептів після зміни параметрів запиту з 1 сторынки з перемальовкою пагінації
function iT(){iN.off("afterMove",iL),iO("page",1),t2(iC).then(e=>{ih(e.data.results),// встановлення слухача пагінації, відображення її
function(e){if(iN.reset(e*iw),e>1){iN.on("afterMove",iL),iv.paginationShow.classList.remove("is-hidden");return}iv.paginationShow.classList.contains("is-hidden")||iv.paginationShow.classList.add("is-hidden"),e||/*@__PURE__*/h(ic).Notify.info("Вибачте, згідно параметрів пошуку рецептів не знайдено")}(e.data.totalPages)}).catch(()=>{})}// перемальовка рецептів при зміщенні пагінації
function iL(){iO("page",ik=iN.getCurrentPage()),t2(iC).then(e=>{ih(e.data.results)}).catch(()=>{})}// вибір "всіх категорій" по натисканню "AllCategories"
function iA(){iM(),iv.allCategiries.classList.add("is-active"),iB("category"),iT()}// вибір конкретної категорії
function iI(e){if("BUTTON"!==e.target.nodeName)return;iv.allCategiries.classList.contains("is-active")&&iv.allCategiries.classList.remove("is-active"),iM(),e.target.classList.add("is-active");let t=e.target.dataset.set;iO("category",t),iT()}// знімаємо помітку з активної категорії
function iM(){let e=iv.categories.querySelector(".is-active");e&&e.classList.remove("is-active")}// обробка вибору популярного рецепту
function iz(e){if("BUTTON"!==e.currentTarget.nodeName)return;let t=e.currentTarget.dataset.set;!function(e){tQ(e).then(e=>{ix(e);let t=document.querySelector(".basicLightbox");t.classList.add("correct-recipe")}).catch(e=>{console.log(e)})}(t)}// додавання/зміна параметру в об'єкт для пошуку рецепту
function iO(e,t){iC.has(e)&&iC.delete(e),iC.append(e,t)}// вилучення параметра в об'єкті пошуку рецепту
function iB(e){for(;iC.has(e);)iC.delete(e)}/**
  |============================
  | Refs hero
  |============================
*/function iP(){return{swiperJs:document.querySelector(".swiper"),pagination:document.querySelector(".swiper-pagination"),eventSwiper:document.querySelector(".hero-swiper"),markupSwiper:document.querySelector(".swiper-wrapper"),orderBtnHero:document.querySelector(".btn-hero"),message:document.querySelector(".header-form"),btnMessage:document.querySelector(".header-form-btn")}}// слухачі подій
iv.allCategiries.addEventListener("click",iA),iv.categories.addEventListener("click",iI),iv.popular.addEventListener("click",iz),// прибирання слухачів подій
window.addEventListener("unload",function(){iv.allCategiries.removeEventListener("click",iA),iv.categories.removeEventListener("click",iI),iv.popular.removeEventListener("click",iz),iN.off("afterMove",iL)}),tK().then(e=>{iv.categories.insertAdjacentHTML("beforeend",// формування розмітки переліку категорій
...
iT(),tJ().then(e=>{iv.popular.insertAdjacentHTML("beforeend",e.data.map(e=>`
...
let t=iv.popular.querySelectorAll(".popular-button-js");t.forEach(e=>{e.addEventListener("click",iz)})}).catch(()=>{});let i_=iP();function iR(e){let t=/**
  |============================
  | Розмітка Swiper
  |============================
*/function(e){let{cook:t,topic:i}=e;return e.map(e=>`<div class="swiper-slide">
        ...
        </div>`).join("")}(e.data);i_.markupSwiper.insertAdjacentHTML("afterbegin",t)}/**
  |============================
  | Бібліотека Swiper
  |============================
*//**
 ...
 *//* eslint-disable no-param-reassign */function iD(e){return null!==e&&"object"==typeof e&&"constructor"in e&&e.constructor===Object}function ij(e,t){void 0===e&&(e={}),void 0===t&&(t={}),Object.keys(t).forEach(i=>{void 0===e[i]?e[i]=t[i]:iD(t[i])&&iD(e[i])&&Object.keys(t[i]).length>0&&ij(e[i],t[i])})}// Прослуховувачі подій
window.addEventListener("load",function(){tY().then(iR).catch(e=>{console.log(e)})}),i_.orderBtnHero.addEventListener("click",function(){t9();// const modalMessage = document.querySelector('.header-form');
// callMassageAdd(modalMessage);
});let iW={body:{},addEventListener(){},removeEventListener(){},activeElement:{blur(){},nodeName:""},querySelector:()=>null,querySelectorAll:()=>[],getElementById:()=>null,createEvent:()=>({initEvent(){}}),createElement:()=>({children:[],childNodes:[],style:{},setAttribute(){},getElementsByTagName:()=>[]}),createElementNS:()=>({}),importNode:()=>null,location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""}};function iF(){let e="undefined"!=typeof document?document:{};return ij(e,iW),e}let i$={document:iW,navigator:{userAgent:""},location:{hash:"",host:"",hostname:"",href:"",origin:"",pathname:"",protocol:"",search:""},history:{replaceState(){},pushState(){},go(){},back(){}},CustomEvent:function(){return this},addEventListener(){},removeEventListener(){},getComputedStyle:()=>({getPropertyValue:()=>""}),Image(){},Date(){},screen:{},setTimeout(){},clearTimeout(){},matchMedia:()=>({}),requestAnimationFrame:e=>"undefined"==typeof setTimeout?(e(),null):setTimeout(e,0),cancelAnimationFrame(e){"undefined"!=typeof setTimeout&&clearTimeout(e)}};function iU(){let e="undefined"!=typeof window?window:{};return ij(e,i$),e}function iH(e,t){return void 0===t&&(t=0),setTimeout(e,t)}function iX(){return Date.now()}function iq(e){return"object"==typeof e&&null!==e&&e.constructor&&"Object"===Object.prototype.toString.call(e).slice(8,-1)}function iG(){let e=Object(arguments.length<=0?void 0:arguments[0]),t=["__proto__","constructor","prototype"];for(let i=1;i<arguments.length;i+=1){let n=i<0||arguments.length<=i?void 0:arguments[i];if(null!=n&&// eslint-disable-next-line
("undefined"!=typeof window&&void 0!==window.HTMLElement?!(n instanceof HTMLElement):!n||1!==n.nodeType&&11!==n.nodeType)){let i=Object.keys(Object(n)).filter(e=>0>t.indexOf(e));for(let t=0,o=i.length;t<o;t+=1){let o=i[t],a=Object.getOwnPropertyDescriptor(n,o);void 0!==a&&a.enumerable&&(iq(e[o])&&iq(n[o])?n[o].__swiper__?e[o]=n[o]:iG(e[o],n[o]):!iq(e[o])&&iq(n[o])?(e[o]={},n[o].__swiper__?e[o]=n[o]:iG(e[o],n[o])):e[o]=n[o])}}}return e}function iV(e,t,i){e.style.setProperty(t,i)}function iY(e){let t,{swiper:i,targetPosition:n,side:o}=e,a=iU(),r=-i.translate,s=null,l=i.params.speed;i.wrapperEl.style.scrollSnapType="none",a.cancelAnimationFrame(i.cssModeFrameID);let c=n>r?"next":"prev",f=(e,t)=>"next"===c&&e>=t||"prev"===c&&e<=t,d=()=>{t=new Date().getTime(),null===s&&(s=t);let e=Math.max(Math.min((t-s)/l,1),0),c=r+(.5-Math.cos(e*Math.PI)/2)*(n-r);if(f(c,n)&&(c=n),i.wrapperEl.scrollTo({[o]:c}),f(c,n)){i.wrapperEl.style.overflow="hidden",i.wrapperEl.style.scrollSnapType="",setTimeout(()=>{i.wrapperEl.style.overflow="",i.wrapperEl.scrollTo({[o]:c})}),a.cancelAnimationFrame(i.cssModeFrameID);return}i.cssModeFrameID=a.requestAnimationFrame(d)};d()}function iK(e,t){return void 0===t&&(t=""),[...e.children].filter(e=>e.matches(t))}function iJ(e,t){void 0===t&&(t=[]);let i=document.createElement(e);return i.classList.add(...Array.isArray(t)?t:[t]),i}function iQ(e,t){let i=iU();return i.getComputedStyle(e,null).getPropertyValue(t)}function iZ(e){let t,i=e;if(i){// eslint-disable-next-line
for(t=0;null!==(i=i.previousSibling);)1===i.nodeType&&(t+=1);return t}}function i0(e,t){let i=[],n=e.parentElement;// eslint-disable-line
for(;n;)t?n.matches(t)&&i.push(n):i.push(n),n=n.parentElement;return i}function i1(e,t,i){let n=iU();return i?e["width"===t?"offsetWidth":"offsetHeight"]+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-right":"margin-top"))+parseFloat(n.getComputedStyle(e,null).getPropertyValue("width"===t?"margin-left":"margin-bottom")):e.offsetWidth}function i2(){return t||(t=function(){let e=iU(),t=iF();return{smoothScroll:t.documentElement&&t.documentElement.style&&"scrollBehavior"in t.documentElement.style,touch:!!("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)}}()),t}let i5=(e,t)=>{if(!e||e.destroyed||!e.params)return;let i=t.closest(e.isElement?"swiper-slide":`.${e.params.slideClass}`);if(i){let t=i.querySelector(`.${e.params.lazyPreloaderClass}`);!t&&e.isElement&&(t=i.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`)),t&&t.remove()}},i6=(e,t)=>{if(!e.slides[t])return;let i=e.slides[t].querySelector('[loading="lazy"]');i&&i.removeAttribute("loading")},i3=e=>{if(!e||e.destroyed||!e.params)return;let t=e.params.lazyPreloadPrevNext,i=e.slides.length;if(!i||!t||t<0)return;t=Math.min(t,i);let n="auto"===e.params.slidesPerView?e.slidesPerViewDynamic():Math.ceil(e.params.slidesPerView),o=e.activeIndex;if(e.params.grid&&e.params.grid.rows>1){let i=[o-t];i.push(...Array.from({length:t}).map((e,t)=>o+n+t)),e.slides.forEach((t,n)=>{i.includes(t.column)&&i6(e,n)});return}let a=o+n-1;if(e.params.rewind||e.params.loop)for(let n=o-t;n<=a+t;n+=1){let t=(n%i+i)%i;(t<o||t>a)&&i6(e,t)}else for(let n=Math.max(o-t,0);n<=Math.min(a+t,i-1);n+=1)n!==o&&(n>a||n<o)&&i6(e,n)};function i4(e){let{swiper:t,runCallbacks:i,direction:n,step:o}=e,{activeIndex:a,previousIndex:r}=t,s=n;if(s||(s=a>r?"next":a<r?"prev":"reset"),t.emit(`transition${o}`),i&&a!==r){if("reset"===s){t.emit(`slideResetTransition${o}`);return}t.emit(`slideChangeTransition${o}`),"next"===s?t.emit(`slideNextTransition${o}`):t.emit(`slidePrevTransition${o}`)}}function i8(e){let t=iF(),i=iU(),n=this.touchEventsData;n.evCache.push(e);let{params:o,touches:a,enabled:r}=this;if(!r||!o.simulateTouch&&"mouse"===e.pointerType||this.animating&&o.preventInteractionOnTransition)return;!this.animating&&o.cssMode&&o.loop&&this.loopFix();let s=e;s.originalEvent&&(s=s.originalEvent);let l=s.target;if("wrapper"===o.touchEventsTarget&&!this.wrapperEl.contains(l)||"which"in s&&3===s.which||"button"in s&&s.button>0||n.isTouched&&n.isMoved)return;// change target el for shadow root component
...
r.updateProgress(a),s.cssMode){let e=r.isHorizontal();if(0===t)l[e?"scrollLeft":"scrollTop"]=-a;else{if(!r.support.smoothScroll)return iY({swiper:r,targetPosition:-a,side:e?"left":"top"}),!0;l.scrollTo({[e?"left":"top"]:-a,behavior:"smooth"})}return!0}return 0===t?(r.setTransition(0),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",t,o),r.emit("transitionEnd"))):(r.setTransition(t),r.setTranslate(a),i&&(r.emit("beforeTransitionStart",t,o),r.emit("transitionStart")),r.animating||(r.animating=!0,r.onTranslateToWrapperTransitionEnd||(r.onTranslateToWrapperTransitionEnd=function(e){r&&!r.destroyed&&e.target===this&&(r.wrapperEl.removeEventListener("transitionend",r.onTranslateToWrapperTransitionEnd),r.onTranslateToWrapperTransitionEnd=null,delete r.onTranslateToWrapperTransitionEnd,i&&r.emit("transitionEnd"))}),r.wrapperEl.addEventListener("transitionend",r.onTranslateToWrapperTransitionEnd))),!0}},transition:{setTransition:function(e,t){this.params.cssMode||(this.wrapperEl.style.transitionDuration=`${e}ms`,this.wrapperEl.style.transitionDelay=0===e?"0ms":""),this.emit("setTransition",e,t)},transitionStart:function(e,t){void 0===e&&(e=!0);let{params:i}=this;i.cssMode||(i.autoHeight&&this.updateAutoHeight(),i4({swiper:this,runCallbacks:e,direction:t,step:"Start"}))},transitionEnd:function(e,t){void 0===e&&(e=!0);let{params:i}=this;this.animating=!1,i.cssMode||(this.setTransition(0),i4({swiper:this,runCallbacks:e,direction:t,step:"End"}))}},slide:{slideTo:function(e,t,i,n,o){let a;void 0===e&&(e=0),void 0===t&&(t=this.params.speed),void 0===i&&(i=!0),"string"==typeof e&&(e=parseInt(e,10));let r=this,s=e;s<0&&(s=0);let{params:l,snapGrid:c,slidesGrid:f,previousIndex:d,activeIndex:p,rtlTranslate:u,wrapperEl:m,enabled:h}=r;if(r.animating&&l.preventInteractionOnTransition||!h&&!n&&!o)return!1;let g=Math.min(r.params.slidesPerGroupSkip,s),y=g+Math.floor((s-g)/r.params.slidesPerGroup);y>=c.length&&(y=c.length-1);let x=-c[y];// Normalize slideIndex
...
imagesToLoad:[],imagesLoaded:0}),c.emit("_swiper"),c.params.init&&c.init(),c)}getSlideIndex(e){let{slidesEl:t,params:i}=this,n=iK(t,`.${i.slideClass}, swiper-slide`),o=iZ(n[0]);return iZ(e)-o}getSlideIndexByData(e){return this.getSlideIndex(this.slides.filter(t=>1*t.getAttribute("data-swiper-slide-index")===e)[0])}recalcSlides(){let{slidesEl:e,params:t}=this;this.slides=iK(e,`.${t.slideClass}, swiper-slide`)}enable(){this.enabled||(this.enabled=!0,this.params.grabCursor&&this.setGrabCursor(),this.emit("enable"))}disable(){this.enabled&&(this.enabled=!1,this.params.grabCursor&&this.unsetGrabCursor(),this.emit("disable"))}setProgress(e,t){e=Math.min(Math.max(e,0),1);let i=this.minTranslate(),n=this.maxTranslate(),o=(n-i)*e+i;this.translateTo(o,void 0===t?0:t),this.updateActiveIndex(),this.updateSlidesClasses()}emitContainerClasses(){let e=this;if(!e.params._emitClasses||!e.el)return;let t=e.el.className.split(" ").filter(t=>0===t.indexOf("swiper")||0===t.indexOf(e.params.containerModifierClass));e.emit("_containerClasses",t.join(" "))}getSlideClasses(e){let t=this;return t.destroyed?"":e.className.split(" ").filter(e=>0===e.indexOf("swiper-slide")||0===e.indexOf(t.params.slideClass)).join(" ")}emitSlidesClasses(){let e=this;if(!e.params._emitClasses||!e.el)return;let t=[];e.slides.forEach(i=>{let n=e.getSlideClasses(i);t.push({slideEl:i,classNames:n}),e.emit("_slideClass",i,n)}),e.emit("_slideClasses",t)}slidesPerViewDynamic(e,t){void 0===e&&(e="current"),void 0===t&&(t=!1);let{params:i,slides:n,slidesGrid:o,slidesSizesGrid:a,size:r,activeIndex:s}=this,l=1;if(i.centeredSlides){let e,t=n[s]?n[s].swiperSlideSize:0;for(let i=s+1;i<n.length;i+=1)n[i]&&!e&&(t+=n[i].swiperSlideSize,l+=1,t>r&&(e=!0));for(let i=s-1;i>=0;i-=1)n[i]&&!e&&(t+=n[i].swiperSlideSize,l+=1,t>r&&(e=!0))}else // eslint-disable-next-line
...
return e}return iK(i,n())[0]})();return!o&&t.params.createElements&&(o=iJ("div",t.params.wrapperClass),i.append(o),iK(i,`.${t.params.slideClass}`).forEach(e=>{o.append(e)})),Object.assign(t,{el:i,wrapperEl:o,slidesEl:t.isElement&&!i.parentNode.host.slideSlots?i.parentNode.host:o,hostEl:t.isElement?i.parentNode.host:i,mounted:!0,// RTL
rtl:"rtl"===i.dir.toLowerCase()||"rtl"===iQ(i,"direction"),rtlTranslate:"horizontal"===t.params.direction&&("rtl"===i.dir.toLowerCase()||"rtl"===iQ(i,"direction")),wrongRTL:"-webkit-box"===iQ(o,"display")}),!0}init(e){let t=this;if(t.initialized)return t;let i=t.mount(e);if(!1===i)return t;t.emit("beforeInit"),t.params.breakpoints&&t.setBreakpoint(),// Add Classes
...
t.attachEvents();let n=[...t.el.querySelectorAll('[loading="lazy"]')];return t.isElement&&n.push(...t.hostEl.querySelectorAll('[loading="lazy"]')),n.forEach(e=>{e.complete?i5(t,e):e.addEventListener("load",e=>{i5(t,e.target)})}),i3(t),// Init Flag
t.initialized=!0,i3(t),// Emit
 ...
 * _.isObject(null);
 * // => false
 */function nA(e){var t=typeof e;return!!e&&("object"==t||"function"==t)}/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function nI(e){if("number"==typeof e)return e;if("symbol"==typeof(t=e)||t&&"object"==typeof t&&"[object Symbol]"==nE.call(t))return ng;if(nA(e)){var t,i="function"==typeof e.valueOf?e.valueOf():e;e=nA(i)?i+"":i}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(ny,"");var n=nb.test(e);return n||nv.test(e)?nw(e.slice(2),n?2:8):nx.test(e)?ng:+e}nh=/**
...
return void 0===l||i>=t||i<0||d&&n>=a}function h(){var e,i,n,o=nL();if(m(o))return g(o);// Restart the timer.
s=setTimeout(h,(e=o-l,i=o-c,n=t-e,d?nT(n,a-i):n))}function g(e){return(// Only invoke if we have `lastArgs` which means `func` has been
// debounced at least once.
(s=void 0,p&&n)?u(e):(n=o=void 0,r))}function y(){var e,i=nL(),a=m(i);if(n=arguments,o=this,l=i,a){if(void 0===s)return(// Reset any `maxWait` timer.
c=e=l,// Start the timer for the trailing edge.
s=setTimeout(h,t),f?u(e):r);if(d)return(// Handle invocations in a tight loop.
s=setTimeout(h,t),u(l))}return void 0===s&&(s=setTimeout(h,t)),r}return t=nI(t)||0,nA(i)&&(f=!!i.leading,a=(d="maxWait"in i)?nN(nI(i.maxWait)||0,t):a,p="trailing"in i?!!i.trailing:p),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,n=l=o=s=void 0},y.flush=function(){return void 0===s?r:g(nL())},y};let nM={form:document.querySelector(".js-form-search"),search:document.querySelector(".js-search"),time:document.querySelector(".js-time"),area:document.querySelector(".js-area"),ingredients:document.querySelector(".js-ingredients"),category:document.querySelector(".categories-js"),resetBtn:document.querySelector(".js-reset-filter-btn")};// ❗ Слухачі подій ❗
nM.form.addEventListener("submit",function(e){e.preventDefault()}),nM.time.addEventListener("change",function(e){iO("time",e.currentTarget.value),iT()}),nM.area.addEventListener("change",function(e){iO("area",e.currentTarget.value),iT()}),nM.ingredients.addEventListener("change",function(e){iO("ingredient",e.currentTarget.value),iT()}),nM.search.addEventListener("input",/*@__PURE__*/h(nh)(()=>{iO("title",nM.search.value.trim()),iT()},300)),t0().then(e=>{nM.area.innerHTML=e.data.map(({name:e})=>`<option class="filter-opt" value="${e}">${e}</option>`).join("")}).catch(e=>{console.log(e)}),tZ().then(e=>{nM.ingredients.innerHTML=e.data.map(({name:e,_id:t})=>`<option class="filter-opt" value="${t}">${e}</option>`).join("")}).catch(e=>{}),// ❗ Створення Time ❗
function(){let e="";// ❗ ДОРОБИТИ ПРАВИЛЬНУ ЛОГІКУ ЧАСУ ❗
for(let t=0;t<220;t+=5)t%10==0&&(e+=`<option class="filter-opt" value="${t}">${t}</option>`);nM.time.insertAdjacentHTML("beforeend",e)}(),// ❗ Створення js-reset-filter-btn ❗
nM.resetBtn.addEventListener("click",function(e){iB("time"),iB("area"),iB("ingredient"),iB("title"),iT()})}();//# sourceMappingURL=index.2a7140bc.js.map

//# sourceMappingURL=index.2a7140bc.js.map
