...
let{Axios:tD,AxiosError:tj,CanceledError:tF,isCancel:tW,CancelToken:tU,VERSION:tH,all:tX,Cancel:t$,isAxiosError:tG,spread:tV,toFormData:tq,AxiosHeaders:tY,HttpStatusCode:tK,formToJSON:tJ,getAdapter:tQ,mergeConfig:tZ}=tR,t0=document.querySelector(".card-list"),t1=async(e,t,i,n,r,o)=>{// Праметри API запиту
...
function(e){let{data:t}=e,i=t.map(({name:e})=>`<li class="categories-list-js"><button type="button" data-set="${e}" class="categories-btn-js">${e}</button></li>`).join("");return i}(e))}).catch(()=>{}),t9().then(e=>{ii.popular.insertAdjacentHTML("beforeend",e.data.map(e=>`
     <li class="popular-item-js">
        ...
        </li> `).join(""))}).catch(()=>{});let ig=ih();function ix(e){let t=/**
  |============================
  | Запит для Swiper
  |============================
*//**
...
s(t.wrapperEl,{attributes:!1})}}),n("destroy",()=>{o.forEach(e=>{e.disconnect()}),o.splice(0,o.length)})}]);let i0=ih();new iZ(i0.swiperJs,{pagination:{el:i0.pagination,type:"bullets",clickable:!0},direction:"horizontal",loop:!0,slidesPerView:"auto",noSwiping:!0,noSwipingClass:"no-swipe",speed:700,spaceBetween:16})}();//# sourceMappingURL=favorite.63003c08.js.map

//# sourceMappingURL=favorite.63003c08.js.map
